		...
		next: function () {
			...
			var lastStep = (this.currentStep === this.numSteps);
				if(this.currentStep==1)
				{
					...
					var appval  = $('#appName').val();
					var desval  = $('#appDescription').val();
					var dateval = $('.datepicker').val();
					var cateval = $('#appcategory').val();
					
					var special_char_check = charReg.test(appval);
					
					if(appval=='')
					{
						$('#appNamee').addClass("state-error");
					}
					else if(!special_char_check)
					{
						$('#appNamee').addClass("state-error");
						$.smallBox({
							title : "<i class='fa fa-warning-circle'></i>&nbsp;&nbsp; Warning !",
					...
					{
						$('#appDescriptionn').addClass("state-error");
					}
					else if(dateval=='')
					{
						$('#datepickerr').addClass("state-error");
					}
					else if(cateval=='0')
					{
						$('#appcategoryy').addClass("state-error");
					}
					...
					else
					{
						if (canMoveNext) {
							...
							// console.log(this.currentStep+"3");
