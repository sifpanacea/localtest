...
$.ajax({
	...
	userss.push({
            label:"TMREIS Health Supervisors Naresh",
            value:"TMREIS Health Supervisors Naresh"
   		  });
	userss.push({
	...
	userss.push({
            label:"BC Welfare Admin",
            value:"BC Welfare Admin"
   		  });
	...
	userss.push({
            label:"BC Welfare Health Supervisors",
            value:"BC Welfare Health Supervisors"
   		  });
	userss.push({
            label:"BC Welfare Doctors",
            value:"BC Welfare Doctors"
   		  });
	userss.push({
            label:"RHSO Officers",
            value:"RHSO Officers"
	...
	//console.log('GROUPS_LIST=============114',userss);
...
$.ajax({
			...
			//console.log("TTWREIS==HS===",data);
				if(data!='[]')
				{
					var group="BC Welfare Health Supervisors";
...
// BC welfare Doctors
$.ajax({
		url: 'get_bc_welfare_doctors_list',
		type: 'POST',
		async:false,
		dataType:"json",
  		success: function (data) {
