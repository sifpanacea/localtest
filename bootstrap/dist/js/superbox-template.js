...
(function($) {
	...
	console.log("..............")	
		...
		var superbox      = $('<div class="superbox-show"></div>'),
			superboximg   = $('<img src="" class="superbox-current-img"><div id="imgInfoBox" class="superbox-imageinfo inline-block"> <h1 class="title">Image Title</h1><span><p><em></em></p><p class="superbox-img-description">Image description</p><p><a href="javascript:void(0);" class="btn btn-primary btn-sm select">Select Image</a> <a href="javascript:void(0);" class="btn btn-danger btn-sm image-delete">Cancel</a></p></span> </div>'),
		...
		return this.each(function() {
			...
			//console.log($(this))
				...
				var currentimg = $this.find('.superbox-img'),
					...
					imgDescription = currentimg.attr('description') || "No description",
					imgLink = imgData,
