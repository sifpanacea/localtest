$(document).ready(function() {
		...
		{
			//$('#disapprove_stage').modal('show');
			//console.log("mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm1111111111111111");
			$('#disapprove_stage').one('show.bs.modal', function () 
			{
			  //console.log("mmmmmmmmmmmmmmmmmmm222222222222222222222222222222222",$('.modal-body').children().length);
			  if($('.modal-body').children().length == 0)
			  {
				//console.log("mmmmmmmmmmmmmmmmmmmmmmm333333333333333333333333333")
				var company_folder=_company_;//_app.replace(/[0-9]/g, '');
