...
function formsubmit()
{
	var valuecheck=$('#feedback_code').val();
...
if(clickedid)
{
	$.SmartMessageBox({
				title : "Alert !",
				content : "This Feedback application is not yet saved. Do you want to continue ?",
				buttons : '[No][Yes]'
