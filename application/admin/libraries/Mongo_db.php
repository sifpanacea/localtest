...
class Mongo_db
{
   ...
   protected $_configData = array(
    ...
    /**
     * id field Sorts array.
     *
     * @var array
     * @access protected
     */
    protected $id_field_sorts = array();
...
/**
	...
	public function insertTemp($collection = '', $insert1 = array(), $_id, $appName, $appDescription, $apptype, $appexpiry,$useremail,
     $options = array())
	 {
		if (empty($collection)) {
            throw new My_Exception('No Mongo collection selected to insert
        ...
        if (count($insert1) === 0 OR ! is_array($insert1)) {
            throw new My_Exception('Nothing to insert into Mongo collection
             or insert is not an array');
        }
        ...
        $insert['_id'] = $_id;
		$insert['appName'] = $appName;
		$insert['app_template'] = $insert1;
		$insert['appDescription'] = $appDescription;
		$insert['apptype'] = $apptype;
		$insert['appexpiry'] = $appexpiry;
		$insert['time'] = date('Y-m-d H:i:s');
...
/**
	...
	public function insertStut($collection = '', $appID, $_id, $options = array())
	 {
		if (empty($collection)) {
            throw new My_Exception('No Mongo collection selected to insert
             into');
    ...
    private function _connectionString()
    {
        ...
        $this->_host = trim($this->_configData['hostname']);
