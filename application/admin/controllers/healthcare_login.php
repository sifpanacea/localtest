...
class Healthcare_login extends CI_Controller {
	 ...
	 */
	 ...
	 {
		 //echo "working";
		/*log_message('debug','loginnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn'.print_r($this->input->post('identity'),true));
		log_message('debug','loginnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn'.print_r($this->input->post('password'),true));
		log_message('debug','postttttttttttttttttttttttttttttttttttttttttttttt'.print_r($_POST,true));*/
	 	$response ="";
	 	header('Access-Control-Allow-Origin: *');
	 	$name                 = $this->input->post('identity');
	 	$password             = $this->input->post('password');
	 		
	 	if ($this->ion_auth->dashlogin_healthcare($name,$password))
	 	{
	 		// $response=$name;
	 		// echo $response;
