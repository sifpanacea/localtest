...
class Ameya_life extends CI_Controller {
	...
	public function sample_ehr_case()
	{
		...
		$query = $this->mongo_db->select ( array (
				...
				'history' 
		) )->where ( "_id", new MongoID ( "5806fa061abb4eee3c7b23c9" ) )->get ( "healthcare20161014212024617" );
		if ($query) {
		...
		$this->_render_page('ameya_life/reports_display_ehr',$this->data);
	}
