		...
		<aside id="left-panel" style="min-height: 1108px;top: 95px;">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					...
					<a id="show-shortcut">
						...
						<img src="https://mednote.in/PaaS/bootstrap/dist/img//avatars/male.png" alt="me" class="online" />
						<span>
						    <div class="nav pull-right" id="adminusername">
							<div>PANACEA Admin</div>
							</div>
						</span>
					</a> 
