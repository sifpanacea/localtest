...
$page_title = "Activate (or) Deactivate Support Admin";
		...
		<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td>
							<?php echo ($user->active) ? anchor("auth/deactivate_support_admin/".$user->id, lang('support_deactivate_link')) : anchor("auth/activate_support_admin/". $user->id, lang('support_activate_link'));?>
                        </td>
					</tr>
					<?php $u++;?>
					<?php endforeach;?>
