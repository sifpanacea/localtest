...
$page_title = "Activate (or) Deactivate Customer";
		...
		<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td>
							<?php echo ($eachcustomer['active']) ? anchor("admin_dash/deactivate/".$eachcustomer['_id'], lang('customer_deactivate_link')) : anchor("admin_dash/activate/". $eachcustomer['_id'], lang('customer_activate_link'));?>
                        </td>
					</tr>
					<?php $u++;?>
					<?php endforeach;?>
