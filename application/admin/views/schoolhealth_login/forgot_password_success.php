...
<div id="main" role="main">
	...
	<!-- MAIN CONTENT -->
		...
		<!--<div class="logo">
			<h1 class="semi-bold"><img src="<?php echo IMG; ?>logo-tlstec.png" alt="" /></h1>
		</div>-->
		<div>
			<div>
				<p class="text-muted">
				...
				<br>
				<p>
				 <a  class="btn btn-success" href="<?php echo URL.'diabetic_care_auth/login'; ?>"> <?php echo lang('act_home');?></a>
				</p>
			</div>
