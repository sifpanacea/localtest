...
<?php */?>
		...
		<link href="<?php echo(CSS.'static_view_ameya.css'); ?>" media="screen" rel="stylesheet" type="text/css" />
		<style type="text/css">
		...
		?>
				...
				<header id="header">
				    <div id="logo-group">
						...
						<span id="">
						<img src="https://mednote.in/PaaS/healthcare/uploaddir/public/TS_GOVT_LOGO.jpg" alt="" class="logo_1 hide" style="">
						
						</span>
						<span id="">
						<img src="https://mednote.in/PaaS/bootstrap/dist/img/ameya.jpg" alt="" style="width:200px">
						</span>
				    	<!-- END LOGO PLACEHOLDER -->
					</div>
					
					<div class="panacea-custom-title" style="">
					<p class="panacea-headertext-top" style="">Ameya Life</p>
