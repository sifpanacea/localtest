...
// Errors
$lang['error_csrf'] = '。這種形式後沒有通過我們的安全檢查';

//Common

$lang['common_dash_heading']	           	=	'<img src= '.(IMG."logo-tlstec.png").' height="100px" width="177px">';
$lang['common_message']						=	'郵件!';
$lang['common_create_user_link']			=	'<i class="icon-dash-large icon-user icon-white"></i><span class="hidden-tablet">  創建一個新的管理員 </span>';
$lang['common_create_group_link'] 			=	'<i class="icon-dash-large icon-edit icon-white"></i><span class="hidden-tablet">  創建新組 </span>';
$lang['common_design_template_link']		=	'設計模板';
$lang['common_change_password_link']	    =	'<i class="icon-dash-large icon-folder-close-alt icon-white"></i><span class="hidden-tablet">  更改密碼 </span>';
$lang['common_design_template_link']		=	'<i class="icon-dash-large icon-font icon-white"></i><span class="hidden-tablet">  設計模板 </span>';
$lang['common_logout_link']					=	'<i class="icon-dash-large icon-lock icon-white"></i><span class="hidden-tablet"> 註銷 </span>';
$lang['common_logout_link_small']			=	'<i class="icon-off"></i> 註銷 </span>';
$lang['common_admin_dash_link']        		=	'<i class="icon-dash-large icon-home icon-white"></i><span class="hidden-tablet">  儀表板';
$lang['common_customers_dash_link']        		=	'<i class="icon-dash-large glyphicon icon-group"></i><span class="hidden-tablet">  客戶';
$lang['admin_profile']                            =   '<i class="icon-user"></i> 簡介 </span>';
$lang['admin_settings']                            =  '<i class="icon-wrench icon-white"></i> 設置 </span>';


$lang['common_copy_rights']					=	'&copy;2014, TLSTEC。版權所有。';
$lang['common_follow']		 				= ' - 跟隨我們 -';
$lang['common_comp_name_req']		 		= '\'請輸入您的公司名稱。\'';
$lang['common_comp_name_min']		 		= '\'請輸入至少5個字符.\'';
$lang['common_comp_name_max']		 		= '\'請輸入不超過25個字符.\'';
$lang['common_comp_site_req']		 		= '\'請輸入您公司的網站.\'';
$lang['common_comp_addr_req']		 		= '\'請輸入您公司的地址.\'';
$lang['common_email_req']	   				= '\'請輸入您的電子郵件地址.\'';
$lang['common_email_valid']	   				= '\'請輸入一個有效的電子郵件地址.\'';
$lang['common_pass_req']	   				= '\'請輸入您的密碼.\'';
$lang['common_pass_min']	   				= '\'請輸入至少8個字符.\'';
$lang['common_pass_max']	   				= '\'請輸入不超過25個字符.\'';
$lang['common_con_pass_req']	   			= '\'請輸入您的密碼一次.\'';
$lang['common_con_pass_min']	   			= '\'請輸入至少8個字符.\'';
$lang['common_con_pass_max']	   			= '\'請輸入不超過25個字符.\'';
$lang['common_con_pass_equal']	   			= '\'應該是相同的密碼字段.\'';
$lang['common_user_req']	   				= '\'請輸入您的用戶名.\'';
$lang['common_plan_req']	   				= '\'請選擇你的計劃.\'';
$lang['common_customer_req']	   			= '\'請選擇客戶.\'';
$lang['common_mobile_req']	   				= '\'請輸入您的手機號碼.\'';
$lang['common_mobile_no']	   				= '\'請輸入一個有效的數字.\'';
$lang['common_cp_req']	   					= '\'請輸入聯繫人的姓名.\'';
$lang['common_tc_req']	   					= '\'您必須同意條款和條件.\'';
$lang['common_type_req']	   				= '\'請輸入您的公司的類別.\'';

$lang['common_passage_1']	   		= '想像一下，你的精良辦公會，如果你的辦公室是無紙化呢！想體驗？我們加入 !';
$lang['common_passage_2']	   		= '搬出的紙張，不過遺憾的關於鍵入基於Web的形式 ?';
$lang['common_passage_3']	   		= '別擔心。填寫您自己的筆跡形式。感到興奮？想了解更多？只是領先一步！報名';
$lang['common_passage_4']	   		= '設計並立即部署業務應用程序！';
$lang['common_passage_5']	   		= '我們不單單只讓你設計你的應用程序。您也可以在幾分鐘內部署我們的安全的雲你的應用程序，讓您的企業進步輕鬆 !';

// Activation pages
$lang['title']     			= '激活你的PaaS帳戶';
$lang['act_sign']      		= '登錄';
$lang['act_sub_con']      	= '確認訂閱！..你TLSTEC PaaS的帳戶激活！ ！';
$lang['act_mail_sent']      = '你的PaaS的帳戶接受！確認電子郵件將被發送一次管理員激活您的賬號！ ！';
$lang['act_mail_sent_api']      = '您的API客戶接受！確認電子郵件將被發送一次所選客戶激活您的帳號！ ！';
$lang['forgot_password_mail_sent']   = '重置密碼電子郵件發送！ ！';
$lang['act_home']      		= '家'; 
...
$lang['login_subheading']      		= '登錄';
$lang['login_identity_label']  		= '電子郵件：';
$lang['login_identity_label_help']  = '請輸入電子郵件地址';
$lang['login_password_label']  		= '密碼:';
$lang['login_password_label_help']  = '請輸入您的密碼';
$lang['login_remember_label']  		= '保持登錄';
$lang['login_submit_btn']     		= '登錄';
$lang['login_forgot_password'] 		= '忘記密碼？';
$lang['login_need_acc'] 			= '需要一個帳戶？';
$lang['login_create_acc'] 			= '創建帳戶';
$lang['login_create_api'] 			= '創建第三方賬戶';
$lang['login_email_req']	   		= '\'請輸入您的電子郵件地址\'';
$lang['login_email_valid']	   		= '\'請輸入一個有效的電子郵件地址\'';
$lang['login_pass_req']	   			= '\'請輸入您的密碼\'';


//TLSTEC create account page
$lang['signup_title']							    	= '後';
$lang['signup_already_reg']							    	= '已經註冊？';
$lang['signup_sign_in']							    	= '登錄';
$lang['signup_subheading']      						= '在這裡註冊';
$lang['signup_customer_company_name']           		= '公司名稱';
$lang['signup_customer_company_name_help']           	= '請輸入您的公司名稱';
$lang['signup_customer_company_website']  				= '公司網站';
$lang['signup_customer_company_website_help']  			= '請輸入您公司的網站';
$lang['signup_customer_company_address']        		= '公司地址';
$lang['signup_customer_company_email']					= '電子郵件';
$lang['signup_customer_company_email_help']	        	= '請輸入您的電子郵件地址';
$lang['signup_customer_password'] 						= '密碼';
$lang['signup_customer_password_help']					= '8到20個字符之間輸入密碼';
$lang['signup_customer_confirm_password'] 				= '確認密碼';
$lang['signup_customer_confirm_password_help']			= '如果符合上述密碼';
$lang['signup_customer_username'] 						= '用戶名';
$lang['signup_customer_company_contact_mobile']			= '手機號';
$lang['signup_customer_company_contact_person']			= '聯繫人';
$lang['signup_customer_company_contact_person_help']	= '請輸入聯繫人的姓名。';
$lang['signup_customer_plan']							= '選擇計劃';
$lang['signup_customer_offers']							= '我想收到消息和特別優惠';
$lang['signup_customer_tc']								= '我同意 <a href="#" data-toggle="modal" data-target="#myModal"> 條款 </a>';
$lang['signup_customer_req']							= '註冊';
$lang['signup_customer_thanks']							= '謝謝您註冊！';
$lang['signup_customer_plan_bronze']							= '青銅';
$lang['signup_customer_plan_silver']							= '銀';
$lang['signup_customer_plan_gold']							= '金';
$lang['signup_customer_plan_diamond']							= '鑽石';
