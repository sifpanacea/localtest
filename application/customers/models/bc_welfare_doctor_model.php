...
class Bc_welfare_doctor_model extends CI_Model
{
	/**
...
//     	$query = $this->mongo_db->whereLike('doc_data.widget_data.page2.Review Info.Status',$type)->get($this->request_app_col);
	 ...
	 public function get_hs_req_docs($usercollection)
    {
      ...
      /*  $documents = [];
        $this->mongo_db->orderBy(array('doc_received_time' => -1));
        $not_emergency = $this->mongo_db->select(array(),array('_id'))->limit(200)->whereNe(array('request_type' => 'Emergency'))->where(array('status'=>'new','app_id'=>'healthcare2018122191146894'))->get($usercollection);
    ...
    {
        $this->mongo_db->orderBy(array('doc_received_time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->limit(200)->where(array('status'=>'new','app_id'=>'healthcare2018122191146894','request_type' => 'Emergency'))->get($usercollection);
        return $query;
    }
    ...
    {
        $this->mongo_db->orderBy(array('doc_received_time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->limit(200)->where(array('status'=>'new','app_id'=>'healthcare2018122191146894','request_type' => 'Chronic'))->get($usercollection);
    ...
    {
            /*$status = array();  
            $match = array('app_properties.status' => "new",'app_properties.app_id' => "healthcare2018122191146894");
        ...
        $query = $this->mongo_db->select(array(),array('_id'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->limit(2000)->where($hs_history)->get($usercollection);
        $full_doc = array();
    ...
    public function get_hs_req_emergency_new($usercollection)
    {
        ...
        $query=$this->mongo_db->select(array(),array('_id'))->limit(200)->where(array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2018122191146894','doc_data.widget_data.page2.Review Info.Request Type' => 'Emergency'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->get($usercollection);
        return $query;*/
        $hs_history = array('doc_data.widget_data.page2.Review Info.Request Type' => 'Emergency');
         $this->mongo_db->orderBy(array('history.time' => -1));
        $query = $this->mongo_db->select(array(),array('_id'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->limit(950)->where($hs_history)->get($usercollection);
        $full_doc = array();
        foreach ($query as $history)
            {
             $end_array = end($history['history']);
    ...
    {
       /* $this->mongo_db->orderBy(array('history.0.time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->limit(200)->where(array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2018122191146894','doc_data.widget_data.page2.Review Info.Request Type' => 'Chronic'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->get($usercollection);
    ...
    public function access_request_docs_form_hs($doc_id,$doc_access,$access_by)
    {
       ...
       // return $query;
       $time = time();
        $get_document = $this->mongo_db->select(array(),array('_id'))->where(array('doc_properties.doc_id' => $doc_id))->limit(1)->get('healthcare2018122191146894_static_html');
            if(isset($get_document) && !empty($get_document))
            {
                foreach ($get_document as $document) 
                {
                    ...
                    {
                       // $final_doc = $document;
                        $update = $this->mongo_db->where(array('doc_properties.doc_id' => $doc_id))->set(array('doc_properties.doc_access' => $doc_access,'doc_properties.access_by' => $access_by,'doc_properties.doc_access_time' => $time))->update('healthcare2018122191146894_static_html');
                         $get_document = $this->mongo_db->select(array(),array('_id'))->where(array('doc_properties.doc_id' => $doc_id))->limit(1)->get('healthcare2018122191146894_static_html');
                    ...
                    {                   
                        ...
                        {           
                            $final_doc = $document;
                            $time_2 = time();
                            $update = $this->mongo_db->where(array('doc_properties.doc_id' => $doc_id))->set(array('doc_properties.doc_access' => $doc_access,'doc_properties.access_by' => $access_by,'doc_properties.doc_access_time' => $time_2))->update('healthcare2018122191146894_static_html');
    ...
    {
        $doctor_history = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2018122191146894','doc_data.widget_data.page2.Review Info.Request Type' => 'Normal');
             $this->mongo_db->orderBy(array('history.time' => -1));
    ...
    {
       $doctor_history = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2018122191146894','doc_data.widget_data.page2.Review Info.Request Type' => 'Emergency');
             $this->mongo_db->orderBy(array('history.time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->limit(200)->where($doctor_history)->get($usercollection);
       $full_doc = array();
        foreach ($query as $history)
    ...
    {
    $doctor_history = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2018122191146894','doc_data.widget_data.page2.Review Info.Request Type' => 'Chronic');
             $this->mongo_db->orderBy(array('history.time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->limit(200)->where($doctor_history)->get($usercollection);
       $full_doc = array();
        foreach ($query as $history)
