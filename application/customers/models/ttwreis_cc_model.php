...
class Ttwreis_cc_model extends CI_Model
{
	/**
	 ...
	 function __construct()
    {
        ...
        $this->absent_app_col = "healthcare201671112421329";
...
//     	$query = $this->mongo_db->whereLike('doc_data.widget_data.page2.Review Info.Status',$type)->get($this->request_app_col);
    ...
    public function fetch_student_info_model($unique_id)
    {
        ...
        $res = $this->mongo_db->select(array('doc_data.widget_data'))->where(array('doc_data.widget_data.page1.Personal Information.Hospital Unique ID' => $unique_id))->get('ttwreis_screening_report_col_2021-2022');
        if(empty($res))
        {
        $res = $this->mongo_db->where ( "doc_data.widget_data.page1.Personal Information.Hospital Unique ID", $unique_id )->get ("ttwreis_other_classes_screening_data_2020-2021");
        }else if (empty($res)) {
        $res = $this->mongo_db->where ("doc_data.widget_data.page1.Personal Information.Hospital Unique ID", $unique_id)->get ("ttwreis_screening_report_col_2021-2022_passed_out");
        }     
            return $res;
    }
    ...
    public function get_dist_name_with_dist_id( $districtID)
    {
        ...
        $query = $this->mongo_db->select(array('dt_name'))->where("_id", new MongoID($districtID))->get('ttwreis_district');
    ...
    public function update_hb_values($month, $monthly_hb, $unique_id)
    {
        ...
        $is_already_updated = $this->mongo_db->where($check_query)->get('ttwreis_himglobin_report_col');
        ...
        if ($is_already_updated) {
            ...
            $response = $this->mongo_db->command(array(
                'findAndModify' => 'ttwreis_himglobin_report_col',
                'query'         => $query,
                'update'        => $update,
            ));
        ...
        $after_update = $this->mongo_db->where(array('doc_data.widget_data.page1.Student Details.Hospital Unique ID' => $unique_id))->set(array(
            ...
            ->update('ttwreis_himglobin_report_col');

        $after_update = $this->mongo_db->where(array('doc_data.widget_data.page1.Student Details.Hospital Unique ID' => $unique_id))->push('doc_data.widget_data.page1.Student Details.HB_values', $monthly_hb)->update('ttwreis_himglobin_report_col');
    ...
    {
        $query = $this->mongo_db->select(array('doc_data.widget_data.page1.Student Details.HB_values'))->where(array('doc_data.widget_data.page1.Student Details.Hospital Unique ID' => $unique_id))->get('ttwreis_himglobin_report_col');
     ...
     public function get_hs_req_normal($usercollection)
    {
          ...
          $query_normal = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2016108181933756','doc_data.widget_data.page2.Review Info.Request Type' => 'Normal');
        $this->mongo_db->orderBy(array('history.0.time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->limit(1500)->
     ...
     public function get_hs_req_emergency($usercollection)
    {
        ...
        $query_emergency = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2016108181933756','doc_data.widget_data.page2.Review Info.Request Type' => 'Emergency');
        $this->mongo_db->orderBy(array('history.0.time' => -1));
    ...
    {
        $query_chronic = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2016108181933756','doc_data.widget_data.page2.Review Info.Request Type' => 'Chronic');
        $this->mongo_db->orderBy(array('history.0.time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->limit(900)->
    ...
    public function get_school_information_for_school_code($school_code)
    {
        ...
        $school_data = $this->mongo_db->where(array('school_code'=>$school_code))->select(array('school_name','dt_name','contact_person_name','school_mob'),array())->get('ttwreis_schools');
    ...
    // -------------------------------------------------------------------------------
    public function get_history($doc_id)
    {
        $query = $this->mongo_db->select(array(),array('_id'))->where(array('doc_properties.doc_id' => $doc_id))->get('healthcare2016108181933756_static_html');
        return $query;
    }
    ...
    {
        $query = $this->mongo_db->where(array('doc_data.widget_data.page1.Personal Information.Hospital Unique ID' => $uniqueid))->get('ttwreis_screening_report_col_2021-2022');
        return $query;
    }
    ...
    public function fetch_field_officer_reports($today_date)
    {
        $final_data = array();
          ...
          $out_patients = $this->mongo_db->whereLike('history.last_stage.time',$today_date )->where('doc_data.widget_data.type_of_request',"Out Patients")->count('ttwreis_field_officer_report');
    ...
    public function drill_down_to_ttwreis_field_officer_reports_list($selectedCase, $selectedDate)
    {
    ...
    //screeening new data submit show
     ...
     public function update_screening_report_model($unique_id, $doc_data, $history)
    {
        ...
        $query = $this->mongo_db->where ('doc_data.widget_data.page1.Personal Information.Hospital Unique ID',$unique_id)->set(array('doc_data.widget_data' => $doc_data,"history"=>$history))->update($this->screening_app_col_tt_2021_2022);
        return $query;
    }
    ...
    public function get_searched_student_sick_requests_model($search_data)
    {
        ...
        if(preg_match("/_/", $data)){
            ...
            $query = $this->mongo_db->whereLike('doc_data.widget_data.page1.Student Info.Unique ID', $data)->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->orderBy(array('history.0.time' => -1))->get("healthcare2016108181933756_static_html");

        }else{

            $query = $this->mongo_db->whereLike('doc_data.widget_data.page1.Student Info.Name.field_ref', $data)->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->orderBy(array('history.0.time' => -1))->get("healthcare2016108181933756_static_html");
