...
class Bc_welfare_cc_model extends CI_Model
{
	/**
	 ...
	 function __construct()
    {
		...
		$this->sanitation_app_col = "healthcare201822113134483";
    ...
    {
     $query = $this->mongo_db->get('bc_welfare_district');
    ...
    {
     $count = $this->mongo_db->count('bc_welfare_schools');
	 return $count;
    }
	...
	public function get_schools($per_page,$page)
    {
     $offset = $per_page * ( $page - 1) ;
		$query = $this->mongo_db->limit($per_page)->offset($offset)->get('bc_welfare_schools');
    ...
    {
    	$query = $this->mongo_db->get('bc_welfare_schools');
    	foreach($query as $schools => $school){
    		$dt_name = $this->mongo_db->where('_id', new MongoId($school['dt_name']))->get('bc_welfare_district');
    		if(isset($school['dt_name'])){
    			$query[$schools]['dt_name'] = $dt_name[0]['dt_name'];
	...
	public function create_school($post)
    {
     ...
     $query = $this->mongo_db->insert('bc_welfare_schools',$data);
	 return $query;
    }
	
	public function delete_school($school_id)
    {
     $query = $this->mongo_db->where(array("_id"=>new MongoId($school_id)))->delete('bc_welfare_schools');
	 return $query;
    }
	
	public function classescount()
    {
     $count = $this->mongo_db->count('bc_welfare_classes');
	 return $count;
    }
    ...
    {
     $offset = $per_page * ( $page - 1) ;
		$query = $this->mongo_db->limit($per_page)->offset($offset)->get('bc_welfare_classes');
	 return $query;
    }
	...
	public function create_class($post)
    {
     ...
     $query = $this->mongo_db->insert('bc_welfare_classes',$data);
	 return $query;
    }
	
	public function delete_class($class_id)
    {
     $query = $this->mongo_db->where(array("_id"=>new MongoId($class_id)))->delete('bc_welfare_classes');
	 return $query;
    }
	
	public function sectionscount()
    {
     $count = $this->mongo_db->count('bc_welfare_sections');
	 return $count;
    }
    ...
    {
     $offset = $per_page * ( $page - 1) ;
		$query = $this->mongo_db->limit($per_page)->offset($offset)->get('bc_welfare_sections');
	 return $query;
    }
	...
	public function create_section($post)
    {
     ...
     $query = $this->mongo_db->insert('bc_welfare_sections',$data);
	 return $query;
    }
	
	public function delete_section($section_id)
    {
     $query = $this->mongo_db->where(array("_id"=>new MongoId($section_id)))->delete('bc_welfare_sections');
	 return $query;
    }
	
	public function symptomscount()
    {
     $count = $this->mongo_db->count('bc_welfare_symptoms');
	 return $count;
    }
    ...
    {
     $offset = $per_page * ( $page - 1) ;
		$query = $this->mongo_db->limit($per_page)->offset($offset)->get('bc_welfare_symptoms');
	 return $query;
    }
	...
	public function create_symptoms($post)
    {
     ...
     $query = $this->mongo_db->insert('bc_welfare_symptoms',$data);
	 return $query;
    }
	
	public function delete_symptoms($symptoms_id)
    {
     $query = $this->mongo_db->where(array("_id"=>new MongoId($symptoms_id)))->delete('bc_welfare_symptoms');
	 return $query;
    }
    ...
    public function doctorscount()
    {
    	...
    	$count = $this->mongo_db->count($this->collections['bc_welfare_doctors']);
    ...
    public function get_doctors($per_page,$page)
    {
    	$offset = $per_page * ( $page - 1) ;
    	$this->mongo_db->switchDatabase($this->common_db['common_db']);
    	$query = $this->mongo_db->limit($per_page)->offset($offset)->get($this->collections['bc_welfare_doctors']);
    	$this->mongo_db->switchDatabase($this->common_db['dsn']);
    	return $query;
    }
    ...
    {
    	$query = $this->mongo_db->where(array("_id"=>new MongoId($diagnostic_id)))->delete('bc_welfare_diagnostics');
    	return $query;
    }
    ...
    {
    	$query = $this->mongo_db->where(array("_id"=>new MongoId($hospital_id)))->delete('bc_welfare_hospitals');
    	return $query;
    }
    ...
    public function create_emp($post)
    {
    	...
    	$query = $this->mongo_db->insert('bc_welfare_emp',$data);
    	return $query;
    }
    
    public function delete_emp($emp_id)
    {
    	$query = $this->mongo_db->where(array("_id"=>new MongoId($emp_id)))->delete('bc_welfare_emp');
    	return $query;
    }
...
//     	$query = $this->mongo_db->whereLike('doc_data.widget_data.page2.Review Info.Status',$type)->get($this->request_app_col);
    ...
    public function user_exists($email = FALSE){
    	...
    	$this->mongo_db->switchDatabase($this->common_db['common_db']);
    	$query = $this->mongo_db->where(array('email'=> $email))->get($this->collections['bc_welfare_health_supervisors']);
    	$this->mongo_db->switchDatabase($this->common_db['dsn']);
      ...
      public function fetch_student_info_model($unique_id)
    {
        ...
        $res = $this->mongo_db->select(array('doc_data.widget_data'))->where(array('doc_data.widget_data.page1.Personal Information.Hospital Unique ID' => $unique_id))->get('bcwelfare_screening_report_col_2020-2021');
        if(empty($res))
        {
        $res = $this->mongo_db->where ( "doc_data.widget_data.page1.Personal Information.Hospital Unique ID", $unique_id )->get ("bcwelfare_other_classes_screening_data_2019-2020");
        }else if (empty($res)) {
        $res = $this->mongo_db->where ("doc_data.widget_data.page1.Personal Information.Hospital Unique ID", $unique_id)->get ("bcwelfare_screening_report_col_2020-2021_passed_out");
        }     
            return $res;
    }
    // ------------------------------------------------------------------------
     ...
     public function fetch_field_officer_reports($today_date)
    {
        $final_data = array();
          ...
          $out_patients = $this->mongo_db->whereLike('history.last_stage.time',$today_date )->where('doc_data.widget_data.type_of_request',"Out Patients")->count('bc_welfare_field_officer_report');
    ...
    public function show_field_officer_submit_student(/*$student_id,$doctor_visit_date*/ $doc_id)
    {
             ...
             $getSubmittedDocs = $this->mongo_db->where(array('doc_properties.doc_id'=>$doc_id))->get('bc_welfare_field_officer_report');
    ...
    $query_normal = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2018122191146894','doc_data.widget_data.page2.Review Info.Request Type' => 'Normal');
        $this->mongo_db->orderBy(array('history.0.time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->limit(2000)->where($query_normal)->get($usercollection);
     ...
     public function get_hs_req_emergency($usercollection)
    {
        //$array_emergency = array();
         $documents = [];
         $query_emergency = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2018122191146894','doc_data.widget_data.page2.Review Info.Request Type' => 'Emergency');
        $this->mongo_db->orderBy(array('history.0.time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->limit(1000)->where($query_emergency)->get($usercollection);
    ...
    {
        $query_chronic = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2018122191146894','doc_data.widget_data.page2.Review Info.Request Type' => 'Chronic');
        $this->mongo_db->orderBy(array('history.0.time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->limit(1000)->
        where($query_chronic)->get($usercollection);

        return $query;
    }

     public function get_hs_req_chronic_anemia($usercollection)
    {
        $query_chronic = array('app_properties.status'=>'new','app_properties.app_id'=>'healthcare2018122191146894','doc_data.widget_data.page1.Problem Info.Chronic.Blood' => 'Anemia');
        $this->mongo_db->orderBy(array('history.0.time' => -1));
        $query=$this->mongo_db->select(array(),array('_id'))->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->limit(1000)->
        where($query_chronic)->get($usercollection);
    ...
    function update_hb_values($ndate,$monthly_hb,$unique_id)
    {
     ...
     public function get_dist_name_with_dist_id( $districtID)
    {
        ...
        $query = $this->mongo_db->select(array('dt_name'))->where("_id", new MongoID($districtID))->get('bc_welfare_district');
    ...
    public function get_searched_student_sick_requests_model($search_data)
    {
        ...
        if(preg_match("/_/", $data)){
            ...
            $query = $this->mongo_db->whereLike('doc_data.widget_data.page1.Student Info.Unique ID', $data)->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->orderBy(array('history.0.time' => -1))->get("healthcare2018122191146894_static_html");

        }else{

            $query = $this->mongo_db->whereLike('doc_data.widget_data.page1.Student Info.Name.field_ref', $data)->whereNe(array('doc_data.widget_data.page2.Review Info.Status' => "Cured"))->orderBy(array('history.0.time' => -1))->get("healthcare2018122191146894_static_html");
    ...
    {
        $query = $this->mongo_db->select(array('doc_data.widget_data.page1.Personal Information.Photo'))->where(array('doc_data.widget_data.page1.Personal Information.Hospital Unique ID' => $unique_id))->whereNe(array('doc_data.widget_data.page1.Personal Information.Photo' => ""))->get($this->screening_app_col_bc_2021_2022);
        if(!empty($query))
        {
            return $query;
        }
    ...
    {
        $query = $this->mongo_db->where(array('doc_data.widget_data.page1.Personal Information.Hospital Unique ID' => $uniqueid))->get($this->screening_app_col_bc_2021_2022);
        return $query;
    }
    ...
    public function update_screening_report_model($unique_id, $doc_data, $history)
    {
      ...
      //  $doc_data = array("doc_data"=>array("widget_data"=>$doc_data),"doc_properties"=>$doc_properties, "app_properties" => $app_properties ,"history"=>$history);
        ...
        $query = $this->mongo_db->where ('doc_data.widget_data.page1.Personal Information.Hospital Unique ID',$unique_id)->set(array('doc_data.widget_data' => $doc_data,"history"=>$history))->update($this->screening_app_col_bc_2021_2022);
        return $query;
    }
