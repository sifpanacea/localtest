								...
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
											...
											<tr>
												...
												<td><?php echo $get_doc['doc_data']['widget_data']['page2']['Personal Information']['District'];?></td>
												<?php //foreach() ?>
												<?php //echo json_encode($get_doc['BMI_values']);?>
												<td><a class='delete1' href='<?php echo URL."bc_welfare_schools/show_student_bmi_graph/".$get_doc['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?>'>
