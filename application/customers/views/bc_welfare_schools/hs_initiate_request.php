...
<div id="content">
	<div class="row">
		...
		<div class="jarviswidget jarviswidget-color-greenLight show_requests_form"  id="wid-id-3" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" style="display: none;">
			...
			echo  form_open_multipart('bc_welfare_schools/initiate_hs_request',$attributes);
			?>
							...
							<div class="tab-pane fade in active" id="emergency_disease">
								<div class="row">
									...
									<div class="col col-md-4">
										...
										<i></i>Suicides</label>
										<label class="checkbox">
										<input type="checkbox" id="emergency_identifier" name="emergency_identifier[]" value="Burns">
										<i></i>Burns</label>									
										<label class="checkbox">
       ...
       if(result.length > 0){
           ...
           $('.ehrButton').click(function(){
               ...
               //$("#student_id").val(studentHealthID);
                window.location = '<?php echo URL; ?>bc_welfare_schools/access_submited_request_docs/'+studentHealthID;
              // $("#request_form").submit();
