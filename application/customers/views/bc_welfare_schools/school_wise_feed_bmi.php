...
$(document).ready(function() {
		...
		$(document).on('click','#app_open',function(e)
		{
			...
			if($(this).hasClass("attendance"))
			{
		      ...
		      /* apd__ = "healthcare2016620153753258";
		        ...
		        _url = "http://www.paas.com/PaaS/healthcare/index.php/healthcare/healthcare201651317373988_con/create";
		...
		var apd__ = "healthcare2018213172422286";
		var url = "https://mednote.in/PaaS/healthcare/index.php/healthcare/healthcare2018213172422286_con/create";
