                      ...
                      <div class="jarviswidget jarviswidget-color-orange" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" style="border: 5px solid #CB9235;">
                        ...
                        <div>
                          ...
                          <?php  $attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
                            echo  form_open_multipart('bc_welfare_schools/create_doctor_visit_report',$attributes);
                            ?>
                            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6" >
                                   <textarea class="form-control" name="remarks" placeholder="Textarea" rows="4"></textarea></div>
                                </div>
                          <div class="form-group">
                    ...
                    <div id="myModal" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                              ...
                              <div class="modal-content">                                      
                                <?php  $attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
                                  echo  form_open_multipart('bc_welfare_schools/add_doctor_profile',$attributes);
                                  ?>
...
<?php if($this->session->flashdata('success')): ?>
         ...
         swal({
                title: "Good job! Dr.name created successfully",
