...
$page_nav["pa feed_bmi"]["sub"]["Monthly BMI"]["active"] = true;
include("inc/nav.php");
       ...
       <article class="col-sm-12 col-md-12 col-lg-6">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
						...
						<header class="bg-color-greenDark txt-color-white">
							...
							<h2><strong>Import Monthly BMI </strong></h2>
		                </header>
						...
						<div>
							...
							<!-- widget content -->
											...
											echo form_open_multipart('bc_welfare_schools/imports_bmi_values',$attributes);?>
											<div class="panel-body">
												...
												<select  id="select_dt_name" required>
														<?php if(isset($district_name)): ?>
															...
															<option class='hidden' id='dist_name_naresh' value='<?php echo ucfirst($district_name)?>' ></option>
															<?php else: ?>
												...
												<select id="school_name" name="school_name" disabled=true>
                                    				...
                                    				<section >
														<p>To upload BMI data into our database select a file of excel format and press Import button.
														</p>
                                                    </section>
...
<?php if($message) {?>
$.smallBox({
				title : "<i class='fa fa-info-circle'></i>&nbsp;&nbsp;Import Success!",
