...
<div class="well well-sm col-sm-12">
		...
		<!-- <div class="row">
		    ...
		    <ul class="nav nav-tabs" id="myTab"> -->
                    <!-- <div class="liner"></div> -->
              <!--   <li class="col">
                     <a href="http://www.paas.com/PaaS/healthcare/index.php/bc_welfare_schools/all_activities" title="Basic Dashboard">
                      <span class="one">
                           <i>Basic Dashboard</i>
                      </span></a></li> -->
              <!-- <li class="col"><a href="<?php //echo URLCustomer; ?>index.php/bc_welfare_schools/to_dashboard" title="Advanced Dashboard"">
                     <span class="two">
			         ...
			         <div class="col-md-3 col-sm-6 col-xs-12">
			          <div class="info-box">
			            ...
			            <div class="info-box-content">
			              ...
			              <span class="info-box-number"><?php //echo $basic_dash_screening_report_yearly;?>
						  <?php echo 0;?></span>
			            </div>
			            <!-- /.info-box-content -->
			          </div>
           ...
           <div class="panel-heading" style="background-color: #ef5c0bc9; color: #f0f8ff;">Daily Health Issues</div>
				<table class="table table-sm">
				  ...
				  <tbody>
				   ...
				   <br><br>
				  <div class="panel-footer" style="background-color: #6b718c;"><a class="btn btn-primary" href="<?php echo URLCustomer.'index.php/bc_welfare_schools/hs_request' ?>">Submit Request</a>
				</div>
				</div>
    		  </div>
				...
				<table class="table table-sm">
				  ...
				  <br><br>
				   <div class="panel-footer" style="background-color: #6b718c;">
				    <a href="<?php echo URLCustomer.'index.php/bc_welfare_schools/fetch_submited_requests_docs' ?>">	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateRequests">Update Request </button></a>
				   </div>
				</div>
    		  </div>
			 ...
			 <div class="panel panel-primary">
				...
				<table class="table table-sm">
				  ...
				  <tbody>
				   ...
				   <div class="panel-footer" style="background-color: #6b718c;"><a href="<?php echo URLCustomer.'index.php/bc_welfare_schools/initiateBmiReport' ?>"><button type="button" class="btn btn-primary">Submit BMI
				   </button></a></div>
				</div>
    		  </div>
				...
				<table class="table table-sm">
				  ...
				  <tbody>
				    <tr>
				     ...
				     <td><span class="badge bg-color-red"><?php echo $severe_anamia; ?></span></td>
				    </tr>
				    <tr>
				      <th scope="row">
					 <a href="#" data-toggle="modal" data-target="#moderateinfo" style="color:#0033cc">Moderate</a></th>
				     <td><span class="badge bg-color-red"><?php echo $moderate_anamia; ?></span></td>
				    </tr>
				    <tr>
				      <th scope="row">
					 <a href="#" data-toggle="modal" data-target="#mildinfo" style="color:#0033cc">Mild</a></th>
				     <td><span class="badge bg-color-red"><?php echo $mild_anamia; ?></span></td>
				    </tr>
				    <tr>
				      <th scope="row">
					 <a href="#" data-toggle="modal" data-target="#normalinfo" style="color:#0033cc">Normal</a></th>
				     <td><span class="badge bg-color-red"><?php echo $normal_anamia; ?></span></td>
				    </tr>
				  </tbody>
				  </table>
				   <div class="panel-footer" style="background-color: #6b718c;"><a href="<?php echo URLCustomer.'index.php/bc_welfare_schools/initiateHemoglobinReport' ?>"><button type="button" class="btn btn-primary">Submit HB
				   </button></a></div>
				</div>
    		  </div>
    	</div>
				...
				<tbody>
				   <tr>
				    ...
				    <tr>
						...
						<tr>
					    <?php else: ?>
						<td><pre><p style="font-size: 18px; color: red;">Attendance Report <br>Not submittedToday,<br>please Submit!</pre><a href="<?php echo URLCustomer.'index.php/bc_welfare_schools/initiateAttendanceReport' ?>"><button type="button" class="btn btn-info">Submit Attendance</button></a></td>
						</tr>
				    <?php endif; ?>
				</form>
				  </table>
			...
			<div class="panel panel-primary" style="">
         		<div class="panel-heading" style="background-color: #ef5c0bc9; color: #f0f8ff;">Daily Sanitation Details</div>
				    ...
				    <tr>
				    	<?php else: ?>
					<td>
						<pre><p style="font-size: 18px; color: red; font-family: ">Sanitation Report<br>Not submitted Today,<br>Please Submit!</pre><br><a href="<?php echo URLCustomer.'index.php/bc_welfare_schools/initiateSanitationReport' ?>"><button type="button" class="btn btn-info">Submit Sanitation</button></a></p>
					</td>
						<?php endif; ?>
				    </tr>
					    	...
					    	<div class="modal-header" style="background-color: #ff3547;">
					     	...
					     	<div class="table-responsive">
									<table class="table">
									  ...
									  <td><a href='<?php echo URL."bc_welfare_schools/get_students_load_ehr_doc_basic_dashboard/".$row['doc_data']['widget_data']['page1']['Student Info']['Unique ID'];?>'>
							    ...
							    <div class="modal-header" style="background-color: #ff3547;">
							            <p class="heading lead" style="color: white; font-family: initial;">PANACEA HELP LINE NO : 040-45511222<br>Under Weight Students</h2></p>
							     		...
							     		<div class="table-responsive">
											...
											<td><a href='<?php echo URL."bc_welfare_schools/get_students_load_ehr_doc_basic_dashboard/".$row['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
										  <button class="btn btn-primary btn-xs">Show EHR</button>
										  </a></td>
										</tr>
									  </tbody>
