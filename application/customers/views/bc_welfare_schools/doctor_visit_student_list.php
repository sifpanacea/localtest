...
$page_title = "Doctor Treated Students";
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<header>
							...
							<h2>Doctor Treated Students on <?php echo $doctor_visiting_date; ?> <span class="badge bg-color-greenLight"><?php if(!empty($student_list)) {?><?php echo count($student_list);?><?php } else {?><?php echo "0";?><?php }?></span></h2>
					...
					<?php foreach ($student_list as $student):?>
						<tr>
                   		<td id ="uid" name= "uid"><?php echo $student['doc_data']['widget_data']['Student Details']['Hospital Unique ID']; ?></td>
                   		<td><?php echo $student['doc_data']['widget_data']['Student Details']['Name']; ?></td>
                   		<td><?php echo $student['doc_data']['widget_data']['Student Details']['Class']; ?></td>
                   		<td><?php echo $student['doc_data']['widget_data']['Student Details']['Section']; ?></td>
                   		<td><?php echo $student['doc_data']['widget_data']['Student Details']['remarks']; ?></td>
                   		
                   		<!-- <td  class="hide"><a href="<?php //echo URL.'tswreis_schools/show_doctor_treated_student/'.$student['doc_data']['widget_data']['Student Details']['Hospital Unique ID']."/".$student['doc_data']['widget_data']['Student Details']['doctor_visiting_date']; ?>" class="btn bg-color-greenDark txt-color-white btn-xs">Show</a></td> -->

                   		<td><a href="<?php echo URL.'bc_welfare_schools/show_doctor_treated_student/'.$student['doc_properties']['doc_id']; ?>" class="btn bg-color-greenDark txt-color-white btn-xs">Show</a></td>
                   		</tr>
					<?php endforeach;?>
					<?php else: ?>
        			<p>
