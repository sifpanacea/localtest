...
<div>
	...
	<div class="widget-body no-padding">
		...
		<div class="smart-form">
			...
			<section class="col col-6">
				<label class="label" for="first_name"><b>Student Unique ID</b></label>
				<?php if(isset($district_code) && isset($school_code)):?>
				   <label class='labelform uid'><?php echo $district_code."_".$school_code."_";?></label>
	...
	<!-- end widget content -->
	<div class="row">
	<div class="col-lg-8" id="show_bmi_graph">
	
	<h2>Student HB Graph</h2>
	<div id="show_bloodgroup">
	...
	<div class="col-lg-4 hb_tip hide">
	<br>
	 <h4>Plotting Graph based on Hemoglobin Ranges</h4>
		...
		graph_values = [];
			$.ajax({
				...
				try
				{
					...
					var bloodgroup = line_chart_data.bloodgroup;
					var show_bloodgroup = "<h3>Blood Group: "+bloodgroup+"</h3>" 
					$('#show_bloodgroup').html(show_bloodgroup);
					
					console.log('response',response);
					var graph_data = line_chart_data.graph_data;
					var month_data = line_chart_data.month_data;
