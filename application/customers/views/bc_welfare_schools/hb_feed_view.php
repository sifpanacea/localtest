                      ...
                      <div class="jarviswidget jarviswidget-color-orange" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" style="border: 2px solid #CB9235;">
                        ...
                        <div>
                          ...
                          <?php  $attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
                            echo  form_open_multipart('bc_welfare_schools/create_hemoglobin_report',$attributes);
                            ?>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-3">
                                 <!-- <input type="text" class="form-control" name="page1_StudentDetails_bloodgroup"> -->
                                  <input list="blood groups" class="form-control" name="page1_StudentDetails_bloodgroup">
                                ...
                                <div class="col-md-2">
                                   <input type="number" class="form-control" name="page1_StudentDetails_HB"></div>
...
page1_StudentDetails_bloodgroup:{minlength:1,maxlength:4},
...
page1_StudentDetails_bloodgroup:{},
