...
$page_title = "Screening file Import";
...
$page_nav["pa imports"]["sub"]["Screening file Imports"]["active"] = true;
include("inc/nav.php");
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
						...
						<div>
							...
							<!-- widget content -->
											...
											echo form_open_multipart('tmreis_mgmt/school_screening_file_import',$attributes);?>
											<div class="panel-body">
												<fieldset>
												
                                    				<section >
														<p>To upload zipfile of medical screening data into our database select a file of zip format and press Import button.
														</p>
                                                    </section>
                                              	...
                                              	<section>
													<div class="input input-file">
														<span class="button"><input type="file" id="file" name="userfile" accept=".zip,.rar" onchange="this.parentNode.nextSibling.value = this.value">Browse</span><input type="text" placeholder="Browse to import in compressed(ZIP) format" class="inputfield" id="btn_file"readonly="">
													</div>
												</section>
