								...
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
											...
											<tr>
												...
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page1']['Student Details']['HB_values']['0']['hb'];?></td>
												<?php //foreach() ?>
												<?php //echo json_encode($get_doc['BMI_values']);?>
												<td><a class='delete1' href='<?php echo URL."tmreis_mgmt/show_student_hb_graph/".$get_doc['student_info']['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
