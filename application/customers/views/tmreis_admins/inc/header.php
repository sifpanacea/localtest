...
<html lang="en-us">
	<head>
		...
		<link href="<?php echo CSS.'smartadmin-skins.css'; ?>" rel="stylesheet" type="text/css" media="screen" />
		<link href="<?php echo(CSS.'prettyPhoto.css'); ?>" media="screen" rel="stylesheet" type="text/css" />
...
<?php */?>
	...
	<body 
		...
		?>class="desktop-detected pace-done smart-style-5"
	>
		...
		?>
				...
				<header id="header" style="margin-top: 0px;height: 95px;">
				    <div id="logo-group">
						...
						<span id="">
						<img src="<?php echo TMREIS_LOGO_IMG; ?>" alt="" style="width: 75px;height:90px;margin-top:6px;margin-left:6px;">
						</span>
