									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												...
												<td><?php echo (gettype($student['doc_data']['widget_data']['page1']['Personal Information']['Mobile']) == "array") ? $student['doc_data']['widget_data']['page1']['Personal Information']['Mobile']['mob_num'] : "Mobile number not available";?></td>
												...
												<td><a class='ldelete' href='<?php echo URL."tmreis_mgmt/drill_down_screening_to_students_load_ehr_doc/".$student['_id'];?>'>
						                			<button class="btn btn-primary btn-xs">Show EHR</button>
						                			</a>
						                			<!-- 
						                			|
						                			<a class='ldelete' href='<?php echo URL."tmreis_mgmt/drill_down_screening_initiate_request/".$student['_id'];?>'>
