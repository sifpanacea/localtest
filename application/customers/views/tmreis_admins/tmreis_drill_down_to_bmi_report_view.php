								...
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
											...
											<tr>
												...
												<td><a class='delete1' href='<?php echo URL."tmreis_mgmt/show_student_bmi_graph/".$get_doc['student_info']['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?>'>
