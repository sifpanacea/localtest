...
$page_nav["application"]["sub"]["allapps"]["active"] = true;
include("inc/nav.php");
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<header>
							...
							<h2>All Apps <span class="badge bg-color-greenLight"><?php if(!empty($appcount)) {?><?php echo $appcount;?><?php } else {?><?php echo "0";?><?php }?></span></h2>
                    ...
                    <tbody>
					<tr>
						<td><?php echo ucfirst($app->app_name) ;?>
						...
						<td id="deleteallapps"><a class='ldelete' href='<?php echo URL."dashboard/delete_app/".$app->_id;?>'>
                			<?php echo lang('app_delete')?>
                			</a>
                		</td>
						<td><?php echo anchor("dashboard/share_app/".$app->_id, lang('app_share'));?></td>
					</tr>
					<?php $a++;?>
					<?php endforeach;?>
					<?php else: ?>
