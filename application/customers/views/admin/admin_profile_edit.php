	...
	<div id="content">
        ...
        <div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-1" data-widget-colorbutton="true" data-widget-editbutton="true" data-widget-custombutton="true">
						...
						<div>
							...
							echo  form_open_multipart('dashboard/edit_profile',$attributes);
							?>
		      					<!--<form class="smart-form">-->
									...
									<fieldset>
                                    <section>
                            			<label class="label" for="company_name"><?php echo lang('edit_profile_company_name_label', 'company_name');?></label>
                                    ...
                                    <section>
                            			<label class="label" for="contact_person"><?php echo lang('edit_profile_contactp_label', 'contact_person');?></label>
                                			<label class="input"> <i class="icon-append fa fa-pencil"></i>
                                    ...
                                    <section>
                            			<label class="label" for="mobile_number"><?php echo lang('edit_profile_mobile_label', 'mobile_number');?></label>
                                			<label class="input"> <i class="icon-append fa fa-pencil"></i>
