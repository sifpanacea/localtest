...
$page_nav["application"]["sub"]["myapps"]["active"] = true;
include("inc/nav.php");
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<header>
							...
							<h2>My Apps <span class="badge bg-color-greenLight"><?php if(!empty($myapps)) {?><?php echo count($myapps);?><?php } else {?><?php echo "0";?><?php }?></span></h2>
					...
					<tr>
						...
						<td id="deletemyapps"><a class='ldelete' href='<?php echo URL."dashboard/delete_my_app/".$app->_id;?>'>
