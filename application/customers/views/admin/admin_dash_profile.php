...
<div id="main" role="main">
	...
	<div id="acontent">
		...
		<div class="col-sm-12 text-align-right">
											...
											<div class="btn-group">
												<a href="<?php echo URL."dashboard/edit_profile"?>" class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i> Edit Profile</a>
											</div>
		                                            ...
		                                            <div class="row">
														...
														<table class="table table-bordered">
														 ...
														 <tr><td><?php echo $data['plan'];?></td><td><?php echo $data['registered_on'];?></td><td><?php echo $data['plan_expiry'];?></td></tr>
															...
															<div class="btn-group pull-left hide" style="margin-left:13px">
												<a href="<?php echo URL."auth/plan_upgrade/".$profile_data[0]['company_name']?>" class="btn btn-sm btn-primary"> <i class="fa fa-level-up"></i> Upgrade</a>
											</div>
														</li>
													</ul></h6></div>
...
<!-- ==========================CONTENT ENDS HERE ========================== -->
 <input type='hidden' id='company' name='company' value="<?php echo set_value('company', $data['company_name']);?>" />
<?php 
