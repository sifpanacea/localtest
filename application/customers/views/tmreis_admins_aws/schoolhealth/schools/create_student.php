...
<div>
	...
	echo  form_open_multipart('schoolhealth_school_portal/add_student_ehr',$attributes);
	?>
									...
									<section class="input-group col col-6">
											...
											<!--<div class="input-group">-->
															...
															<input class="form-control" placeholder=" Have Siblings ? Enable and please provide health unique ids separated by comma" type="text" id="siblings" name="siblings">
															<span class="input-group-addon">
																<span class="onoffswitch">
																	<input type="checkbox" name="siblings_check" class="siblings_check onoffswitch-checkbox" id="st3">
															...
															<!--<input class="form-control" placeholder=" Have Siblings ? Enable and please provide health unique ids separated by comma" type="text" id="siblings" name="st3">
															<span class="input-group-addon">
																<span class="onoffswitch">
																	<input type="checkbox" name="start_interval" id="siblings_check" class="onoffswitch-checkbox">
																	<label class="onoffswitch-label" for="st3"> 
																		<span class="onoffswitch-inner" data-swchon-text="YES" data-swchoff-text="NO"></span> 
																		<span class="onoffswitch-switch"></span> 
																	</label> 
