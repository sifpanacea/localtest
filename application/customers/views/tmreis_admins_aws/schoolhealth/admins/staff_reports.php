...
$page_nav["reports"]["sub"]["staff"]["active"] = true;
include("inc/nav.php");
...
<header>
	...
	<h2>Select a Category | Total staffs : <span class="badge bg-color-greenLight">
							<?php if(!empty($staffscount)) {?><?php echo $staffscount;?><?php } else {?><?php echo "0";?><?php }?></span></h2>
	...
	<form class=smart-form>
		<!--<form class="smart-form">-->
			...
			<section class="col col-6">
				<label class="label" for="first_name">Category</label>
				<label class="select">
				<select id="select_dt_name" >
					<option value="" selected="0" disabled="">Select a category</option>
						<option value='All' >All</option>
						<option value='teaching' ><?php echo "Teaching";?></option>
						<option value='non_teaching' ><?php echo "Non Teaching";?></option>
