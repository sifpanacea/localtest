...
<div>
	...
	echo  form_open('tmreis_mgmt/create_district',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><?php //echo anchor("tmreis_mgmt/tmreis_mgmt_manage_dists/".$dist['_id'], lang('app_edit')) ;?>
						
						<a class='ldelete' href='<?php echo URL."tmreis_mgmt/tmreis_mgmt_delete_dists/".$dist['_id'];?>'>
