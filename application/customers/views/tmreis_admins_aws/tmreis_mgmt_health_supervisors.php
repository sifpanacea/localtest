...
$page_title = "tmreis Health Supervisors";
...
<div>
	...
	echo  form_open('tmreis_mgmt/create_health_supervisors',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<a class='ldelete' href='<?php echo URL."tmreis_mgmt/tmreis_mgmt_delete_health_supervisors/".$hs['_id'];?>'>
