...
<div>
	...
	echo  form_open('tmreis_mgmt/create_doctor',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<a class='ldelete' href='<?php echo URL."tmreis_mgmt/tmreis_mgmt_delete_doctor/".$doctor['_id'];?>'>
