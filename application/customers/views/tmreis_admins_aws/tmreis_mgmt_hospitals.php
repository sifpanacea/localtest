...
<div>
	...
	echo  form_open('tmreis_mgmt/create_hospital',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><?php //echo anchor("tmreis_mgmt/tmreis_mgmt_diagnostic/".$hospital['_id'], lang('app_edit')) ;?>
						
						<a class='ldelete' href='<?php echo URL."tmreis_mgmt/tmreis_mgmt_delete_hospital/".$hospital['_id'];?>'>
