...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<?php if($chronic_case_type == "HIV" ): ?> 
							<td> <a class='ldelete' href='<?php echo URL."ttwreis_mgmt/ttwreis_reports_display_ehr_uid/"?>? id = <?php echo $chronic['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>' onclick="return false;">
						                			<button class="btn btn-primary btn-xs" disabled="disabled">Show EHR</button>
						         </a>			
							</td>
						<?php else: ?>
							<td> <a class='ldelete' href='<?php echo URL."ttwreis_mgmt/drill_down_screening_to_students_load_ehr_new_dashboard/".$chronic['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
