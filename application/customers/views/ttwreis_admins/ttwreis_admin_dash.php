                ...
                <div class="col-sm-5">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li <?php if($current_page == 'School_Reports') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_reports_school"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'Hospital_Reports') { echo 'class="active"';} ?>>
                                  <a href='<?php echo URL."ttwreis_mgmt/ttwreis_reports_hospital"; ?>'>
                                      <i class="material-icons">navigate_next</i>
                                      <span>Hospital Reports</span>
                                  </a>
                                </li>
                                <li <?php if($current_page == 'Doctor_Reports') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_reports_doctors"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'blood banks') { echo 'class="active"';} ?>>
                                  <a href='<?php echo URL."ttwreis_mgmt/panacea_blood_blanks_report"; ?>'>
                                      <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'cured_requests') { echo 'class="active"';} ?>>
                                    <a href='<?php echo URL."ttwreis_mgmt/panacea_mgmt_dmho_numbers"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>DM & HO Data</span>
                                    </a>
                                </li>

                                <li <?php if($current_page == 'Student_Reports') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_reports_students_filter"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Student Reports</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'Symptoms') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_reports_symptom"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Symptoms</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'Electronic_Health_Record') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_reports_ehr"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Electronic Health Record</span>
                                    </a>
                                </li>
                                 <li <?php if($current_page == 'Reports Download') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/get_reports_download"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/napkin_distribution_reports"; ?>">
                                       <i class="material-icons">navigate_next</i>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li <?php if($current_page == 'Diagnostics') { echo 'class="active"';}?>>
                                        <a href="<?php echo URL."ttwreis_mgmt/ttwreis_imports_diagnostic"; ?>">
                                            <i class="material-icons">navigate_next</i>
                                            <span>Diagnostics</span>
                                        </a>
                                </li>                            
                                <li <?php if($current_page == 'Hospitals') { echo 'class="active"';} ?>>
                                  <a href='<?php echo URL."ttwreis_mgmt/ttwreis_imports_hospital"; ?>'>
                                      <i class="material-icons">navigate_next</i>
                                      <span>Hospitals</span>
                                  </a>
                                </li>
                                <li <?php if($current_page == 'Schools') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_imports_school"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Schools</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'Health Supervisors') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_imports_health_supervisors"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Health Supervisors</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'Students') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_imports_students"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                 ...
                                 <li <?php if($current_page == 'Students') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_upgrade_students_clases"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Updrade Classes</span>
                                    </a>
                                </li>

                                <li <?php if($current_page == 'Screening File Import') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/imports"; ?>">
                                        <i class="material-icons">navigate_next</i>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li <?php if($current_page == 'Add_News_Feed') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/add_news_feed_view"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Add News Feed</span>
                                    </a>
                                </li>                            
                                <li <?php if($current_page == 'Manage_News_Feed') { echo 'class="active"';} ?>>
                                  <a href='<?php echo URL."ttwreis_mgmt/manage_news_feed_view"; ?>'>
                                      <i class="material-icons">navigate_next</i>
                            ...
                            <ul class="dropdown-menu">
                               <!--  <li <?php //if($current_page == 'School_health_status') { echo 'class="active"';} ?>>
                                ...
                                <li <?php if($current_page == 'Disease_wise_Students_list') { echo 'class="active"';} ?>>
                                    <a href='<?php echo URL."ttwreis_mgmt/schools_overall_information"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'Disease_wise_Students_list') { echo 'class="active"';} ?>>
                                    <a href='<?php echo URL."ttwreis_mgmt/disease_wise_students_list"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                 ...
                                 <li <?php if($current_page == 'Health Assistants Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/health_assistancts_status"; ?>">
                                       <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'pie_export') { echo 'class="active"';} ?>>
                                    <a href='<?php echo URL."ttwreis_mgmt/pie_export"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Pie Export</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'send_message') { echo 'class="active"';} ?>>
                                    <a href='<?php echo URL."ttwreis_mgmt/send_message_to_schools"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Send Message</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'parent_registration') { echo 'class="active"';} ?>>
                                    <a href='<?php echo URL."ttwreis_mgmt/get_parent_health_registration"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Parent Registration</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/requests_notes"; ?>">
                                       <i class="material-icons">navigate_next</i>
                                       <span>Request Notes</span>
                                    </a>
                               </li>
                               <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/panacea_aarogyasri_hospitals_list"; ?>">
                                       <i class="material-icons">navigate_next</i>
                                       <span>Aarogyasri Hospitals</span>
                                    </a>
                               </li>
                               <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/ttwreis_dr_not_responded_docs"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/panacea_organ_transplant_hospitals_list"; ?>">
                                       <i class="material-icons">navigate_next</i>
                               ...
                               <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."ttwreis_mgmt/tt_welfare_ro_plant_incinarators"; ?>">
                                        <i class="material-icons">navigate_next</i>
                        ...
                        <div id="mySidepanel" class="sidepanel">
                          <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>
                            ...
                            <a href="<?php echo URL."ttwreis_mgmt/tribal_covid_cases"; ?>">
                                <i class="material-icons">navigate_next</i>
                                <span>Covid-19 Cases</span>
                            </a>

                            <a href="<?php echo URL."ttwreis_mgmt/tribal_covid_cured_cases"; ?>">
                                <i class="material-icons">navigate_next</i>
                                <span>Covid Cured Cases</span>
                            </a>

                             <a href="<?php echo URL."ttwreis_mgmt/ttwreis_staff_covid_cases"; ?>">
                                <i class="material-icons">navigate_next</i>
                                <span>Staff Covid Cases</span>
                            </a> 
                           
                            <a href="<?php echo URL."ttwreis_mgmt/tribal_deadth_cases"; ?>">
                                <i class="material-icons">navigate_next</i>
                                <span>Expired Cases</span>
                            </a>                           

                        </div>
                        <button class="openbtn" data-toggle="tooltip" data-placement="bottom" title="To See Covid-19 Cases" onclick="openNav()">Covid-19</button> 
                    </div>
                    ...
                    <ul class="dropdown-menu">
                        <li <?php if($current_page == 'employees_tracking_dashboard') { echo 'class="active"';} ?>>
                            <a href='<?php echo URL."ttwreis_mgmt/employees_tracking_dashboard"; ?>'>
                                <i class="material-icons">navigate_next</i>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="info-box-3 bg-grey hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <a href="<?php echo URL."ttwreis_mgmt/panacea_today_followup_cases"; ?>" class="badge bg-red status_blink">Today's Follow up cases :<span class="badge bg-green" style="padding: 8px;"><?php echo $regular_alerts; ?></span></a>
                    </div>
                </div>
            </div>
        </div>
                         ...
                         <div class="body"  style="height: 290px;">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <a class='ldelete' href='<?php echo URL."ttwreis_mgmt/ttwreis_reports_display_ehr_uid/"?>? id = <?php echo $pic['uniqid']; ?>'>
                                    <button type="button" style="width: 79%;" class="btn bg-pink waves-effect">Show EHR</button>
                                    </a> 
                                </div>
                            </div>
                        </div>
        ...
        <div class="card">
            <div class="header" style="padding: 15px">
               <!--  <h2>Yearly Requests Pie</h2> -->
                ...
                <ul class="header-dropdown m-r--5 m-t--10 " >
                    <li>
                        <select class="form-control show-tick academic_filter_request common_change hidden" id="academic_filter_request">
                            <option value="2020-2021" selected="">2020-2021 AcademicYear</option>
                            <option value="2019-2020">2019-2020 AcademicYear</option>
                            <option value="2018-2019">2018-2019 AcademicYear</option>
                            <option value="2017-2018">2017-2018 AcademicYear</option>
                            <option value="2016-2017">2016-2017 AcademicYear</option>
            ...
            <div class="body">
                ...
                <!-- <div id="chronic_piechart" style="display: none;">Work Is In progress</div> -->
...
<script type="text/javascript">
   ...
   $('input[name = "disease_pie_radio"]').click(function(){
        ...
        if(radio == 'yearly_request_pie'){
            $('#piechart_3d').show();
            $('#academic_filter_request').show();
            $('#chronic_pie_disease').hide();
        }else{
            $('#chronic_pie_disease').show();
            $('#piechart_3d').hide();
            $('#academic_filter_request').hide();
        }
   });
        ...
        function selectHandler() {
            ...
            if (selectedItem) {
             ...
             //alert('The user selected ' + value);
              ...
              var district = $('.district_filter').val();
              var school = $('.school_filter').val();
              var academicYear = $('.academic_filter_request').val();
              //var gender =  $('.gender_filter').val();
              //$('#date_req').val(date);
              $('#val_req').val(value);
...
/*
    ...
    $('#screened_school_count').html('<div class="text">Screened Institutions </div><div class="number count-to" data-from="0" data-to="" data-speed="1000" data-fresh-interval="20">0</div>');

    $('#not_screened_school_count').html('<div class="text">Unscreened Institutions </div><div class="number count-to" data-from="0" data-to="" data-speed="1000" data-fresh-interval="20">188</div>');
...
function show_chronic_request_bar(datas){
    ...
    var chronic_pie_chart = Morris.Donut({
        ...
        data: datas,
    colors: ['rgb(233, 30, 99)', 'rgb(0, 188, 212)', 'rgb(255, 152, 0)', 'rgb(0, 150, 136)', 'rgba(0, 0, 255, 1)', 'rgb(60, 60, 60)', 'rgba(255, 99, 71, 0.6)', 'rgb(238, 130, 238)','rgba(0, 104, 0, 1)','rgba(255, 255, 0, 1)','rgba(0, 255, 0, 1)','rgb(0,0, 150, 136)','rgb(0, 250, 136)','rgb(0, 150, 256)','rgb(0, 350, 196)'],
...
$('#school_health_zone_wise').change(function(){
 ...
 /*Strat Attendance submitted and not submitted list counts date wise*/
