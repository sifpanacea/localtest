...
<br>
 ...
 -->
  ...
  <form style="display: hidden" action="<?php echo URL; ?>ttwreis_mgmt/get_students_for_admitted" method ="POST" id="get_students_for_admitted">
    ...
    function data_table_for_filters(result){
      ...
      if(result){
            ...
            /*if(requestsCount == 'Animals'){*/
              ...
              data_table = data_table+'<td><button class="btn btn-primary show_studs">Show Students</button></td>';
