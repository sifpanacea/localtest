...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="row clearfix">
                <div class="col-sm-5">
                   <h3 class="font-bold col-green"><li data-toggle="tooltip" data-placement="top" title="" data-original-title="Attendance Type"><?php echo $ro_plant_status; ?> Information</h3>
                </div>
