					...
					<table id="datatable_fixed_column" class="table table-bordered table-striped table-hover dataTable js-exportable">
						...
						<tbody>
				        	...
				        	<tr>
				        		...
				        		<td>
				        			<a href="<?php echo URL."ttwreis_mgmt/ttwreis_reports_display_ehr_uid/"?>? id = <?php echo $stud['doc_data']['widget_data']['page1']['Personal Information']["Hospital Unique ID"]; ?>"><button type="button" class="btn bg-teal waves-effect">Show EHR</button></a>
				        		</td>
				        	</tr>
						        <?php endforeach; ?>
						    <?php endif; ?>
