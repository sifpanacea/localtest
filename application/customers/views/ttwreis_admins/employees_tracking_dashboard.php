...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="row clearfix">
                <div class="col-sm-2">
                   <h3 class="font-bold col-green">Employees Track</h3>
                </div>
                  ...
                  <!--  <div class="col-sm-2">
                   <h2 class="card-inside-title">Select RHSO</h2>
                    ...
                    <option value="All">All</option>
                      <?php //if(isset($cc_names) && !empty($cc_names)): ?>
                      <?php //foreach($cc_names as $cc): ?>
                        <option value="<?php //echo $cc['email']; ?>"><?php echo $cc['username']; ?></option>
                      <?php //endforeach; ?>
                      <?php //endif; ?>
                     </select>
                    </div>
    ...
    function data_table_for_filters(result){
      ...
      if(result == "No Data Available"){
          $('#sanitation_filters').html('<h4>No Data Available For this Doctor....</h4>');
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>Employee Name</th><th>Request calls</th><th>Attendance Calls</th><th>Other Calls</th></tr></thead><tbody>';
             ...
             /* data_table = data_table+'<td>'+this.School Name+'</td>';
              ...
              var data = "";
                 ...
                 data_table = data_table +'<td>'+value['request_count']+'</td>';
                 data_table = data_table +'<td>'+value['attendance_count']+'</td>';
                 data_table = data_table +'<td>'+value['other_count']+'</td>';
