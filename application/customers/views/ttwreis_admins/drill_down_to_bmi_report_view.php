								...
								<div class = "under weight " id ="under weight">
									...
									<thead>			                
										<tr>
											...
											<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> BMI Values</th>
											<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> BMI Graph</th>
											
										</tr>
									</thead>
									<tbody>
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
												
											<tr>
												<td><?php echo $get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?></td>
												<?php if(isset($get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref']) && !empty($get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref'])): ?>
												<td><?php echo $get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref'];?></td>
												<?php else: ?>
												<td><?php echo "";?></td>
												<?php endif; ?>	
												<?php if(isset($get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['Class']['field_ref']) && !empty($get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['Class']['field_ref'])): ?>
												<td><?php echo $get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['Class']['field_ref'];?></td>
												<?php else: ?>
												<td><?php echo "";?></td>
												<?php endif; ?>	
												<td><?php echo $get_doc[0]['doc_data']['widget_data']['school_details']['School Name'];?></td>
												<td><?php echo $get_doc[0]['doc_data']['widget_data']['school_details']['District'];?></td>
												<?php $bmi = $get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['BMI_values']; $bmi_final = end($bmi);?>
												<td><?php echo $bmi_final['bmi'];?></td>
												<?php //foreach() ?>
												<?php //echo json_encode($get_doc['BMI_values']);?>
												<td><a class='delete1' href='<?php echo URL."ttwreis_mgmt/show_student_bmi_graph/".$get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
