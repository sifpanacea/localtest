                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <tr>     
                                ...
                                <td> <a class='ldelete' href='<?php echo URL."ttwreis_mgmt/ttwreis_reports_display_ehr_uid/"?>? id = <?php echo $doc['doc_data']['widget_data']["Student Details"]['Hospital Unique ID'];?>'>                                        
