				...
				<div class="col-lg-4 col-xs-6">
					<div class="panel panel-primary suman_panel">					 
					  <div class="panel-body btn-primary">
					  	<div id='sevier_count'>					  		
							<a class="hbCases" style="color: #fafafa"><h4>Critical Anemia Cases Count :<strong id="below_6_hb"></strong></h4></a><p></p>
			...
			<div>
				...
				<form class=smart-form>
					...
					<fieldset>
						<div class="row">
						<section class="col col-4">							
							   <a href='<?php echo URL."ttwreis_mgmt/ttwreis_covid_cases"; ?>'>Covid-19 Cases</a> 							  
						</section>
						<br>
						<br>						
						<section class="col col-4">
							 <a href='<?php echo URL."ttwreis_mgmt/ttwreis_covid_cured_cases"; ?>'>Covid Cured Cases</a>
						</section> 
						</div>
					</fieldset>	
				</form>
...
<br><br>
	...
	<form style="display: hidden" action="<?php echo URL; ?>ttwreis_mgmt/get_bmi_students_docs" method="POST" 
		id="bmi_report_form">
	  
	  <input type="hidden" id="bmi_type" name="bmi_type" value=""/>
	</form>
	<form style="display: hidden" action="<?php echo URL; ?>ttwreis_mgmt/get_hb_students_docs" method="POST" 
		id="hb_report_form">
	  
	  <input type="hidden" id="hb_type" name="hb_type" value=""/>
	</form>
	<form style="display: hidden" action="<?php echo URL; ?>ttwreis_mgmt/get_chronic_students_docs" method="POST" 
		id="chronic_report_form">
	  
	  <input type="hidden" id="chronic_type" name="chronic_type" value=""/>
	</form>
	<form style="display: hidden" action="<?php echo URL; ?>ttwreis_mgmt/get_emergency_req_students_docs" method="POST" 
		id="emergency_report_form">
	  
	  <input type="hidden" id="emergencyReq" name="emergencyReq" value=""/>
	</form>
	<form style="display: hidden" action="<?php echo URL; ?>ttwreis_mgmt/get_field_officer_docs" method="POST" 
		id="fieldOfficer_report_form">
	  
	  <input type="hidden" id="fieldOfficerReq" name="fieldOfficerReq" value=""/>
	</form>
	
	<form style="display: hidden" action="<?php echo URL; ?>ttwreis_mgmt/get_show_ehr_details" method="POST" id="requests_show_form">
	...
	function document_details_list(result)
		{
			...
			url = '<?php echo URL."ttwreis_mgmt/get_show_ehr_details"; ?>';
