...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="row clearfix">
                <div class="col-sm-3">
                   <h3 class="font-bold col-green">Students Request Notes </h3>
                </div>
                         ...
                         <tbody>
                             <?php foreach ($notes_data as  $data ): ?>                                   
                              <tr>
                                ...
                                <td>              
                                    <a class='ldelete' href='<?php echo URL."ttwreis_mgmt/ttwreis_reports_display_ehr_uid/"?> ? id = <?php echo $data['uid'];?>'>                  
    ...
    function data_table_for_filters(result){
      ...
      if(result == "No Data Available"){
          $('#sanitation_filters').html('<h4>No Data Available For this Field Officer.</h4>');
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>Health ID</th><th>Name</th><th>Class</th><th>School Name</th><th>Date of Submit</th><th>Remarks</th><th>Submitted By</th><th>Action</th></tr></thead><tbody>';
              ...
              data_table = data_table+'<td>'+this.username+'</td>';
