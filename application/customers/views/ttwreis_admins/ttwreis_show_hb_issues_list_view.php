...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<?php if(isset($hb['doc_data']['widget_data']['school_details']['District']) && !empty($hb['doc_data']['widget_data']['school_details']['District']) && !is_null($hb['doc_data']['widget_data']['school_details']['District'])): ?>
							<td><?php echo $hb['doc_data']['widget_data']['school_details']['District'];?></td>
							<?php else : ?>
								<td><?php echo "";?></td>
							<?php endif; ?>
						<?php if(isset($hb['doc_data']['widget_data']['school_details']['School Name']) && !empty($hb['doc_data']['widget_data']['school_details']['School Name']) && !is_null($hb['doc_data']['widget_data']['school_details']['School Name'])): ?>
							<td><?php echo $hb['doc_data']['widget_data']['school_details']['School Name'];?></td>
							<?php else : ?>
								<td><?php echo "";?></td>
								<?php endif; ?>
						<td> <a class='ldelete' href='<?php echo URL."ttwreis_mgmt/drill_down_screening_to_students_load_ehr_new_dashboard/".$hb['doc_data']['widget_data']["page1"]['Student Details']['Hospital Unique ID'];?>'>
