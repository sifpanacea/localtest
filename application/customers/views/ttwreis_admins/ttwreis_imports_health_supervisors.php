        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card"> 
                <div class="header">
					...
					echo form_open_multipart('ttwreis_mgmt/import_health_supervisors',$attributes);?>
				<div class="body">
                    <div class="row clearfix">
						<div class="row body">
							<p>To upload health supervisors data into our database select a file of excel format and press Import button.</p>
