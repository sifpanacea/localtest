...
$('.post_note').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : "TTWREIS Admin", "uid" : uid},
...
$('.post_note_request').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : "TTWREIS Admin","doc_id":doc_id},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + 'TTWREIS Admin' + '</a>' + note + '</div></li>';
