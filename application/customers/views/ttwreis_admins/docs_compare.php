...
$(document).ready(function() {
	...
	for(var doc in docs){
		...
		doc_tab = doc_tab + '<a id = "doc_span_'+count+'" href="doc_comp/' + value['document1'] + '/' + value['document2'] + '"<div class="row"><section class="col col-12"><label class="label">' + count + ')</label>' +  value['doc_id'] + ' Matchs  ' + value['matched_count'] + '</a><a href=\'show_all_docs/' + value['uid'] + '\'>Open all matched documents</a></section></div>'
	}
