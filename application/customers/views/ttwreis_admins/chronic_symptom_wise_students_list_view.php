...
<div class="block-header">
    <center><h2>Chronic Students Details</h2></center>
</div>
<!-- Input -->
        ...
        <div class="card">
            <div class="header">
                 <span class="font-bold col-teal">
                        ...
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="status type"> =>> <?php echo $symptom_name; ?></li>
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Symptom Count"><span class="badge bg-red"><?php if(!empty($students_count)) {?><?php echo $students_count;?><?php } else {?><?php echo "0";?><?php }?></span> =>></li>
                        </ol>
                    </span>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($students_list as $index => $doc ):?>
                            <tr>  
                                ...
                                <td><?php echo $doc['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref'] ;?></td>
                                 <td> 
                                    <a class='ldelete' href='<?php echo URL."ttwreis_mgmt/ttwreis_reports_display_ehr_uid/"?>? id = <?php echo $doc['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
