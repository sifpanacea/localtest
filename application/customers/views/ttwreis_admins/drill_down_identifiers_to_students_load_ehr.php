									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												...
												<td><?php if(isset($student['doc_data']['widget_data']["page1"]['Personal Information']['Mobile']['mob_num']))
												{ ?>
												<?php echo $student['doc_data']['widget_data']["page1"]['Personal Information']['Mobile']['mob_num'] ;?>
												<?php} else 
												{?>
													<?php echo "";?>
												<?php } ?></td>
												...
												<td><a class='ldelete' href='<?php echo URL."ttwreis_mgmt/drill_down_screening_to_students_load_ehr_doc/".$student['_id'];?>'>
