...
$page_title = "Multi User Messaging";
...
$page_nav["chat"]['sub']['multi_msg']["active"] = true;
include("inc/nav.php");
						...
						<div>
							...
							<div class="widget-body">
				             ...
				             <form class="smart-form">
									...
									<fieldset>
									<section>
										<label class="">Select multiple recipients and send a message. You can use ctrl or shift to select multiple users</label>
									</section>
									...
									<div class="row">
										...
										<section class="col col-6">
											...
											<label class="select select-multiple" >
												<select id="users" name="users" multiple=""  required class="custom-scroll">
										...
										<section>
											...
											<label class="textarea"> 										
												<textarea rows="3" class="custom-scroll" id="send_to_multiple"></textarea> 
											</label>
										</section>
									</fieldset>
									<footer>
										<button type="button" id="send_to_multiple_users" class="btn btn-primary">
											Send
...
$(document).ready(function () {
	$('#loader_single').hide();
         ...
         $('#send_to_multiple_users').on('click', function () {
             ...
             var selMulti = $.map($("#user option:selected"), function (el, i) {
                 return $(el).val();
             });

             to = selMulti.join(",");

             $.post("multi_users/message",
             ...
             function (data) {
                 ...
                 if (data.error === false) {
                     ...
                     $.smallBox({
           				title : "<i class='fa fa-info-circle'></i>&nbsp;&nbsp; Message!",
           				content : "Push notification sent successfully to multiple users",
           				color : "#C46A69",
           				iconSmall : "fa fa-bell bounce animated",
           			});
                 } else {
