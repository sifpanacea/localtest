...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<!-- widget div-->
							<h2><?php echo $emergency_requests; ?><span class="badge bg-color-greenLight"><?php if(!empty($get_emergency_docs)) {?><?php echo count($get_emergency_docs);?><?php } else {?><?php echo "0";?><?php }?></span></h2>
					...
					<tbody>
					<?php foreach ($get_emergency_docs as $req):?>
					<tr>
						
						<td><?php echo $req['doc_data']['widget_data']['page1']['Student Info']['Unique ID'];?></td>
						<td><?php echo $req['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref'];?></td>
						<td><?php echo $req['doc_data']['widget_data']['page1']['Student Info']['Class']['field_ref'];?></td>
						<td><?php echo $req['doc_data']['widget_data']['page1']['Student Info']['Section']['field_ref'];?></td>
						...
						<td> <a class='ldelete' href='<?php echo URL."ttwreis_mgmt/drill_down_screening_to_students_load_ehr_new_dashboard/".$req['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
