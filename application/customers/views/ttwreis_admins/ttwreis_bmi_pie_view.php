...
<!-- PAGE RELATED PLUGIN(S) 
	...
	<script>
			...
			function drill_down_hb_to_students(label)
			{
				...
				$.ajax({
					...
					success: function (data) 
					{
						...
						$("#ehr_navigation_for_hb").val(bmi_navigation.join(" / "));
		...
		$('#bmi_report_table tr:last').after('<tr class="txt-color-darkblue"><th>HB Total Count</th><td colspan="2"><span class="badge bg-color-orange">'+hb_total+'</span></td></tr>');
			...
			$(this).click(function (){
				...
				$.ajax({
					...
					success: function (data) {
						...
						$("#ehr_navigation_for_hb").val(case_type);
						$("#form_for_bmi_report").submit();					
