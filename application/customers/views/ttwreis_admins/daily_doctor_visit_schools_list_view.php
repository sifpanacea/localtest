...
<div class="row clearfix">
                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <tr>                                                          
                                ...
                                <form action='<?php echo URL."ttwreis_mgmt/visiting_doctor_students_data" ?>'accept-charset="utf-8" method="POST">
  ...
  <form style="display: hidden" action="<?php echo URL;?>ttwreis_mgmt/time_span_visiting_doctor_students_data" method="POST" id="submit_form">
