...
<div class="block-header">
    <h2> Students Information Admitted in Hospital Type </h2>
</div>
<!-- Input -->
        ...
        <div class="card">
            ...
            <div class="body">
                <div class="table-responsive">
                    <?php if($type == 'Government' || $type == 'Private'): ?>
                        ...
                        <tbody>
                            ...
                            <tr>           
                              ...
                              <td><?php echo $doc['doc_data']['widget_data']["page2"]['Hospital Info']['Hospital Type'] ;?></td>                            
                              <td><?php echo $doc['doc_data']['widget_data']["page2"]['Hospital Info']['Hospital Name'] ;?></td>   
                              <td><?php echo $doc['doc_data']['widget_data']["page2"]['Hospital Info']['District Name'] ;?></td>   
                              <td><?php echo $doc['doc_data']['widget_data']["page2"]['Review Info']['Status'] ;?></td>   
