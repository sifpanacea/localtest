...
<div>
	...
	echo  form_open('ttwreis_mgmt/create_state',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><?php //echo anchor("ttwreis_mgmt/ttwreis_mgmt_manage_states/".$state['_id'], lang('app_edit')) ;?>
						
						<a class='ldelete' href='<?php echo URL."ttwreis_mgmt/ttwreis_mgmt_delete_states/".$state['_id'];?>'>
