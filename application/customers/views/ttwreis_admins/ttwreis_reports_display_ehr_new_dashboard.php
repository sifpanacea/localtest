						...
						<li>
							...
							<?php foreach ($request['doc_data']['Discharge_Summary'] as $attachment):?>
								<li style="display:none">
									...
									<center>
											<p>Attachment</p>
											<a data-magnify="gallery" data-src="" data-caption="Discharge Summary" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
      								<img src="<?php echo URLCustomer.$attachment['file_path'];?>" alt="" width="300" >
									</a>
										</center>
									</div>
						...
						<ul>
							<li style="">
								...
								<a data-magnify="gallery" data-src="" data-caption="Profile pic" data-group="a" href="<?php echo URLCustomer.$doc['doc_data']['widget_data']['page1']['Personal Information']['Photo']['file_path'];?>">
      							<img src="<?php echo URLCustomer.$doc['doc_data']['widget_data']['page1']['Personal Information']['Photo']['file_path'];?>" height="155" width="150"/>
								 </a>
									<?php else: ?>
...
$('.post_note').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : "Gurukulam Admin", "uid" : uid},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + 'Gurukulam Admin' + '</a>' + note + '</div><br><button class="btn btn-xs btn-danger pull-right msg_delete" doc_id = "'+data+'">Delete</button></li>';
...
$('.post_note_request').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : "Gurukulam Admin","doc_id":doc_id},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + 'Gurukulam Admin' + '</a>' + note + '</div></li>';
...
$("#submit_print_request").click(function(){
    ...
    $.ajax({
        url    : 'https://mednote.in/PaaS/healthcare/index.php/ttwreis_mgmt/init_health_summary_report_process',
        type   : 'POST',
