							...
							<h5 class="alert alert-info"> <?php echo ucwords($navigation) ;?> </h5>
								...
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
											...
											<tr>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?></td>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page1']['Personal Information']['Name'];?></td>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page2']['Personal Information']['Class'];?></td>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page2']['Personal Information']['School Name'];?></td>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page2']['Personal Information']['District'];?></td>
												<?php //foreach() ?>
												<?php //echo json_encode($get_doc['BMI_values']);?>
												<td><a class='delete1' href='<?php echo URL."ttwreis_mgmt/show_student_bmi_graph/".$get_doc['student_info']['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?>'>
