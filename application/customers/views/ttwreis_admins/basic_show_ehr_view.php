						        ...
						        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									...
									<tbody>
										...
										<?php endif;?>
												...
												<td> <a class='ldelete' href='<?php echo URL."ttwreis_mgmt/drill_down_screening_to_students_load_ehr_new_dashboard/".$doc['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
