								...
								<?php if(!empty($get_hb_docs)): ?>
										<?php  foreach ($get_hb_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
											...
											<tr>
												...
												<td><a class='delete1' href='<?php echo URL."ttwreis_mgmt/show_student_hb_graph/".$get_doc['student_info']['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
