        ...
        <div class="menu">
            <ul class="list">
                    ...
                    <li <?php if($current_page == 'homepage') { echo 'class="active"';} ?>>
                        <a href='<?php echo URL."ttwreis_mgmt/to_dashboard"; ?>'>
                    ...
                    <!-- <li <?php //if($current_page == 'raised_requests') { echo 'class="active"';} ?>>
                        <a href='<?php //echo URL."maharashtra_doctor/fetch_request_docs_from_hs_list"; ?>'>
                            <i class="material-icons">content_paste</i>
                            <span>HS Raised Requests</span>
                        </a>
                    </li>
                    <li <?php //if($current_page == 'submitted_requests') { echo 'class="active"';} ?>>
                        <a href='<?php //echo URL."maharashtra_doctor/fetch_doctor_submitted_requests_list"; ?>'>
                            <i class="material-icons">note_add</i>
                            <span>DR Submitted Requests</span>
                        </a>
                    </li> -->
                    ...
                    <!-- <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <span>Chronic Cases</span>
                        </a>
                        <ul class="ml-menu">
                            <li <?php //if($current_page == 'from_requests') { echo 'class="active"';} ?>>
                                <a href='<?php //echo URL."maharashtra_doctor/list_chronic_cases"; ?>'>
                                    <span>From Requests</span>
                                </a>
                            </li>
                            <li <?php //if($current_page == 'from_screening') { echo 'class="active"';} ?>>
                                <a href="<?php //echo URL."maharashtra_doctor/list_chronic_cases_from_screening"; ?>">
                                    <span>From Screening</span>
                                </a>
                            </li>
                    ...
                    <li <?php if($main_nav == 'Reports') { echo 'class="active"';} ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php if($current_page == 'Blood_Banks') { echo 'class="active"';}?>>
                            ...
                            <li <?php if($current_page == 'Manage_DMHO') { echo 'class="active"';}?>>
                    ...
                    <li <?php if($main_nav == 'Imports') { echo 'class="active"';} ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php if($current_page == 'Students') { echo 'class="active"';}?>>
                             ...
                             <li <?php if($current_page == 'Updrade Classes') { echo 'class="active"';}?>>
