                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <tr>    
                                ...
                                <td>              
                                    <a class='ldelete' href='<?php echo URL."panacea_secretary/panacea_reports_display_ehr_uid/"?>? id = <?php echo $surgery['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>                                        
