...
<div>
	...
	echo  form_open('panacea_mgmt/create_cc_user',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_mgmt_delete_cc_user/".$cc_user['_id'];?>'>
