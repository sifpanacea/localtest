...
$page_title = "Abnormal Cases Report";
...
$page_nav["pa school pie"]["sub"]["abnormal_pie"]["active"] = true;
include("inc/nav.php");
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <header class ="bg-color-orange txt-color-white">
                        ...
                        <h2>Abbominal Cases <span class="badge bg-color-greenLight"></span>
                        </h2>
                            ...
                            <div class="panel-group smart-accordion-default" id="accordion-2">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseOne-1"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Abdominal Pain Cases Student List </a></h4>
                                    </div>
                                    <div id="collapseOne-1" class="panel-collapse collapse in">
                                        ...
                                        <tbody>                                            
                                            <?php foreach ($all as $chronics) : ?>
                                                <?php if(isset($chronics['all_abdominal_cases_docs']) && !empty($chronics['all_abdominal_cases_docs']) && !is_null($chronics['all_abdominal_cases_docs'])): ?>
                                                <?php foreach ($chronics['all_abdominal_cases_docs'] as $chronic) : ?>
                                                    <tr>
                                                    ...
                                                    <td> <a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_reports_display_ehr_uid/"?>? id = <?php echo $chronic['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
                                                        <button class="btn btn-primary btn-xs">Show EHR</button></a></td>
                                                    </tr>
                                                <?php endforeach; ?>                                                
                                                <?php endif; ?>
                                            <?php endforeach; ?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseTwo-1" class="collapsed"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Vomitings Cases Student List </a></h4>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            <table id="chronic_report_table" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($all as $chronics) : ?>
                                                            <?php if(isset($chronics['all_vomitings_cases_docs']) && !empty($chronics['all_vomitings_cases_docs']) && !is_null($chronics['all_vomitings_cases_docs'])): ?>
                                                        <?php foreach ($chronics['all_vomitings_cases_docs'] as $chronic) : ?>
                                                            <tr>
                                                                <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Unique ID']; ?></td>
                                                                <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref']; ?></td>
                                                                <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref']; ?></td>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseThree-1" class="collapsed"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Diarrhoea Cases Student List </a></h4>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            <table id="chronic_report_table" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($all as $chronics) : ?>
                                                        <?php if(isset($chronics['all_diarrhoea_cases_docs']) && !empty($chronics['all_diarrhoea_cases_docs']) && !is_null($chronics['all_diarrhoea_cases_docs'])): ?>
                                                        <?php foreach ($chronics['all_diarrhoea_cases_docs'] as $chronic) : ?>
                                                            <tr>
                                                                <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Unique ID']; ?></td>
                                                                <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref']; ?></td>
                                                                <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref']; ?></td>
