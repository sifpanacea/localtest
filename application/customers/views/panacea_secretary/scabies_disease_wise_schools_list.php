...
$page_title = "Scabies Case Report";
...
$page_nav["pa school pie"]["sub"]["scabies_pie"]["active"] = true;
include("inc/nav.php");
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <header class ="bg-color-orange txt-color-white">
                        ...
                        <h2>Scabies Cases <span class="badge bg-color-greenLight"></span>
                        </h2>
                            ...
                            <div class="panel-group smart-accordion-default" id="accordion-2">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseThree-1" class="collapsed"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Scabies Students Report </a></h4>
                                    </div>
