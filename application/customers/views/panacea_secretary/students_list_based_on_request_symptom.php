            ...
            <div class="row">               
                <article class="col-sm-12">
                    <div class="alert alert-danger fade in">
                        ...
                        <strong><?php echo $selectedMonth; ?></strong> =>
                        ...
                        <tbody>
                                        <?php foreach ($students as $student):?>
                                            <tr>
                                                ...
                                                <td><a class='ldelete' href='<?php echo URL."panacea_secretary/panacea_reports_display_ehr_uid/"?>? id = <?php echo $student['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
