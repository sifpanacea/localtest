    ...
    <div>
       <button class="btn btn-block btn-lg bg-pink waves-effect">
            <?php if(!empty($news)): ?>
               ...
               <img src="<?php echo IMG; ?>/Panacea_small.png"><span class="label bg-green"><?php echo $new['username']; ?></span><?php echo $new['news_feed']; ?> <!-- <a href="#" class="open_news" news_data="<?php echo $new['_id']; ?>" style="color:#0a0a0a"> read more ...</a> -->&nbsp; &nbsp;
            <?php endforeach; ?>
            </marquee>
            <?php else: ?>
        ...
        <div class="panel-body">
            ...
            <!-- District Filter -->
                ...
                <div class="col-sm-2">
                    ...
                    <div class="form-line">
                        <input type="text" id="set_date" name="set_date" class="datepicker form-control date set_date common_change" value="<?php echo date('yy-m-d'); ?>">
                    </div>
                </div>
                ...
                <div class="col-sm-2">
                    <label>Options</label>
                    <div class="form-line">
                        <a href="<?php echo URL; ?>panacea_secretary/disease_wise_students_list"><button type="button" class="btn btn-default">Health Track Chart</button></a>
                    </div>
                </div>
            <!--Time span filter  -->    
                <!-- <div class="col-sm-2">
                ...
                <div class="col-sm-2">
                   <div class="form-line">
                       <button type="button" id="" class="btn bg-green btn-circle-lg waves-effect waves-circle waves-float">
                ...
                <!-- <div class="col-sm-5">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu">
                                <li <?php //if($current_page == 'Manage_States') { echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_states"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage States</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'Manage_District') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_district"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage District</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'submitted_requests') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_diagnostic"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage Diagnostic</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'Regular Followups') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_schools"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage Schools</span>
                                    </a>
                                </li>
                                 <li <?php //if($current_page == 'cured_requests') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_classes"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage classes</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'cured_requests') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_sections"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage Sections</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'cured_requests') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_health_supervisors"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage Health Supervisors</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'cured_requests') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_hospitals"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage Hospitals</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'cured_requests') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_doctors"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage Doctors</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'cured_requests') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_symptoms"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage Symptoms</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'cured_requests') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_emp"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage Employees</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'cured_requests') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/panacea_mgmt_cc"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li <?php //if($current_page == 'Student Reports') { //echo 'class="active"';}?>>
                                    <a href="<?php //echo URL."panacea_mgmt/panacea_reports_school"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>School Reports</span>
                                    </a>
                                </li>
                                
                                <li <?php //if($current_page == 'reports') { //echo 'class="active"';} ?>>
                                  <a href='<?php //echo URL."panacea_mgmt/panacea_reports_hospital"; ?>'>
                                      <i class="material-icons">navigate_next</i>
                                      <span>Hospital Reports</span>
                                  </a>
                                </li>
                                <li <?php //if($current_page == 'Diseases Counts') { //echo 'class="active"';}?>>
                                    <a href="<?php //echo URL."panacea_mgmt/panacea_reports_doctors"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php //if($current_page == 'Diseases Counts') { //echo 'class="active"';}?>>
                                    <a href="<?php //echo URL."panacea_mgmt/panacea_reports_symptom"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Symptoms</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'Diseases Counts') { //echo 'class="active"';}?>>
                                    <a href="<?php //echo URL."panacea_mgmt/panacea_reports_ehr"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Electronic Health Record</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'Diseases Counts') { //echo 'class="active"';}?>>
                                    <a href="<?php //echo URL."panacea_mgmt/get_reports_download"; ?>">
                                        <i class="material-icons">navigate_next</i>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li <?php //if($current_page == 'Diagnostics') { //echo 'class="active"';}?>>
                                        <a href="<?php //echo URL."panacea_mgmt/panacea_imports_diagnostic"; ?>">
                                            <i class="material-icons">navigate_next</i>
                                            <span>Diagnostics</span>
                                        </a>
                                </li>                            
                                <li <?php //if($current_page == 'reports') { //echo 'class="active"';} ?>>
                                  <a href='<?php //echo URL."panacea_mgmt/panacea_imports_hospital"; ?>'>
                                      <i class="material-icons">navigate_next</i>
                                      <span>Hospitals</span>
                                  </a>
                                </li>
                                <li <?php //if($current_page == 'Diseases Counts') { //echo 'class="active"';}?>>
                                    <a href="<?php //echo URL."panacea_mgmt/panacea_imports_school"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Schools</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'Diseases Counts') { //echo 'class="active"';}?>>
                                    <a href="<?php //echo URL."panacea_mgmt/panacea_imports_health_supervisors"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Health Supervisors</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'Diseases Counts') { //echo 'class="active"';}?>>
                                    <a href="<?php //echo URL."panacea_mgmt/panacea_imports_students"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Students</span>
                                    </a>
                                </li>
                                <li <?php //if($current_page == 'Diseases Counts') { //echo 'class="active"';}?>>
                                    <a href="<?php //echo URL."panacea_mgmt/imports"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>Screening File Import</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li <?php //if($current_page == 'Disease_wise_Students_list') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/disease_wise_students_list"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php //if($current_page == 'parent_registration') { //echo 'class="active"';} ?>>
                                    <a href='<?php //echo URL."panacea_mgmt/get_parent_health_registration"; ?>'>
                                        <i class="material-icons">navigate_next</i>
...
<div class="row clearfix">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <!-- <a href="javascript:void(0);" class="btn waves-effect" data-toggle="cardloading" data-loading-effect="ios" title="Refresh" style="float: right;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="info-box-3 bg-grey hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <a href="<?php echo URL."panacea_secretary/panacea_today_followup_cases"; ?>" class="badge bg-red status_blink">Today Followup cases :<span class="badge bg-green" style="padding: 8px;"><?php echo $regular_alerts; ?></span></a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row clearfix">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="card">
          <!-- <div class="btn-group" > 
              <select class="form-control show-tick school_health_zone_wise" id="school_health_zone_wise">
                    <option value="">Risk Based</option>
                    <option value="">Sympton Based</option>
                    <option value="">Class Based</option>
                    <option value="">Age Based</option>
              </select>
          </div> -->
           <!-- <small><b> Select School Health Status For.....</b></small> -->
          <!-- <a href="javascript:void(0);" class="btn waves-effect" data-toggle="cardloading" data-loading-effect="ios" title="Refresh" style="float: right;">
          	...
          	<ul class="header-dropdown m-r--5">
			    <li class="dropdown">
			        ...
			        <ul class="dropdown-menu pull-right">
			            <h5 class="text-center"><span class="badge bg-red">Predictive Criteria</span></h5>
			            <table class="table">
			                <td>Predective reports are displayed according with parents health.</td>
			            </table>
			        </ul>
			    </li>
			</ul>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="card">
            <div class="header" style="padding: 10px">
              	...
              	<ul class="header-dropdown m-r--6">
				    ...
				    <li class="dropdown">
				        ...
				        <ul class="dropdown-menu pull-right">
				            <h5 class="text-center"><span class="badge bg-red">Hospitalized Criteria</span></h5>
				            <table class="table">
				                <td>Hospitalized displayes the students who are hospitalized in hyderabad districts and in other districts.</td>
				            </table>
				        </ul>
				    </li>
				</ul>
            ...
            <div class="body">
                <div class="row clearfix" id="time_span_filter">                   
                    <div class="collapse" id="multicollapseExample">
                      <div class="col-sm-4">                       
                           <span id="monitoring_datepicker">
                            From Date
                           <input type="text" id="h_passing_date" name="h_passing_date" class="form-control date" value="<?php echo date('yy-m-d'); ?>">
                           </span>
                      </div>
                      <div class="col-sm-4">
                           <span id="monitoring_datepicker">
                           To Date
                           <input type="text" id="h_passing_end_date" name="h_passing_end_date" class="form-control date" value="<?php echo date('yy-m-d'); ?>">
                           </span>
                      </div>
                      <div class="col-sm-1">
                          <div class="form-line">
            ...
            <div class="header" style="padding: 10px">
                ...
                <ul class="header-dropdown m-r--5">
				    <li class="dropdown">
				        ...
				        <ul class="dropdown-menu pull-right">
				            <h5 class="text-center"><span class="badge bg-red">Quick Glance Criteria</span></h5>
				            <table class="table">
				                <td>Today's Emergency Requests</td>
				            </table>
				        </ul>
				    </li>
				</ul>
                         ...
                         <div class="body"  style="height: 300px;">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <a class='ldelete' href='<?php echo URL."panacea_secretary/panacea_reports_display_ehr_uid/"?>? id = <?php echo $pic['uniqid']; ?>'>
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
        ...
        <div class="card">
            <div class="header" style="padding: 10px">
                ...
                <ul class="header-dropdown m-r--5">
                    <li class="dropdown">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-toggle="tooltip" data-placement="bottom" title="Attendance List" role="button" aria-haspopup="true" aria-expanded="true">
                            <i class="material-icons">info_outline</i>
                        </a>
                        <ul class="dropdown-menu pull-right">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="card">
            <div class="header" style="padding: 10px">
                ...
                <h2>Admitted Cases Issues</h2>
            </div>
            <div class="body">
                <!-- <div id="hospitalized_bar_graph"></div>
                <div id="hospital_type_graph"  style="display: none;"></div> -->
                <div class="row clearfix" id="filter_for_table">
...
<form style="display: hidden" action="get_hospital_type_data_table" method="POST" id="hospital_type_table">
    <input type="hidden" id="hospital_date" name="hospital_date" value=""/>
...
<form style="display: hidden" action="get_hb_gender_wise_data_table" method="POST" id="hb_gender_wise_table">
    <input type="hidden" id="date_hb" name="date_hb" value=""/>
 ...
 <form style="display: hidden" action="get_bmi_gender_wise_data_table" method="POST" id="bmi_gender_wise_table">
    <input type="hidden" id="date_bmi" name="date_bmi" value=""/>
...
<!-- For Predictive bar -->
<form style="display: none;" action="get_schools_for_predictive_zones" method="POST" id="predictives_show">
    <input type="hidden" name="value_zone" id="value_zone" value=""/>
    <input type="hidden" name="predictive_dist" id="predictive_dist" value=""/>
    <input type="hidden" name="predictive_scl" id="predictive_scl" value=""/>
    <input type="hidden" name="predictive_academic" id="predictive_academic" value=""/>
</form>
...
<script type="text/javascript">
   ...
   $('input[name = "disease_pie_radio"]').click(function(){
        ...
        if(radio == 'yearly_request_pie'){
            $('#piechart_3d').show();
            $('#chronic_piechart').hide();
        }else{
            $('#chronic_piechart').show();
            $('#piechart_3d').hide();
        }
   });
...
function daily_attendace_pie_show(){
    var date = $('#set_date').val();
    var district = $('.district_filter').val();
    var school = $('.school_filter').val();
...
/*
    ...
    $('#screened_school_count').html('<div class="text">Screened Schools </div><div class="number count-to" data-from="0" data-to="" data-speed="1000" data-fresh-interval="20">248</div>');
...
predective_reports_bar();
  ...
  function predective_reports_bar(){
        //var date = $('#set_date').val();
        var district = $('.district_filter').val();
        var school = $('.school_filter').val();
        var academicYear = $('.academic_filter').val();
      ...
      /* alert(district);
       ...
       alert(academicYear);*/
       $.ajax({
           url:'get_predictive_counts_zone_wise',
           type:'POST',
           data:{'academic' : academicYear, 'dist_id':district, 'scl_id':school},
           success:function(data){
            var datas = $.parseJSON(data);
            //console.log(datas);
           bar_for_doc_predictions(datas);
           }
       });

   };

   function bar_for_doc_predictions(datas){
        ...
        var greenZone = datas.green;
          ...
          function drawChart() {
            var data = google.visualization.arrayToDataTable([
              ["Element", "Zone", { role: "style" } ],
              ["Red Zone", redZone, "#F44336"],
              ["Orange Zone", orangeZone, "#FF9800"],
              ["Green Zone", greenZone, "#4CAF50"]
            ]);
            ...
            var options = {
              title: "Predective Reports",
              width: 420,
              height: 300,
              bar: {groupWidth: "80%"},
              legend: { position: "none" },
            };
            var chart = new google.visualization.ColumnChart(document.getElementById("predective_reports"));
            chart.draw(view, options);

             function selectHandler()
            {
               var predictives = chart.getSelection()[0];
              if (predictives) {
                var pre_value = data.getValue(predictives.row, 0);
                var pre_district = $('.district_filter').val();
                var pre_school = $('.school_filter').val();
                var pre_academicYear = $('.academic_filter').val();

               /* alert(pre_value);
                alert(pre_district);
                alert(pre_school);
                alert(pre_academicYear);*/

                $('#value_zone').val(pre_value);
                $('#predictive_dist').val(pre_district);
                $('#predictive_scl').val(pre_school);
                $('#predictive_academic').val(pre_academicYear);
                $('#predictives_show').submit();
