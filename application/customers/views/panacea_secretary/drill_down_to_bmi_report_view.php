								...
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
											...
											<tr>
												...
												<td><?php echo $get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['bmi'];?></td>
												<?php //foreach() ?>
												<?php //echo json_encode($get_doc['BMI_values']);?>
												<td><a class='delete1' href='<?php echo URL."panacea_mgmt/show_student_bmi_graph/".$get_doc[0]['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
