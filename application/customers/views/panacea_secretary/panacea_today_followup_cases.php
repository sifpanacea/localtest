  	      	...
  	      	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  	          	<div class="card">
  		            <div class="header">
  		                ...
  		                <button type="button" class="btn btn-sm btn-success pull-right" onclick="window.history.back()">Back</button>
  		            </div>
  		            <div class="body">
  		                <div class="row clearfix">
  		                	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  		                		<ul class="nav nav-tabs tab-nav-right" role="tablist" id="ss">
  			                        ...
  			                        <li role="presentation" class="active"><a href="#today_followups" data-toggle="tab" aria-expanded="true"><button class="btn bg-pink waves-effect" type="button">Today Followups</button></a></li>

  			                        <li role="presentation"><a href="#pending_followups" data-toggle="tab" ><button class="btn bg-red waves-effect" type="button">Pending Followups</button></a></li>

  			                        <li role="presentation"><a href="#future_followups" data-toggle="tab" ><button class="btn bg-green waves-effect" type="button">Future Followups</button></a></li>
  			                    </ul>
  				                        ...
  				                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
  				                            ...
  				                            <tbody>
  	                        					...
  	                        					<?php if($date == $current_date):?>
  	                        						...
  	                        						<form action='<?php echo URL."panacea_secretary/panacea_reports_display_ehr_uid" ?>'accept-charset="utf-8" method="POST">
