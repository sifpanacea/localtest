...
$page_nav["pa schools status"]["active"] = true;
include("inc/nav.php");
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
					...
					<header class ="bg-color-orange txt-color-white">
						...
						<h2>Chronic Cases <span class="badge bg-color-greenLight"></span>
						</h2>
							...
							<div class="panel-group smart-accordion-default" id="accordion-2">
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseOne-1"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Asthma Cases Report </a></h4>
									</div>
											...
											<table id="chronic_report_table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php foreach ($all as $chronics) : ?>
														<?php if(isset($chronics['all_asthma_cases_docs']) && !empty($chronics['all_asthma_cases_docs']) && !is_null($chronics['all_asthma_cases_docs'])): ?>
														<?php foreach ($chronics['all_asthma_cases_docs'] as $chronic) : ?>
															<tr>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Unique ID']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Class']['field_ref']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Section']['field_ref']; ?></td>
															<td> <a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_reports_display_ehr_uid/"?>? id = <?php echo $chronic['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseTwo-1" class="collapsed"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Kidney Cases Report </a></h4>
									</div>
										...
										<div class="panel-body">
											<table id="chronic_report_table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php foreach ($all as $chronics) : ?>
															<?php if(isset($chronics['all_kidney_cases_docs']) && !empty($chronics['all_kidney_cases_docs']) && !is_null($chronics['all_kidney_cases_docs'])): ?>
														<?php foreach ($chronics['all_kidney_cases_docs'] as $chronic) : ?>
															<tr>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Unique ID']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref']; ?></td>
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseThree-1" class="collapsed"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Scabies Cases Report </a></h4>
									</div>
										...
										<div class="panel-body">
											<table id="chronic_report_table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php foreach ($all as $chronics) : ?>
														<?php if(isset($chronics['all_scabies_cases_docs']) && !empty($chronics['all_scabies_cases_docs']) && !is_null($chronics['all_scabies_cases_docs'])): ?>
														<?php foreach ($chronics['all_scabies_cases_docs'] as $chronic) : ?>
															<tr>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Unique ID']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref']; ?></td>
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseFour-1" class="collapsed"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Epilepsy Cases Report</a></h4>
									</div>
										...
										<div class="panel-body">
											<table id="chronic_report_table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php foreach ($all as $chronics) : ?>
														<?php if(isset($chronics['all_epilepsy_cases_docs']) && !empty($chronics['all_epilepsy_cases_docs']) && !is_null($chronics['all_epilepsy_cases_docs'])): ?>
														<?php foreach ($chronics['all_epilepsy_cases_docs'] as $chronic) : ?>
															<tr>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Unique ID']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref']; ?></td>
									...
									<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseFive-1"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> BMI Cases Report Below 14 </a></h4>
									</div>
										...
										<div class="panel-body">
											<table id="chronic_report_table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php foreach ($all as $chronics) : ?>
														<?php if(isset($chronics['all_bmi_cases_docs']) && !empty($chronics['all_bmi_cases_docs']) && !is_null($chronics['all_bmi_cases_docs'])): ?>
														<?php foreach ($chronics['all_bmi_cases_docs'] as $chronic) : ?>
															<tr>
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseSix-1"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> BMI Cases Report Above 28</a></h4>
									</div>
										...
										<div class="panel-body">
											<table id="chronic_report_table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php foreach ($all as $chronics) : ?>
														<?php if(isset($chronics['all_bmi_cases_docs_28']) && !empty($chronics['all_bmi_cases_docs_28']) && !is_null($chronics['all_bmi_cases_docs_28'])): ?>
														<?php foreach ($chronics['all_bmi_cases_docs_28'] as $chronic) : ?>
															<tr>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['school_details']['School Name']; ?></td>
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseFive-6"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> HB Cases Report </a></h4>
									</div>
										...
										<div class="panel-body">
											<table id="chronic_report_table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php foreach ($all as $chronics) : ?>
														<?php if(isset($chronics['all_hb_cases_docs']) && !empty($chronics['all_hb_cases_docs']) && !is_null($chronics['all_hb_cases_docs'])): ?>
														<?php foreach ($chronics['all_hb_cases_docs'] as $chronic) : ?>
															<tr>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref']; ?></td>
																<td><?php echo $chronic['doc_data']['widget_data']['school_details']['School Name']; ?></td>
