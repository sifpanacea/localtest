...
<body class="theme-green">
    ...
    echo  form_open('panacea_secretary/panacea_reports_display_ehr_uid',$attributes);
    ?>
    <div class="search-bar">
        <div class="search-icon">
            <i class="material-icons">search</i>
        </div>
        <input type="text" placeholder="Enter Student Health ID..." name="uid" id="uid" value="<?PHP echo set_value('uid'); ?>">
