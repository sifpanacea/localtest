    ...
    <div class="row clearfix">
		...
		<?php foreach($pics as $photo):?>
			<div class="row">
				...
				<h2>Campus Photos</h2>
				<?php if(isset($photo['doc_data']['widget_data']['daily']['Campus']['external_attachments']) && !empty($photo['doc_data']['widget_data']['daily']['Campus']['external_attachments'])): ?>
					...
					<?php endforeach; ?>
				<?php else: ?>
					<h2>No atachments added by school</h2>
				<?php endif; ?>
				

				<h2>Kitchen Photos</h2>
				<?php if(isset($photo['doc_data']['widget_data']['daily']['Kitchen']['external_attachments']) && !empty($photo['doc_data']['widget_data']['daily']['Kitchen']['external_attachments'])): ?>
				...
				<?php if(isset($photo['doc_data']['widget_data']['daily']['Toilets']['external_attachments']) && !empty($photo['doc_data']['widget_data']['daily']['Toilets']['external_attachments'])): ?>
