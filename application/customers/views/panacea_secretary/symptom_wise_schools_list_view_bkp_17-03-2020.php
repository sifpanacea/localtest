        ...
        <section id="widget-grid" class="">
          ...
          <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
            ...
            <header>
              ...
              <h2>Abnormality wise Schools Report</h2>
                ...
                <div class = "under weight " id ="under weight">
                  ...
                  <?php if(!empty($students_list)): ?>
                    <?php foreach ($students_list as $key => $value): ?>
                      ...
                      <tr>
                        <td><?php echo $key; ?></td>
                        <td><span class="badge badge-warning" style="background-color:green"><?php echo $value; ?></span></td>

                       <form action='<?php echo URL."panacea_mgmt/get_students_by_symptom" ?>'accept-charset="utf-8" method="POST">
