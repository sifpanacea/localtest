            ...
            <div class="card">
                <div class="header">
	                ...
	                <ol class="breadcrumb" style="background: beige">
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Today Date"><?php echo $today_date; ?></li>
                        ...
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Count"><span class="badge bg-red"><?php if(!empty($students_count)) {?><?php echo $students_count;?><?php } else {?><?php echo "0";?><?php }?></span></li>
                    </ol>
                    </span>
                ...
                <div class="body">
                    <div class="table-responsive">
                        ...
                        <tr>
                        <td><?php echo $case['0']['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?></td>
                        <td><?php echo $case['0']['doc_data']['widget_data']['page1']['Personal Information']['Name']; ?></td>
                        <td><?php echo $case['0']['doc_data']['widget_data']['page2']['Personal Information']['Class'];?></td>
                        <form action='panacea_reports_display_ehr_uid' accept-charset="utf-8" method="post">
                          <input type="hidden" name="uid" value="<?php echo $case['0']['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?>">
                        <td><button type="submit" class="btn bg-teal btn-sm waves-effect">Show EHR</button></td>
                        </form> 
                        </tr>
                        <?php endforeach;?>
                        <?php else: ?>
