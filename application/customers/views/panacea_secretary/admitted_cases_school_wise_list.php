...
<br>
      ...
      <!--  <section class="content"> -->
        <div class="container-fluid">
           ...
           <div class="row clearfix">
                ...
                <input type="hidden" name="request" id="request" value="<?php echo $request; ?>">
                   <div class="card">
                    <div class="header">
                             <div class="row clearfix">
                                 <div class="col-sm-2">
                                    <h3 class="font-bold col-green"><?php echo $request; ?> Data</h3>
                                 </div>
 ...
 -->
  ...
  <form style="display: hidden" action="<?php echo URL; ?>panacea_secretary/get_students_for_admitted" method ="POST" id="get_students_for_admitted">
   ...
   // var sanitation = $('#sanitation').val();
     ...
     /* 
      ...
      ('#sanitation_filters').hide();*/
        $.ajax({
            url : 'get_admitted_cases_schools_list',
            type : 'POST',
            data : {"start_date" : starts, "end_date": ends, "request_type":type},
    ...
    function data_table_for_filters(result){
      ...
      if(result){
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>School Name</th><th>Count</th><th>Show Students</th><th>Respond '+'<input type="checkbox" id="select_all_chk" class="filled-in chk-col-red">'+
            ...
            /*if(requestsCount == 'Animals'){*/
              ...
              data_table = data_table+'<td>'+'<button class="btn btn-primary show_studs" id="show_studs">Show Students</button>'+'</td>';
