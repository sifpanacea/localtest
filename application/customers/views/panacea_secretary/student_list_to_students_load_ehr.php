						        ...
						        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												<td><?php echo $student['doc_data']['widget_data']["page1"]['Student Details']['Hospital Unique ID'] ;?></td>
												<td><?php echo $student['doc_data']['widget_data']["page1"]['Student Details']['Name']['field_ref'] ;?></td>
												<td><?php echo $student['doc_data']['widget_data']['school_details']['School Name'] ;?></td>
												<td><?php echo $student['doc_data']['widget_data']["page1"]['Student Details']['Class']['field_ref'] ;?></td>
												<td><?php echo $student['doc_data']['widget_data']["page1"]['Student Details']['Section']['field_ref'] ;?></td>
												<td><a class='ldelete' href='<?php echo URL."panacea_mgmt/drill_down_screening_to_students_load_ehr_doc/".$student['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
