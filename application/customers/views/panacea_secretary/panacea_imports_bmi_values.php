...
$page_nav["pa imports"]["sub"]["Monthly BMI"]["active"] = true;
include("inc/nav.php");
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
						...
						<div>
							...
							<!-- widget content -->
											...
											echo form_open_multipart('panacea_mgmt/imports_bmi_values',$attributes);?>
											<div class="panel-body">
												...
												<select  id="select_dt_name" required>
														...
														<?php if(isset($distslist)): ?>
															...
															<option class='hidden' id='dist_name_naresh' value='<?php echo ucfirst($dist['dt_name'])?>' ></option>
															<?php endforeach;?>
															<?php else: ?>
															<option value="1"  disabled="">No district entered yet</option>
														<?php endif ?>
														<input type="hidden" name="district_name" id="dist_name" value="">
													</select> <i></i>
												</label>
												</section>
												<section>
...
$(document).ready(function() {
	$('#select_dt_name').change(function(e){
		...
		dist_name = $('#dist_name_naresh').val();
