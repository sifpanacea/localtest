...
<head>
   ...
   <!-- <title>Panacea School Health Program</title> -->
    <title>Power Of Ten</title>
    <!-- Favicon-->
    <link rel="icon" href="favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" type="image/ico" href="<?php echo (IMG.'swaero_logo_small.jpg') ?>"/>
    <!-- Google Fonts -->
...
<body class="theme-green">
    ...
    echo  form_open('maharashtra_doctor/maharashtra_reports_display_ehr_uid',$attributes);
    ?>
    <div class="search-bar">
        <div class="search-icon">
            <i class="material-icons">search</i>
        </div>
        <input type="text" placeholder="Enter Swareo ID..." name="uid" id="uid" value="<?PHP echo set_value('uid'); ?>">
    ...
    <!-- Top Bar -->
      <nav class="navbar" style="height:74px;">
            ...
            <div class="navbar-header">
             <a href="javascript:void(0);" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false"></a>
                ...
                <!-- <img class="pull-left"  style="height: 60px;margin-top: -5px;margin-right: 5px; border-radius: 30px; " src="<?php //echo IMG; ?>/TELANGANA.png" alt="logo" title="" /> -->
                    <!-- <img class="pull-left"  style="height: 70px; margin-top: -6px;" src="<?php //echo IMG; ?>/PANACEA_LOGO_NEW.jpg" alt="" title="" />  -->
                    <img class="pull-left"  style="height: 58px; margin-top: -6px;" src="<?php echo IMG; ?>/swaeroes.png" alt="" title="" />
                <!-- <img class="pull-left"  style="height: 60px;margin-top: -5px;margin-right: 5px; border-radius: 30px; " src="<?php //echo IMG; ?>/TELANGANA.png" alt="logo" title="" /> -->
                <!-- <img class="pull-left"  style="height: 70px; margin-top: -6px;" src="<?php //echo IMG; ?>/PANACEA_LOGO_NEW.jpg" alt="" title="" /> -->
               <!--  <img class="pull-left" style="height:60px;margin-left: 2px; margin-top: -5px;width:60px; border-radius: 50px; " src="<?php //echo IMG; ?>/Panacea_LOGO_Final.jpg" alt=""> -->
        ...
        <!-- <img class="pull-left"  style="height: 62px;margin-top: -5px;margin-right: 5px; border-radius: 30px; " src="<?php //echo IMG; ?>/L3_dr_logo.png" alt="logo" title="" />

     <img class="pull-left" style="height:80px;margin-left: -6px; margin-top: -8px;width:90px; border-radius: 100px; " src="<?php //echo IMG; ?>/SYNERGY.png" alt="">
      <img class="pull-left" style="height:68px;margin-left: -6px; margin-top: -8px;width:75px; border-radius: 100px; " src="<?php //echo IMG; ?>/Havik_Logo_New.png" alt=""> -->
                ...
                <div class="col-sm-offset-6">
                	<!-- <a class="navbar-brand" href="#" style="margin-left: 300px"> PANACEA SCHOOL HEALTH PROGRAM</a> -->
                     <a class="navbar-brand" href="#" style="margin-left: 310px"> POWER OF TEN DAR ACTIVITY PROGRAM</a> 
                </div>
            </div>
