...
$('#set_date_btn').click(function(e){
	...
	$.ajax({
		...
		success: function (data) {
			...
			chronic_id_list   = $.parseJSON(data.chronic_ids);
			...
			initialize_variables(today_date,absent_report,request_report,symptoms_report,screening_report,chronic_id_list);
			draw_absent_pie();
			draw_identifiers_pie();
			draw_request_pie();
			draw_screening_pie();
