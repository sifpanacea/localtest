    ...
    <!-- MAIN PANEL -->
        <div id="content">
                ...
                <div class="row">
                          ...
                          <div class="jarviswidget jarviswidget-color-orange" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" style="border: 2px solid #CB9235;">
                            ...
                            <div>
                              ...
                              <?php  $attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
                                echo  form_open_multipart('panacea_cc/show_doctor_treated_student',$attributes);
                                ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3">UNIQUE ID:</label>
                                    <div class="col-md-5">
                                     <input type="text" class="form-control student_code" id="page1_StudentDetails_HospitalUniqueID" name="page1_StudentDetails_HospitalUniqueID" value="<?php echo $student['doc_data']['widget_data']['Student Details']['Hospital Unique ID'];  ?>" readonly>   
                                    </div>
                               </div>
                                  ...
                                  <div class="">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" id="student_name" name="student_name" value="<?php echo $student['doc_data']['widget_data']['Student Details']['Student Name'];  ?>" readonly></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    <label class="col col-sm-3 ">SECTION:</label>
                                    <div class="col-md-5">
                  ...
                  <?php if($student['doc_data']['widget_data']['type_of_request']  == "Out Patients"): ?>
                            ...
                            <div id="out_patient" class="tab-content padding-10">
                                ...
                                <div class="form-group row">
                                    <label  class="col-sm-3">Doctor Name</label>
                                        <div class="col-md-5">
                                            <input type="text"  class="form-control" id ="op_doctor_name" name="op_doctor_name" value="<?php echo $student['doc_data']['widget_data']['Out Patient']['doctor_name'];  ?>">
                                        </div> 
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text"  class="form-control" id ="op_hospital_name" name="op_hospital_name" value="<?php echo $student['doc_data']['widget_data']['Out Patient']['hospialt_name'];  ?>">
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="op_patient_details" id="op_patient_details" name="op_patient_details" class="col-md-5" placeholder="case details"><?php echo $student['doc_data']['widget_data']['Out Patient']['patient_details'];  ?></textarea> 
                        
                        </div>
                        <div class="form-group">
                            <label class="col-md-3">Investigatin:</label>
                        <div class="col-md-5">
                            <input type="text"  class="form-control" id ="op_investigation" name="op_investigation" value="<?php echo $student['doc_data']['widget_data']['Out Patient']['investigations'];  ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                            <input type="text"  class="form-control datepicker"  id ="op_review_date" name="op_review_date" value="<?php echo $student['doc_data']['widget_data']['Out Patient']['review_date'];  ?>">
                            </div> 
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                            <input type="text"  class="form-control " id ="op_meditation" name="op_meditation" value="<?php echo $student['doc_data']['widget_data']['Out Patient']['hospialt_name'];  ?>">
                            </div> 
                        </div>
                        ...
                        <div class="widget-body">
                            ...
                            <div id="out_patient" class="tab-content padding-10">
                                ...
                                <div class="form-group row">
                                    <label  class="col-sm-3">Doctor Name</label>
                                        <div class="col-md-5">
                                            <input type="text"  class="form-control" id ="admitted_doctor_name" name="admitted_doctor_name" value="<?php echo $student['doc_data']['widget_data']['Emergency or Admitted']['doctor_name'];  ?>">
                                        </div> 
                                </div>
                                <div class="form-group">
                                        ...
                                        <label class="col-sm-3">Hospital  Name</label>
                                        <div class="col-md-5">
                                            <input type="text"  class="form-control" id ="admitted_hospital_name" name="admitted_hospital_name" value="<?php echo $student['doc_data']['widget_data']['Emergency or Admitted']['hospialt_name'];  ?>">
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="textarea col-md-3">Case Details</label>
                            <textarea rows="4"  id="admitted_patient_details" name="admitted_patient_details" class="col-md-5" placeholder="case details"> <?php echo $student['doc_data']['widget_data']['Emergency or Admitted']['patient_details'];  ?> </textarea> 
                        
                        </div>
                        <div class="form-group">
                            <label class="col-md-3">Investigatin:</label>
                        <div class="col-md-5">
                            <input type="text"  class="form-control" id ="admitted_investigation" name="admitted_investigation" value="<?php echo $student['doc_data']['widget_data']['Emergency or Admitted']['investigations'];  ?>">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-3">Review Date :</label>
                            <div class="col-md-5">
                            <input type="text"  class="form-control datepicker"  id ="admitted_review_date" name="admitted_review_date" value="<?php echo $student['doc_data']['widget_data']['Emergency or Admitted']['review_date'];  ?>">
                            </div> 
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-3">Medication :</label>
                            <div class="col-md-5">
                            <input type="text"  class="form-control " id ="admitted_meditation" name="admitted_meditation" value="<?php echo $student['doc_data']['widget_data']['Emergency or Admitted']['hospialt_name'];  ?>">
                            </div> 
                        </div>
                        ...
                        <div class="widget-body">
                            ...
                            <div id="out_patient" class="tab-content padding-10">
                                ...
                                <div class="form-group row">
                                    <label  class="col-sm-3">Doctor Name</label>
                                        <div class="col-md-5">
                                            <input type="text"  class="form-control" id ="review_doctor_name" name="review_doctor_name" value="<?php echo $student['doc_data']['widget_data']['Review Cases']['doctor_name'];  ?>">
                                        </div> 
                                </div>
                                <div class="form-group">
                                        ...
                                        <label class="col-sm-3">Hospital  Name</label>
                                        <div class="col-md-5">
                                            <input type="text"  class="form-control" id ="op_hospital_name" name="op_hospital_name" value="<?php echo $student['doc_data']['widget_data']['Review Cases']['hospialt_name'];  ?>">
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="textarea col-md-3">Case Details</label>
                            <textarea rows="4" name="op_patient_details" id="op_patient_details" name="op_patient_details" class="col-md-5" placeholder="case details"><?php echo $student['doc_data']['widget_data']['Review Cases']['patient_details'];  ?></textarea> 
                        
                        </div>
                        <div class="form-group">
                            <label class="col-md-3">Investigatin:</label>
                        <div class="col-md-5">
                            <input type="text"  class="form-control" id ="op_investigation" name="op_investigation" value="<?php echo $student['doc_data']['widget_data']['Review Cases']['investigations'];  ?>">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-3">Review Date :</label>
                            <div class="col-md-5">
                            <input type="text"  class="form-control datepicker"  id ="op_review_date" name="op_review_date" value="<?php echo $student['doc_data']['widget_data']['Review Cases']['review_date'];  ?>">
                            </div> 
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-3">Medication :</label>
                            <div class="col-md-5">
                            <input type="text"  class="form-control " id ="op_meditation" name="op_meditation" value="<?php echo $student['doc_data']['widget_data']['Review Cases']['hospialt_name'];  ?>">
                            </div> 
                        </div>
          ...
          <ul class="nav nav-tabs md-tabs nav-justified primary-color" role="tablist" style="background: cadetblue;">
            <li class="nav-item">
