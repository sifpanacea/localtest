                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel panel-body" style="border-bottom-color: cornflowerblue;">
                          ...
                          <?php  $attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
                            echo form_open('ttwreis_cc/create_attendence_report',$attributes);
                            ?>
                        <div class="col-md-offset-1">
                                 <span class="pull-right note">
                                    Note: Fields marked with <span class="required_field">*</span>  Required.<br>
                                     <br>Note: If any category count is 0, Nil will be auto filled.</span>
                            <div class="form-group row">

                                <label for="staticEmail" class="col-sm-2 col-form-label">District <span class="required_field">*</span></label>
                                <div class="col-sm-5">
                                    <label class="select">
                <select id="page1_AttendenceDetails_District" class="form-control" name="page1_AttendenceDetails_District">
                    ...
                    <?php endif ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                        <label class="select">
                                        <select id="page1_AttendenceDetails_SelectSchool" class="form-control" name="page1_AttendenceDetails_SelectSchool" disabled=true>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <label class="textarea textarea-resizable">
                                                <textarea rows="3" cols="80" class="UID form-control custom-scroll" id="page1_AttendenceDetails_SickUID" name="page1_AttendenceDetails_SickUID" ></textarea> 
                                              </label>
                                              </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                   <label class="textarea textarea-resizable">
                                        <textarea rows="3" cols="80" class="form-control custom-scroll" id="page1_AttendenceDetails_R2HUID" name="page1_AttendenceDetails_R2HUID"   ></textarea> 
                                      </label>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                  <label class="textarea textarea-resizable">
                                        <textarea rows="3" cols="80" class="form-control custom-scroll" id="page2_AttendenceDetails_AbsentUID" name="page2_AttendenceDetails_AbsentUID" ></textarea> 
                                      </label>
                                      </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <label class="textarea textarea-resizable">
                                        <textarea rows="3" cols="80" id="page2_AttendenceDetails_RestRoomUID" name="page2_AttendenceDetails_RestRoomUID" class="form-control custom-scroll"></textarea> 
                                      </label>
                                 </div>
            ...
            $(document).on("click",".selectstudent",function()
            {
                ...
                if($(".selectstudent").is(':checked') && added == "false")
                {
                  ...
                  /*  alert(district+school);*/
                    ...
                    school = btoa(school)
                    $.ajax({
                    url: '../healthcare/healthcare20161015173311279_con/get_students_list/'+school,
                    type: 'POST',
