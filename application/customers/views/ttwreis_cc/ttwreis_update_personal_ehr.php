...
<!-- widget content -->
  <?php
	...
	echo  form_open_multipart('ttwreis_cc/update_student_ehr',$attributes);
	?>
						...
						<ul>
							<li style="">
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										<th>Class</th><td colspan="2"><i class="icon-leaf"><input type="number" name="class" value="<?php echo $doc['doc_data']['widget_data']['page2']['Personal Information']['Class'];?>"></i></td>
									</tr>
									<tr>
