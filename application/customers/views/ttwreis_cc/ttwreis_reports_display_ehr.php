			...
			<li>
				...
				<ul>
					...
					<li>
						...
						<li>
							<span class="req-notes"><i class="fa fa-lg fa-plus-circle"></i> Notes on this request<span class="badge bg-color-red "> <?php echo (isset($request['doc_data']["notes_data"])? count($request['doc_data']["notes_data"]) : "0"); ?> </span></span>
							<ul>
								<li style="display:none">
									<div class="well well-sm ">
									<div>
...
$('.post_note').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note, "uid" : uid , "Name" : Name , "Class" : Class,"School_Name" : School},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + 'TTWREIS CC' + '</a>' + note + '</div><br><button class="btn btn-xs btn-danger pull-right msg_delete" doc_id = "'+data+'">Delete</button></li>';
...
$('.post_note_request').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : "PANACEA CC","doc_id":doc_id},
