                      ...
                      <div class="jarviswidget jarviswidget-color-orange" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false"    style="border: 2px solid #CB9235;">
                        ...
                        <div>
                          ...
                          <?php  $attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
                            echo  form_open_multipart('ttwreis_cc/feedBmiStudentReport',$attributes);
                            ?>
                            <fieldset>
                                ...
                                <div class="col-md-6">
                                 ...
                                 <button type="button" class=" col-md-3  btn btn-primary" id="searchIdBtn" data-toggle="modal" data-target="#load_waiting" data-backdrop="static" data-keyboard="false">SEARCH</button> -->
                                  ...
                                  <label class="col-md-2">UNIQUE ID:</label>
                                    ...
                                    <input type="text" class="col-md-2 col-md-offset-1 student_code" id="page1_StudentDetails_HospitalUniqueID" name="page1_StudentDetails_HospitalUniqueID" required> 
                              ...
                              <section class="col col-lg-2">
                                ...
                                <div class="form-group">
                                <label class="col-md-2 ">HEIGHT (cms)</label>
                                <div class="col-md-2">
                                 <input type="number" class="form-control height-weight" name="page1_StudentDetails_Heightcms" id="page1_StudentDetails_Heightcms"></div>
                               
                                <label class="col-md-2 ">WEIGHT (kgs)</label>
                                <div class="col-md-2">
                                   <input type="number" class="form-control height-weight" name="page1_StudentDetails_Weightkgs" id="page1_StudentDetails_Weightkgs"></div>
                                </div>
...
<?php endif; ?>
  ...
  $('.height-weight').mouseout(function (){
