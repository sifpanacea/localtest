				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php foreach ($student_list as $student):?>
						<tr>
                   		...
                   		<td><a href="<?php echo URL.'ttwreis_cc/show_doctor_treated_student/'.$student['doc_properties']['doc_id']; ?>" class="btn bg-color-greenDark txt-color-white btn-xs">Show</a></td>
                   		</tr>
					<?php endforeach;?>
					<?php else: ?>
        			<p>
