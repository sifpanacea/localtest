...
<div>
  ...
  echo  form_open_multipart('panacea_cc/update_screening_report',$attributes);
  ?>
                    ...
                    <div class="form-group">
                      ...
                      <section class="col col-1">
                        <label class="control-label">Height cms</label>
                         <input class="form-control height-weight" id="cms" type="text" name="height" placeholder="height in cms" value="<?php echo (isset($doc['doc_data']['widget_data']['page3']['Physical Exam']['Height cms']) ? $doc['doc_data']['widget_data']['page3']['Physical Exam']['Height cms'] : ""); ?>"/>

                         
                      </section>
                       <section class="col col-1">
                        <label class="control-label">Weight kgs</label>
                        <input type="text" class="form-control height-weight" id="page1_StudentDetails_Weightkgs" name="weight" placeholder="weight in kgs" value="<?php echo(isset($doc['doc_data']['widget_data']['page3']['Physical Exam']['Weight kgs']) ? $doc['doc_data']['widget_data']['page3']['Physical Exam']['Weight kgs'] : ""); ?>"/>                        
                      </section>
                      <section class="col col-1">
                        <label class="control-label">BMI</label>

                        <input type="text" class="form-control" name="bmi" placeholder="bmi" id="page1_StudentDetails_BMI" />
                      </section>
                      <section class="col col-1">
                      ...
                      <section class="col col-1">
                        ...
                        <input type="text" class="form-control" name="hb" placeholder="HB" value="<?php echo(isset($doc['doc_data']['widget_data']['page3']['Physical Exam']['H B']) ? $doc['doc_data']['widget_data']['page3']['Physical Exam']['H B']: "");?>"/>
                      </section>
                      <section class="col col-1">
    ...
    <fieldset>
      ...
      <header class="bg-color-green txt-color-white">Doctor Check Up</header>
        ...
        <div class="form-group">
          ...
          <div class="col col-3">
            <label class="checkbox">
              <input type="checkbox" id="" name="ortho_problems[]" value="Neck"<?php if(isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && is_array($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && in_array("Neck",isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) ? $doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']:array())) { ?> checked="checked" <?php } ?>>
              <i></i>Neck</label>
              <label class="checkbox">
              <input type="checkbox" id="" name="ortho_problems[]" value="Knees"<?php if(isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && is_array($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && in_array("Knees",isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) ? $doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']:array())) { ?> checked="checked" <?php } ?>>
              <i></i>Knees</label>
          </div>
          <div class="col col-3">
            <label class="checkbox">
              <input type="checkbox" id="" name="ortho_problems[]" value="Shoulders"<?php if(isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && is_array($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && in_array("Shoulders",isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) ? $doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']:array())) { ?> checked="checked" <?php } ?>>
              <i></i>Shoulder</label> 
            <label class="checkbox">
              <input type="checkbox" id="" name="ortho_problems[]" value="Feet"<?php if(isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && is_array($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && in_array("Feet",isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) ? $doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']:array())) { ?> checked="checked" <?php } ?>>
              <i></i>Feet</label>
          </div>
          <div class="col col-3">
            <label class="checkbox">
              <input type="checkbox" id="" name="ortho_problems[]" value="Arms"<?php if(isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && is_array($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && in_array("Arms",isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) ? $doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']:array())) { ?> checked="checked" <?php } ?>>
              <i></i>Arms</label>
          </div>
          <div class="col col-3">
            <label class="checkbox">
              <input type="checkbox" id="" name="ortho_problems[]" value="Hips"<?php if(isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && is_array($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) && in_array("Hips",isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) ? $doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']:array())) { ?> checked="checked" <?php } ?>>
              <i></i>Hips</label>
          </div>
...
function bmi_calculate(){
  ...
  var weight = parseFloat($('#page1_StudentDetails_Weightkgs').val()) || 0;
    ...
    if( height_cms !=0 && weight !=0)
    {
      
      if(height_cms < 10){
        var foots_to_cms =  (height_cms * 30.48).toFixed(0);
      }
      
      //  var foots_to_cms =  (height_foots * 30.48).toFixed(0);
      //  var inchs_to_cms =  (height_inchs * 2.54).toFixed(0);
      if(foots_to_cms != undefined && foots_to_cms != 0)
      {       
