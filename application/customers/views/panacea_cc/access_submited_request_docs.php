...
<header>
	...
	<?php foreach ($hs_req_docs as $unique):?>
		...
		<form action='<?php echo URL."panacea_cc/reports_display_ehr_uid_new_html_static_hs";?>' accept-charset="utf-8" method="POST">
...
<div>
	...
	<div class="widget-body no-padding">
		...
		echo  form_open_multipart('panacea_cc/update_request_and_submit',$attributes);
		?>
		<fieldset>
