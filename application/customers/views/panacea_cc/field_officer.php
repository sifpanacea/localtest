...
<div id="main" role="main">
    ...
    <div id="content">
                ...
                <div class="panel panel-warning">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="well well-sm well-light">                                
                                    <?php  $attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
                                        echo form_open_multipart('panacea_cc/submit_field_officer',$attributes);
                                    ?>
                                    <fieldset>
                    ...
                    <!-- end widget -->
                          ...
                          <div id="school_code"></div>
                            ...
                            <div class="form-group row">
                                <label  class="col-sm-3 col-md-3 col-form-label">Class</label>
                                <div class="col-md-5">
                    ...
                    <div class="general_related bg-color-light-pink">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-md-3">Case Details</label>
                            <div class="col-md-5">
                            <textarea rows="4" name="op_patient_details" id="op_patient_details" name="op_patient_details" class="form-control" placeholder="case details"></textarea> 
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3">Investigatin:</label>
                        <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-3">Review Date :</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-3">Medication :</label>
                            <div class="col-md-5">
        ...
        <div class="general_related">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3">Case Details</label>
                            <div class="col-md-5">
                                <textarea rows="4" name="admitted_patient_details" id="admitted_patient_details" name ="admitted_patient_details" class="form-control" placeholder="case details"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-md-2">Doctor Advice :</label>
                                    <div class="form-check form-check-inline col-sm-offset-1 col-sm-3">
                                        <label class='labelform'><input class="selectstudent" added="false" id="dr_advice_surgery" name="doctor_advice[]" type="checkbox" value="Surgery"> Surgery</label>
                                    </div>
                                    <div class="form-check form-check-inline col col-sm-2">
                                        <label class="labelform"><input class="clearstudent" id="dr_advice_tretment" name="doctor_advice[]" type="checkbox" value="Treatment"> Treatment</label>
                                    </div>
                        </div>
        ...
        <div class="general_related">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3">Case Details</label>
                            <div class="col-md-5">
                            <textarea rows="4" name="review_patient_details" id="review_patient_details" class="form-control" placeholder="case details"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="review_date_div">
                            <label class="col-md-3">Review Date :</label>
...
<!-- PAGE RELATED PLUGIN(S) 
   ...
   <script type="text/javascript">
    ...
    $.ajax({
        ...
        {
        if (($.trim($('#page1_StudentDetails_HospitalUniqueID').val()).length > 0))
                {
