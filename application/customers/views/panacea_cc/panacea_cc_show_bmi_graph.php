		...
		<div class="smart-form">
			...
			<section class="col col-6">
				...
				<label class="input"> <i class="icon-append fa fa-pencil"></i>
					<input type="text" name="uid" id="uid" class="uid" value="" required>
				</label>
			</section>
			</div>
