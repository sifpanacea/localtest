									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												...
												<td><a class='ldelete' href='<?php echo URL."panacea_cc/drill_down_screening_to_students_load_ehr_doc/".$student['_id'];?>'>
						                			<button class="btn btn-primary btn-xs">Show EHR</button>
						                			</a>
						                			<!-- 
						                			|
						                			<a class='ldelete' href='<?php echo URL."panacea_mgmt/drill_down_screening_initiate_request/".$student['_id'];?>'>
