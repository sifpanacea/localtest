...
<div>
	...
	<div class="widget-body no-padding">
		...
		echo  form_open_multipart('panacea_cc/initiate_hs_request',$attributes);
		?>
		<fieldset>
           ...
           if(result.length > 0){
               ...
               $('.ehrButton').click(function(){
                   ...
                   //$("#student_id").val(studentHealthID);
                    window.location = '<?php echo URL; ?>panacea_cc/access_submited_request_docs/'+studentHealthID;
                  // $("#request_form").submit();
