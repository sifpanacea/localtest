...
$page_title = "ttwreis Health Supervisors";
...
<div>
	...
	echo  form_open('ttwreis_mgmt/create_health_supervisors',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<a class='ldelete' href='<?php echo URL."ttwreis_mgmt/ttwreis_mgmt_delete_health_supervisors/".$hs['_id'];?>'>
