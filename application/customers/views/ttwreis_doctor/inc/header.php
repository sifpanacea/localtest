		...
		?>
				...
				<header id="header">
				    <div id="logo-group">
						...
						<span id="">
						<img class="logo_2" src="<?php echo BCWELFARE_LOGO_IMG; ?>" alt="" style="">
						</span>
						<span id="">
					...
					<p class="panacea-headertext-top" style="">TRIBAL WELFARE </p>
					<p class="panacea-headertext-bottom" style="padding-left: 40%">SCHOOL HEALTH PROGRAM</p>
					</div>
