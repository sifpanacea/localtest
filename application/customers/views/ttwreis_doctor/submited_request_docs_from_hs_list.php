												...
												<table id="table_id" class="display col-xs-12 col-sm-8 col-md-8 col-lg-10">
												    ...
												    <tbody>
														...
														<?php foreach($hs_req_docs as $index => $doc):?>
															...
															<?php endif;?>
																<td><a href="<?php echo URL.'ttwreis_doctor/access_request_docs_form_hs/'.$doc['doc_properties']['doc_id'].'';?>" class="btn bg-color-greenDark txt-color-white btn-xs">Access</a></td>
															</tr> 
												   		<?php endforeach;?>
														<?php else: ?>
														<p> No docs found </p>
