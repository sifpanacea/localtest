...
<header>
	...
	<span class="pull-right">
		...
		<form action='<?php echo URL."ttwreis_doctor/reports_display_ehr_uid_new_html_static_hs";?>' accept-charset="utf-8" method="POST">
...
<div>
	...
	<div class="widget-body no-padding">
		...
		echo  form_open_multipart('ttwreis_doctor/doctor_submit_request_docs',$attributes);
		?> 
		<fieldset>
    ...
    <option value="YADADRI" <?php echo  preset_select('std_join_hospital_dist', 'YADADRI', (isset($doc['doc_data']['widget_data']['page2']['Hospital Info']['District Name'])) ? $doc['doc_data']['widget_data']['page2']['Hospital Info']['District Name'] : ''  ) ?>>YADADRI</option>
					...
					<div class="tab-content">
					 ...
					 <?php if(isset($doc['doc_data']['external_attachments'])): ?>
      					...
      					<img src="<?php echo URLCustomer.$data['file_path'];?>" alt="" width="600">
			                </a>
			                <?php endforeach ?>
			                </div>
