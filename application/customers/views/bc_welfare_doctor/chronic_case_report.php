					   ...
					   <section>
							...
							<div class="inline-group">
								<label class="checkbox">
									<input type="checkbox" name="med_to_be_taken" value="mor">
									<i></i>Morning</label>
								<label class="checkbox">
									<input type="checkbox" name="med_to_be_taken" value="noon">
									<i></i>Afternoon</label>
								<label class="checkbox">
									<input type="checkbox" name="med_to_be_taken" value="night">
									<i></i>Night</label>
							</div>
						</section>
						<section>
						...
						<section>
											...
											<div class="inline-group">
												<label class="checkbox state-disabled">
													<input type="checkbox" name="med_taken" value="mor">
													<i></i>Morning</label>
												<label class="checkbox state-disabled">
													<input type="checkbox" name="med_taken" value="noon">
													<i></i>Afternoon</label>
												<label class="checkbox state-disabled">
													<input type="checkbox" name="med_taken" value="night">
													<i></i>Night</label>
											</div>
										</section>
