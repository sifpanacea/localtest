...
<div>
	...
	echo  form_open('panacea_cc/create_hospital',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><?php //echo anchor("panacea_cc/panacea_cc_diagnostic/".$hospital['_id'], lang('app_edit')) ;?>
						
						<a class='ldelete' href='<?php echo URL."panacea_cc/panacea_cc_delete_hospital/".$hospital['_id'];?>'>
