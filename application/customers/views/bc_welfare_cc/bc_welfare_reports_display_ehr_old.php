						...
						<ul>
							...
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										<th>Referral Made</th><td><i class="icon-leaf"><?php echo (gettype($doc['doc_data']['widget_data']['page9']['Dental Check-up']['Referral Made'])=="array")? implode (", ",$doc['doc_data']['widget_data']['page9']['Dental Check-up']['Referral Made']) : $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Referral Made'];?></i></td>
										</tr>
										<tr>
										<th>DC</th>
										<td>DC 11<i class="icon-leaf"><?php if(isset($doc['doc_data']['widget_data']['page9']['Dental Check-up']['DC 11']) && !empty($doc['doc_data']['widget_data']['page9']['Dental Check-up']['DC 11'])):?> <?php echo $doc['doc_data']['widget_data']['page9']['Dental Check-up']['DC 11']?></i><?php endIf;?></br>
