									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												...
												<td><?php if(isset($student['doc_data']['widget_data']["page1"]['Personal Information']['Mobile']['mob_num']) && !empty($student['doc_data']['widget_data']["page1"]['Personal Information']['Mobile']['mob_num'])):?><?php echo $student['doc_data']['widget_data']["page1"]['Personal Information']['Mobile']['mob_num'] ;?><?php else:?><?php echo "Mobile Number not available";?><?php endIf;?></td>
												...
												<td><a class='ldelete' href='<?php echo URL."bc_welfare_cc/drill_down_screening_to_students_load_ehr_doc/".$student['_id'];?>'>
						                			<button class="btn btn-primary btn-xs">Show EHR</button>
						                			</a>
						                			<!-- 
						                			|
						                			<a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/drill_down_screening_initiate_request/".$student['_id'];?>'>
						                			<button class="btn btn-success btn-xs">Initiate Request</button>
						                			</a>
						                			-->
												</td>
											</tr>
