				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<header>
							...
							<h2><?php echo $selected_case; ?> on <?php echo $selected_date; ?> <span class="badge bg-color-greenLight"><?php if(!empty($student_list)) {?><?php echo count($student_list);?><?php } else {?><?php echo "0";?><?php }?></span></h2>
					...
					<?php foreach ($student_list as $student):?>
						<tr>
                   		...
                   		<td><?php echo $student['doc_data']['widget_data']['Student Details']['Student Name']; ?></td>
                   		...
                   		<td><a href="<?php echo URL.'bc_welfare_cc/show_doctor_treated_student/'.$student['doc_properties']['doc_id']; ?>" class="btn bg-color-greenDark txt-color-white btn-xs">Show</a></td>
                   		</tr>
					<?php endforeach;?>
					<?php else: ?>
        			<p>
