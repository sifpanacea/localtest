...
$page_title = "bc_welfare Symptoms";
...
$page_nav["pa mgmt"]["sub"]["symptom"]["active"] = true;
include("inc/nav.php");
...
<div>
	...
	echo  form_open('bc_welfare_cc/create_symptoms',$attributes);
	?>
		<!--<form class="smart-form">-->
			...
			<section class="col col-12">
				<label class="label" for="first_name">Symptoms Name</label>
					<label class="input"> <i class="icon-append fa fa-pencil"></i>
					<input type="text" name="symptom_name" id="symptom_name" value="<?PHP echo set_value('symptom_name'); ?>" required>
				</label>
			</section>
			</div>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><?php //echo anchor("bc_welfare_cc/bc_welfare_cc_manage_symptoms/".$symptom['_id'], lang('app_edit')) ;?>
						
						<a class='ldelete' href='<?php echo URL."bc_welfare_cc/bc_welfare_cc_delete_symptoms/".$symptom['_id'];?>'>
