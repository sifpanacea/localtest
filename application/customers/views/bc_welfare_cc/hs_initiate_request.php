...
<div>
	...
	<div class="widget-body no-padding">
		...
		echo  form_open_multipart('bc_welfare_cc/initiate_hs_request',$attributes);
		?>
			...
			<div class="row">
				<!-- <section class="col col-md-7"> -->
					<label class="col-md-2" style="margin:15px; font-size: large;"><b>UNIQUE ID</b></label>
						...
						<input type="text" class="col-md-2 student_code" id="page1_StudentDetails_HospitalUniqueID" name="page1_StudentDetails_HospitalUniqueID" required>
       ...
       if(result.length > 0){
           ...
           $('.ehrButton').click(function(){
               ...
               //$("#student_id").val(studentHealthID);
                window.location = '<?php echo URL; ?>bc_welfare_cc/access_submited_request_docs/'+studentHealthID;
              // $("#request_form").submit();
