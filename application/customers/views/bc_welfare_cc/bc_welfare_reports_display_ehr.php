				...
				<ul>
					...
					<li>
						...
						<?php if(isset($request['doc_data']['Prescriptions']) && !is_null($request['doc_data']['Prescriptions']) && !empty($request['doc_data']['Prescriptions'])):?>
							<li>
								<span><i class="fa fa-lg fa-plus-circle"></i> Prescription </span>
								<ul>
						...
						<?php if(isset($request['doc_data']['Lab_Reports']) && !is_null($request['doc_data']['Lab_Reports']) && !empty($request['doc_data']['Lab_Reports'])):?>
							<li>
								<span><i class="fa fa-lg fa-plus-circle"></i> Lab Reports</span>
								<ul>
						...
						<?php if(isset($request['doc_data']['Digital_Images']) && !is_null($request['doc_data']['Digital_Images']) && !empty($request['doc_data']['Digital_Images'])):?>
							<li>
								<span><i class="fa fa-lg fa-plus-circle"></i> Digital Images </span>
								<ul>
						...
						<?php if(isset($request['doc_data']['Payments_Bills']) && !is_null($request['doc_data']['Payments_Bills']) && !empty($request['doc_data']['Payments_Bills'])):?>
							<li>
								<span><i class="fa fa-lg fa-plus-circle"></i> Payment Bills</span>
								<ul>
						...
						<?php if(isset($request['doc_data']['Discharge_Summary']) && !is_null($request['doc_data']['Discharge_Summary']) && !empty($request['doc_data']['Discharge_Summary'])):?>
							<li>
								<span><i class="fa fa-lg fa-plus-circle"></i> Discharge Summary</span>
								<ul>
...
$('.post_note').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : "cc_login", "uid" : uid,"Name" : Name , "Class" : Class,"School_Name" : School},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + 'bc_welfare Admin' + '</a>' + note + '</div><br><button class="btn btn-xs btn-danger pull-right msg_delete" doc_id = "'+data+'">Delete</button></li>';
...
$('.post_note_request').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : "bc_welfare Admin","doc_id":doc_id},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + 'bc_welfare Admin' + '</a>' + note + '</div></li>';
