...
$page_nav["pa feed_bmi"] ["sub"] ["feed_bmi"] ["active"] = true;
include("inc/nav.php");
?>
<style>
...
<!-- ==========================CONTENT STARTS HERE ========================== -->
		...
		<!-- END MAIN PANEL -->
<!-- ==========================CONTENT ENDS HERE ========================== -->
<form method="post" action="reports_display_ehr_uid" id="previousval">
<input type="hidden" id="student_unique_id" name="student_unique_id"/>
...
$(document).ready(function() {
		...
		$(document).on('click','#app_open',function(e)
		{
			...
			if($(this).hasClass("attendance"))
			{
		      ...
		      /* apd__ = "healthcare2016620153753258";
		        _url = "https://bc_welfare-schoolhealth.com/PaaS/healthcare/index.php/healthcare/healthcare2016620153753258_con/create"; */
				
		        apd__ = "healthcare201651317373988";
		        _url = "https://bc_welfare-schoolhealth.com/PaaS/healthcare/index.php/healthcare/healthcare201651317373988_con/create";
		...
		var apd__ = "healthcare2017617145744625";
		var url = "https://mednote.in/PaaS/healthcare/index.php/healthcare/healthcare2017617145744625_con/create";
