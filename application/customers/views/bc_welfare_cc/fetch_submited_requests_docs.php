...
$page_title = "BC Welfare Dashboard";
								...
								<div>
									...
									<div class="widget-body">
										...
										<ul id="myTab1" class="nav nav-tabs bordered">
											...
											<li>
												<a href="#s4" data-toggle="tab"> Anemia <span class="badge bg-color-blue txt-color-white"><?php if(isset($hs_req_chronic_anemia) && !empty($hs_req_chronic_anemia)):?><?php echo count($hs_req_chronic_anemia);?><?php endif;?></span></a>
											</li>
												...
												<table id="table_id" class="display">
												    ...
												    <tbody>
														...
														<?php foreach($hs_req_docs as $index => $doc ):?>
															...
															<?php endif;?>
																<td><a href="<?php echo URL.'bc_welfare_cc/access_submited_request_docs/'.$doc['doc_properties']['doc_id'].'';?>" class="btn bg-color-greenDark txt-color-white btn-xs">Access</a></td>
															</tr>
												   		<?php endforeach;?>
														<?php else: ?>
														<p> No docs found </p>
