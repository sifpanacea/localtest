...
<header>
	...
	<?php foreach ($hs_req_docs as $unique):?>
		...
		<form action='<?php echo URL."bc_welfare_cc/reports_display_ehr_uid_new_html_static_hs";?>' accept-charset="utf-8" method="POST">
...
<div>
	...
	<div class="widget-body no-padding">
		...
		echo  form_open_multipart('bc_welfare_cc/update_request_and_submit',$attributes);
		?>
		<fieldset>
					...
					<div class="tab-content">
					  ...
					  <div class="tab-pane fade" id="panel555" role="tabpanel">
					    ...
					    <?php if(isset($doc['doc_data']['Lab_Reports'])): ?>
			               ...
			               <a href="<?php echo URLCustomer.$data['file_path'];?>" rel="prettyPhoto[pp_gal]">
			                <embed src="<?php echo URLCustomer.$data['file_path'];?>" width="200"/></a>
			                <?php endforeach ?>
			                </div>
					  ...
					  <div class="tab-pane fade" id="panel667" role="tabpanel">
					  	...
					  	<?php if(isset($doc['doc_data']['Payments_Bills'])): ?>
			               ...
			               <a href="<?php echo URLCustomer.$data['file_path'];?>" rel="prettyPhoto[pp_gal]" title="Payments Bills">
			                <embed src="<?php echo URLCustomer.$data['file_path'];?>" width="200"/></a>
			                <?php endforeach ?>
			                </div>
					  ...
					  <div class="tab-pane fade" id="panel669" role="tabpanel">
					  	<?php if(isset($doc['doc_data']['Discharge_Summary']) ): ?>
			               ...
			               <a href="<?php echo URLCustomer.$data['file_path'];?>" rel="prettyPhoto[pp_gal]" title="Discharge Summary" alt="Discharge Summary">
