                ...
                <div class="row">
                  ...
                  <?php if($student['doc_data']['widget_data']['type_of_request']  == "Out Patients"): ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="op_patient_details" id="op_patient_details" name="op_patient_details" class="col-md-5" placeholder="case details" value="<?php echo $student['doc_data']['widget_data']['Out Patient']['patient_details'];  ?>"></textarea> 
                        ...
                        <div class="form-group">
                            ...
                            <label class="textarea col-md-3">Case Details</label>
                            <textarea rows="4"  id="admitted_patient_details" name="admitted_patient_details" class="col-md-5" placeholder="case details" value="<?php echo $student['doc_data']['widget_data']['Emergency or Admitted']['patient_details'];  ?>"></textarea> 
                        ...
                        <div class="widget-body">
                            ...
                            <div id="out_patient" class="tab-content padding-10">
                                <div class="row tab-pane fade in active" id="op">
                                <div class="form-group row">
                                    <label  class="col-sm-3">Doctor Nameeeeeeeee</label>
                                        <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <label class="textarea col-md-3">Case Details</label>
                            <textarea rows="4" name="op_patient_details" id="op_patient_details" name="op_patient_details" class="col-md-5" placeholder="case details" value="<?php echo $student['doc_data']['widget_data']['Review Cases']['patient_details'];  ?>"></textarea> 
