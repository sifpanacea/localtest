...
<div>
	...
	echo  form_open('bc_welfare_cc/create_state',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><?php //echo anchor("bc_welfare_cc/bc_welfare_cc_manage_states/".$state['_id'], lang('app_edit')) ;?>
						
						<a class='ldelete' href='<?php echo URL."bc_welfare_cc/bc_welfare_cc_delete_states/".$state['_id'];?>'>
