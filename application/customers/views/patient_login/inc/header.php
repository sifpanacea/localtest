		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo">
						<img src="<?php echo HAVIK_LOGO_IMG;//TLSTEC_LOGO_IMG; ?>" alt="">
						</span>
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a class="menu-links" href="<?php echo URL; ?>patient_login/logout" title="Sign Out" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
