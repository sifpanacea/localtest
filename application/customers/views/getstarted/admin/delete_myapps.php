	...
	<div class="well well-sm bg-color-darken txt-color-white text-center">
								...
								<div class="modal-dialog demo-modal">
									<div class="modal-content">
										...
										<br>
										<br>
										Apps created by you will be listed here. To delete an app, just click <button class="btn btn-danger btn-xs">Delete</button> option. By Clicking this you will be asked confirmation to delete an app. If yes, then that app will be deleted.
										</div>
