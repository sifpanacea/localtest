...
<div id="main" role="main">
	...
	<div class="well well-sm bg-color-darken txt-color-white text-center">
									<h5>Listing all groups</h5>
									
								</div>
								<div class="modal-dialog demo-modal">
									<div class="modal-content">
										<div class="modal-body">
										<span class="fa fa-share"> Group Management > Groups </span>
										<br>
										<br>
										All Groups of your enterprise will be listed here with its name and its description
