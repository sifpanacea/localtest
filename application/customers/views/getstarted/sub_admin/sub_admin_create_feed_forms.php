...
$page_title = "Create Feedback Forms";
...
<div id="main" role="main">
	...
	<div class="well well-sm bg-color-darken txt-color-white text-center">
									<h5>Create Feedback Forms</h5>
									
								</div>
								<div class="modal-dialog demo-modal">
									<div class="modal-content">
										<div class="modal-body">
										<span class="fa fa-share"> Feedbacks > Create Feedback Forms </span>
										<br><br> Sub Admin can create feedback & request enterprise admin to create form on behalf on him<br><br>
										<table class="table table-bordered">
										<tr>
											<td><B>
												Name
											</B></td>
											<td> Name of the feedback app</td>
											</tr>
											<tr>
											<td><B>
												Description
											</B></td>
											<td> Description of the feedback app</td>
											</tr>
											<tr>
											<td><b>
												App Expiry Date
											</b></td>
											<td> Expiry of the feedback app</td>
											</tr>
											<tr>
											<td><b>
												Attach
