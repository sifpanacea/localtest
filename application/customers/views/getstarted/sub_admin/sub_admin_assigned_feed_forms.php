...
<div id="main" role="main">
	...
	<div class="well well-sm bg-color-darken txt-color-white text-center">
									<h5>Assigned Feedbacks</h5>
									
								</div>
								<div class="modal-dialog demo-modal">
									<div class="modal-content">
										<div class="modal-body">
										<span class="fa fa-share"> Feedbacks > Assigned Feedbacks </span>
										...
										<u> Actions </u><br>
										     &nbsp;&nbsp;<a href='<?php echo URL.'help/sub_admin_feedback_prop'?>'>Properties</a> of the feedback <br><br>
											<br>
								        </div>
