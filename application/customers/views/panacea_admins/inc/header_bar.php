...
<body class="theme-green">
    ...
    echo  form_open('panacea_mgmt/get_entered_related_data',$attributes);
    ?>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php if(isset($user_identity) && $user_identity != "PANACEA ADMIN VIEW"): ?>
                     <li <?php if($current_page == 'blood_group_wise_search') { echo 'class="active"';} ?>>
                        <a href="<?php echo URL."panacea_mgmt/panacea_blood_group_pie"?>" data-toggle="tooltip" data-placement="bottom" title="Blood Donor Data" data-original-title="Search Blodd Group wise">
                            <i class="material-icons">bloodtype</i>
                        </a>
                    </li>

                    <li <?php if($current_page == 'Gender_wise_search') { echo 'class="active"';} ?>>
                        <a href="<?php echo URL."panacea_mgmt/gender_wise_student_data"?>" data-toggle="tooltip" data-placement="bottom" title="Gender Wise Search" data-original-title="Search Gender wise">
