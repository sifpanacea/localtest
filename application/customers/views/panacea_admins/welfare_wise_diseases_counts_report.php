...
<br>
        ...
        <div class="container-fluid">
           <div class="row clearfix">
                        ...
                        <div class="body">
                               <div class="row clearfix">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <?php if(isset($welfare) && !empty($welfare)): ?>
                                    <select class="form-control show-tick welfare_filter common_change" id="welfare_filter">
                                        <?php if($welfare == "tswreis"): ?>
                                        <option value="tswreis" selected="">Social Welfare</option>
                                        <?php else: ?>
                                        <option value="tswreis">Social Welfare</option>
                                        <?php endif; ?>
                                        <?php if($welfare == "ttwreis"): ?>
                                        <option value="ttwreis" selected
                                        ="">Tribal Welfare</option>
                                        <?php else: ?>
                                        <option value="ttwreis">Tribal Welfare</option>
                                        <?php endif; ?>
                                        <?php if($welfare == "bcwelfare"): ?>
                                        <option value="bcwelfare" selected="">BC Welfare</option>
                                        <?php else: ?>
            ...
            <!-- #END# Exportable Table -->
              ...
              <input type="hidden" id="welfares" name="welfares_name" value=""/>
            </form>
 ...
 <!--</section> -->
    ...
    <form style="display: hidden" action="get_schools_by_symptom" method="POST" id="abnormality_list_clicked">
        ...
        <input type="hidden" id="welfares_pie" name="welfares_name" value=""/>
    </form>
...
get_disease_wise_data();

$(".common_change").change(function(){
    get_disease_wise_data();
});

function get_disease_wise_data() {
   ...
   var welfare = $('#welfare_filter').val();
   ...
   $.ajax({
       ...
       type : 'POST',
       data : {"academic_year": academicYear, "abnormalities": Abnormalitie, "po_name": poName, "school_name": schoolName, "welfare_name":welfare},
       success: function(data){
    ...
    /*$('#welfare_filter').change(function(e){
