...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="row clearfix">
                <div class="col-sm-4">
                   <h3 class="font-bold col-green">L3 Help Line Services Information</h3>
                </div>
        ...
        <div class="card">
            <div class="body">
                <figure class="highcharts-figure">
                    <div id="l3_help_line_service"></div>                    
                </figure>
            </div>
        </div>
...
<form style="display: hidden" action="get_l3_help_line_district_drill" method="POST" id="l3_help_line_drill">
...
<script type="text/javascript">
  ...
  /*======= Start L3 HElp Line PIE============= */

    function show_registered_data_two(){
        $.ajax({
                url: 'get_l3_help_line_calls_data',
                type: 'POST',
                data: "",
                success: function (data) {          
    ...
    function get_l3_data(result)
    {
        // Create the chart
        Highcharts.chart('l3_help_line_service', {
            chart: {
                type: 'pie'
            },
            title: {
