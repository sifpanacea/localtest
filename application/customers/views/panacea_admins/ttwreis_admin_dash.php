            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="info-box-3 bg-grey hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <a href="<?php echo URL."ttwreis_mgmt/panacea_today_followup_cases"; ?>" class="badge bg-red status_blink">Today Followup cases :<span class="badge bg-green" style="padding: 8px;"><?php echo $regular_alerts; ?></span></a>
                    </div>
                </div>
            </div>
        </div>
...
/*
    ...
    $('#screened_school_count').html('<div class="text">Screened Schools </div><div class="number count-to" data-from="0" data-to="" data-speed="1000" data-fresh-interval="20">0</div>');

    $('#not_screened_school_count').html('<div class="text">Not Screened Schools </div><div class="number count-to" data-from="0" data-to="" data-speed="1000" data-fresh-interval="20">188</div>');
