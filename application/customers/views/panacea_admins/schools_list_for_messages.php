    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                    <h3 class="col-green">Message Info</h3>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <?php if(isset($messages)): ?>
                                    <?php foreach ($messages as $dist):?>
                                    <h4><?php echo $dist['doc_data']['widget_data']['page1']['message']; ?></h4>
                                <?php endforeach; ?>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <div class="row clearfix">
                            <div class="col-sm-4">
                                <h3 class="col-green">Sent School List</h3>
                            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <?php foreach ($messages as $msg):?>
                                    <?php foreach($msg['doc_data']['widget_data']['page1']['schools'] as $scl): ?>
                            <tr>
                            <td class='unique_id'><?php echo $scl;?></td>
...
<script type="text/javascript">
    ...
    function data_table_message(result)
    {
       // console.log(result);
            ...
            data_table = '<table id="more_requests" class="table table-striped table-bordered" width="100%">  <thead><tr> <th>Date and Time</th><th>Message Title</th><th>Sent To</th><th>School count</th></tr> </thead> <tbody>';
