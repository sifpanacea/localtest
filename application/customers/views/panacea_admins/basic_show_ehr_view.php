				...
				<section id="widget-grid" class="">
					...
					<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
						...
						<tr>
							...
							<td><span class="badge badge-warning" style="background-color:blue">
						...
						<?php endforeach;?>												
						 ...
						 <?php elseif($doc['doc_data']['widget_data']['page2']['Review Info']['Request Type'] == "Emergency"):?>
                                ...
                                <td><span class="badge badge-warning" style="background-color:red">
                                	<?php foreach ($identifiers as $identifier => $values) :?>
                    ...
                    <td><span class="badge badge-warning" style="background-color:Green">
                    	<?php foreach ($identifiers as $identifier => $values) :?>
                ...
                <?php endforeach;?></span></td>
                 <?php endif;?>
					...
					<?php endif;?>
						...
						<td> <a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_reports_display_ehr_uid/"?>? id = <?php echo $doc['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
