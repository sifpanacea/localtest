...
$page_nav["hospitalized_pie"]["active"] = true;
include("inc/nav.php");
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget" id="wid-id-60" data-widget-editbutton="false">
						...
						<header>
							...
							<h2>Hospitalized PIE Total &nbsp; &nbsp; Students Count : <?php echo $screening_report_count['total_students'];?></h2>
											...
											<section class="col col-4">
												...
												<label class="select">
													<select id="status_type">
														<option selected value="Hospitalized">Hospitalized</option>
...
$(document).ready(function() {
	...
	function draw_request_pie()
	{
		if(request_data == 1){
			...
			request_navigation.push("Hospitalized PIE");
