        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="header">
                      ...
                      <div class="row">                       
                        ...
                        <div class="col-sm-3">
                            ...
                            <select class="form-control show-tick donor_type" id="donor_type">

                                <option value="others" selected="0" >Non Swaroes</option>
                                <option value="swaroes" >Swaroes</option>                                                               
              ...
              <tr>    
                ...
                <td><?php echo $doc['doc_data']['donor type'] ;?></td>              
...
<script type="text/javascript">
  ...
  $("#rhso_hospital_visit_search").click(function(){
   ...
   function blood_group_wise_data_information()
   {
      ...
      var blood_donor_type = $('#donor_type').val();
      ...
      var blood_group_name = $('#blood_group_select').val();
        ...
        $.ajax({
         ...
         type : 'POST',
         data:{ 'district' : blood_group_district,'type': blood_donor_type, 'blood': blood_group_name },
  ...
  function blood_group_wise_table(result, blood_group_name){
   ...
   if(result == "No Data Available"){
          $('#sanitation_filters').html('<h4>No Data Available For this Doctor....</h4>');
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>Donor Name</th><th>Contact Number</th><th>Blood Group</th><th>Donor Type</th><th>District</th><th>Address</th></tr></thead><tbody>';
              ...
              data_table = data_table+'<td>'+this.doc_data['donor type']+'</td>';
