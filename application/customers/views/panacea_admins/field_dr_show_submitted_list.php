    ...
    $page_title = "Show Doctor Visiting Report";
                ...
                <div class="row">
                   <!-- NEW WIDGET START -->
                    ...
                    <div class="jarviswidget" id="wid-id-8" data-widget-editbutton="false" data-widget-custombutton="false">
                     ...
                     echo  form_open_multipart('panacea_mgmt/update_dr_visiting_and_submit',$attributes);
                                 ?>
                                  ...
                                  <?php foreach ($unique_id as $student): ?>
                                    <fieldset>                  
                                        <div class="row">
                                            <input type="text" name="doc_id" class="hide" id="doc_id" value="<?php echo $student['doc_properties']['doc_id'];  ?>" readonly>
                                            <section class="col col-6">
                                                <label class="label">Unique ID</label>
                                                <label class="input">
                                                    <input type="text" name="unique_id" id="unique_id" value="<?php echo $student['doc_data']['widget_data']['Student Details']['Hospital Unique ID'];  ?>" readonly>
                                                </label>
                                            </section>
                                            <section class="col col-6">
                                        ...
                                        <div class="row">
                                            <section class="col col-6">
                                                ...
                                                <label class="input">
                                                    <input type="text" value="<?php echo $student['doc_data']['widget_data']['Student Details']['doctor_visiting_date'];  ?>" readonly>
                                                </label>
                                            </section>
                                            <section class="col col-6">
                                                <label class="label">Remarks</label>
                                                <label class="input">
                                                   <textarea class="form-control" id="page_student_remarks" name="page_student_remarks"><?php echo $student['doc_data']['widget_data']['Student Details']['remarks'];  ?></textarea>
                                                </label>
                                            </section>
                                        </div>
                                   ...
                                   <h4 class="text-center text-primary"><strong><i class="fa fa-link"> Attachments</strong></h4></i>
                                    ...
                                    <footer>
                                        ...
                                        <button type="submit" class="btn btn-success pull-right btn-sm" style="margin-right:6px">Update</button>
                                    </footer>
