            ...
            <div class="card">
                <div class="header">
                	<span class="font-bold col-teal">
                        ...
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Attendance Type">Student status : <?php echo $attendance_type; ?></li>
                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                ...
                                <?php if($attendance_type == "Attendance"): ?>
                                    <th class="hidden">Students List</th>
                                <?php else: ?>
                                    <th>Students List</th>
                                <?php endif; ?>
                        ...
                        <tbody>
                            <?php foreach ($attendance_details as $data):?>
                        <tr>
                        <td class='unique_id'><?php echo $data['label'];?></td>
                        <td class='unique_id'><span class="badge bg-red"><?php echo $data['value'];?></span></td>

                        <?php if($attendance_type == "Attendance"): ?>
                            <form action='<?php echo URL."panacea_mgmt/get_attendance_data_for_bar_students" ?>' accept-charset="utf-8" method="POST">
                               <input type="hidden" name="symptom_type" value="<?php echo $attendance_type;?>">
                                <input type="hidden" name="school_name" value="<?php echo $data['label'];?>">
                                <input type="hidden" name="today_date" value="<?php echo $today_date;?>">
                            <td><button class="btn bg-teal btn-sm waves-effect hidden">Show Students</button></td>
                            </form> 
                        <?php else: ?>
                            <form action='<?php echo URL."panacea_mgmt/get_attendance_data_for_bar_students" ?>' accept-charset="utf-8" method="POST">
                               <input type="hidden" name="symptom_type" value="<?php echo $attendance_type;?>">
