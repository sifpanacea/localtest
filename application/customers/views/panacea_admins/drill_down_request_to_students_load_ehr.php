									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												...
												<td><a class='ldelete' href='<?php echo URL."panacea_mgmt/drill_down_screening_to_students_load_ehr_doc/".$student['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
