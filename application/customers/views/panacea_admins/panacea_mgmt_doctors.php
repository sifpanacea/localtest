                    ...
                    <div class="card">
                        ...
                        <div class="body">
                         <?php
                            ...
                            echo  form_open('panacea_mgmt/create_doctor',$attributes); ?>
                        ...
                        <div class="body">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
								...
								<tr>
                                    ...
                                    <a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_mgmt_active_deactive_doctor?doc_id=".$doctor['_id']."&id=0";?>' onclick="return confirm('Are you sure. You want deactivate the user?')">
                                        <button class="btn btn-success btn-xs">Active</button>
                                        </a>
                                    <?php else: ?>
                                        <a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_mgmt_active_deactive_doctor?doc_id=".$doctor['_id']."&id=1";?>' onclick="return confirm('Are you sure. You want activate the user?')">
                                        <button class="btn btn-danger btn-xs">Inactive</button>
                                        </a>
                                    <?php endif; ?>
                                    <hr>
									<a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_mgmt_delete_doctor/".$doctor['_id'];?>' onclick="return confirm('Are you sure. You want delete the user?')">
