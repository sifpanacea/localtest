            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">                      
                      ...
                      <div class="row">  
                        ...
                        <div class="col-sm-4">
                                 <h3 class="font-bold col-green">Staff Vaccination Details Districts Wise Information</h3>
                        </div>
                   ...
                   <div class="col-sm-2">
                    <h2 class="card-inside-title">Select District</h2>
                        ...
                        <div class="col-sm-2">                            
                               <h2 class="card-inside-title">Select Vaccination Type</h2>                                
                            <select class="form-control show-tick vaccination_type" id="vaccination_type">
                                <option value="All" >All</option>
                ...
                <div class="table-responsive" id="table_hide">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
              <?php foreach ($staff_covid as $index => $doc ):?>
              <tr>    
                <td><?php echo $doc['doc_data']['employee_name'] ;?></td>
                <td><?php echo $doc['doc_data']['designation'] ;?></td>
                <td><?php echo $doc['doc_data']['district'] ;?></td>              
                <td><?php echo $doc['doc_data']['vaccine_type'] ;?></td>  
                <td><?php echo $doc['doc_data']['school_name'] ;?></td>              
                <td><?php echo $doc['doc_data']['first_dose'] ;?></td> 
                <td><?php echo $doc['doc_data']['second_dose'] ;?></td>                             
              </tr>
              <?php endforeach;?>
            </tbody>
                    </table>
...
<script type="text/javascript">
  ...
  $('#set_date').change(function(e){
        ...
        $('#filter_search').click(function(){
            ...
            var vaccine_name  = $('#vaccination_type').val();             
                                 
                $.ajax({
                    url : 'get_staff_vaccination_data_based_on_span',
                    type : 'POST',
                    data : {"district" : district_name , "vaccination" : vaccine_name },
  ...
  function data_table_for_filters(result){
   ...
   if(result == "No Data Available"){
          $('#sanitation_filters').html('<h4>No Data Available ......</h4>');
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>Staff Name</th><th>Designation</th><th>District</th><th>School Name</th><th>Vaccination Type</th><th>First Dose</th><th>Second Dose</th></tr></thead><tbody>';
              ...
              data_table = data_table+'<td>'+this.doc_data['employee_name']+'</td>';
              data_table = data_table+'<td>'+this.doc_data['designation']+'</td>';
              data_table = data_table+'<td>'+this.doc_data['district']+'</td>';
              data_table = data_table+'<td>'+this.doc_data['school_name']+'</td>';               
              data_table = data_table+'<td>'+this.doc_data['vaccine_type']+'</td>';
              data_table = data_table+'<td>'+this.doc_data['first_dose']+'</td>';
              data_table = data_table+'<td>'+this.doc_data['second_dose']+'</td>';              
