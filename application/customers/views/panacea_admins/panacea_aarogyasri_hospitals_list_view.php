    ...
    $('#passing_end_date').change(function(e){
     ...
     function data_table_for_filters(result){
       ...
       if(result){
           ...
           data_table = '<table class="table table-bordered" id="more_requests"><thead><tr><th>Hospital Name</th><th>Diseases Covered</th><th>md name</th><th>contact number</th><th>arrogya mitra</th><th>district co-ordinator</th><th>district manager</th><th>team leader</th><th>hospital type</th><th>District</th></tr></thead><tbody>';
