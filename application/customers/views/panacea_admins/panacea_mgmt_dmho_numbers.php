                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            echo  form_open('panacea_mgmt/create_dmho_details',$attributes);
                            ?>

                            <h2 class="card-inside-title">Please Enter The DMHO Information</h2>
                            <div class="row clearfix">
                                <div class="col-sm-4">                                	
                                ...
                                <div class="col-sm-4">
                                	<div class="form-group">
                                    	<div class="form-line">                                    		
                                            <input type="text" class="form-control" placeholder="District Code " name="hospital_code" id="hospital_code" value="<?PHP echo set_value('hospital_code'); ?>" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">                                        	
                                            <input type="text" class="form-control" placeholder="DMHO Name" name="hospital_name" id="hospital_name" value="<?PHP echo set_value('hospital_name'); ?>" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
