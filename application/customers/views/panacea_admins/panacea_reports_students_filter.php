					...
					<div class="row clearfix">
						<div class="col-sm-3">
							<select id="collection_name" class="form-control">
								<option value="tswreis_screening_report_col_2022-2023">Academic Year 2022-23</option>
								<option value="tswreis_screening_report_col_2021-2022">Academic Year 2021-22</option>
								<option value="tswreis_screening_report_col_2020-2021">Academic Year 2020-21</option>
								<option value="healthcare2016226112942701">Academic Year 2019-20</option>
								<option value="healthcare2016226112942701_local_dental_screened_students">Dental</option>
							</select>
						</div>
                        <div class="col-sm-3">
                        ...
                        <?php if(isset($user_identity) && $user_identity != "PANACEA ADMIN VIEW"): ?>
	...
	function display_data_table(result){
		if(result.length > 0){
			...
			$.each(result, function() {
				...
				// if(typeof this.doc_data.widget_data["page1"]["Personal Information"]['Photo']['file_path'] == null || typeof this.doc_data.widget_data["page1"]["Personal Information"]['Photo']['file_path'] == undefined){
