    ...
    function data_table_for_filters(result){
      ...
      if(result == "No Data Available"){
          $('#sanitation_filters').html('<h4>No Data Available For this Doctor....</h4>');
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>School Name</th><th>Campus</th><th>Kitchen</th><th>Toilets</th><th>Dormitory</th><th>RHSO Grading</th><th>Submitted By</th></tr></thead><tbody>';
