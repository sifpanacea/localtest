...
function draw_request_pie(){
    if(request_data == 1){
        ...
        request_navigation.push("Over-all Health Status PIE");
...
$(".student_type").each(function(){
    ...
    $.ajax({
        url : "get_schoolhealth_bmi_students_values",
        method : "POST",
