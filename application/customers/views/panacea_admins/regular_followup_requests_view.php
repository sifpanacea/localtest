<?php $current_page="Followup Counts"; ?>
<?php $main_nav=""; ?>
                ...
                <div class="table-responsive" id="table_hide">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        <thead>
                         ...
                         <tbody>
                             <?php foreach ($followup_data as  $data ): ?>                                                               
                              <tr>       
                                <td><?php echo $data['doc_data']['widget_data']['page1']['Student Info']['Unique ID'] ;?></td>
                                <td><?php echo $data['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref'] ;?></td>
                                <td><?php echo $data['doc_data']['widget_data']['page1']['Student Info']['Class']['field_ref'] ;?></td>
                                <td><?php echo $data['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref'] ;?></td>                                
                                <td><?php echo $data['regular_follow_up']['Follow_Up'][0]['created_time'] ;?></td>
                                <td><?php echo $data['regular_follow_up']['Follow_Up'][0]['medicine_details'] ;?></td>
                                <td><?php echo $data['regular_follow_up']['Follow_Up'][0]['followup_desc'] ;?></td>   

                                <td>              
                                    <a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_reports_display_ehr_uid/"?> ? id = <?php echo $data['doc_data']['widget_data']['page1']['Student Info']['Unique ID'];?>'>                  
...
<script type="text/javascript">
   ...
   /* alert(startDate);
    alert(endDate);*/
                ...
                $.ajax({
                    url : 'get_regular_followup_requests_based_on_time_span',
                    type : 'POST',
    ...
    function data_table_for_filters(result){
      ...
      if(result == "No Data Available"){
          $('#sanitation_filters').html('<h4>No Data Available For this Field Officer.</h4>');
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>Health ID</th><th>Name</th><th>Class</th><th>School Name</th><th>Date of Submit</th><th>Problem Info</th><th>Followup Status</th><th>Action</th></tr></thead><tbody>';
              ...
              data_table = data_table+'<td>'+this.regular_follow_up.Follow_Up[0]['created_time']+'</td>';
              data_table = data_table+'<td>'+this.regular_follow_up.Follow_Up[0]['medicine_details']+'</td>';
              data_table = data_table+'<td>'+this.regular_follow_up.Follow_Up[0]['followup_desc']+'</td>';
