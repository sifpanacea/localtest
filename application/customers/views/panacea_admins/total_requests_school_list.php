            ...
            <div class="card">
                <div class="header">
                    ...
                    <ol class="breadcrumb" style="background: beige">
                        ...
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Academic Year"><?php echo $academic_year; ?></li>
                        <!-- <?php //else: ?> -->
                ...
                <div class="body">
                    <div class="table-responsive">
                        ...
                        <form action='<?php echo URL."panacea_mgmt/get_students_by_requests_symptom" ?>'accept-charset="utf-8" method="POST">
                            ...
                            <input type="hidden" name="dist_name" value="<?php echo $dist_name;?>">
