...
<script type="text/javascript">
  ...
  function rhso_hospital_data_table(fetch_data, from)
  {
    ...
    {
      data_table = '<table id="more_requests" class="table table-striped table-bordered" width="100%"><thead><tr><th>School Name</th><th>Submitted Date</th><th>Campus</th><th>Kitchen</th><th>Toilets</th><th>Dormitory</th></tr></thead><tbody>';
