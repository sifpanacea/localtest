                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            echo  form_open('panacea_mgmt/create_blood_bank_details',$attributes);
                            ?>

                            <h2 class="card-inside-title">Please Enter The Blood Banks Information</h2>
                            <div class="row clearfix">
                                <div class="col-sm-4">                                	
                                ...
                                <div class="col-sm-4">
                                	<div class="form-group">
                                    	<div class="form-line">                                    		
                                            <input type="text" class="form-control" placeholder="Blood Bank Code " name="hospital_code" id="hospital_code" value="<?PHP echo set_value('hospital_code'); ?>" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">                                        	
                                            <input type="text" class="form-control" placeholder="Blood Bank Name" name="hospital_name" id="hospital_name" value="<?PHP echo set_value('hospital_name'); ?>" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                	<div class="form-group">
                                    	<div class="form-line">                                    		
                                            <input type="number" class="form-control" placeholder="Phone Number" name="hospital_ph" id="hospital_ph" value="<?PHP echo set_value('hospital_ph'); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                	<div class="form-group">
                                    	<div class="form-line">                                    		
                                            <input type="number" class="form-control" placeholder="Mobile Number" name="hospital_mob" id="hospital_mob" value="<?PHP echo set_value('hospital_mob'); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea id="hospital_addr" name="hospital_addr" class="form-control" placeholder="Blood Banks Address" ><?php echo set_value('hospital_addr');?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>  
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                              All Blood Banks <span class="badge bg-color-greenLight"><?php if(!empty($bloodbankscount)) {?><?php echo $bloodbankscount;?><?php } else {?><?php echo "0";?><?php }?></span>
                            </h2>                            
                        </div>
                        <div class="body">
