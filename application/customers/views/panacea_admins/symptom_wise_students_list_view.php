            ...
            <div class="card">
                <div class="header">
                    ...
                    <ol class="breadcrumb" style="background: beige">
                        ...
                        <?php endif; ?>
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="PO Name"><?php echo $students_list[0]['doc_data']['widget_data']['page2']['Personal Information']['District']; ?></li>
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="School Name"><?php echo $students_list[0]['doc_data']['widget_data']['page2']['Personal Information']['School Name']; ?></li>
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic">
                            ...
                            <tbody>
                               <?php foreach ($students_list as $case):?>
                                    <tr>
                                      <td class='unique_id'><?php echo $case['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?></td>
                                     
                                      <td class="name"><?php echo $case['doc_data']['widget_data']['page1']['Personal Information']['Name']; ?></td>

                                      <td class="class"><?php echo $case['doc_data']['widget_data']['page2']['Personal Information']['Class'];?></td>

                                      <td class="class">
                                        <?php if($symptom_name == "Normal Vision" || $symptom_name == "Defective Vision"): ?>
                                        <span class="badge bg-red"><?php echo $case['doc_data']['widget_data']['page6']['Without Glasses']['Right']; ?>, <?php echo $case['doc_data']['widget_data']['page6']['Without Glasses']['Left']; ?>, <?php echo $case['doc_data']['widget_data']['page6']['With Glasses']['Right']; ?>, <?php echo $case['doc_data']['widget_data']['page6']['With Glasses']['Left']; ?></span>
                                        <?php else: ?>
                                        <span class="badge bg-red"><?php echo $symptom_name; ?></span>
                                    <?php endif; ?>
                                    </td>    

                                      <td class="class"><?php echo $case['doc_data']['widget_data']['page2']['Personal Information']['School Name'];?></td>                            
                                      
                                      <form action='<?php echo URL."panacea_mgmt/panacea_reports_display_ehr_uid" ?>'accept-charset="utf-8" method="POST">
                                         <input type="hidden" name="uid" value="<?php echo $case['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?>">
                                    <?php if(isset($welfare_name) && !empty($welfare_name)): ?>
                                    <input type="hidden" name="welfares_name" value="<?php echo $welfare_name;?>">
                                    <?php endif; ?>
