...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="row clearfix">
                <div class="col-sm-5">
                   <h3 class="font-bold col-green"><li data-toggle="tooltip" data-placement="top" title="" data-original-title="Attendance Type"><?php echo $ro_plant_status; ?> Schools Information</h3>
                </div>
                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        <thead>
                            <tr>
                                ...
                                <th>School Name</th>                                                 
                                <th>District</th>                               
                                <th>Total Ro Plants</th>                               
                                <th>Active RO Plants</th>                               
                                <th>InAvtive RO Plants</th> 
                         ...
                         <tbody>
                             <?php foreach ($school_details as  $data ): ?>                                   
                              <tr>
                                ...
                                <td><?php echo $data['doc_data']['ro_plants'] ;?></td>
                                <td><?php echo $data['doc_data']['ro_active'] ;?></td>
                                <td><?php echo $data['doc_data']['ro_inactive'] ;?></td>
                                <td><?php echo $data['doc_data']['vendor_details'] ;?></td>
                                <td><?php echo $data['doc_data']['hs_details'] ;?></td>
                                <td><?php echo $data['doc_data']['care_taker_details'] ;?></td>                                   
