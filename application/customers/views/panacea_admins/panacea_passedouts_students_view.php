					...
					<div class="row clearfix">
						<div class="col-sm-4">
							<select id="collection_name" class="form-control">
								<option value="screening_report_col_2021-2022_passed_out">Academic Year 2020-21</option>
								<option value="screening_report_col_2020-2021_passed_out">Academic Year 2019-20</option>
