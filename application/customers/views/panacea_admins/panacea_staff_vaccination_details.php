...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="row clearfix">
                <div class="col-sm-4">
                   <h3 class="font-bold col-green">Staff Vaccination Information</h3>
                </div>
...
<form style="display: hidden" action="get_staff_vaccination_details_district_drill" method="POST" id="staff_covid_cases">
...
<script type="text/javascript">
  ...
  /*======= Start Vaccination details PIE============= */

    function show_registered_data_two(){
        $.ajax({
                url: 'get_staff_vaccination_details_data',
                type: 'POST',
                data: "",
                success: function (data) {          
