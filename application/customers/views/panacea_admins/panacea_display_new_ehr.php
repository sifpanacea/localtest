                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        	...
                        	<div class="row">
                        		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                <div class="form-group">
	                                    <div class="form-line">        
	                                        <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Student Health ID" id="" value="<?php echo $docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?>" readonly/>
	                                    </div>
	                                </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" placeholder="Mother's Name"class="form-control" data-toggle="tooltip" data-placement="bottom" title="Mother's Name" value="<?php echo(isset($docs_two[0]['doc_data']['widget_data']['page2']['Personal Information']['Mother Name'])) ? $docs_two[0]['doc_data']['widget_data']['page2']['Personal Information']['Mother Name'] : "" ;?>" readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                <div class="form-group">
	                                    <div class="form-line">
	                                        <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Class" value="<?php echo $docs_two[0]['doc_data']['widget_data']['page2']['Personal Information']['Class']; ?>" readonly />
	                                    </div>
	                                </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Section" value="<?php echo $docs_two[0]['doc_data']['widget_data']['page2']['Personal Information']['Section'];?>" readonly />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Mobile number" value="<?php echo(isset($docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Mobile']['mob_num'])) ? $docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Mobile']['mob_num'] : "" ;?>" readonly />
                                            </div>
                                        </div> 
                                    </div>
                                </div>
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Aadhaar Card" value="<?php echo(isset($docs_2021_22[0]['doc_data']['widget_data']['page2']['Personal Information']['Aadhar card'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page2']['Personal Information']['Aadhar card'] : "Nil" ;?>" readonly />
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Aarogyasri Card" value="<?php echo(isset($docs_2021_22[0]['doc_data']['widget_data']['page2']['Personal Information']['Aarogya sri'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page2']['Personal Information']['Aarogya sri'] : "Nil" ;?>" readonly />
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        	<div class="row">
                        		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                <div class="form-group">
	                                    <div class="form-line">
	                                        <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Student Name" value="<?php echo $docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Name'];?>" readonly />
	                                    </div>
	                                </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                <div class="form-group">
	                                    <div class="form-line">
	                                        <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="School Name" value="<?php echo $docs_two[0]['doc_data']['widget_data']['page2']['Personal Information']['School Name'];?>" readonly/>
	                                    </div>
	                                </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                <div class="form-group">
	                                    <div class="form-line">
	                                        <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Gender" value="<?php echo(isset($docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Gender'])) ? $docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Gender'] : "" ;?>" readonly/>
	                                    </div>
	                                </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="White Ration Cards" value="<?php echo(isset($docs_2021_22[0]['doc_data']['widget_data']['page2']['Personal Information']['Ration card'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page2']['Personal Information']['Ration card'] : "Nil" ;?>" readonly/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        	<div class="row">
                        		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                <div class="form-group">
	                                    <div class="form-line">
	                                        <input type="text" class="form-control" data-toggle="tooltip" data-palcement="bottom" title="Father Name" value="<?php echo(isset($docs_two[0]['doc_data']['widget_data']['page2']['Personal Information']['Father Name'])) ? $docs_two[0]['doc_data']['widget_data']['page2']['Personal Information']['Father Name'] : ""; ?>" readonly/>
	                                    </div>
	                                </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                <div class="form-group">
	                                    <div class="form-line">
	                                        <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Date of Birth" value="<?php echo $docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Date of Birth']; ?>" readonly />
	                                    </div>
	                                </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                <div class="form-group">
	                                    <div class="form-line">
	                                        <input type="text" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Date of Exam" value="<?php echo $docs_two[0]['doc_data']['widget_data']['page2']['Personal Information']['Date of Exam'];?>" readonly/>
	                                    </div>
	                                </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <?php if(isset($docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Photo']) && !is_null($docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Photo']) && !empty($docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Photo']) && isset($docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Photo']['file_path'])):?>
                            <!-- <a href="<?php //echo URLCustomer.$doc['doc_data']['widget_data']['page1']['Personal Information']['Photo']['file_path'];?>" rel="prettyPhoto"> -->
                            <a data-magnify="gallery" data-src="" data-caption="Profile pic" data-group="a" href="<?php echo URLCustomer.$docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Photo']['file_path'];?>">
                                <img src="<?php echo URLCustomer.$docs_two[0]['doc_data']['widget_data']['page1']['Personal Information']['Photo']['file_path'];?>" style="height: 170px;width: 180px; border: 4px solid darkgrey;"/>
...
<div class="row clearfix">  
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<ul class="nav nav-tabs tab-nav-right" role="tablist">
            ...
            <li role="presentation"><a href="#student_screening_info_2021_22" data-toggle="tab" ><button class="btn bg-cyan waves-effect" type="button">Screening Info 2021-22</button></a></li>
            ...
            <li role="presentation"><a href="#request_notes" data-toggle="tab" ><button class="btn bg-orange waves-effect" type="button">Request Notes</button></a></li>
            <!-- <li role="presentation"><a href="#rhso_visit" data-toggle="tab" ><button class="btn bg-blue waves-effect" type="button">RHSO visit</button></a></li>-->
...
<div id="student_screening_info" role="tabpanel" class="tab-pane fade in active">
   <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                        ...
                        <li role="presentation"><a href="#othermedicalattach_animation" data-toggle="tab">Other Medical Attachments</a></li>
                         <li role="presentation"><a href="#mef_animation" data-toggle="tab">MEF Attchments</a></li>
                    </ul>
                </div>
...
<div id="othermedicalattach_animation" role="tabpanel" class="tab-pane animated fadeInRight">
    <p>External Attachments</p>
 <?php if(isset($doc['doc_data']['widget_data']['external_attachments']) && !is_null($doc['doc_data']['widget_data']['external_attachments']) && !empty($doc['doc_data']['widget_data']['external_attachments'])): ?>  
    <?php foreach ($doc['doc_data']['widget_data']['external_attachments'] as $attachment):?>
...
<!-- MEF ATTACHMENTS SECTION -->

<div id="mef_animation" role="tabpanel" class="tab-pane animated fadeInRight">
<p>Medical Evalution Form</p>
 <?php if(isset($doc['doc_data']['widget_data']['mef_attachments']) && !is_null($doc['doc_data']['widget_data']['mef_attachments']) && !empty($doc['doc_data']['widget_data']['mef_attachments'])): ?>  
    <?php foreach ($doc['doc_data']['widget_data']['mef_attachments'] as $attachment):?>
            <img src="<?php echo URLCustomer.$attachment['file_path'];?>" width="500" height="600"/>
    <?php endforeach;?>   
<?php endif; ?>      
</div>

<!-- -------------End of MEF attachments---------------- -->
...
<!-- SCREENING INFORMATION 2021-22-->      
<div class="tab-content">
<div id="student_screening_info_2021_22" role="tabpanel" class="tab-pane fade">
   <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                        <li role="presentation" class="active"><a href="#physical_animation_2021_22" data-toggle="tab">Physical Exam</a></li>
                        <li role="presentation"><a href="#doctor_animation_2021_22" data-toggle="tab">Doctor Check Up</a></li>
                        <li role="presentation"><a href="#vision_animation_2021_22" data-toggle="tab">Vision Screening</a></li>
                        <li role="presentation"><a href="#auditory_animation_2021_22" data-toggle="tab">Auditory Screening</a></li>
                        <li role="presentation"><a href="#dental_animation_2021_22" data-toggle="tab">Dental Check Up</a></li>
                        <li role="presentation"><a href="#othermedicalattach_animation_2021_22" data-toggle="tab">Other Medical Attachments</a></li>
                        <li role="presentation"><a href="#mef_animation_2021_22" data-toggle="tab">MEF Attachments</a></li>
                    </ul>
                </div>
...
<!-- PHYSICAL EXAMINATION SECTION --> 
    ...
    <?php if(isset($docs_2021_22[0]["doc_data"]["widget_data"]["page3"]["Physical Exam"])):?>
        <div id="physical_animation_2021_22" role="tabpanel" class="tab-pane animated fadeInRight active">
        <div class="body table-responsive">
            <table class="table table-striped" id="">
                ...
                <!-- <?php //if(isset($doc['doc_data']['widget_data']['page3']['Physical Exam']) && !empty($doc['doc_data']['widget_data']['page3']['Physical Exam'])): ?> -->
                    ...
                    <tbody>
                        <tr>
                            <th>Height cms</th><td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page3']['Physical Exam']['Height cms'];?></i></td>
                            <th>Weight kgs</th><td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page3']['Physical Exam']['Weight kgs']; ?></i></td>
                        </tr>
                        <tr>
                            <th>BMI%</th><td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page3']['Physical Exam']['BMI%']; ?></i></td>
                            <th>Pulse</th><td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page3']['Physical Exam']['Pulse']; ?></i></td>
                        </tr>
                        <tr>
                            <th>H B</th><td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page3']['Physical Exam']['H B']; ?></i></td>
                            <th>B P</th><td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page3']['Physical Exam']['B P']; ?></i></td>
                        </tr>
                        <tr>
                            <th>Blood Group</th><td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page3']['Physical Exam']['Blood Group']; ?></i></td>
                            <!-- <th>SPO2</th><td><i class="icon-leaf"><?php //echo $doc['']['']['']['']['']; ?></i></td> -->
                        </tr>
                        <tr>
                            <!-- <th>Ni Gluc</th><td><i class="icon-leaf"><?php //echo $doc['']['']['']['']['']; ?></i></td>
...
<!-- ===========DOCTOR CHECKUP SECTION================= -->
    ...
    <?php if (isset($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']) && isset($docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up'])): ?>

        <div id="doctor_animation_2021_22" role="tabpanel" class="tab-pane animated fadeInRight">
            <p>
            <table id="" class="table table-striped table-bordered table-hover">
                <tbody>
                    <tr>
                        <th>Abnormalities</th>
                        <td><i class="icon-leaf">
                            <?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Check the box if normal else describe abnormalities']) && !empty($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Check the box if normal else describe abnormalities'])) :?> 
                           <?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Check the box if normal else describe abnormalities'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Check the box if normal else describe abnormalities']) : $docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Check the box if normal else describe abnormalities'];?><?php endif; ?> </i></td>
                        <th>Ortho</th><td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho']) : $docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Ortho'];?></i></td>
                    </tr>
                    
                    <tr>
                        <th>Description</th><td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Description'];?></i></td>
                    </tr>
                    <tr>
                        <th>Advice</th><td><i class="icon-leaf"><?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Advice']) && !empty($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Advice'])) :?><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Advice'];?> <?php else : ?> <?php echo "";?><?php endIf;?></i></td>
                        <th>Postural</th><td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Postural'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Postural']) : $docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Postural'];?></i></td>
                    </tr>
                    <tr>
                        <th>Skin conditions</th><td><i class="icon-leaf"><?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Skin conditions']) && !empty($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Skin conditions'])) :?> 
                        <?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Skin conditions'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Skin conditions']) : $docs_2021_22[0]['doc_data']['widget_data']['page4']['Doctor Check Up']['Skin conditions'];?><?php endIf; ?> </i></td>
                        <th>Defects at Birth</th><td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['Defects at Birth'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['Defects at Birth']) : $docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['Defects at Birth'];?></i></td>
                    </tr>
                    <tr>
                        <th>Deficencies</th><td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['Deficencies'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['Deficencies']) : $docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['Deficencies'];?></i></td>
                        <th>Childhood Diseases</th><td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['Childhood Diseases'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['Childhood Diseases']) : $docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['Childhood Diseases'];?></i></td>
                    </tr>
                    <tr>
                        <th>N A D</th><td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['N A D']))?(gettype($docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['N A D'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['N A D']) : $docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['N A D'] : "";?></i></td>
                        <th class="hidden">General Physician Sign</th>
                        <td class="hidden"><?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['General Physician Sign']) && !empty($docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['General Physician Sign'])) :?>
                        <img src="<?php echo URLCustomer.$docs_2021_22[0]['doc_data']['widget_data']['page5']['Doctor Check Up']['General Physician Sign']['file_path'];?>" height="100" width="180"/><?php else: ?><?php echo "General Physician Sign Not Available";?><?php endif ;?></td>
                    </tr>
...
<!-- VISION SCREENING SECTION -->
<?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['page6']['With Glasses']) && isset($docs_2021_22[0]['doc_data']['widget_data']['page6']['Without Glasses']) && isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']) ): ?>

    <div id="vision_animation_2021_22" role="tabpanel" class="tab-pane animated fadeInRight">
        <!-- <b>Vision Screening</b> -->
        <p>
        <table id="" class="table table-striped table-bordered table-hover">
        <tbody>
            <tr>
                <th rowspan="2">Without Glasses</th>
                <th>Right</th>
                <td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page6']['Without Glasses']['Right'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page6']['Without Glasses']['Right'] : ""?></i></td>
                <th rowspan="2">
                <th>Right</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page6']['With Glasses']['Right'];?></i></td>
            </tr>
            <tr>
                <th>Left</th>
                <td><i class="icon-leaf"></i><?php echo(isset($docs_2021_22[0]['doc_data']['widget_data']['page6']['Without Glasses']['Left'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page6']['Without Glasses']['Left'] : "" ?></td>
                <th>Left</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page6']['With Glasses']['Left'];?></i></td>
            </tr>
            <tr>
                <th>Colour Blindness</th><!--<th>Right</th>-->
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Right'];?></i></td>
                <th>Description</th>
                <td colspan="2"><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Description'];?></i></td>
            </tr>
            <tr>
                <!--<th>Left</th><td><i class="icon-leaf"><?php// echo $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Left'];?></i></td>-->
                <th rowspan="2">Slit Lamp Examination</th>
                <th>Conjunctiva</th>
                <td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Conjunctiva'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Conjunctiva'] : "" ;?></i></td>
                <th>Eye Lids</th>
                <td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Eye Lids'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Eye Lids'] : "" ;?></i></td>
            </tr>                                   
            <tr>
                <th>Cornea</th>
                <td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Cornea'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Cornea'] : "" ;?></i></td>
                <th>Pupil</th>
                <td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Pupil'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Pupil'] : "" ;?></i></td>
            </tr>
            <tr>                                        
                <th>Complaints</th>
                <td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Complaints'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Complaints'] : "" ;?></i></td>
                <th colspan="2">Wearing Spectacles</th>
                <td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Wearing Spectacles'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Wearing Spectacles'] : "" ;?></i></td>
            </tr>
            <tr>    
                <th>Subjective Refraction</th>
                <td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Subjective Refraction'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Subjective Refraction'] : "" ;?></i></td>
                <th colspan="2">Ocular Diagnosis</th>
                <td><i class="icon-leaf"><?php echo (isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Ocular Diagnosis'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Ocular Diagnosis'] : "" ;?></i></td>
            </tr>
            <tr>
                <th>Referral Made</th>
                <td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Referral Made'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Referral Made']) : $docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Referral Made'];?></i></td>
            </tr>
            <tr>
            <th class="hidden">Opthomologist Sign</th>
            <td class="hidden"><i class="icon-leaf"><?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Opthomologist Sign']) && !is_null($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Opthomologist Sign']) && !empty($docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Opthomologist Sign'])) : ?>
                <img src="<?php echo URLCustomer.$docs_2021_22[0]['doc_data']['widget_data']['page7']['Colour Blindness']['Opthomologist Sign']['file_path'];?>" height="100" width="180" /> <?php else :?> <?php echo "Opthomologist Sign Not Available";?> <?php endIf;?></i></td>
            </tr>
        </tbody>
        </table>
        </p>
...
<?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening'])):?>
            
    <div id="auditory_animation_2021_22" role="tabpanel" class="tab-pane animated fadeInRight">
        <!-- <b>AUDITORY SCREENING</b> -->
        <p>
        <table id="" class="table table-striped table-bordered table-hover">
            <tbody>
            <tr>
                <th rowspan="2">Auditory Screening</th>
                <th>Right</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Right'];?></i></td>
                <th>Speech Screening</th>
                <td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Speech Screening'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Speech Screening']) : $docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Speech Screening'];?></i></td>
            </tr>
            <tr>
                <th>Left</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Left'];?></i></td>
                <th>D D and disability</th>
                <td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['D D and disability'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['D D and disability']) : $docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['D D and disability'];?></i></td>
            </tr>
            <tr>
                <th>Description</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Description'];?></i></td>
                <th>Referral Made</th>
                <td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Referral Made'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Referral Made']) : $docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Referral Made'];?></i></td>
            </tr>
        </tbody>
    </table>
    </p>
...
<!-- DENTAL CHECKUP SECTION --> 
<?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up'])): ?>
      
    <div id="dental_animation_2021_22" role="tabpanel" class="tab-pane animated fadeInRight">
       <!--  <b>DENTAL CHECK UP</b> -->
        <p>
    <table id="" class="table table-striped table-bordered table-hover">
        <tbody>
            <tr>
                <th>Oral Hygiene</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Oral Hygiene']; ?></i></td>
                <th>Carious Teeth</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Carious Teeth']; ?></i></td>
            </tr>
            <tr>
                <th>Flourosis</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Flourosis']; ?></i></td>
                <th>Orthodontic Treatment</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Orthodontic Treatment']; ?></i></td>
            </tr>
            <tr>
                <th>Indication for extraction</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Indication for extraction']; ?></i></td>
                <th>Root Canal Treatment</th>
                <td><i class="icon-leaf"><?php echo (isset( $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Root Canal Treatment'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Root Canal Treatment'] : "";?></i></td>
            </tr>
            <tr>
                <th>Curettage</th>
                <td><i class="icon-leaf"><?php echo (isset( $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Curettage'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Curettage'] : "";?></i></td>
                <th>Estimated Amount</th>
                <td><i class="icon-leaf"><?php echo (isset( $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Estimated Amount'])) ? $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Estimated Amount'] : "";?></i></td>
            </tr>
            <tr>
                <th>Result</th>
                <td><i class="icon-leaf"><?php echo $docs_2021_22[0]['doc_data']['widget_data']['page9']['Dental Check-up']['Result'];?></i></td>
                <th>Referral Made</th>
                <td><i class="icon-leaf"><?php echo (gettype($docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Referral Made'])=="array")? implode (", ",$docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Referral Made']) : $docs_2021_22[0]['doc_data']['widget_data']['page8'][' Auditory Screening']['Referral Made'];?></i></td>
            </tr>
        </tbody>
...
<!-- OTHER MEDICAL ATTACHMENTS SECTION -->
<div id="othermedicalattach_animation_2021_22" role="tabpanel" class="tab-pane animated fadeInRight">
    <p>External Attachments</p>
 <?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['external_attachments']) && !is_null($docs_2021_22[0]['doc_data']['widget_data']['external_attachments']) && !empty($docs_2021_22[0]['doc_data']['widget_data']['external_attachments'])): ?>  
    <?php foreach ($docs_2021_22[0]['doc_data']['widget_data']['external_attachments'] as $attachment):?>
        <img src="<?php echo URLCustomer.$attachment['file_path'];?>" width="500" height="600"/>
    <?php endforeach;?>   
<?php endif; ?>      
</div>
...
<!-- MEF ATTACHMENTS SECTION -->
<div id="mef_animation_2021_22" role="tabpanel" class="tab-pane animated fadeInRight">
    <p>Medical Evalution Form</p>
<!-- MEF Forms attachment has two different paths so taken two times -->
 <?php if(isset($docs_2021_22[0]['doc_data']['widget_data']['mef_attachments']) && !is_null($docs_2021_22[0]['doc_data']['widget_data']['mef_attachments']) && !empty($docs_2021_22[0]['doc_data']['widget_data']['mef_attachments'])): ?>  
    <?php foreach ($docs_2021_22[0]['doc_data']['widget_data']['mef_attachments'] as $attachment):?>
        <img src="<?php echo URLCustomer.$attachment['file_path'];?>" width="500" height="600"/>
    <?php endforeach;?>   
<?php endif; ?>

<?php if(isset($docs_2021_22[0]['doc_data']['mef_attachments']) && !is_null($docs_2021_22[0]['doc_data']['mef_attachments']) && !empty($docs_2021_22[0]['doc_data']['mef_attachments'])): ?>  
    <?php foreach ($docs_2021_22[0]['doc_data']['mef_attachments'] as $attachment):?>
        <img src="<?php echo URLCustomer.$attachment['file_path'];?>" width="500" height="600"/>
    <?php endforeach;?>   
<?php endif; ?>         
</div>
...
<!-- =============================END OF SCREENING INFORMATION SECTION 2021-22=============================================== -->
...
<p>
    <div class="card">
        ...
        <!-- For Rhso Followup Data -->

        <?php if(isset($request['doc_data']['rhso_followup'])): ?>
        
        <table id="dt_basic" class="table table-striped table-bordered table-hover">
            <tbody>
               
                <tr style="center;background-color: #FF00FF;">
                    <th colspan=2><h4 style="color: black;text-align: center;"><b>RHSO Followups</b></h4></th>
                </tr>
            <?php foreach($request['doc_data']['rhso_followup'] as $follows): ?>
                <tr>
               
                     <th colspan=2><u><h4 style="color: green;text-align:center;float:left;"><?php echo $follows['doc_data']['widget_data']['type_of_request'];?></h4>
                        <h4 style="color: red;"><?php echo $follows['history']['last_stage']['time'];?></h4></u></th>
                    
           
                </tr>
                
                <?php if($follows['doc_data']['widget_data']['type_of_request'] == "Out Patients"): ?>

                <tr>
                    <th>Hospital Name</th><td><?php echo $follows['doc_data']['widget_data']['Out Patient']['hospialt_name'];?></td>
                </tr>               
                <tr>
                    <th>Problem Info</th><td><?php echo $follows['doc_data']['widget_data']['Out Patient']['patient_details'];?></td>
                </tr>
                <tr>
                    <th>Investigation</th><td><?php echo $follows['doc_data']['widget_data']['Out Patient']['investigations'];?></td>
                </tr>
                <tr>
                    <th>Medication</th><td><?php echo $follows['doc_data']['widget_data']['Out Patient']['medication'];?></td>
                </tr>

                 <tr>
                    <th>Review Date</th><td><?php echo $follows['doc_data']['widget_data']['Out Patient']['review_date'];?></td>
                </tr>
             
                <?php elseif($follows['doc_data']['widget_data']['type_of_request'] == "Emergency or Admitted"): ?>

                <tr>
                    <th>Hospital Name</th><td><?php echo $follows['doc_data']['widget_data']['Emergency or Admitted']['hospialt_name'];?></td>
                </tr>               
                <tr>
                    <th>Problem Info</th><td><?php echo $follows['doc_data']['widget_data']['Emergency or Admitted']['patient_details'];?></td>
                </tr>
                <tr>
                    <th>Investigation</th><td><?php echo $follows['doc_data']['widget_data']['Emergency or Admitted']['investigations'];?></td>
                </tr>
                <tr>
                    <th>Medication</th><td><?php echo $follows['doc_data']['widget_data']['Emergency or Admitted']['medication'];?></td>
                </tr>
                <tr>
                    <th>Doctor Advice</th><td><?php echo $follows['doc_data']['widget_data']['Emergency or Admitted']['Doctor Advice'];?></td>
                </tr>
                   
                 <?php elseif($follows['doc_data']['widget_data']['type_of_request'] == "Review Cases"): ?>

                <tr>
                    <th>Hospital Name</th><td><?php echo $follows['doc_data']['widget_data']['Review Cases']['hospialt_name'];?></td>
                </tr>               
                <tr>
                    <th>Problem Info</th><td><?php echo $follows['doc_data']['widget_data']['Review Cases']['patient_details'];?></td>
                </tr>
                <tr>
                    <th>Investigation</th><td><?php echo $follows['doc_data']['widget_data']['Review Cases']['investigations'];?></td>
                </tr>
                <tr>
                    <th>Medication</th><td><?php echo $follows['doc_data']['widget_data']['Review Cases']['medication'];?></td>
                </tr>
                <tr>
                    <th>Review case close</th><td><?php echo $follows['doc_data']['widget_data']['Review Cases']['review_caseclose'];?></td>
                </tr>
            ...
            <div class="row clearfix">
                        ...
                        <?php $ran = rand(51,70); ?>
                            ...
                            <li role="presentation"><a href="#prescription_attach<?php echo $ran; ?>" data-toggle="tab"><button class="btn bg-green btn-lg btn-block waves-effect" type="button">Prescription<span class="badge"><?php if(isset($follows['doc_attachments']['Prescriptions'])): echo count($follows['doc_attachments']['Prescriptions']); else: echo "0"; endif; ?></span></button></a></li>

                             <li role="presentation"><a href="#lab_report_attch<?php echo $ran; ?>" data-toggle="tab"><button class="btn bg-red btn-lg btn-block waves-effect" type="button">Lab-Reports<span class="badge"><?php if(isset($follows['doc_attachments']['Lab_Reports'])): echo count($follows['doc_attachments']['Lab_Reports']); else: echo "0"; endif; ?></span></button></a></li>

                              <li role="presentation"><a href="#xmdigital_attach<?php echo $ran; ?>" data-toggle="tab"><button class="btn bg-blue btn-lg btn-block waves-effect" type="button">X-ray/MRI/Digital Images<span class="badge"><?php if(isset($follows['doc_attachments']['Digital_Images'])): echo count($follows['doc_attachments']['Digital_Images']); else: echo "0"; endif; ?></span></button></a></li>

                              <li role="presentation"><a href="#payment_attach<?php echo $ran; ?>" data-toggle="tab"><button class="btn bg-teal btn-lg btn-block waves-effect" type="button">Payments-Bills<span class="badge"><?php if(isset($follows['doc_attachments']['Payments_Bills'])): echo count($follows['doc_attachments']['Payments_Bills']); else: echo "0"; endif; ?></span></button></a></li>

                               <li role="presentation"><a href="#discharge_attach<?php echo $ran; ?>" data-toggle="tab"><button class="btn bg-orange btn-lg btn-block waves-effect" type="button">Discharge Summary<span class="badge"><?php if(isset($follows['doc_attachments']['Discharge_Summary'])): echo count($follows['doc_attachments']['Discharge_Summary']); else: echo "0"; endif; ?></span></button></a></li>

                                <li role="presentation"><a href="#other_attach<?php echo $ran; ?>" data-toggle="tab"><button class="btn bg-purple btn-lg btn-block waves-effect" type="button">Other Attachments<span class="badge"><?php if(isset($follows['doc_attachments']['external_attachments'])): echo count($follows['doc_attachments']['external_attachments']); else: echo "0"; endif; ?></span></button></a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="prescription_attach<?php echo $ran; ?>">
                            <?php if(isset($follows['doc_attachments']['Prescriptions']) && !is_null($follows['doc_attachments']['Prescriptions']) && !empty($follows['doc_attachments']['Prescriptions'])):?>

                             <b>Prescription Attachments</b>
                                <p>
                                    <?php foreach ($follows['doc_attachments']['Prescriptions'] as $attachment):?>
                           ...
                           <div role="tabpanel" class="tab-pane fade" id="lab_report_attch<?php echo $ran; ?>">
                            <?php if(isset($follows['doc_attachments']['Lab_Reports']) && !is_null($follows['doc_attachments']['Lab_Reports']) && !empty($follows['doc_attachments']['Lab_Reports'])):?>

                              <b>Lab report Attachments</b>
                                <p>
                                    <?php foreach ($follows['doc_attachments']['Lab_Reports'] as $attachment):?>

                                        <a data-magnify="gallery" data-src="" data-caption="Lab_Reports" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
                                        <img src="<?php echo URLCustomer.$attachment['file_path'];?>" alt="" width="300" >
                                        </a>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="xmdigital_attach<?php echo $ran; ?>">
                            <?php if(isset($follows['doc_attachments']['Digital_Images']) && !is_null($follows['doc_attachments']['Digital_Images']) && !empty($follows['doc_attachments']['Digital_Images'])):?>

                             <b>X-ray/MRI/Digital Attachments</b>
                                <p>
                                    <?php foreach ($follows['doc_attachments']['Digital_Images'] as $attachment):?>

                                        <a data-magnify="gallery" data-src="" data-caption="Digital_Images" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
                                        <img src="<?php echo URLCustomer.$attachment['file_path'];?>" alt="" width="300" >
                                        </a>
                           ...
                           <div role="tabpanel" class="tab-pane fade" id="payment_attach<?php echo $ran; ?>">
                            <?php if(isset($follows['doc_attachments']['Payments_Bills']) && !is_null($follows['doc_attachments']['Payments_Bills']) && !empty($follows['doc_attachments']['Payments_Bills'])):?>

                             <b>Payments Bills Attachments</b>
                                <p>
                                    <?php foreach ($follows['doc_attachments']['Payments_Bills'] as $attachment):?>

                                        <a data-magnify="gallery" data-src="" data-caption="Payments_Bills" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
                                        <img src="<?php echo URLCustomer.$attachment['file_path'];?>" alt="" width="300" >
                                        </a>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="discharge_attach<?php echo $ran; ?>">
                            <?php if(isset($follows['doc_attachments']['Discharge_Summary']) && !is_null($follows['doc_attachments']['Discharge_Summary']) && !empty($follows['doc_attachments']['Discharge_Summary'])):?>

                             <b>Discharge Summary Attachments</b>
                                <p>
                                    <?php foreach ($follows['doc_attachments']['Discharge_Summary'] as $attachment):?>

                                        <a data-magnify="gallery" data-src="" data-caption="Discharge_Summary" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
                                        <img src="<?php echo URLCustomer.$attachment['file_path'];?>" alt="" width="300" >
                                        </a>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="other_attach<?php echo $ran; ?>">
                            <?php if(isset($follows['doc_attachments']['external_attachments']) && !is_null($follows['doc_attachments']['external_attachments']) && !empty($follows['doc_attachments']['external_attachments'])):?>

                             <b>Other Attachments</b>
                                <p>
                                    <?php foreach ($follows['doc_attachments']['external_attachments'] as $attachment):?>

                                        <a data-magnify="gallery" data-src="" data-caption="external_attachments" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
                                        <img src="<?php echo URLCustomer.$attachment['file_path'];?>" alt="" width="300" >
                                        </a>
...
<div id="calling_info" role="tabpanel" class="tab-pane fade" >
          ...
          <?php if(isset($doctors_medical_reports) && !is_null($doctors_medical_reports) && !empty($doctors_medical_reports)):?>
        
            <legend><h3 class="text-primary">Doctor's School Visitings</h3></legend>
            <table class="table table-striped table-bordered table-hover">
                ...
                <?php foreach($doctors_medical_reports as $report): ?>
                    <tr>
                        <td><?php echo $report["doc_data"]["widget_data"]["Student Details"]['doctor_visiting_date'];?></td>
                        <td><?php echo $report["doc_data"]["widget_data"]["Student Details"]['remarks'];?></td>
...
<!-- ===================================== NOTES START ============================================= -->                                
<div id="request_notes" role="tabpanel" class="tab-pane fade">
    <p>
        <b>Request Notes</b>
        <table id="" class="table table-striped table-bordered table-hover">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><i class="icon-leaf"></i><?php echo $data['datetime'];?></td>
                        <td><i class="icon-leaf"><?php echo $data['note'];?></i></td>
                    </tr>
                       <?php endforeach;?>               
                </tbody>
        </table>
