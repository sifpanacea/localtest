    ...
    <div id="collapseExample" class="collapse panel">
        <div class="panel-body">
            ...
            <!-- District Filter -->
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li <?php if($current_page == 'cured_requests') { echo 'class="active"';} ?>>
                                 ...
                                 <li <?php if($current_page == 'cured_requests') { echo 'class="active"';} ?>>
                                    <a href='<?php echo URL."panacea_mgmt/panacea_mgmt_dmho_numbers"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'cured_requests') { echo 'class="active"';} ?>>
                                    <a href='<?php echo URL."panacea_mgmt/panacea_mgmt_blood_banks"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'cured_requests') { echo 'class="active"';} ?>>
                                 ...
                                 <li <?php if($current_page == 'cured_requests') { echo 'class="active"';} ?>>
                                    <a href='<?php echo URL."panacea_mgmt/panacea_mgmt_rhso"; ?>'>
                                        <i class="material-icons">navigate_next</i>
                                        <span>Manage Rhso</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li <?php if($current_page == 'blood banks') { echo 'class="active"';} ?>>
                                  <a href='<?php echo URL."panacea_mgmt/panacea_blood_blanks_report"; ?>'>
                                      <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                 ...
                                 <li <?php if($current_page == 'Passedouts Students') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_passedouts_students"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_dr_not_responded_docs"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                 ...
                                 <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/napkin_distribution_reports"; ?>">
                                       <i class="material-icons">navigate_next</i>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li <?php if($current_page == 'Import Students') { echo 'class="active"';}?>>
                                 ...
                                 <li <?php if($current_page == 'Import Blood Donors') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_imports_blood_donors"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                ...
                                <li <?php if($current_page == 'Upgrade Classes') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_upgrade_students_classes"; ?>">
                                        <i class="material-icons">navigate_next</i>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li <?php if($current_page == 'Manage_Health_Quotation') { echo 'class="active"';} ?>>
                                  <a href='<?php echo URL."panacea_mgmt/manage_health_quotation_view"; ?>'>
                                      <i class="material-icons">navigate_next</i>
                 ...
                 <div class="btn-group">
                        ...
                        <div id="mySidepanel" class="sidepanel">
                          ...
                          <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>
                            ...
                            <a href="<?php echo URL."panacea_mgmt/panacea_covid_cases"; ?>">
                                <i class="material-icons">navigate_next</i>
                                <span>Covid-19 Cases</span>
                            </a>

                            <a href="<?php echo URL."panacea_mgmt/panacea_covid_cured_cases"; ?>">
                                <i class="material-icons">navigate_next</i>
                                <span>Covid Cured Cases</span>
                            </a>

                            <a href="<?php echo URL."panacea_mgmt/panacea_l3_helpline_services"; ?>">
                                <i class="material-icons">navigate_next</i>
                                <span>L3 Help Line Services</span>
                            </a>

                            <a href="<?php echo URL."panacea_mgmt/panacea_staff_covid_cases"; ?>">
                                <i class="material-icons">navigate_next</i>
                                <span>Staff Covid Cases</span>
                            </a> 

                            <a href="<?php echo URL."panacea_mgmt/panacea_staff_vaccination_details"; ?>">
                                <i class="material-icons">navigate_next</i>
                                <span>Staff Vaccination Details</span>
                            </a>

                             <a href="<?php echo URL."panacea_mgmt/panacea_deadth_cases"; ?>">
                                <i class="material-icons">navigate_next</i>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li <?php if($current_page == 'School_health_status') { echo 'class="active"';} ?>>
                                 ...
                                 <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/schools_overall_information"; ?>">
                                       <i class="material-icons">navigate_next</i>
                               ...
                               <!--  <li <?php //if($current_page == 'parent_registration') { echo 'class="active"';} ?>>
                                ...
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/requests_notes"; ?>">
                                       <i class="material-icons">navigate_next</i>
                                       <span>Request Notes</span>
                                    </a>
                               </li>
                               <li <?php if($current_page == 'Health Assistants Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/health_assistancts_status"; ?>">
                                       <i class="material-icons">navigate_next</i>
                                       <span>Health & Technical Assis.. Submitted Requests</span>
                                    </a>
                               </li>
                                <li <?php if($current_page == 'Followup Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/regular_followup_requests"; ?>">
                                       <i class="material-icons">navigate_next</i>
                                       <span>Regular Followup Requests</span>
                                    </a>
                               </li>
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_rhso_followup_reports"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>RHSO Followup Reports</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_rhso_reports"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>RHSO School Visits</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_rhso_hospital_reports"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>RHSO Hospital Visits</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_aarogyasri_hospitals_list"; ?>">
                                       <i class="material-icons">navigate_next</i>
                                       <span>Aarogyasri Hospitals</span>
                                    </a>
                               </li>
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_organ_transplant_hospitals_list"; ?>">
                                       <i class="material-icons">navigate_next</i>
                                       <span>Organ Transplant Hospitals</span>
                                    </a>
                               </li>
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_ro_plant_incinarators"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>RO Plants & Incinarators</span>
                                    </a>
                                </li>
                                <li <?php if($current_page == 'Diseases Counts') { echo 'class="active"';}?>>
                                    <a href="<?php echo URL."panacea_mgmt/panacea_hospitalized_info"; ?>">
                                        <i class="material-icons">navigate_next</i>
                                        <span>RO Plants & Incinarators</span>
                                    </a>
                                </li>
                ...
                <!-- Sponsored school Data seperate Dashboard -->

                <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        CSR Data<span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu">
                        <li <?php if($current_page == 'sponsored_schools_dashboard') { echo 'class="active"';} ?>>
                            <a href='<?php echo URL."panacea_mgmt/sponsored_schools_dashboard"; ?>'>
                                <i class="material-icons">navigate_next</i>
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Employees Tracking<span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu">
                        <li <?php if($current_page == 'employees_tracking_dashboard') { echo 'class="active"';} ?>>
                            <a href='<?php echo URL."panacea_mgmt/employees_tracking_dashboard"; ?>'>
                                <i class="material-icons">navigate_next</i>
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Menstural Cycle Tracking<span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu">
                        <li <?php if($current_page == 'menstural_tracking_dashboard') { echo 'class="active"';} ?>>
                            <a href='<?php echo URL."panacea_mgmt/menstural_tracking_dashboard"; ?>'>
                                <i class="material-icons">navigate_next</i>
                                <span>Track List</span>
                            </a>
                        </li>
...
<div class="row clearfix">
    ...
    <div class="col-lg-3 col-md-4 col-sm-8 col-xs-12">
        <div class="card">
            <div class="header" style="padding: 3px">
                ...
                <label for="updated_request_bar"><b>Updated Health Request</b></label>                
            </div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="height: 40%">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="info-box-3 bg-grey hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <a href="<?php echo URL."panacea_mgmt/panacea_today_followup_cases"; ?>" class="badge bg-red status_blink" style="height: 60px;margin-bottom: -10px;">Today's Follow up cases :<span class="badge bg-green" style="padding: 8px;"><?php echo $regular_alerts; ?></span></a>
                    </div>
                </div>
            </div>
        </div>
                         ...
                         <div class="body"  style="height: 290px;">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_reports_display_ehr_uid/"?>? id = <?php echo $pic['uniqid']; ?>'>
...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <div class="card">
        ...
        <div class="body">
            ...
            <div class="row clearfix" id="update_yearly_request_pie_span"> 
               <div class="col-sm-6">
                   <select class="form-control show-tick request_academic_filter" id="request_academic_filter">
                       <option value="2021-2022" selected="">2021-2022 AcademicYear</option>
                       <option value="2020-2021">2020-2021 AcademicYear</option>
                       <option value="2019-2020">2019-2020 AcademicYear</option>
                       <option value="2018-2019">2018-2019 AcademicYear</option>
...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <div class="card">
        <div class="header" style="padding: 10px">
           ...
           <label for="bmi_gender_wise_pie"><b>BMI Gender wise</b></label>
