    ...
    <div class="row clearfix">
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="card"> 
                ...
                echo form_open_multipart('panacea_mgmt/import_blood_donors',$attributes);?>
                <div class="body">
         ...
         <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="card"> 
                ...
                <?php 
                $attributes = array('class' => 'smart-form');
                echo form_open_multipart('panacea_mgmt/import_aarogyasri_hospitals',$attributes);?>
                <div class="body">
         ...
         <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="card"> 
                <div class="header">
                    <h2>Organ Transplant Hospitals </h2>
                    <ul class="header-dropdown m-r--5">
                        <div class="button-demo">
                ...
                <?php 
                $attributes = array('class' => 'smart-form');
                echo form_open_multipart('panacea_mgmt/import_organ_transplant_hospitals',$attributes);?>
                <div class="body">
                    <div class="custom-control custom-radio import_type">
                      <input type="radio" class="custom-control-input" id="import_type" name="import_type" value="personal_info" checked <?PHP echo set_radio('import_type','1',TRUE); ?>>
                      <label class="custom-control-label" for="defaultUnchecked">Only Personal Information</label>                    
                    ...
                    <div class="panel-body">
                        <form action="/" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn bg-indigo waves-effect" name="submit" id="sbt" data-toggle="modal" data-target="#import_waiting" data-backdrop="static" data-keyboard="false">
                                Import Organ Transplant Hospitals
                            </button>
                        </form>
                    </div>
                    <?php echo form_close();?>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="card "> 
                <div class="header">
                    <h2>Napkins Distribution Schools </h2>
                    <ul class="header-dropdown m-r--5">
                        <div class="button-demo">
                ...
                <?php 
                $attributes = array('class' => 'smart-form');
                echo form_open_multipart('panacea_mgmt/import_napkin_distribution_schools',$attributes);?>
                <div class="body">
                    <div class="custom-control custom-radio import_type">
                      <input type="radio" class="custom-control-input" id="import_type" name="import_type" value="personal_info" checked <?PHP echo set_radio('import_type','1',TRUE); ?>>
                      <label class="custom-control-label" for="defaultUnchecked">Only Personal Information</label>                    
                    ...
                    <div class="panel-body">
                        <form action="/" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn bg-indigo waves-effect" name="submit" id="sbt" data-toggle="modal" data-target="#import_waiting" data-backdrop="static" data-keyboard="false">
                                Import Napkins Ditribution Schools
                            </button>
                        </form>
                    </div>
                    <?php echo form_close();?>
...
<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="card"> 
                ...
                <?php 
                $attributes = array('class' => 'smart-form');
                echo form_open_multipart('panacea_mgmt/import_detailed_school_information',$attributes);?>
                <div class="body">
                    <div class="custom-control custom-radio import_type">
                      <input type="radio" class="custom-control-input" id="import_type" name="import_type" value="personal_info" checked <?PHP echo set_radio('import_type','1',TRUE); ?>>
                      <label class="custom-control-label" for="defaultUnchecked">Only Personal Information</label>                    
       ...
       <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="card"> 
                ...
                <?php 
                $attributes = array('class' => 'smart-form');
                echo form_open_multipart('panacea_mgmt/import_l3_services_data',$attributes);?>
                <div class="body">
                    <div class="custom-control custom-radio import_type">
                      <input type="radio" class="custom-control-input" id="import_type" name="import_type" value="personal_info" checked <?PHP echo set_radio('import_type','1',TRUE); ?>>
                      <label class="custom-control-label" for="defaultUnchecked">Only Personal Information</label>                    
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="card"> 
                ...
                <?php 
                $attributes = array('class' => 'smart-form');
                echo form_open_multipart('panacea_mgmt/import_staff_covid_cases',$attributes);?>
                <div class="body">
                    <div class="custom-control custom-radio import_type">
                      <input type="radio" class="custom-control-input" id="import_type" name="import_type" value="personal_info" checked <?PHP echo set_radio('import_type','1',TRUE); ?>>
                      <label class="custom-control-label" for="defaultUnchecked">Only Personal Information</label>                    
         ...
         <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="card"> 
                <div class="header">
                    <h2>Staff Vaccination Details </h2>
                    <ul class="header-dropdown m-r--5">
                        <div class="button-demo">
                        <button type="button" class="btn bg-pink waves-effect" onclick="window.history.back();">Back</button>
                        </div>
                ...
                <?php 
                $attributes = array('class' => 'smart-form');
                echo form_open_multipart('panacea_mgmt/import_vaccination_details',$attributes);?>
                <div class="body">
                    <div class="custom-control custom-radio import_type">
                      <input type="radio" class="custom-control-input" id="import_type" name="import_type" value="personal_info" checked <?PHP echo set_radio('import_type','1',TRUE); ?>>
                      <label class="custom-control-label" for="defaultUnchecked">Only Personal Information</label>                    
