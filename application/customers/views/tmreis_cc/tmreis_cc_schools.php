...
<div>
	...
	echo  form_open('tmreis_cc/create_school',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><?php //echo anchor("tmreis_cc/tmreis_cc_manage_school/".$school['_id'], lang('app_edit')) ;?>
						
						<a class='ldelete' href='<?php echo URL."tmreis_cc/tmreis_cc_delete_school/".$school['_id'];?>'>
