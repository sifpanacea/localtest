...
/*"req_extend" => array(
		"title" => "Extend Req",
		"url" => URL."tmreis_cc/extend_request_view",
		"icon" => "fa-star",
		"class" => "menu-links"
),*/
"pa att_req" => array(
...
"pa sani_report" => array(
		...
		"url" => URL."tmreis_cc/initiate_sanitation_report",
		"icon" => "fa-copy",
		"class" => "menu-links"
),
"pa chronic_report" => array(
		"title" => "Chronic Case Report",
		"url" => URL."tmreis_cc/list_chronic_cases",
		"icon" => "fa-tags",
		"class" => "menu-links"
),
 "pa feed_bmi" => array(
		...
		"sub" => array(
				"feed_bmi" => array(
				"title" => "Feed BMI",
				"url" => URL."tmreis_cc/feed_bmi_student",
				"icon" => "fa-user",
				"class" => "menu-links",
		),
		"show_bmi_graph" => array(
		"title" => "Show BMI Graph",
		"url" => URL."tmreis_cc/show_bmi_student",
		"icon" => "fa-user",
		"class" => "menu-links",
		)
		),
...
// 			),
		...
		"pa imports" => array(
				...
				"sub" => array(
						...
						"update_student_info" => array(
								...
								"url" => URL."tmreis_cc/tmreis_update_ehr",
								"icon" => "fa-star",
								"class" => "menu-links",
						),
				),
	...
	//==pasasia menu =======================
		...
		"sub" => array(
				"add_nf" => array(
						"title" => "Add News Feed",
						"url" => URL."tmreis_cc/add_news_feed_view",
						"icon" => "fa-star",
						"class" => "menu-links",
				),
				"view_nf" => array(
						"title" => "Manage News Feed",
						"url" => URL."tmreis_cc/manage_news_feed_view",
						"icon" => "fa-star",
						"class" => "menu-links",
				),
		),
