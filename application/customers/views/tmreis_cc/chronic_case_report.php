...
<script>
	$(document).ready(function(){
		...
		$.ajax({
			...
			type   : 'POST',
			data   : {"start_date":medic_start_date,"unique_id" : unique_id, "medication_schedule" : medication_schedule, "treatment_period" : treatment_period},
