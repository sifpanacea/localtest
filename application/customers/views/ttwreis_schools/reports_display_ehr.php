						...
						<ul>
							...
							<li style="display:none">
								<div class="well well-sm ">
									...
									<tr>
										<th class="hidden">Audiologist Sign</th><td class="hidden"><?php if(isset($doc['doc_data']['widget_data']['page8'][' Auditory Screening']['Audiologist Sign']) && !is_null($doc['doc_data']['widget_data']['page8'][' Auditory Screening']['Audiologist Sign']) && !empty($doc['doc_data']['widget_data']['page8'][' Auditory Screening']['Audiologist Sign'])) : ?>
