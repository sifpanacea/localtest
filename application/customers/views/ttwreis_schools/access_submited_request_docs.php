...
<div>
	...
	<div class="widget-body no-padding">
		...
		<form action='<?php echo URL."ttwreis_schools/reports_display_ehr_uid_new_html_static_hs";?>' accept-charset="utf-8" method="POST">
		...
		<button type="submit" id="show_ehr" class="btn bg-color-greenDark txt-color-white btn-lg show_ehr">Show EHR</button>
	</form>
<?php endforeach;?>
		<?php
		$attributes = array('class' => 'smart-form','id'=>'create_user','name'=>'userform');
		echo  form_open_multipart('ttwreis_schools/update_request_and_submit',$attributes);
		?>
		<fieldset>
...
<!--GI related information -->
				<div class="row tab-pane fade" id="gi">
					...
					<div class="col col-md-4">
						<label class="checkbox">
						<input type="checkbox" name="normal_gi_identifier[]" value="Melena(Blood stools)"
						<?php if(in_array("Melena(Blood stools)",$doc['doc_data']['widget_data']['page1']['Problem Info']['Normal']['Gastro_intestinal'])) { ?> checked="checked" <?php } ?>>
						<i></i>Melena(Blood stools)</label>
						<label class="checkbox">
						...
						<label class="checkbox">
						<input type="checkbox" name="normal_gi_identifier[]" value="Perineal Pain"
						<?php if(in_array("Perineal Pain",$doc['doc_data']['widget_data']['page1']['Problem Info']['Normal']['Gastro_intestinal'])) { ?> checked="checked" <?php } ?>>
						<i></i>Perineal Pain</label>
						<label class="checkbox">
...
<!-- PSYCHIARTIC-->
				<div class="row tab-pane fade" id="psychiartic">
					<div class="col col-md-4">
						<label class="checkbox">
						<input type="checkbox" name="normal_psychiartic_identifier[]" value="Psychiatric"
						<?php if(in_array("Psychiatric",$doc['doc_data']['widget_data']['page1']['Problem Info']['Normal']['Psychiartic'])) { ?> checked="checked" <?php } ?>>
						<i></i>Psychiatric</label>
		...
		<!-- CHRONIC RELATED INFORMATION (ON CLICK RADIO) -->
				...
				<!--VITAMINS & MINERALS DEFECIENCY PROBLEMS -------------------------------------------->
							<div class="tab-pane fade" id="chronic_vandm">
								<div class="row">
									...
									<i></i>Vitamin D</label>
									<label class="checkbox">
									<input type="checkbox" name="chronic_vandm_identifier[]" value="Vitamin B12" <?php if(in_array("Vitamin B12",$doc['doc_data']['widget_data']['page1']['Problem Info']['Chronic']['VandM'])) { ?> checked="checked" <?php } ?>>
									<i></i>Vitamin B12</label>
								</div>
			...
			<fieldset>
				...
				<section>
					<textarea class='form-control' rows="5" 'text_area' id='page2_ProblemInfo_Description'  name='page2_ProblemInfo_Description'>
			...
			<section>
				<textarea class='form-control' rows="5" 'text_area' id="page2_DiagnosisInfo_DoctorSummary" name="page2_DiagnosisInfo_DoctorSummary" readonly="readonly"> <?php echo set_value('page2_DiagnosisInfo_DoctorSummary', (isset($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Doctor Summary'])) ? htmlspecialchars_decode($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Doctor Summary']) : ''); ?></textarea>
			</section>
				...
				<textarea class='form-control' rows="5" 'text_area' id="page2_DiagnosisInfo_Prescription" name="page2_DiagnosisInfo_Prescription" readonly="readonly"><?php echo set_value('page2_DiagnosisInfo_Prescription', (isset($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Prescription'])) ? htmlspecialchars_decode($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Prescription']) : ''); ?></textarea>
			</section>
				</fieldset>
			<fieldset>
                ...
                <a target='_blank' href="<?php //echo URL;?>healthcare/healthcare2016108181933756_con/web_file_download/<?php //echo $pathvar;?>" name="<?php //echo $data['file_client_name']?>"></a>
                <?php //endforeach ?>
                </div>
				<br><br>
