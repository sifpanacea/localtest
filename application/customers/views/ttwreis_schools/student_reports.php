	...
	<form class=smart-form>
		<!--<form class="smart-form">-->
			...
			<section class="col-md-12">
				<label class="label col col-md-1" for="first_name"><b>Class:</b></label>
	...
	function display_data_table(result){
		if(result.length > 0){
			...
			$.each(result, function() {
				...
				data_table = data_table + '<td><a class="btn btn-primary btn-xs" href="'+urlLink+'ttwreis_schools/drill_down_screening_to_students_load_ehr_doc/'+obj[0]+'">Show EHR</a></td>';
				data_table = data_table + '</tr>';
