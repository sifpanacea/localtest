...
<!-- widget content -->
  <?php
	...
	echo  form_open_multipart('ttwreis_schools/update_student_ehr',$attributes);
	?>
	...
	<ul>
		...
		<li>
				...
				<ul>
				<li>
						<span class="label label-primary txt-color-white"><i class="fa fa-lg fa-minus-circle"></i> Personal Information</span>
						<ul>
							<li style="">
