...
<div class="well well-sm col-sm-12">
	...
	<!-- MAIN CONTENT -->
	 <div class="row container-fluid">
			          ...
			          <div class="info-box status txt-color-white">
				...
				<p class="square normal"><strong>Healthy School</strong></p>
				<?php endIf;?>
				...
				<?php endIf;?>
			         ...
			         <div class="col-md-3 col-sm-6 col-xs-12">
			          <div class="info-box screened_students txt-color-white">
			        ...
			        <div class="col-md-3 col-sm-6 col-xs-12">
			          <div class="info-box request_students txt-color-white">
			        ...
			        <!-- /.col -->
			        <div class="col-md-3 col-sm-6 col-xs-12">
			          <div class="info-box txt-color-white total_students">
		 ...
		 <div class="panel panel-primary">
           <div class="panel-heading" style="background-color: #ef5c0bc9; color: #f0f8ff;">Daily Health Issues</div>
				<table class="table table-sm">
				  ...
				  <div class="panel-footer" style="background-color: #6b718c;"><a class="btn btn-primary" href="<?php echo URLCustomer.'index.php/ttwreis_schools/hs_request' ?>">Submit Request</a>
				</div>
				</div>
    		  </div>
				...
				<table class="table table-sm">
				  ...
				  <tbody>
				   ...
				   <div class="panel-footer" style="background-color: #6b718c;">
				    <a href="<?php echo URLCustomer.'index.php/ttwreis_schools/fetch_submited_requests_docs' ?>">	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateRequests">Update Request </button></a>
				   </div>
				</div>
    		  </div>
			 ...
			 <div class="panel panel-primary">
				...
				<table class="table table-sm">
				  ...
				  <tbody>
				   ...
				   <div class="panel-footer" style="background-color: #6b718c;"><a href="<?php echo URLCustomer.'index.php/ttwreis_schools/feedBmiStudentReport' ?>"><button type="button" class="btn btn-primary">Submit BMI
				   </button></a></div>
				</div>
    		  </div>
			 ...
			 <div class="panel panel-primary">
				...
				<table class="table table-sm">
				  ...
				  <tbody>
				   ...
				   <div class="panel-footer" style="background-color: #6b718c;"><a href="<?php echo URLCustomer.'index.php/ttwreis_schools/initiateHemoglobinReport' ?>"><button type="button" class="btn btn-primary">Submit HB
				   </button></a></div>
				</div>
    		  </div>
    	</div>
				...
				<tbody>
				   <tr>
				    ...
				    <tr>
						...
						<tr>
					    <?php else: ?>
						<td><h4 style="color: red;">Attendance <br>Not submitted Today<br>please<br>Submit.</h4><a href="<?php echo URLCustomer.'index.php/ttwreis_schools/initiateAttendanceReport' ?>"><button type="button" class="btn btn-info">Submit Attendance</button></a></td>
						</tr>
				    <?php endif; ?>
				</form>
				  </table>
			...
			<div class="panel panel-primary" style="">
         		<div class="panel-heading" style="background-color: #ef5c0bc9; color: #f0f8ff;">Daily Sanitation Details</div>
				    ...
				    <tr>
				    	<?php else: ?>
					<td>
						<p style="font-size: 20px; color: red; font-family: ">Sanitation<br> Not submitted Today<br>Please Submit.<br><a href="<?php echo URLCustomer.'index.php/ttwreis_schools/initiateSanitationReport' ?>"><button type="button" class="btn btn-info">Submit Sanitation</button></a></p>
					</td>
						<?php endif; ?>
				    </tr>
					    	...
					    	<div class="modal-header" style="background-color: #ff3547;">
					     	...
					     	<div class="table-responsive">
									<table class="table">
									  ...
									  <td><a href='<?php echo URL."ttwreis_schools/get_students_load_ehr_doc_basic_dashboard/".$row['doc_data']['widget_data']['page1']['Student Info']['Unique ID'];?>'>
							    ...
							    <div class="modal-header" style="background-color: #ff3547;">
							            <p class="heading lead" style="color: white; font-family: initial;">PANACEA HELP LINE NO : 040-45511222<br>Under Weight Students</h2></p>
							     		...
							     		<div class="table-responsive">
											...
											<td><a href='<?php echo URL."ttwreis_schools/get_students_load_ehr_doc_basic_dashboard/".$row['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
										  <button class="btn btn-primary btn-xs">Show EHR</button>
										  </a></td>
										</tr>
									  </tbody>
