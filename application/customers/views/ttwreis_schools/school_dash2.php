						...
						<div>
							...
							<div class="widget-body no-padding smart-form" style="height:250px; overflow-y: scroll;">
								...
								<li>
										...
										<p>
											<strong><?php if(isset($doc['notification_param']['Unique ID'])):?><?php echo $doc['notification_param']['Unique ID'];?><?php else:?><?php echo "Notification Field";?><?php endIF;?></strong> - <?php echo $doc['doc_received_time'];?>&nbsp;&nbsp;&nbsp;<a href="<?php echo URL.'ttwreis_schools/access_request/'.$doc['doc_id'].'';?>" class="btn bg-color-greenDark txt-color-white btn-xs">Access</a>
										</p>
									</li>
							    <?php endforEach;?>
								<?php else: ?>
							...
							<div class="no-padding">
								...
								<div class="widget-body">
									...
									<div class="well well-sm well-light" id="news_feed_div" style="min-height: 245px;">
										...
										<table >
										<tr>
										<td> <li class="news-item"><i class="fa fa-hand-o-right"></i>&nbsp&nbsp <?php echo $news_feed["display_date"].' <i class="fa fa-lg fa-fa-calendar"></i> '.((strlen($news_feed["news_feed"])>=30)? substr($news_feed["news_feed"], 0,30)." <font size='2' color='blue'><i>cont...</i></font>" : $news_feed["news_feed"]) ;?> 
