						...
						<div>
							...
							<div class="widget-body no-padding smart-form" style="height:250px; overflow-y: scroll;">
								...
								<li>
										...
										<p>
											<strong><?php if(isset($doc['notification_param']['Unique ID'])):?><?php echo $doc['notification_param']['Unique ID'];?><?php else:?>"Notification Field"<?php endIF;?></strong> - <?php echo $doc['doc_received_time'];?>&nbsp;&nbsp;&nbsp;<a href="<?php echo URL.'ttwreis_schools/access_request/'.$doc['doc_id'].'';?>" class="btn bg-color-greenDark txt-color-white btn-xs">Access</a>
										</p>
									</li>
							    <?php endforEach;?>
								<?php else: ?>
