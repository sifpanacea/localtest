...
<div>
	...
	echo  form_open('ttwreis_schools/ttwreis_update_personal_ehr_uid',$attributes);
	?>
		<!--<form class="smart-form">-->
			...
			<section class="col-md-4">
				...
				<button type="reset" class="btn btn-default btn-sm bg-color-greenLight txt-color-white">
					Clear
				</button>
			</section>
			</div>
