...
<div id="content">
	<div class="row">
		        ...
		        <div class="row clearfix" id="search_btn">
		            <p>
		                ...
		                Other wise raise a New request on this student...
		                    <button class="btn bg-teal waves-effect" id="news_req">New Reqest</button>
		               <br>
		...
		echo  form_open_multipart('ttwreis_schools/initiate_hs_request',$attributes);
		?>
		<fieldset><section class="col-lg-10">
			...
			<button type="button" class="btn btn-primary  col-md-offset-3 col-md-2 retriever_search" id="searchIdBtn"  field_ref='page1_Personal_Information_Hospital_Unique_ID'><i class="fa fa-search"> SEARCH</i></button>

			<button type="submit" class="btn btn-primary col-md-offset-3 col-md-3" id="go_search">Open Search Bar</button>
				...
				<div class="tab-pane fade" id="ent">
                 ...
                 <div class="row tab-pane fade" id="rs">
					...
					<div class="col col-md-4">
						...
						<i></i>Dry Cough</label>
						<label class="checkbox">
						<input type="checkbox" id="normal_identifier" name="normal_rs_identifier[]" value="Wet Cough(Productive cough)">
...
<!--GI related information -->
				<div class="row tab-pane fade" id="gi">
					...
					<div class="col col-md-4">
						...
						<label class="checkbox">
						<input type="checkbox" id="normal_identifier" name="normal_gi_identifier[]" value="Piles(Blood in Stools)">
						<i></i>Piles(Blood in Stools)</label>
					</div>
					<div class="col col-md-4">
						<label class="checkbox">
						<input type="checkbox" id="normal_identifier" name="normal_gi_identifier[]" value="Melena(Blood Stools)">
						...
						<label class="checkbox">
						<input type="checkbox" id="normal_identifier" name="normal_gi_identifier[]" value="Perineal Pain">
...
<!--cns related information -->
				<div class="row tab-pane fade" id="cns">
					<div class="col col-md-4">
						...
						<label class="checkbox">
						<input type="checkbox" id="normal_identifier" name="normal_cns_identifier[]" value="Abnormal Gait">
					...
					<div class="col col-md-4">
						...
						<label class="checkbox">
						<input type="checkbox" id="normal_identifier" name="normal_cns_identifier[]" value="Abnormal Sleep">
...
<!-- PSYCHIARTIC-->
				<div class="row tab-pane fade" id="psychiartic">
					<div class="col col-md-4">
						<label class="checkbox">
						<input type="checkbox" id="normal_identifier" name="normal_psychiartic_identifier[]" value="Psychiatric">
...
<!---doubt in cvs -->					<i></i>RHD</label>
				...
				<!--VITAMINS & MINERALS DEFECIENCY PROBLEMS -------------------------------------------->
							<div class="tab-pane fade" id="chronic_vandm">
								<div class="row">
									<div class="col col-md-4">
									<label class="checkbox">
									<input type="checkbox" name="chronic_vandm_identifier[]" value="Vitamin D">
									<i></i>Vitamin D</label>
									<label class="checkbox">
									<input type="checkbox" name="chronic_vandm_identifier[]" value="Vitamin B12">
				...
				<!-- END SKIN PROBLEMS  -------------------------------------------------------->
							...
							<div class="tab-pane fade" id="chronic_endo_chronic">
								...
								<div class="col col-4">
								    <label class="checkbox">
									<input type="checkbox" name="chronic_endo_identifier[]" value="Hypo thyroidism">
									<i></i>Hypo thyroidism</label>
									<label class="checkbox">
									<input type="checkbox" name="chronic_endo_identifier[]" value="Hyper Thyroidism">
       ...
       if(result.length > 0){
           ...
           $('.ehrButton').click(function(){
               ...
               //$("#student_id").val(studentHealthID);
                window.location = '<?php echo URL; ?>ttwreis_schools/access_submited_request_docs/'+studentHealthID;
              // $("#request_form").submit();
...
<script type="text/javascript">                                 
  ...
  runAllForms();
		...
		if($("#page2_ProblemInfo_Description").text()  == ""){
