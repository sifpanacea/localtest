								...
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
											...
											<tr>
												...
												<td><a class='delete1' href='<?php echo URL."ttwreis_schools/show_student_bmi_graph/".$get_doc['bmi_info'][0]['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
