...
$page_nav["masters"]["sub"]["classes"]["active"] = true;
include("inc/nav.php");
...
<div>
	...
	echo  form_open('ttwreis_schools/create_class',$attributes);
	?>
		<!--<form class="smart-form">-->
			<header>
				<strong>Please Enter The Class.</strong>
			</header>
			<fieldset>
			<div class="row">
				<label class="label col  col-2" for="first_name">Class Name</label>
			<section class="col col-3">
				
					<label class="input"> <i class="icon-append fa fa-pencil"></i>
					<input type="text" name="class_name" id="class_name" value="<?PHP echo set_value('class_name'); ?>" required>
				</label>
			</section>
			<section class="col col-3">
				...
				<button type="reset" class="btn bg-color-greenLight txt-color-white btn-default btn-sm">
					Clear
				</button>
			</section>
			</div>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-11">
					...
					<tr>
						...
						<td>
						<a class='ldelete' href='<?php echo URL."ttwreis_schools/delete_class/".$class['_id'];?>'>
