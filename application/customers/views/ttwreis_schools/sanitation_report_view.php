...
<div id="content">
      <div class="container">
        <div class="row">
          <!-- <form action="https://mednote.in/PaaS/healthcare/index.php/ttwreis_schools/create_sanitation_report_new" method="POST" id='web_view' class="form-horizontal" enctype="multipart/form-data"> -->
            <?php
$attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
echo  form_open_multipart('ttwreis_schools/create_sanitation_report_new',$attributes);
?>

            <div class="alert alert-info" role="alert">
                <h4 class="text-center"><b>Sanitation Report</b> </h4>
              </div>
