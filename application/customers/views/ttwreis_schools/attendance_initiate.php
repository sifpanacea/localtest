...
$page_nav["pa att_req"]["active"] = true;
include("inc/nav.php");
...
<!-- ==========================CONTENT STARTS HERE ========================== -->
		...
		?>
			...
			<button id="app_open" class="hide attendance"></button>
			</div>
			<!-- END MAIN CONTENT -->
...
$(document).ready(function() {
		...
		$(document).on('click','#app_open',function(e)
		{
			...
			{
				apd__ = "healthcare20161015173311279";
		        _url = "https://mednote.in/PaaS/healthcare/index.php/healthcare/healthcare20161015173311279_con/create";
		...
		var apd__ = "healthcare20161015173311279";
		var url = "https://mednote.in/PaaS/healthcare/index.php/healthcare/healthcare20161015173311279_con/create";
