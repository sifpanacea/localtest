...
$page_nav["masters"]["sub"]["sections"]["active"] = true;
include("inc/nav.php");
...
<div>
	...
	echo  form_open('ttwreis_schools/create_section',$attributes);
	?>
		<!--<form class="smart-form">-->
			<header><b>
				Please Enter The Section.</b>
			</header>
			<fieldset>
			<div class="row">
				<label class="label col col-3" for="first_name">Section Name</label>
			...
			<section class="col col-3">
				...
				<button type="reset" class="btn bg-color-greenLight btn-default btn-sm txt-color-white">
					Clear
				</button>
			</section>
			</div>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-11">
					...
					<tr>
						...
						<a class='ldelete' href='<?php echo URL."ttwreis_schools/delete_section/".$section['_id'];?>'>
					...
					<?php else: ?>
        			<p>
          				<?php echo "No section entered yet.";?>
        			</p>
        			<?php endif ?>
									</tbody>
									<?php if($links):?>
