				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<header>
							...
							<h2><?php echo lang('admin_dash_list_feedbacks');?></h2>
					...
					<tr>
						...
						<th><?php echo lang('index_feedback_creation');?></th>
					</tr>
					...
					<tr>
						...
						<td><?php if(isset($feedback['attachment']) && !empty($feedback['attachment'])):?><a target='_blank' href="download_attachment/<?php echo str_replace('/','=',$feedback['attachment']['file_path']);?>">Download file (<?php echo $feedback['attachment']["file_client_name"];?>)</a><br><?php else: ?><?php echo "No files attached";?></a><?php endif ?></td>
						<td><?php echo anchor("sub_app_builder/feedback_prop/".$feedback['id']."/".$feedname."/".base64_encode($feedback['feedback_desc']), lang('feedback_create')) ;?></td>
					</tr>
					<?php $u++;?>
					<?php endforeach?>
					<?php else: ?>
