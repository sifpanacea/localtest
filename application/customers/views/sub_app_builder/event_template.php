...
<div id="main" role="main">
    ...
    <article class="col-sm-12 col-lg-6">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-2" data-widget-editbutton="false" data-widget-deletebutton="false">
                        ...
                        <span class="widget-icon"> <i class="fa fa-paste"></i> </span>
							<h2><?php if ($updType == 'create'){
								echo lang('event_create_heading');
							}elseif ($updType == 'edit'){
								echo lang('event_edit_heading');
							}?></h2>
						...
						<div>
                            ...
                            <div class="device">
                                    <center><label id="apptitle" name="apptitle" class="control-label apptit"><?php echo $event_name; ?></label></center>
    								...
    								echo form_open_multipart('sub_app_builder/save_event_form', $attributes);?>
		...
		<input type="hidden" id="event_code"  name="event_code"  class='scaffold_textarea' /><?php echo set_value('event_code', ''); ?></textarea>
								...
								<div class="step-content">
										<div class="step-pane active" id="step2">
											...
											<div class="row">
												...
												<div class="row">
												<textarea class="custom-scroll form-control col-md-6" id="" type="text" value="" placeholder="Description" disabled><?php echo set_value('event_desc', (isset($event_desc)) ? $event_desc : ''); ?></textarea>
												</div>
												<div class="row">
												Comment:
												</div>
												<div class="row">
												<textarea class="custom-scroll form-control col-md-6" id="" type="text" value="" placeholder="Description" disabled><?php echo set_value('event_comment', (isset($event_comment)) ? $event_comment : ''); ?></textarea>
												</div>
												</div>
											</div>
...
<!-- Flot Chart Plugin: Flot Engine, Flot Resizer, Flot Tooltip -->
        ...
        <script src="<?php echo(JS.'event_template.js'); ?>" type="text/javascript"></script>
        <script src="<?php echo(JS.'event_def.js'); ?>" type="text/javascript"></script>
