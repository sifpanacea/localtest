						...
						<div>
							...
							<div class="widget-body widget-hide-overflow">
								...
								<div class="chat-footer">
									...
									<!-- CHAT REPLY/SEND -->
									<span class="textarea-controls">
							<button class="btn btn-sm btn-primary pull-left post_note" id="post_note" style="display:block;" uid= "<?php echo $doc['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?>" , Name="<?php echo $doc['doc_data']['widget_data']['page1']['Personal Information']['Name'];?>", Clas="<?php echo $doc['doc_data']['widget_data']['page2']['Personal Information']['Class'];?>", School="<?php echo $doc['doc_data']['widget_data']['page2']['Personal Information']['School Name'];?>">
											Post Note
										</button>  
										<div class="col-md-12" id="posting_note_gif" style="display:none;">
									<center><img src="<?php echo(IMG.'select2-spinner.gif'); ?>" id="gif" ></center>
...
$('.post_note').click(function(e){
	...
	var datetime = currentdate.getFullYear() + "-"
				...
				+ ("0" + (currentdate.getDate("dd") )).slice(-2) + " "
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : "School user", "uid" : uid ,"Name" : Name , "Class" : Class,"School_Name" : School},
