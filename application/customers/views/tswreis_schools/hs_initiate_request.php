            ...
            <p>
               ...
               <br>
                <div id="stud_report"></div>
                                ...
                                echo  form_open_multipart('tswreis_schools/initiate_hs_request',$attributes);
                                ?>
                                ...
                                <button type="button" class="btn btn-primary  col-md-offset-3 col-md-3 retriever_search" id="searchIdBtn"  field_ref='page1_Personal_Information_Hospital_Unique_ID'>
                                ...
                                <label class="input"> 
                                <input type="text" id='page1_StudentInfo_Name' rel='page1_Personal_Information_Name' name='page1_StudentInfo_Name'  minlength='1' maxlength='123' readonly required="required">
                                </label>
                                </section>
                                       ...
                                       if(result.length > 0){
                                           ...
                                           $('.ehrButton').click(function(){
                                               ...
                                               //$("#student_id").val(studentHealthID);
                                                window.location = '<?php echo URL; ?>tswreis_schools/access_submited_request_docs/'+studentHealthID;
                                              // $("#request_form").submit();
