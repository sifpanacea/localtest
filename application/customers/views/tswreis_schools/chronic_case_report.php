...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <tr>
						<td class='unique_id'><?php echo $case['student_unique_id'];?></td>
						
						 <?php if(isset($case['chronic_disease']) && !empty($case['chronic_disease'])):?>
						
						<?php $diseases = $case['chronic_disease']; ?>
						
						<?php  foreach($diseases as $disease => $value):?>
							
							<?php if(is_string($case['chronic_disease'][$disease])):?>
								<?php $var123 = implode(",", $case['chronic_disease']);?>
							
								<td><?php echo $var123;?></td> 
								
								<?php else:?>
						<?php $var123 = implode(",", $case['chronic_disease'][$disease]);?>
						<?php if(!empty($var123)):?>
				...
				<div class="modal-content">
					...
					<fieldset>
					   ...
					   <label class="input"> <i class="icon-append fa fa-calendar"></i>
													<input type="text" name="medic_start_date" id="medic_start_date" placeholder="Select start date" class="hasDatepicker" value="<?php echo date("Y-m-d");?>" disabled>
												</label>
					   </section>
					   <section>
						...
						<section>
							...
							<label class="input"> <i class="icon-append fa fa-question-circle"></i>
								<input type="number" class="period_to_be_taken" id="period_to_be_taken">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form class="smart-form">
					   ...
					   <section>
												<label class="input"> <i class="icon-append fa fa-calendar"></i>
													<input type="text" name="today_date" id="today_date" placeholder="Select date" class="hasDatepicker" value="<?php echo date("Y-m-d");?>" disabled>
												</label>
											</section>
						<section>
