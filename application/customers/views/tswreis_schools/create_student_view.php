...
<div>
	...
	?>
										...
										<div class="row">
											...
											<section class="col col-5">
												...
												<label class="input"> <i class="icon-prepend fa fa-calendar"></i>
													<input type="text" name="date_of_birth" id="date_of_birth" placeholder="DOB" class="datepicker hasDatepicker" data-dateformat="dd/mm/yy" required="required">
												</label>
											</section>
									...
									<fieldset>
										...
										<section class="col col-3">
												<label class="select"><i class="arrow down"></i>
													<select name="class" id="class" required>
														...
														<option value="11">11(Inter 1st)</option>
														<option value="12">12(Inter 2nd)</option>
										...
										<section class="col col-3">
												<label class="input">
													<input type="text" name="section" id="section" placeholder="Enter Student Section/Course">
											...
											<section class="col col-3">
												<label class="input">
													<input type="text" name="student_age" minlength="2" maxlength="2" pattern="[0-9]*" placeholder="Enter Student Age">
												</label>
											</section>
										<section class="col col-3">
									...
									<footer>
										<button type="submit" class="btn btn-success bg-color-green">
											Create Student EHR
										</button>
									</footer>
									<br>
