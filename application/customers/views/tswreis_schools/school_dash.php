	...
	<div id="content">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text" style="font-size: 16px;">School Status</span>
							...
							<div class="footer pull-right badge bg-color-red" style="font-size:xx-small;">Based On BMI Values</div>
									<!-- /.info-box-content -->
					</div>
				</div>
			         ...
			         <div class="col-md-3 col-sm-6 col-xs-12">
			          <div class="info-box">
			            ...
			            <div class="info-box-content">
			              ...
			              <span class="info-box-number"><?php echo "$screening_report_yearly"; ?></span>
			            </div>
			            <!-- /.info-box-content -->
			          </div>
			          <!-- /.info-box -->
			          ...
			          <div class="info-box">
			           <span class="info-box-icon bg-green"><i class="fa fa-list"></i></span>
			            <div class="info-box-content">
			              ...
			              <span class="info-box-number"><?php echo "$yearly_request_count"; ?></span>
			            </div>
			            <!-- /.info-box-content -->
			          </div>
			          <!-- /.info-box -->
			        ...
			        <div class="col-md-3 col-sm-6 col-xs-12">
			          <div class="info-box">
			            ...
			            <div class="info-box-content">
			              ...
			              <span class="info-box-number">
			              	<h4><span><?php if(!empty($students_count)) {?><?php echo $students_count;?><?php } else {?><?php echo "0";?><?php }?></span></h4>
			              </span>
			            </div>
			            <!-- /.info-box-content -->
			          </div>
		...
		<div class="col-xs-12 col-sm-4 col-md-6 col-lg-6">
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" hidden="hidden">
					<!-- new widget -->
					<div class="jarviswidget" id="wid-id-1000" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
						<!-- widget options:
						usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
						...
						<div>
							...
							<div class="widget-body no-padding smart-form" style="height:250px; overflow-y: scroll;">
								...
								<li>
										<span class="handle"><a href="<?php echo URL.'tswreis_schools/access_request/'.$doc['doc_id'].'';?>" class="btn bg-color-greenDark txt-color-white btn-xs">Access</a>
										</span>
										<p>
										 
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><?php if(isset($doc['notification_param']['Unique ID'])):?><?php echo $doc['notification_param']['Unique ID'];?><?php else:?>"Notification Field"<?php endIF;?></strong> - <?php echo $doc['doc_received_time'];?>
										</p>
									</li>
							    <?php endforEach;?>
								<?php else: ?>
...
//}/*else{
		...
		/*$.ajax({
			...
			url: 'get_sanitaiton_report_by_school',
			type: 'POST',
			data: {"date" : selectedDate},
...
/*function draw_sanitation_report_table(result)
{
	   ...
	   {			   
		 ...
		 /* $('#sanitation_report_table').html('<div class="row"><div id="campus" class="col-md-4"></div><div id="kitchen" class="col-md-4"></div><div id="toilets" class="col-md-4"></div></div><div class="row"><div class="col-md-4" id="campus_attachments"></div><div class="col-md-4" id="kitchen_attachments"></div><div class="col-md-4" id="toilets_attachments"></div></div><div class="row col-md-12" ><div id="water_Supply_Condition" class="col-md-3"></div><div id="dormitories" class="col-md-3"></div><div id="store" class="col-md-3"></div><div id="waste_management" class="col-md-3"></div></div><div class="row col-md-4" id="dormitories_attachments"></div><div class="row col-md-10"><div id="water" class="col-xs-12 col-sm-2 col-md-2 col-lg-2"></div></div>');
		...
		var table = '<div style="overflow-y: " ><table class=" table table-bordered"><thead><tr><th>Campus Attachments <span class="campus_attach_count"></span></th></tr></thead><tbody>'
		...
		$('.campus_attach_count').text(length);
		...
		var table = '<div style="overflow-y: " ><table class=" table table-bordered"><thead><tr><th>Kitchen Attachments <span class="attach_count badge bg-color-blueDark txt-color-white"></span></th></tr></thead><tbody>'
		...
		var table = '<div style="overflow-y: " ><table class=" table table-bordered"><thead><tr><th>Toilets Attachments <span class="attach_count badge bg-color-blueDark txt-color-white"></span></th></tr></thead><tbody>'
		...
		var table = '<div style="overflow-y: " ><table class=" table table-bordered"><thead><tr><th>Dormitories Attachments <span class="attach_count badge bg-color-blueDark txt-color-white"></span></th></tr></thead><tbody>'
