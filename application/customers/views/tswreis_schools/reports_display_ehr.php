...
<?php if(isset($fromEHR)): ?>
<button type="button" class="btn bg-color-pink txt-color-white btn-sm pull-right" id="submit_print_request">
	...
	<div class="tree smart-form">
		...
		<?php if(isset($doc["doc_data"]["widget_data"]["page1"]["Personal Information"]) && isset($doc["doc_data"]["widget_data"]["page2"]["Personal Information"])):?>
			<li>
				...
				<li>
					<span class="label label-success req-follow <?php if(isset($time)){echo "prev-open";}?>"><i class="fa fa-lg fa-plus-circle"></i> Request Follow Ups</span>
					<ul>
					<?php foreach ($docs_requests as $request):?>
					<li style="display:none">
					<span class="label label-warning <?php $last_stage = end($request['history']);if(isset($time)){if($last_stage['time'] == $time){echo "prev-open";}else{echo "req-child";}}?>"><i class="fa fa-lg fa-minus-circle"></i> 
					...
					echo "Request raised on: ".$newformat->format('Y-m-d H:i:s')."<strong> <i class='fa fa-lg fa-hand-o-left'></i> Time listed as per IST.</strong>";
					?></span>
				<ul>
					...
					<li>
						...
						<li>
							<span class="req-notes"><i class="fa fa-lg fa-plus-circle"></i> Notes on this request</span>
							<ul>
								<li style="display:none">
									<div class="well well-sm ">
									<div>
						...
						<ul>
							<li style="">
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<?php if(isset($doc['doc_data']['widget_data']['page1']['Personal Information']['Gender'])):;?>
									<tr>
										<th>Gender</th><td colspan="2"><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page1']['Personal Information']['Gender'];;?> </i></td>
									</tr>
									<?php endif;?>
									<tr>
						...
						<li style="display:none">
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										<?php if(isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Advice'])):;?>
										<th>Advice</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Advice'];?></i></td>
										<?php endif;?>
										<?php if(isset($doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Treatment'])):;?>
										<th>Treatment</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page4']['Doctor Check Up']['Treatment'];?></i></td>
										<?php endif;?>
						...
						<li style="display:none">
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										<?php if(isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Eye Lids'])):;?>
										<th>Eye Lids</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Eye Lids'];?></i></td>
										<?php endif;?>
										<?php if(isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Conjunctiva'])):;?>
											<th>Conjunctiva</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Conjunctiva'] ;?></i></td>
										<?php endif;?>
									</tr>
									<tr>
										<?php if(isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Cornea'])):;?>
										<th>Cornea</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Cornea'];?></i></td>
										<?php endif;?>
										<?php if(isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Pupil'])):;?>
											<th>Pupil</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Pupil'] ;?></i></td>
										<?php endif;?>
									</tr>
									<tr>
										<?php if(isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Complaints'])):;?>
										<th>Complaints</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Complaints'];?></i></td>
										<?php endif;?>
										<?php if(isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Wearing Spectacles'])):;?>
											<th>Wearing Spectacles</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Wearing Spectacles'] ;?></i></td>
										<?php endif;?>
									</tr>
									<tr>
										<?php if(isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Subjective Refraction'])):;?>
										<th>Subjective Refraction</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Subjective Refraction'];?></i></td>
										<?php endif;?>
										<?php if(isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Ocular Diagnosis'])):;?>
											<th>Ocular Diagnosis</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Ocular Diagnosis'] ;?></i></td>
										<?php endif;?>
									</tr>
									</tbody>
								</table>
							...
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<?php if(isset($doc['doc_data']['widget_data']['page9']['Dental Check-up']['Root Canal Treatment'])):;?>
										<th>Root Canal Treatment</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Root Canal Treatment'];?></i></td>
										<?php endif;?>
										
									</tr>
									<tr>
										<?php if(isset($doc['doc_data']['widget_data']['page9']['Dental Check-up']['CROWNS'])):;?>
										<th>CROWNS</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page9']['Dental Check-up']['CROWNS'];?></i></td>
										<?php endif;?>
										<?php if(isset($doc['doc_data']['widget_data']['page9']['Dental Check-up']['Fixed Partial Denture'])):;?>
										<th>Fixed Partial Denture</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Fixed Partial Denture'];?></i></td>
										<?php endif;?>

									</tr>
									<tr>
										<?php if(isset($doc['doc_data']['widget_data']['page9']['Dental Check-up']['Curettage'])):;?>
										<th>Curettage</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Curettage'];?></i></td>
										<?php endif;?>
										<?php if(isset($doc['doc_data']['widget_data']['page9']['Dental Check-up']['Estimated Amount'])):;?>
										<th>Estimated Amount</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Estimated Amount'];?></i></td>
										<?php endif;?>
...
var hs_username = '<?php echo $username;?>';
...
if($(".req-follow").hasClass("prev-open") == true)
{
	$(".req-follow").trigger("click")
	$(".req-child").trigger("click")
	var that = $(".req-follow").next('ul').find('.prev-open').next('ul').find(".req-notes");
	that.trigger("click");
	that.next("ul").find("textarea").focus();
	//that.next("ul").find("textarea").get(0).scrollIntoView();
	$(window).scrollTop(that.next("ul").find("textarea").offset().top);
	//$('html,body').animate({scrollTop: that.next("ul").find("textarea").offset().top}, 1500);
}
...
$('.post_note').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : hs_username, "uid" : uid},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + hs_username + '</a>' + note + '</div><br><button class="btn btn-xs btn-danger pull-right msg_delete" doc_id = "'+data+'">Delete</button></li>';
...
$('.post_note_request').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : hs_username,"doc_id":doc_id},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + hs_username + '</a>' + note + '</div></li>';
