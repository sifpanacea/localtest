...
$page_nav["pa sani_report"]["active"] = true;
include("inc/nav.php");
...
$(document).ready(function() {
		...
		$(document).on('click','#app_open',function(e)
		{
			...
			if($(this).hasClass("attendance"))
			{
		        ...
		        _url = "http://35.154.116.243/PaaS/healthcare/index.php/healthcare/healthcare201651317373988_con/create";
		...
		var apd__ = "healthcare2016111212310531";
		var url = "https://mednote.in/PaaS/healthcare/index.php/healthcare/healthcare2016111212310531_con/create";
