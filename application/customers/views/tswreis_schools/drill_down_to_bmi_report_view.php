							...
							<h5 class="alert alert-info"> <?php echo ucwords($navigation) ;?> </h5>
								...
								<div class = "under weight " id ="under weight">
									...
									<thead>			                
										<tr>
											...
											<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> BMI%</th>
								...
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
												<?php //echo '<pre>'; echo print_r($get_doc,true); echo '</pre>';?>
											<tr>
												<td><?php echo $get_doc['bmi_info'][0]['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?></td>
												<td><?php echo $get_doc['bmi_info'][0]['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref'];?></td>
												<td><?php echo $get_doc['bmi_info'][0]['doc_data']['widget_data']['page1']['Student Details']['Class']['field_ref'];?></td>
												<td><?php echo $get_doc['bmi_info'][0]['doc_data']['widget_data']['school_details']['School Name'];?></td>
												<td><?php echo $get_doc['bmi_info'][0]['doc_data']['widget_data']['school_details']['District'];?></td>
												<td><?php echo $get_doc['bmi_info'][0]['doc_data']['widget_data']['page1']['Student Details']['BMI_values'][0]['bmi'];?></td>
												<?php //foreach() ?>
												<?php //echo json_encode($get_doc['BMI_values']);?>
												<td><a class='delete1' href='<?php echo URL."tswreis_schools/show_student_bmi_graph/".$get_doc['bmi_info'][0]['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
