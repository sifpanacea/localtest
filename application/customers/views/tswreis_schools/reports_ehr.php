...
<header class ="bg-color-orange">
	...
	<h2>Search Student's Document </h2>
...
<div>
	...
	echo  form_open('tswreis_schools/reports_display_ehr_uid',$attributes);
	?>
		<!--<form class="smart-form">-->
			...
			<button type="submit" class="btn btn-sm bg-color-green txt-color-white submit" >
				...
				<button type="reset" class="btn btn-sm txt-color-white bg-color-greenLight">
					Clear
				</button>
			</section>
			</div>
