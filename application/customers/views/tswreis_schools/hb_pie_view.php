										...
										<div class="col-md-12" id="loading_request_pie" style="display:none;">
											 ...
											 <div class="pull-right" id="image-formula">
												...
												<img src="../../uploaddir/public/images.png" alt="" style="height:80px;margin-top:6px;margin-left:6px;">
												 ...
												 <h5>HB Interpretation</h5>
												 <span> -->
												<!-- <img src="../../uploaddir/public/hb_range.jpg" alt="" style="width:250px;height:120px;margin-top:6px;margin-left:6px;">
												 </span> 
												 <h6><span>Source : <a href="http://apps.who.int/bmi/index.jsp?introPage=intro_3.html" target="_blank">World Health Organisation</a></span></h6> --> <table class="table table-bordered">
																	   <thead>
																	     <tr>
																	       <th>HB</th>
																	       <th>Range</th>
