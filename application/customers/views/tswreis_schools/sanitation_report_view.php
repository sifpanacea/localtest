...
<div id="content">
      <div class="container">
        <div class="row">
          <!-- <form action="https://mednote.in/PaaS/healthcare/index.php/tswreis_schools/create_sanitation_report_new" method="POST" id='web_view' class="form-horizontal" enctype="multipart/form-data"> -->
            <?php
$attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
echo  form_open_multipart('tswreis_schools/create_sanitation_report_new',$attributes);
?>
                  ...
                  <div class="form-group hide" id="other_animal">
                                ...
                                <div class="col-sm-5">
                                   <label class="col-sm-offset-5">
                                        <input type="text"  class="col-sm-offset-8" id="other_animal_name" name="type_of_animal" />
                                      </label>
                                </div>
    ...
    $("a[rel^='prettyPhoto']").prettyPhoto();
     <?php if($this->session->userdata('message')) { ?>
      ...
      $("#animals_around_campus_0").click(function(){
        ...
        if($("input:radio[name = 'type_of_animal']").is(":checked"))
        {
          $("input:radio[name = 'type_of_animal']").prop('required', true);
        }
      });
      
      $("#animals_around_campus_1").click(function(){
        $("#animals").addClass("hide");
        $("input:radio[name = 'type_of_animal']").prop('checked', false);
      });
      ...
      $(".type_of_animal").click(function(){
        ...
        $("input:text[name = 'type_of_animal']").val('');
      });

      $("#cleanliness_Of_the_campus_0").click(function(){
        $("#campus").removeClass("hide");
        if($("input:radio[name = 'cleanliness_Of_the_campus']").is(":checked"))
        {
          $("input:radio[name = 'campus_cleanliness_times']").prop('required', true);
        }
      })
      $("#cleanliness_Of_the_campus_1").click(function(){
        $("#campus").addClass("hide");
        $("input:radio[name = 'campus_cleanliness_times']").prop('checked', false);
      })

      $("#cleanliness_toilets_0").click(function(){
        $("#toilets").removeClass("hide");
        if($("input:radio[name = 'cleanliness_toilets']").is(":checked"))
        {
          $("input:radio[name = 'page3_Cleanliness_Toilets']").prop('required', true);
        }
      })
      $("#cleanliness_toilets_1").click(function(){
        $("#toilets").addClass("hide");
        $("input:radio[name = 'page3_Cleanliness_Toilets']").prop('checked', false);
      })
      $("#cleanliness_Kitchen_0").click(function(){
        $("#kitchen").removeClass("hide");
        if($("input:radio[name = 'cleanliness_Kitchen']").is(":checked"))
        {
          $("input:radio[name = 'cleanliness_Kitchen_times']").prop('required', true);
        }
      })
      $("#cleanliness_Kitchen_1").click(function(){
        $("#kitchen").addClass("hide");
        $("input:radio[name = 'cleanliness_Kitchen_times']").prop('checked', false);
      })
      $("#cleanliness_diningHalls_0").click(function(){
        $("#dining").removeClass("hide");
        if($("input:radio[name = 'cleanliness_diningHalls']").is(":checked"))
        {
          $("input:radio[name = 'page2_Cleanliness_DiningHalls']").prop('required', true);
        }
      })
      $("#cleanliness_diningHalls_1").click(function(){
        $("#dining").addClass("hide");
        $("input:radio[name = 'page2_Cleanliness_DiningHalls']").prop('checked', false);
      })
      $("#cleanliness_Of_the_store_0").click(function(){
        $("#store").removeClass("hide");
        if($("input:radio[name = 'cleanliness_of_the_store']").is(":checked"))
        {
          $("input:radio[name = 'page3_Cleanliness_Store']").prop('required', true);
        }
      })
      $("#cleanliness_Of_the_store_1").click(function(){        
        $("#store").addClass("hide");
        $("input:radio[name = 'page3_Cleanliness_Store']").prop('checked', false);
      })
      $("#cleanliness_Of_the_wellness_0").click(function(){
        $("#wellness").removeClass("hide");
        if($("input:radio[name = 'cleanliness_Of_the_wellness']").is(":checked"))
        {
          $("input:radio[name = 'page3_Cleanliness_Wellness']").prop('required', true);
        }
      })
      $("#cleanliness_Of_the_wellness_1").click(function(){
        $("#wellness").addClass("hide");
        $("input:radio[name = 'page3_Cleanliness_Wellness']").prop('checked', false);
      })
      $("#cleanliness_water_loading_0").click(function(){
        $("#water_tank").removeClass("hide");
        if($("input:radio[name = 'cleanliness_water_loading']").is(":checked"))
        {
          $("input:radio[name = 'cleanliness_waterLoading_times']").prop('required', true);
        }
      })
      $("#cleanliness_water_loading_1").click(function(){
        $("#water_tank").addClass("hide");
        $("input:radio[name = 'cleanliness_waterLoading_times']").prop('checked', false);
      })
      $("#cleanliness_Of_the_dormitories_0").click(function(){
        $("#dormitory").removeClass("hide");
        if($("input:radio[name = 'cleanliness_dormitories']").is(":checked"))
        {
          $("input:radio[name = 'page2_Cleanliness_Dormitories']").prop('required', true);
        }
      })
      $("#cleanliness_Of_the_dormitories_1").click(function(){
        $("#dormitory").addClass("hide");
        $("input:radio[name = 'page2_Cleanliness_Dormitories']").prop('checked', false);
      })
    ...
    $(document).on('click','#submit',function(e)
    {
      ...
      for(var j=0;j<numFiles;j++)
      {
       ...
       if(size > 3150403 )
       {
          ...
          content : "Attach file less than 3 MB !",
          color   : "#C46A69",
