...
<!-- widget content -->
  <?php
	...
	echo  form_open_multipart('tswreis_schools/update_student_ehr',$attributes);
	?>
						...
						<ul>
							<li style="">
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
						                <th>Date of Birth</th><td><i class="icon-leaf" data-dateformat="y-m-d"><input type="text" name="date_of_birth"  value="<?php echo $doc['doc_data']['widget_data']['page1']['Personal Information']['Date of Birth'];?>"></i></td>
									</tr>								
									<tr>
								<th>Hospital Unique ID</th><td colspan="2"><i class="icon-leaf"><input type="text" class="" name="unique_id" value="<?php echo $doc['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?>"/><?php echo $doc['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?></i></td>
									</tr>

								<!-- Here updating unique id in query with unique id update query is there. So to set new unique id for wrong format unique id maintaining this one more column. -->

								<input type="hidden" name="health_unque_id" value="<?php if(isset($doc['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID']) && !empty($doc['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'])):?><?php echo $doc['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID']?><?php else:?><?php echo "No unique id";?><?php endif;?>">
