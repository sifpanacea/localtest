			...
			<li>
				...
				<ul>
					...
					<li>
							<div class="well well-sm">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										<th>Problem Information</th><?php if(isset($request['doc_data']['widget_data']['page1']['Problem Info']['Normal'])):?>
                    ...
                    <?php endif;?>
						...
						<li>
							<span><i class="fa fa-lg fa-plus-circle"></i> Notes on this request</span>
							<ul>
								<li style="display:none">
									<div class="well well-sm ">
									<div>
...
$('.post_note').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : username, "uid" : uid},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + username + '</a>' + note + '</div><br><button class="btn btn-xs btn-danger pull-right msg_delete" doc_id = "'+data+'">Delete</button></li>';
...
$('.post_note_request').click(function(e){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"datetime" : datetime, "note" : note,"username" : username,"doc_id":doc_id},
										
		success: function (data) {
			console.log(data);
			
			message = '<li class="message"  id="'+data+'"><div class="message-text"><time>' + datetime + '</time> <a href="javascript:void(0);" class="username">' + username + '</a>' + note + '</div></li>';
