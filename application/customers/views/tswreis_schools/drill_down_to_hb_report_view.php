								...
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_hb_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
											...
											<tr>
												...
												<td><?php echo $get_doc['doc_data']['widget_data']['page1']['Student Details']['HB_latest']['hb'];?></td>
												...
												<td><a class='delete1' href='<?php echo URL."tswreis_schools/show_student_hb_graph/".$get_doc['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
