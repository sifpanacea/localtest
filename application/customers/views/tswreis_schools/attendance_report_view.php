                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel panel-body" style="border-bottom-color: cornflowerblue;">
                          ...
                          <?php  $attributes = array('class' => 'form-horizontal','id'=>'web_view','name'=>'userform');
                            echo form_open('tswreis_schools/create_attendence_report',$attributes);
                            ?>
                        <div class="col-md-offset-1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="number"  class="form-control" name="page1_AttendenceDetails_Sick" id="page1_AttendenceDetails_Sick" placeholder="Sick  students count" value="">
                                        </div>
                                    </div>  
                                    <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="number"  class="form-control " id="page1_AttendenceDetails_R2H" name="page1_AttendenceDetails_R2H" placeholder="R2H  students count in the school">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="number"  class="form-control" id="page1_AttendenceDetails_Absent" name="page1_AttendenceDetails_Absent" placeholder="Absent  students count in the school">
                                </div>
                            </div>  
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" id="page2_AttendenceDetails_RestRoom" name="page2_AttendenceDetails_RestRoom" class="form-control " id="inputPassword" placeholder="RestRoom students Count in the school">
                                </div>
                            </div>  
                            <div class="form-group row">
