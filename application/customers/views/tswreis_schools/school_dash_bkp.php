...
<div id="main" role="main">
	...
	<div class="row">
			...
			<div class="pull-right">
		       <ul class="nav nav-tabs" id="myTab">
                    <div class="liner"></div>
                <li class="col">
                     <a href="<?php echo URLCustomer; ?>index.php/tswreis_schools/all_activities" title="Basic Dashboard">
                      <span class="one">
                           <i>Click Here For Basic Dashboard</i>
                      </span></a></li>
              <!--   <li class="active col-sm-offset-1"><a href="http://www.paas.com/PaaS/healthcare/index.php/tswreis_schools/to_dashboard" title="Advanced Dashboard"">
                     <span class="two">
                         <i class="glyphicon glyphicon-home">Advanced </i>
                     </span></a> 
                 </li> -->
            </ul>
		</div>
		...
		<div class="row container-fluid">
			          ...
			          <div class="info-box">
			            ...
			            <div class="info-box-content">
			              <span class="info-box-text" style="font-size: 18px;">Set Date For Pie</span>
			              <span class="info-box-number">
											...
											<section class="col col-md-6">
											<button type="button" class="btn bg-color-pink txt-color-white btn-sm col-md-5" id="set_date_btn" data-toggle="modal" data-target="#load_waiting" data-backdrop="static" data-keyboard="false">
						                       Set
						                    </button>
											</section>
			              </span>
			         ...
			         <div class="col-md-3 col-sm-6 col-xs-12">
			          <div class="info-box">
			            ...
			            <div class="info-box-content">
			              <span class="info-box-text">Total Screened Students 2018</span>
    ...
    <div class="panel panel-primary col-md-4">
						<div class="panel-heading"><span>Screening Pie Chart 
											<section class="col col-4">
												<label class="label">Search</label>
												<label class="select">
													<select id="screening_pie_span" style="color: black">
    ...
    <div class="panel panel-warning col-md-4">
						<div class="panel-heading">Requests Pie Chart
	...
	<div class="panel panel-info col-md-4">
						<div class="panel-heading">Identifiers Pie Chart
							<section class="col col-4 pull-right">
											<label class="label">Search Span</label>
											<label class="select">
												<select id="request_pie_span">
			...
			<div class="panel panel-primary col-md-4">
						<div class="panel-heading">Attendance Pie Chart</div>
						<div class="panel-body">
			...
			<div class="panel panel-success col-md-8">
						<div class="panel-heading">Health Request Docs</div>
						<div class="panel-body">
						<div>
							<!-- widget edit box -->
							<div class="jarviswidget-editbox">
