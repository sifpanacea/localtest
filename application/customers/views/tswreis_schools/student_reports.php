...
<header class ="bg-color-orange"> 
	...
	<h2 class ="txt-color-white">Select a Class | Total students : <span class="badge bg-color-greenLight">
...
<header class ="bg-color-orange">
	<span class="widget-icon"> <i class="fa fa-user"></i> </span>
	<h2 class ="txt-color-white">Student Report</h2>
	...
	function display_data_table(result){
		if(result.length > 0){
			...
			$.each(result, function() {
				...
				data_table = data_table + '<td><a class="btn btn-primary btn-xs" href="'+urlLink+'tswreis_schools/drill_down_screening_to_students_load_ehr_doc/'+obj[0]+'">Show EHR</a></td>';
				data_table = data_table + '</tr>';
