...
<div>
	...
	echo  form_open('tswreis_schools/panacea_update_personal_ehr_uid',$attributes);
	?>
		<!--<form class="smart-form">-->
			...
			<section class="col col-2">
				...
				<?php if(isset($district_code) && isset($school_code)):?>
				   ...
				   <input class='text_input student_code' id='student_code' type='text' name='student_code' minlength='1' maxlength='6' required/>
