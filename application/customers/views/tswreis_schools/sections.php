...
<div>
	...
	echo  form_open('tswreis_schools/create_section',$attributes);
	?>
		<!--<form class="smart-form">-->
			<header>
				<strong>Please Enter The Section.</strong>
			</header>
			<fieldset>
			<div class="row">
			<label class="label col col-2" for="first_name"><strong>Section Name</strong></label>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-11">
					...
					<tr>
						...
						<a class='ldelete' href='<?php echo URL."tswreis_schools/delete_section/".$section['_id'];?>'>
