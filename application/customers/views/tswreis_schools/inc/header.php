		...
		?>
				...
				<header id="header" style="margin-top: 0px;height: 95px;">
					...
					<div class="pull-left">
						...
						<img style="height: 75px;margin-top: 4px;margin-right: 5px; border-radius: 30px; " src="<?php echo IMG; ?>/TELANGANA.png" alt="logo" title="" />
	                    <img style="height: 80px; margin-top: 7px;" src="<?php echo IMG; ?>/PANACEA_LOGO_NEW.jpg" alt="" title="" />
