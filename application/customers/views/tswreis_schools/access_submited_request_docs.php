...
<header>
	...
	<?php foreach ($hs_req_docs as $unique):?>
		<form action='<?php echo URL."tswreis_schools/reports_display_ehr_uid_new_html_static_hs";?>' accept-charset="utf-8" method="POST">
		...
		<button type="submit" id="show_ehr" class="btn bg-color-greenDark txt-color-white btn-sm show_ehr pull-right">Show EHR</button>
		</form>
		<?php endforeach;?>
		<br><br>
</header>
...
<div>
	...
	<div class="widget-body no-padding">
		...
		echo  form_open_multipart('tswreis_schools/update_request_and_submit',$attributes);
		?>
		<fieldset>
				...
				<div class="tab-pane fade" id="ent">
					<div class="row">
						...
						<div class="col col-md-3">
							...
							<i></i>Difficulty in swellowing(Dysphagia)</label>
						</div>
					</div>
...
<!-- PSYCHIARTIC-->
		...
		<!-- CHRONIC RELATED INFORMATION (ON CLICK RADIO) -->
				...
				<!-- END SKIN PROBLEMS  -------------------------------------------------------->
					...
					<div class="tab-pane fade" id="chronic_endo_chronic">
						<div class="row">
							...
							<div class="col col-md-4">
								<label class="checkbox">
								<input type="checkbox" name="chronic_endo_identifier[]" value="Hypo Thyroidism" <?php if(in_array("Hypo Thyroidism",$doc['doc_data']['widget_data']['page1']['Problem Info']['Chronic']['Endo'])) { ?> checked="checked" <?php } ?>>
								<i></i>Hypo Thyroidism</label>
								<label class="checkbox">
									<input type="checkbox" name="chronic_skin_identifier[]" value="Hyper Thyroidism" <?php if(in_array("Hyper Thyroidism",$doc['doc_data']['widget_data']['page1']['Problem Info']['Chronic']['Skin'])) { ?> checked="checked" <?php } ?>>
			...
			<fieldset>
				...
				<section>
					<textarea class='form-control' rows="5" id='page2_ProblemInfo_Description'  name='page2_ProblemInfo_Description'>
			...
			<section>
				<textarea class='form-control' rows="5" id="page2_DiagnosisInfo_DoctorSummary" name="page2_DiagnosisInfo_DoctorSummary" readonly="readonly"> <?php echo set_value('page2_DiagnosisInfo_DoctorSummary', (isset($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Doctor Summary'])) ? htmlspecialchars_decode($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Doctor Summary']) : ''); ?></textarea>
			</section>
				...
				<textarea class='form-control' rows="5" id="page2_DiagnosisInfo_Prescription" name="page2_DiagnosisInfo_Prescription" readonly="readonly"><?php echo set_value('page2_DiagnosisInfo_Prescription', (isset($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Prescription'])) ? htmlspecialchars_decode($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Prescription']) : ''); ?></textarea>
			</section>
				</fieldset>
			<fieldset>
				...
				<section>
					...
					<section>
						<input type="hidden" name="" id="currentRequestType" value="<?php echo $doc['doc_data']['widget_data']['page2']['Review Info']['Status']; ?>">
                    ...
                    Expired
							        ...
							        <p id="change_review_status_type" class="text-danger"></p>
						</section>
					</fieldset>
            ...
            <section class="col col-sm-3">
					...
					<?php  endif; ?>
					  ...
					  <li class="nav-item">	
					    ...
					    <?php if(isset($doc['doc_data']['special_diet_pics']) && count($doc['doc_data']['special_diet_pics']) >0): ?>
					    <span class="badge bg-color-green"><?php echo count($doc['doc_data']['special_diet_pics']); ?></span>
					    <?php endif; ?>Special Diet</a>
					  </li>
					  <li class="nav-item">
					...
					<div class="tab-content">
					  ...
					  <div class="tab-pane fade" id="panel555" role="tabpanel">
					    ...
					    <?php if(isset($doc['doc_data']['Lab_Reports'])): ?>
			                ...
			                <a data-magnify="gallery" data-src="" data-caption="Lab Reports" data-group="a" href="<?php echo URLCustomer.$data['file_path'];?>">
      					     <img src="<?php echo URLCustomer.$data['file_path'];?>" alt="" width="400" >
			                </a>
			                <?php endforeach ?>
			                </div>
					  ...
					  <div class="tab-pane fade" id="panel667" role="tabpanel">
					  	...
					  	<?php if(isset($doc['doc_data']['Payments_Bills'])): ?>
			               ...
			               <a data-magnify="gallery" data-src="" data-caption="Payment Bills" data-group="a" href="<?php echo URLCustomer.$data['file_path'];?>">
      					<img src="<?php echo URLCustomer.$data['file_path'];?>" alt="" width="400" >
			                </a>
			                <?php endforeach ?>
			                </div>
					  ...
					  <div class="tab-pane fade" id="panel669" role="tabpanel">
					  	<?php if(isset($doc['doc_data']['Discharge_Summary']) ): ?>
			               ...
			               <a data-magnify="gallery" data-src="" data-caption="Discharge Summery" data-group="a" href="<?php echo URLCustomer.$data['file_path'];?>">
      					<img src="<?php echo URLCustomer.$data['file_path'];?>" alt="" width="400" >
			                </a>
			                <?php endforeach ?>
			                </div>
					  ...
					  <div class="tab-pane fade" id="panel668" role="tabpanel">
					 	...
					 	<?php if(isset($doc['doc_data']['Prescriptions'])): ?>
			               ...
			               <a data-magnify="gallery" data-src="" data-caption="Prescription" data-group="a" href="<?php echo URLCustomer.$data['file_path'];?>">
      					<img src="<?php echo URLCustomer.$data['file_path'];?>" alt="" width="400" >
			                </a>
			                <?php endforeach ?>
			                </div>
			...
			<div class="tab-pane fade" id="panel780" role="tabpanel">
			  	<?php if(isset($doc['doc_data']['special_diet_pics']) ): ?>
	                <div class='external_file_attachments'>
	                <?php foreach($doc['doc_data']['special_diet_pics'] as $data):?>			              	
	               <a data-magnify="gallery" data-src="" data-caption="Special Diet" data-group="a" href="<?php echo URLCustomer.$data['file_path'];?>">
  					<img src="<?php echo URLCustomer.$data['file_path'];?>" alt="" width="400" >
		                </a>
		                <?php endforeach ?>
		                </div>							
			...
			<label for="special_diet" class="btn btn-primary btn-lg" style="margin-left: 100px; width: -webkit-fill-available; margin-right: 100px;">
				...
				<!-- Tab panels -->
                                  ...
                                  <div class="col-md-7">
                                    ...
                                    <button class="btn btn-success col-md-3 submit" id='sub_mit' type="submit">
...
<!-- PAGE RELATED PLUGIN(S) 
	...
	<script type="text/javascript">
		...
		$("a[rel^='prettyPhoto']").prettyPhoto();
			...
			var dr_summary = $("#page2_DiagnosisInfo_DoctorSummary").text().length;
			if(dr_summary <= 1){
				$("#page2_DiagnosisInfo_DoctorSummary").addClass('hide');
			}else{
				$("#page2_DiagnosisInfo_DoctorSummary").removeClass('hide');
			}
			var dr_summary = $("#page2_DiagnosisInfo_Prescription").text().length;
			if(dr_summary <= 1){
				$("#page2_DiagnosisInfo_Prescription").addClass('hide');
			}else{
				$("#page2_DiagnosisInfo_Prescription").removeClass('hide');
			}
			$(".nav-tabs").click(function () {
				$(".nav-link").addClass("li-active");
			});
...
return false;
		...
		var numFiles = $("input:file")[0].files.length;
		 ...
		 /*   $('.submit').click(function(){
		     ...
		     $('.submit').click(function(){
		     	$('#sub_mit').hide();
		    	var currentRequestType = $('#currentRequestType').val();
		    	var page2_ReviewInfo_Status = $('#page2_ReviewInfo_Status').val();
		    	var doc_summary_field = $("#page2_DiagnosisInfo_DoctorSummary").text().trim().length;
		    	var doc_prescription_field = $("#page2_DiagnosisInfo_Prescription").text().trim().length;
		    	
		    	//if($("#page2_DiagnosisInfo_DoctorSummary").text().length)
		    	if(page2_ReviewInfo_Status == currentRequestType)
		    	{
		    		if(doc_summary_field > 1 || doc_prescription_field > 1){
			    	
						swal("Info !","Looks like you are updating Doctor's response. Please change the Review status accordingly");
			    		$('#change_review_status_type').text("* Please Change Review Status Here ..");
	...
	<script>
		...
		{				
		//var numFiles = $("input:file")[0].files.length;
		 $("#special_diet").on("change", function(e) {
			var files = e.target.files,
			filesLength = files.length;	        
		    for(var j=0;j<filesLength;j++)
		    {
