...
<header>
	...
	<h2 class="h2title">Search Student's Document by Admission Number </h2>
...
<div>
	...
	echo  form_open('rhso_mgmt/panacea_reports_display_ehr',$attributes);
	?>
...
<div>
	...
	<?php
	$attributes = array('class' => 'smart-form','id'=>'create_user','name'=>'userform');
	echo  form_open('rhso_mgmt/panacea_reports_display_ehr_uid',$attributes);
	?>
		<!--<form class="smart-form">-->
			<header>
