...
<div>
    ...
    <div class="widget-body no-padding">
        ...
        echo  form_open_multipart('panacea_ts_normal/initiate_new_hs_request',$attributes);
        ?>
        <fieldset>
        ...
        <input style="width:250px; height:45px; type="text" class="col-md-3 student_code" id="page1_StudentDetails_HospitalUniqueID" name="page1_StudentDetails_HospitalUniqueID" required>
            ...
            <fieldset>
                ...
                <section class="col col-sm-2">
                    ...
                    <option value="YADADRI" <?php echo  preset_select('std_join_hospital_dist', 'YADADRI', (isset($doc['doc_data']['widget_data']['page2']['Hospital Info']['District Name'])) ? $doc['doc_data']['widget_data']['page2']['Hospital Info']['District Name'] : ''  ) ?>>YADADRI</option>
                            ...
                            <div class="col col-sm-offset-3" id="date_of_discharge" style="display: none;">
...
<script src="<?php echo(MDB_PLUGINS.'bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js'); ?>"></script>
        <script type="text/javascript">
           ...
           $('#go_search').click(function(){
            ...
            {
               if(result.length > 0){
                   data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="screened_Students"><thead><tr><th>Unique ID</th><th class="hide">doc ID</th><th>Student Name</th><th>Class</th><th>School Name</th><th>Request Raised Time</th><th>Access</th></tr></thead><tbody>';
                   ...
                   $('.ehrButton').click(function(){
                       ...
                       //$("#student_id").val(studentHealthID);
                        window.location = '<?php echo URL; ?>panacea_ts_normal/access_submited_notes_request_docs/'+studentHealthID;
                      // $("#request_form").submit();
