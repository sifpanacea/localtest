...
"pa home" => array(
		"title" => "Dashboard",
		"url" => URL."panacea_ts_normal/fetch_normal_requests_docs",
		"icon" => "fa-home",
		"class" => "menu-links"
),
...
"initiate_req" => array(
		"title" => "HS New Request",
		"url" => URL."panacea_ts_normal/hs_new_request",
		"icon" => "fa-medkit",
		"class" => "menu-links"
),
	...
	"pa reports" => array(
		...
		/*
			...
			"school" => array(
				...
				"url" => URL."panacea_ts_normal/panacea_reports_school",
				"icon" => "fa-star",
				"class" => "menu-links",
			),
			/*
			"classes" => array(
				"title" => "Class Reports",
				"url" => URL."panacea_ts_normal/panacea_cc_classes",
				"icon" => "fa-star",
				"class" => "menu-links",
			),
			"sections" => array(
				"title" => "Section Reports",
				"url" => URL."panacea_ts_normal/panacea_cc_sections",
				"icon" => "fa-star",
				"class" => "menu-links",
			),*/
			// "doctors" => array(
			...
			"student" => array(
					...
					"url" => URL."panacea_ts_normal/panacea_reports_students_filter",
					"icon" => "fa-star",
					"class" => "menu-links",
			),
			"ehr" => array(
				"title" => "Electronic Health Record",
				"url" => URL."panacea_ts_normal/panacea_reports_ehr",
				"icon" => "fa-star",
				"class" => "menu-links",
			),/*
			"emp" => array(
				...
				"sub" => array(
					/*
						...
						"update_student_info" => array(
								...
								"url" => URL."panacea_ts_normal/panacea_update_ehr",
								"icon" => "fa-star",
								"class" => "menu-links",
						),
				),
