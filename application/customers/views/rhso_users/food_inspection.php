...
$page_title = "Food And Hygiene Inspection";
...
$page_nav["Food Hygiene Inspection"]["active"] = true;
include("inc/nav.php");
	...
	$(document).ready(function() {
		...
		$(document).on('click','#app_open',function(e)
		{
			...
			if($(this).hasClass("attendance"))
			{
		        ...
		        apd__ = "healthcare20171221112544749";
		        _url = "https://mednote.in/PaaS/healthcare/index.php/healthcare/healthcare20171221112544749_con/create";
			...
			$( ".device" ).load( _url, function(response)
			{
				...
				window.location.href = ''+host+'/PaaS_main';
				}	
				$(".previous").attr("disabled","disabled")
				$(".next").attr("disabled","disabled")
				$('.for_remove').remove();
		...
		//console.log(_url);
			...
			$( ".device" ).load( _url, function(response) 
			{
			  ...
			  $(".next").attr("disabled","diprevioussabled")
				}
				afterload();
		...
		var apd__ = "healthcare20171221112544749";
		var url = "https://mednote.in/PaaS/healthcare/index.php/healthcare/healthcare20171221112544749_con/create";
