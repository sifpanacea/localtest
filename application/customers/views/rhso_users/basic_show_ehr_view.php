									...
									<tbody>
										<?php foreach ($students_details as $index => $doc ):?>
											...
											<tr>
												...
												<td> <a class='ldelete' href='<?php echo URL."rhso_users/drill_down_screening_to_students_load_ehr_new_dashboard/".$doc['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
