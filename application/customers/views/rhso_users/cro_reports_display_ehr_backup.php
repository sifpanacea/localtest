			...
			<li>
				...
				<ul>
					...
					<li>
						...
						<?php endif ?>
						<?php if(isset($request['doc_data']['external_attachments']) && !is_null($request['doc_data']['external_attachments']) && !empty($request['doc_data']['external_attachments']) || isset($request['doc_data']['mri_and_xray_attachments']) && !is_null($request['doc_data']['mri_and_xray_attachments']) && !empty($request['doc_data']['mri_and_xray_attachments']) || isset($request['doc_data']['medical_bill_attachments']) && !is_null($request['doc_data']['medical_bill_attachments']) && !empty($request['doc_data']['medical_bill_attachments'])):?>
					
						<li>
							
							<span><i class="fa fa-lg fa-minus-circle"></i> Attachment(s)</span>
							<ul>
								
								<li>
								
									<span><i class="fa fa-lg fa-plus-circle"></i> Medical Reports <?php if(!empty(count($attachment_count['external_attachments']))){ echo $attachment_count['external_attachments']; }else{ echo "0";} ?></span>
									<ul>
								...
								<li>
									<span><i class="fa fa-lg fa-plus-circle"></i> MRI and Xray Reports 
									
									<?php echo (isset($attachment_count['doc_data']['mri_and_xray_attachments'])? count($$attachment_count['doc_data']['mri_and_xray_attachments']) : "0"); ?></span>
									
									
									<ul>
										<?php foreach ($request['doc_data']['mri_and_xray_attachments'] as $attachments):?>
										<li style="display:none">
											<div class="well well-sm">
											<center>
											<p>Attachment</p>
										        <embed src="<?php echo URLCustomer.$attachments['file_path'];?>" width="500"/>
								...
								<li>
									<span><i class="fa fa-lg fa-plus-circle"></i> Medical Bills <?php if(count($attachment_count['doc_data']['medical_bill_attachments'])){ echo $attachment_count['doc_data']['medical_bill_attachments']; }else{ echo "0";} ?></span>
									<ul>
									<?php foreach ($request['doc_data']['medical_bill_attachments'] as $attachmentss):?>
										<li style="display:none">
											<div class="well well-sm">
											<center>
											<p>Attachment</p>
										        <embed src="<?php echo URLCustomer.$attachmentss['file_path'];?>" width="500"/>
