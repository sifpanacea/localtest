		...
		?>
				...
				<header id="header">
				    <div id="logo-group">
						...
						<span id="">
						<img class="logo_3 hide" src="https://mednote.in/PaaS/bootstrap/dist/img/sif.png" alt="" style="">
						</span>
					...
					<p class="panacea-headertext-top" style="color:blueviolet; padding-left:30%";>REGIONAL HEALTH & SANITATION OFFICER DASHBOARD </p>
					<?php $session = $this->session->userdata('customer'); ?>
					<p class="panacea-headertext-bottom" style="padding-left:47%; color:blueviolet"><?php echo $session['dt_name']; ?></p>
					</div>
