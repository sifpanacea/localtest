...
$page_title = "Food And Hygiene Inspection Report";
...
$page_nav["Food And Hygiene Inspection"]["active"] = true;
include("inc/nav.php");
	...
	$(document).ready(function() {
		...
		$(document).on('click','#app_open',function(e)
		{
			...
			if($(this).hasClass("attendance"))
			{
		        ...
		        _url = "https://panacea-schoolhealth.com/PaaS_main/healthcare/index.php/healthcare/healthcare201651317373988_con/create";
		...
		var apd__ = "healthcare2017116114639466";
		var url = "https://panacea-schoolhealth.com/PaaS/healthcare/index.php/healthcare/healthcare2017116114639466_con/create";
