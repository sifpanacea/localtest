...
<div id="main" role="main">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 col-md-12 col-lg-12">
								...
								<form class='smart-form'>
									<fieldset>
											...
											<div class="form-group">
												<label class="label" for="first_name">Select date</label>
				...
				<article class="col-xs-12 col-sm-12 col-md-6 col-lg-6 hide">
					<!-- new widget -->
...
$(document).ready(function() {
	...
	console.log('absent_submitted_schools_list',absent_submitted_schools_list);
...
function drill_down_screening_to_abnormalities(pie_data){
	...
	$.ajax({
		...
		success: function (data) {
			console.log('drilling_screening_to_abnormalities====2504==',data);
			var content = $.parseJSON(data);
			console.log(content);
			$( "#pie_screening" ).empty();
