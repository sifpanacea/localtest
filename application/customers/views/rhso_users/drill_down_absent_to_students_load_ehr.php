									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												...
												<td><a class='ldelete' href='<?php echo URL."rhso_users/drill_down_screening_to_students_load_ehr_new_dashboard/".$student['doc_data']['widget_data']["page1"]['Personal Information']['Hospital Unique ID'];?>'>
