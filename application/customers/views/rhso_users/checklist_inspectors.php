	...
	$(document).ready(function() {
		...
		$(document).on('click','#app_open',function(e)
		{
			...
			if($(this).hasClass("attendance"))
			{
		        ...
		        apd__ = "healthcare20171227173441869";
		        _url = "https://mednote.in/PaaS/healthcare/index.php/healthcare/healthcare20171227173441869_con/create";
		...
		var apd__ = "healthcare20171227173441869";
		var url = "https://mednote.in/PaaS/healthcare/index.php/healthcare/healthcare20171227173441869_con/create";
