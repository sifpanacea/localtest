...
<header>
	...
	<?php foreach ($hs_req_docs as $unique):?>
		<form action='<?php echo URL."tmreis_schools/reports_display_ehr_uid_new_html_static_hs";?>' accept-charset="utf-8" method="POST">
		...
		<button type="submit" id="show_ehr" class="btn bg-color-greenDark txt-color-white btn-sm pull-right show_ehr">Show EHR</button>
	</form>
<?php endforeach;?>
...
<?php //endforeach;?> -->
		...
		echo  form_open_multipart('tmreis_schools/update_request_and_submit',$attributes);
		?>
		<fieldset>
...
<!-- PSYCHIARTIC-->
		...
		<!-- CHRONIC RELATED INFORMATION (ON CLICK RADIO) -->
			...
			<fieldset>
				...
				<section>
					<textarea class='form-control' rows="4" id='page2_ProblemInfo_Description'  name='page2_ProblemInfo_Description'>
			...
			<section>
				<textarea class='form-control' rows="4" id="page2_DiagnosisInfo_DoctorSummary" name="page2_DiagnosisInfo_DoctorSummary" readonly="readonly"> <?php echo set_value('page2_DiagnosisInfo_DoctorSummary', (isset($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Doctor Summary'])) ? htmlspecialchars_decode($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Doctor Summary']) : ''); ?></textarea>
			</section>
				...
				<textarea class='form-control' rows="4" id="page2_DiagnosisInfo_Prescription" name="page2_DiagnosisInfo_Prescription" readonly="readonly"><?php echo set_value('page2_DiagnosisInfo_Prescription', (isset($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Prescription'])) ? htmlspecialchars_decode($doc['doc_data']['widget_data']['page2']['Diagnosis Info']['Prescription']) : ''); ?></textarea>
			</section>
				</fieldset>
			<fieldset>
