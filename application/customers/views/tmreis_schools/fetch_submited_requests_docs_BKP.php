												...
												<table id="table_id" class="display">
												    ...
												    <tbody>
														...
														<?php foreach($hs_req_docs as $index => $doc ):?>
															...
															<?php endif;?>
																<td><a href="<?php echo URL.'tmreis_schools/access_submited_request_docs/'.$doc['doc_properties']['doc_id'].'';?>" class="btn bg-color-greenDark txt-color-white btn-xs">Access</a></td>
															</tr>
												   		<?php endforeach;?>
														<?php else: ?>
														<p> No docs found </p>
