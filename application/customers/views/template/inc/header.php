...
<html lang="en-us">
	<head>
        ...
        <link href="<?php echo(CSS.'bootstrap-editable.css'); ?>" media="screen" rel="stylesheet" type="text/css" />
        <link href="<?php echo(CSS.'template_design.css'); ?>" media="screen" rel="stylesheet" type="text/css" />
