						...
						<div class="no-padding">
							...
							<div class="widget-body">
								...
								<div class="well well-sm well-light">
									...
									<button type="button" class="btn bg-color-greenDark txt-color-white" id="set_date_btn" data-toggle="modal" data-target="#load_waiting" data-backdrop="static" data-keyboard="false">
				                       Set
				                    </button>
				                    </div>
									</div>
									...
									<div class="well well-sm well-light">
										...
										<div class="row">
											...
											<label class="label" id="refresh_date"><?php echo $last_screening_update?></label>
													<button type="button" class="btn bg-color-greenDark txt-color-white" id="refresh_screening_data" >
							                       	Refresh
							                    	</button>
...
function drill_down_absent_to_districts(pie_data){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"data" : JSON.stringify(pie_data.data),"today_date" : today_date},
		success: function (data) {
			console.log(data);
...
function drill_down_absent_to_schools(pie_data){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"data" : JSON.stringify(pie_data),"today_date" : today_date},
		success: function (data) {
			var content = $.parseJSON(data);
			$( "#pie_absent" ).empty();
...
function drill_down_identifiers_to_districts(pie_data){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"data" : JSON.stringify(pie_data.data), "today_date" : today_date, "request_pie_span" : request_pie_span},
		success: function (data) {
			console.log(data);
			var content = $.parseJSON(data);
			console.log(content);
...
function drill_down_identifiers_to_schools(pie_data){
	...
	$.ajax({
		...
		type: 'POST',
		data: {"data" : JSON.stringify(pie_data), "today_date" : today_date, "request_pie_span" : request_pie_span},
		success: function (data) {
			console.log(data);
			var content = $.parseJSON(data);
			console.log(content);
