<?php $current_page = "swaero_mgmt_network"; ?>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    echo  form_open('power_of_ten_mgmt/swaero_create_network',$attributes);
                    ?>                                                       
                        <h2 class="card-inside-title">Please Enter The Swaero Information</h2>
                        <div class="row clearfix">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                             ...
                             <div class="col-sm-3">
                                ...
                                <select class="form-control show-tick" name="village_name" required>
                                    <option value="" selected="" disabled="" >Select a Village</option>
                                    <?php if(isset($village)): ?>
                                        <?php foreach ($village as $villages):?>
                                        <option value='<?php echo $villages['village_name']?>' ><?php echo ucfirst($villages['village_name'])?></option>
                                        <?php endforeach;?>
                                        <?php else: ?>
                                        <option value="1"  disabled="">No Village entered yet</option>
                                    <?php endif ?>
                                </select>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label>Swaero Type</label>
                                        <input type="text" class="form-control" placeholder="Enter Village Name here" name="swaero_type" id="swaero_type" value="<?PHP echo set_value('swaero_type'); ?>" required/>
                                    </div>
                                </div>
                            </div>
                        </div> 
