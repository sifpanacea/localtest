    ...
    <footer class="footer bg-grey" style="position: fixed;left: 0;bottom: 0; width: 100%;">
     <!-- Copyright -->
        <div class="container" style="text-align: center">
           <p style="padding-top: 10px;"><img src="<?php echo IMG;?>/Havik_logo1.jpeg" style="border-radius: 5px;">   <small>Devoloped By | </small><a target="_blank" href="http://www.haviktec.com/" style="color: white;">Havik Healthcare IT Solutions Pvt Ltd.</a></p>
        </div>
