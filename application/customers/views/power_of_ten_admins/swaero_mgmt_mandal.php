<?php $current_page = "swaero_mgmt_mandal"; ?>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    echo  form_open('power_of_ten_mgmt/swaero_create_mandal',$attributes);
                    ?>                                                       
                        <h2 class="card-inside-title">Please Enter The Mandal Information</h2>
                        <div class="row clearfix">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter District Name here" name="mandal_name" id="mandal_name" value="<?PHP echo set_value('mandal_name'); ?>" required/>
                                    </div>
                                </div>
                            </div>
                        </div> 
