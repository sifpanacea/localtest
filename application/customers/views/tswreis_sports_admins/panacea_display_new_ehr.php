                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        	<div class="row">
                        		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                <div class="form-group">
	                                    <div class="form-line">
	                                        <input type="text" class="form-control" data-toggle="tooltip" data-palcement="bottom" title="Father Name" value="<?php echo $docs_two[0]['doc_data']['widget_data']['page2']['Personal Information']['Father Name'];
                                             ?>" readonly/>
	                                    </div>
	                                </div>
                                </div>
