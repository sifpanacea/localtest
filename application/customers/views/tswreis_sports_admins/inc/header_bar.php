...
<head>
    ...
    <title>TSWREIS SPORTS DASHBOARD</title>
    <!-- Favicon-->
...
<body class="theme-green">
    ...
    <div class="search-bar">
        ...
        <input type="text" placeholder="Enter Student ID..." name="uid" id="uid" value="<?PHP echo set_value('uid'); ?>">
            ...
            <div class="navbar-header">
             <a href="javascript:void(0);" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false"></a>
                ...
                <div class="col-sm-offset-6">
                	<a class="navbar-brand" href="#" style="margin-left: 260px">TSWREIS SPORTS ACHEIVEMENTS DASHBOARD</a>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li <?php if($current_page == 'Import Students') { echo 'class="active"';} ?>>
                        <a href="<?php echo URL."tswreis_sports_mgmt/panacea_imports_students"?>" data-toggle="tooltip" data-placement="bottom" title="Import Students" data-original-title="Import Students">
                            <i class="material-icons">file_upload</i>
                        </a>
                    </li> 

                    <!-- <li <?php //if($current_page == 'Students Sports EHR') { echo 'class="active"';} ?>>
                        <a href="<?php //echo URL."tswreis_sports_mgmt/tswreis_electronic_sports_record"?>" data-toggle="tooltip" data-placement="bottom" title="Electronic Sports Record" data-original-title="Electronic Sports Record">
                            <i class="material-icons">account_box</i>
                        </a>
                    </li> -->

                    <!-- <li <?php //if($current_page == 'maximum_raised_requests') { echo 'class="active"';}?>>
                        <a href="<?php //echo URL."panacea_mgmt/maximum_raised_requests"; ?>" data-toggle="tooltip" data-placement="bottom" title="Maximun Raised Request" data-original-title="Maximun Raised Request">
