	...
	<div id="content">		
					...
					<div class="row clearfix">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                               <div class="card">
                                <div class="header">
                                  <center>
                                  <h3 class="font-bold col-green">HB Report Female</h3>
                                  </center>                         
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                               <div class="card">
                                <div class="header">
                                  <center>
                                  <h3 class="font-bold col-green">HB Report Male</h3>
                                  </center>                               
                                    <ul class="header-dropdown m-r--5">                                       
                                    </ul>
                                </div>
      ...
      <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="loading_modal">
              <div class="modal-dialog modal-sm" role="document">
                ...
                <center><img src="<?php echo(IMG.'Ripple-2s.gif'); ?>" id="gif" ></center>
                </div>
              </div>
            </div>		
