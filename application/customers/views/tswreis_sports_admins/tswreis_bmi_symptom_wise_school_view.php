...
$page_title = "BMI School Case Report";
...
$page_nav["pa school pie"]["sub"]["bmi_pie"]["active"] = true;
include("inc/nav.php");
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <header class ="bg-color-orange txt-color-white">
                        ...
                        <h2>BMI Cases Report <span class="badge bg-color-greenLight"></span>
                        </h2>
                            ...
                            <div class="panel-group smart-accordion-default" id="accordion-2">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseOne-1"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Under Weight BMI Cases Report </a></h4>
                                    </div>
                                ...
                                <?php foreach ($all as $chronics) : ?>
                                    <?php if(isset($chronics['all_under_weight_bmi_cases_docs']) && !empty($chronics['all_under_weight_bmi_cases_docs']) && !is_null($chronics['all_under_weight_bmi_cases_docs'])): ?>
                                    <?php foreach ($chronics['all_under_weight_bmi_cases_docs'] as $chronic) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['month']; ?></td>
                                            <td><span class="badge badge-warning" style="background-color:red"><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['bmi']; ?></span></td>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseTwo-1" class="collapsed"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Over Weight BMI Cases Report </a></h4>
                                    </div>
                    ...
                    <tbody>                                                
                        <?php foreach ($all as $chronics) : ?>
                            <?php if(isset($chronics['all_over_weight_bmi_cases_docs']) && !empty($chronics['all_over_weight_bmi_cases_docs']) && !is_null($chronics['all_over_weight_bmi_cases_docs'])): ?>
                                    <?php foreach ($chronics['all_over_weight_bmi_cases_docs'] as $chronic) : ?>
                                        <tr>
                                            <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID']; ?></td>
                                            <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref']; ?></td>
                                            <td><?php echo $chronic['doc_data']['widget_data']['school_details']['School Name']; ?></td>
                            ...
                            <?php endforeach; ?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-2" href="#collapseThree-1" class="collapsed"> <i class="fa fa-fw fa-plus-circle txt-color-green"></i> <i class="fa fa-fw fa-minus-circle txt-color-red"></i> Obese Weight BMI Cases Report </a></h4>
                                    </div>
                                ...
                                <tbody>                                                
                                    <?php foreach ($all as $chronics) : ?>
                                        <?php if(isset($chronics['all_obese_weight_bmi_cases_docs']) && !empty($chronics['all_obese_weight_bmi_cases_docs']) && !is_null($chronics['all_obese_weight_bmi_cases_docs'])): ?>
                                        <?php foreach ($chronics['all_obese_weight_bmi_cases_docs'] as $chronic) : ?>
                                            <tr>
                                                <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID']; ?></td>
                                                <td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref']; ?></td>
                                                <td><?php echo $chronic['doc_data']['widget_data']['school_details']['School Name']; ?></td>
