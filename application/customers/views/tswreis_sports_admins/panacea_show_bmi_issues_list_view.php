				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php if(isset($bmi['doc_data']['widget_data']['page1']['Student Details']['Class']['field_ref']) && !empty($bmi['doc_data']['widget_data']['page1']['Student Details']['Class']['field_ref']) && !is_null($bmi['doc_data']['widget_data']['page1']['Student Details']['Class']['field_ref'])): ?>
						<td><?php echo $bmi['doc_data']['widget_data']['page1']['Student Details']['Class']['field_ref'];?></td>
							...
							<td><?php echo ""; ?></td>
					<?php endif; ?> 
					<?php if(isset($bmi['doc_data']['widget_data']['page1']['Student Details']['Age']) && !empty($bmi['doc_data']['widget_data']['page1']['Student Details']['Age']) && !is_null($bmi['doc_data']['widget_data']['page1']['Student Details']['Age'])): ?>
						<td><?php echo $bmi['doc_data']['widget_data']['page1']['Student Details']['Age'];?></td>
							<?php else: ?>
							<td><?php echo ""; ?></td>
					<?php endif; ?>
					<?php if(isset($bmi['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['bmi']) && !empty($bmi['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['bmi']) && !is_null($bmi['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['bmi'])): ?>
						<td><?php echo $bmi['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['bmi'];?></td>
							<?php else: ?>
							<td><?php echo ""; ?></td>
					<?php endif; ?>
						...
						<td> <a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_reports_display_ehr_uid/"?>? id = <?php echo $bmi['doc_data']['widget_data']["page1"]['Student Details']['Hospital Unique ID'];?>'>
