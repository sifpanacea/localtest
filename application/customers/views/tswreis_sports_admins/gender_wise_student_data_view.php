                    ...
                    <div class="body">           
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 total_schools_count">
                                 <button type="button" class="btn btn-primary">Total Schools <span class="badge" id="total_schools_count"></span></button>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 total_female_schools_count">
                                 <button type="button" class="btn btn-primary">Total Female Schools <span class="badge" id="total_female_schools_count"></span></button>
                            </div>

                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 total_male_schools_count">
                                 <button type="button" class="btn btn-primary">Total Male Schools <span class="badge" id="total_male_schools_count"></span></button>
                            </div> 
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <button type="button" class="btn btn-primary">Total Female Students<span class="badge" id="female_students_count"></span></button>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <button type="button" class="btn btn-primary">Total Male Students <span class="badge" id="male_students_count"></span></button>
                            </div>
...
<script type="text/javascript">
   ...
   /* function show_classes_for_data(result)
    ...
    function get_students_details(result)
    {
        ...
        data_table = "";
        data_table += "<table id='more_requests' class='table table-striped table-bordered' width='100%'><thead><tr><th>Class</th><th>Total Count</th><th>Total Female Count</th><th>Total Male Count</th></tr></thead><tbody>";
