            ...
            <div class="card">
				<div class="header">
					...
					<?php 
						...
						echo form_open_multipart((isset($news_feed)? 'power_of_ten_mgmt/update_news_feed' : 'power_of_ten_mgmt/add_news_feed'),$attributes);
					?>
				...
				<div class="body">
                    ...
                    <div class="form-line">
                        ...
                        <input type="text" id="set_date" name="time" class="datepicker form-control date set_date" value="<?php echo date('Y-m-d'); ?>" required>
