            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php if($current_page == 'homepage') { echo 'class="active"';} ?>>
                        <a href='<?php echo URL."power_of_ten_mgmt/basic_dashboard"; ?>'>
                            <i class="material-icons">home</i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li <?php if($current_page == 'Verify_Swaero_registration') { echo 'class="active"';} ?>>
                        <a href='<?php echo URL."power_of_ten_mgmt/verify_pending_requests"; ?>'>
                            <i class="material-icons">assignment_turned_in</i>
                            <span>Swaero Registrations</span>
                        </a>
                    </li>
                    <li <?php if($main_nav == 'Masters') { echo 'class="active"';} ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php if($current_page == 'swaero mgmt states') { echo 'class="active"';} ?>>
                                <a href='<?php echo URL."power_of_ten_mgmt/swaero_mgmt_states"; ?>'>
                                    <i class="material-icons">content_paste</i>
                                    <span>Manage States</span>
                                </a>
                            </li>
                            <li <?php if($current_page == 'swaero_mgmt_zonal') { echo 'class="active"';} ?>>
                                <a href='<?php echo URL."power_of_ten_mgmt/swaero_mgmt_zonal"; ?>'>
                                    <i class="material-icons">content_paste</i>
                                    <span>Manage Zonal</span>
                                </a>
                            </li>
                            <li <?php if($current_page == 'swaero_mgmt_district') { echo 'class="active"';} ?>>
                                <a href='<?php echo URL."power_of_ten_mgmt/swaero_mgmt_district"; ?>'>
                                    <i class="material-icons">content_paste</i>
                                    <span>Manage District</span>
                                </a>
                            </li>
                            <li <?php if($current_page == 'swaero_mgmt_mandal') { echo 'class="active"';} ?>>
                                <a href='<?php echo URL."power_of_ten_mgmt/swaero_mgmt_mandal"; ?>'>
                                    <i class="material-icons">content_paste</i>
                                    <span>Manage Mandal</span>
                                </a>
                            </li>
                             <li <?php if($current_page == 'swaero_mgmt_village') { echo 'class="active"';} ?>>
                                <a href='<?php echo URL."power_of_ten_mgmt/swaero_mgmt_village"; ?>'>
                                    <i class="material-icons">content_paste</i>
                                    <span>Manage Village</span>
                                </a>
                            </li>
                            <li <?php if($current_page == 'swaero_mgmt_network') { echo 'class="active"';} ?>>
                                <a href='<?php echo URL."power_of_ten_mgmt/swaero_mgmt_network"; ?>'>
                                    <i class="material-icons">content_paste</i>
                                    <span>Manage swaero Network</span>
                                </a>
                            </li>
                            <li <?php if($current_page == 'swaero_mgmt_dis_co_od') { echo 'class="active"';} ?>>
                                <a href='<?php echo URL."power_of_ten_mgmt/swaero_mgmt_district_coordinator"; ?>'>
                                    <i class="material-icons">content_paste</i>
                                    <span>Manage District Co-ordinator</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li <?php if($main_nav == 'Reports') { echo 'class="active"';} ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php if($current_page == 'swaero_user_reports') { echo 'class="active"';}?>>
                                <a href="<?php echo URL."power_of_ten_mgmt/swaero_user_reports"; ?>">
                    ...
                    <li <?php if($main_nav == 'Imports') { echo 'class="active"';} ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php if($current_page == 'swaero_user_imports') { echo 'class="active"';}?>>
                                <a href="<?php echo URL."power_of_ten_mgmt/swaero_user_imports"; ?>">
                                    <i class="material-icons">note_add</i>
                    ...
                    <li <?php if($current_page == 'send_message') { echo 'class="active"';} ?>>
                        <a href='<?php echo URL."power_of_ten_mgmt/send_message_to_schools"; ?>'>
                    ...
                    <li <?php if($main_nav == 'News Feed') { echo 'class="active"';} ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php if($current_page == 'Add_News_Feed') { echo 'class="active"';}?>>
                                <a href="<?php echo URL."power_of_ten_mgmt/add_news_feed_view"; ?>">
                                    
                                    <span>Add News Feed</span>
                                </a>
                            </li>                            
                            <li <?php if($current_page == 'Manage_News_Feed') { echo 'class="active"';} ?>>
                              <a href='<?php echo URL."power_of_ten_mgmt/manage_news_feed_view"; ?>'>
