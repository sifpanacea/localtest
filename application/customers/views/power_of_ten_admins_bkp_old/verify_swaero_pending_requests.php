							...
							<tbody>
								...
								<?php foreach($pending as $pend): ?>
									<tr>
										...
										<td><?php echo $pend['doc_data']['Personal_Information']['first_name']; ?></td>
										<td><?php echo $pend['doc_data']['Personal_Information']['mobile_no']; ?></td>
										<td><?php echo $pend['doc_data']['Current_Address']['district']; ?></td>
										<td><?php echo $pend['doc_data']['Current_Address']['mandal']; ?></td>
										<td><?php echo $pend['doc_data']['Current_Address']['village']; ?></td>
										<td>
