    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                    <h3 class="col-green">Send Message to Swaero's</h3>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-control show-tick" id="check">
                                    ...
                                    <option value="HS">Professionals</option>
                                    <option value="PRINCIPAL">Bussiness</option>
                                </select>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Message here" name="dt_name" id="dt_name" value="<?PHP echo set_value('dt_name'); ?>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="collapse" id="message_collapse">
                                   <div class="col-sm-2">
                                        ...
                                        <span id="monitoring_datepicker">
                                         Start Date :
                                        <input type="text" id="passing_date" name="passing_date" class="form-control date" value="">
                                        </span>
                                   </div>
                                   <div class="col-sm-2">
                                        <span id="monitoring_datepicker">
