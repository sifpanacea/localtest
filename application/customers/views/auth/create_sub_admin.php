...
$page_nav["users"]["sub"]["sub admin management"]["sub"]["createuser"]["active"] = true;
	...
	<div id="content">
        ...
        <div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-1" data-widget-colorbutton="true" data-widget-editbutton="true" data-widget-custombutton="true">
						...
						<div>
                            ...
                            <?php
						 	$attributes = array('class' => 'smart-form','id'=>'create_sub_admin');
							echo  form_open('auth/create_sub_admin',$attributes);
							?>
		      					<!--<form class="smart-form">-->
                                    ...
                                    <section>
                            			<label class="label" for="company"><?php echo lang('create_user_company_label', 'company');?></label>
                                			<label class="input"> <i class="icon-append fa fa-pencil"></i>
											<input type="text" name="company" id="company" value="<?PHP echo $company['value'];?>" readonly="readonly">
										</label>
		     						</section>
                                    <section>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#create_sub_admin").validate({
			...
			messages : {
				first_name : {
					required  : <?php echo lang('sub_admin_first_name_required');?>,
					minlength : <?php echo lang('sub_admin_first_name_min');?>,
					maxlength : <?php echo lang('sub_admin_first_name_max');?>
		
				},
				last_name : {
					required  : <?php echo lang('sub_admin_last_name_required');?>,
					minlength : <?php echo lang('sub_admin_last_name_min');?>,
					maxlength : <?php echo lang('sub_admin_last_name_max');?>
				},
				email : {
					required : <?php echo lang('sub_admin_email_required');?>,
					email    : <?php echo lang('sub_admin_email_valid');?>,
		
				},
				phone : {
					required : <?php echo lang('sub_admin_phone_required');?>,
					number   : <?php echo lang('sub_admin_phone_number');?>,
					minlength : <?php echo lang('sub_admin_phone_min');?>,
				},
				password : {
					required  : <?php echo lang('sub_admin_password_required');?>,
					minlength : <?php echo lang('sub_admin_password_min');?>,
					maxlength : <?php echo lang('sub_admin_password_max');?>
		
				},
				password_confirm : {
					required : <?php echo lang('sub_admin_password_confirm_required');?>,
					minlength : <?php echo lang('sub_admin_password_confirm_min');?>,
					maxlength : <?php echo lang('sub_admin_password_confirm_max');?>,
					equalTo:   <?php echo lang('sub_admin_password_confirm_match');?>
				}
			},
