...
$page_title = "Activate (or) Deactivate Sub Admin";
...
$page_nav["users"]["sub"]["sub admin management"]["sub"]["userstatus"]["active"] = true;
include("inc/nav.php");
	...
	<div id="content">
        ...
        <div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-1" data-widget-colorbutton="true" data-widget-editbutton="true" data-widget-custombutton="true">
						...
						<div>
							...
							echo form_open("auth/deactivate_sub_admin/".$user->id,$attributes);?>
