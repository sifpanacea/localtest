...
<html lang="en-us">
	<head>
		...
		<link href="<?php echo(CSS.'print.css'); ?>" media="print" rel="stylesheet" type="text/css" />
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo">
						<?php if(@getimagesize(LOGO_IMG)) { ?>
						<img src="<?php echo LOGO_IMG; ?>" alt=""><?php } else if(@getimagesize(TLSTEC_LOGO_IMG)){ ?>
						<img src="<?php echo TLSTEC_LOGO_IMG; ?>" alt=""><?php } else { ?>
						<img src="<?php echo IMG; ?>logo-cut.png" alt=""><?php } ?>
						</span>
						...
						<div class="ajax-dropdown">
							...
							<div class="btn-group btn-group-justified" data-toggle="buttons">
								<label class="btn btn-default">
									<input type="radio" name="activity" id="<?php echo URL; ?>sub_admin/app_history">
									Apps </label>
								<label class="btn btn-default" disabled>
									<input type="radio" name="activity" id="<?php echo URL; ?>sub_admin/docs_history">
									Docs </label>
								<label class="btn btn-default">
									<input type="radio" name="activity" id="<?php echo URL; ?>sub_admin/admin_messages">
									Msgs </label>
							</div>
					...
					<div class="pull-right">
						...
						<span>
						<a class="menu-links" href="<?php echo URL."sub_admin/sub_admin_profile" ?>"><i class="glyphicon glyphicon-user"></i> </a>
						</span>
						</div>
						<!-- profile end -->
