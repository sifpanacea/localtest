...
<?php $message = $this->session->flashdata('message');?>	
	...
	<?php foreach ($company_data as $comdata):?>
	<div class="col-sm-12 text-align-right">
		
											<div class="btn-group">
												<a href="<?php echo URL."web/edit_profile/".$data['company']."/".base64_encode($data['email']);?>" class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i> Edit Profile</a>
											</div>
										...
										<div class="col-sm-12">
											...
											<img src="<?php echo IMG; ?>/avatars/male.png" alt="me"  /><?php } ?>
												...
												<div class="col-sm-6">
													...
													<br>
													<small> User,&nbsp;<?php echo $company_data[0]['display_company_name'];?></small></h1>
													...
													<ul class="list-unstyled">
														...
														<li>
															<p class="text-muted">
																<i class="fa fa-clock-o"></i>&nbsp;&nbsp;<?php echo $comdata['last_login'];?>
															</p>
														</li>
													</ul>
								...
								<div class="padding-10">
												...
												<div class="tab-content padding-top-10">
													<div class="tab-pane fade in active" id="a1">
														...
														<li>
															<p class="text-info">
																<i class="fa fa-globe"></i>&nbsp;&nbsp;<?php echo $comdata['company_website'];?>
															</p>
														</li>
														<li>
															<p class="text-info">
																<i class="fa fa-hand-o-right"></i>&nbsp;&nbsp;<?php echo $comdata['company_address'];?>
															</p>
														</li>
													</ul></h6></div>
		                                            ...
		                                            <div class="row">
														...
														<table class="table table-bordered">
														 ...
														 <tbody>
														 <tr><td><?php echo $comdata['plan'];?></td><td><?php echo $comdata['registered_on'];?></td><td><?php echo $comdata['plan_expiry'];?></td></tr>
														 </tbody>
														</table>
														</div>
														</div>
