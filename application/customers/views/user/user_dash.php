	...
	<div id="content">
		...
		<div class="row">
			...
			<div class="inbox-checkbox-triggered">
				...
				<div class="btn-group">
					<a href="javascript:void(0);" rel="tooltip" title="" data-placement="bottom" data-original-title="Mark Important" class="btn btn-default" disabled><strong><i class="fa fa-exclamation fa-lg text-danger"></i></strong></a>
					<a href="javascript:void(0);" rel="tooltip" title="" data-placement="bottom" data-original-title="Move to folder" class="btn btn-default" disabled><strong><i class="fa fa-folder-open fa-lg"></i></strong></a>
					<a href="javascript:void(0);" rel="tooltip" title="" data-placement="bottom" data-original-title="Delete" class="deletebutton btn btn-default" disabled><strong><i class="fa fa-trash-o fa-lg"></i></strong></a>
					<a href="javascript:void(0);" class="printbutton btn btn-default hide"><strong><i class="fa fa-print fa-lg"></i></strong></a>
			...
			<label class='hide page_lbl label label-success'>Page</label>
			<label class='hide page_no label label-success'></label>
		...
		<div id="inbox-content" class="inbox-body no-content-padding">
			...
			<div class="inbox-side-bar">
				...
				<h6> Folder <a href="javascript:void(0);" rel="tooltip" title="" data-placement="right" data-original-title="Refresh" class="pull-right txt-color-darken refresh"><i class="fa fa-refresh"></i></a></h6>
				...
				<ul class="inbox-menu-lg">
					...
					<li>
						<a href="javascript:void(0);" class="application">Applications</a>
					</li>
					<li>
					...
					<li class="hide">
						<a href="javascript:void(0);" class="hide">Draft</a>
					</li>
				</ul>
		
				<h6 class="hide"> Quick Access <a href="javascript:void(0);" rel="tooltip" title="" data-placement="right" data-original-title="Add Another" class="pull-right txt-color-darken"><i class="fa fa-plus"></i></a></h6>
		
				<ul class="inbox-menu-sm hide">
					<li>
				...
				<div class="hide air air-bottom inbox-space">
...
<script src='<?php echo(JS.'jquery.select2.min.js'); ?>'></script>   
