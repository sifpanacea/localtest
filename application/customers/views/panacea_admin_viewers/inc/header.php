		...
		?>
				...
				<header id="header" style="margin-top: 0px;height: 95px;">
				    <div id="logo-group">
						...
						<span id="">
						<img src="<?php echo PANACEA_LOGO; ?>" alt="" style="width: 75px;height:90px;margin-top:6px;margin-left:6px;">
						</span>
				    	<!-- END LOGO PLACEHOLDER -->
					</div>
					
					<!--<div class="custom-title"><h2 style="font-weight: bolder;padding-left: 430px;padding-bottom: 5px!important;margin-bottom:0px;">PANACEA </h2><h5 style="font-weight: bolder;padding-left: 380px;margin-top: 0px;">SCHOOL HEALTH PROGRAM</h5></div>-->
					...
					<div class="pull-right">
						...
						<div id="hide-menu" class="hide btn-header pull-right">
