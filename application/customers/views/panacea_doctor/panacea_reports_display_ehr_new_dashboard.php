			...
			<li>
				...
				<ul>
					...
					<?php endif ?>
						...
						<!-- Regular Followup Details ------------->
					<?php if(isset($regular_followup) && !empty($regular_followup)) : ?>
					<?php foreach ($regular_followup as $followup): ?>
					<?php if(isset($followup['Follow_Up']) && !empty($followup['Follow_Up'])): ?>
						<li>
								<span class="label label-success"><i class="fa fa-lg fa-minus-circle"></i> Regular Followups</span>
								<ul>
								
									<?php foreach ($followup['Follow_Up'] as $data): ?>
									<li style="display:none">
										
										<span><i class="fa fa-lg fa-plus-circle"></i><?php echo $data['created_time']; ?></span>
										<ul>
											<li style="display:none">
												...
												<table id="dt_basic" class="table table-striped table-bordered table-hover">
														<tbody>
															<tr>
																...
																<td><?php echo $data['medicine_details']; ?></td>
															</tr>
															<tr>
																<th>Followup Description</th>
																<td><?php echo $data['followup_desc']; ?></td>
															</tr>
														</tbody>
													</table>
