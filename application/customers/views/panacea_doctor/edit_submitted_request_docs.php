...
$page_nav["edit_submitted_request"]["active"] = true;
include("inc/nav.php");
			...
			<div>
				...
				<div class="widget-body">
					...
					<ul id="myTab1" class="nav nav-tabs bordered">
						<li class="active">
							<a href="#s1" data-toggle="tab"> Normal <span class="badge bg-color-blue txt-color-white"></span></a>
						</li>
						<li>
							<a href="#s2" data-toggle="tab"> Emergency <span class="badge bg-color-blue txt-color-white"></span></a>
						</li>
						<li>
							<a href="#s3" data-toggle="tab"> Chronic <span class="badge bg-color-blue txt-color-white"></span></a>
						</li>
					</ul>
