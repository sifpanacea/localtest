		...
		<!-- CHRONIC RELATED INFORMATION (ON CLICK RADIO) -->
			...
			<fieldset>
				...
				<section>
					...
					<section class="col col-12" id="follow_date" style="display: none;">
						<div class="row">
							<div class="col col-md-4">
								<label class="label">Select Next Followup Date</label>
							...
							<div class="col col-md-4">
								<label class="label">Allot CC User To Followup</label>
									<label class="select">
										<select name="cc_user_follow" id="cc_user_follow">
											<?php if(isset($cc_people) && !empty($cc_people)): ?>
												<?php foreach($cc_people as $cc): ?>
