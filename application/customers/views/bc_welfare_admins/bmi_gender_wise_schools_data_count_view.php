...
<div class="block-header">
   <center><h2>BMI Submitted Schools List</h2></center>
</div>
<!-- Input -->
        ...
        <div class="card">
            <div class="header">
               <span class="font-bold col-teal">
                        ...
                        <li data-toggle="tooltip" data-placement="top" title="" data-original-title="Symptom Count"><span class="badge bg-red"><?php if(!empty($schools_count)) {?><?php echo $schools_count;?><?php } else {?><?php echo "0";?><?php }?> =>> Schools </span></li>
                        </ol>
                    </span>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <tr>                                                
                          <!--   <?php //echo print_r($schools_list,true); ?> -->
                                <td><?php echo $key ;?></td>
                                <td><?php echo $value;?></td>
                                <form action='<?php echo URL."bc_welfare_mgmt/bmi_gender_wise_students_data" ?>'accept-charset="utf-8" method="POST">
