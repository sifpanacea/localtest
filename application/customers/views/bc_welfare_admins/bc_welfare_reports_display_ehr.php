			...
			<li>
				...
				<ul>
					...
					<li>
						...
						<li>
							<span><i class="fa fa-lg fa-plus-circle"></i> Lab_Reports Attachments<span class="badge bg-color-greenLight">
						...
						<li>
							...
							<?php foreach ($request['doc_data']['external_attachments'] as $attachment):?>
								<li style="display:none">
									...
									<a data-magnify="gallery" data-src="" data-caption="Other_Attachments" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
      								<img src="<?php echo URLCustomer.$attachment['file_path'];?>" alt="" width="300" >
        							</a>
