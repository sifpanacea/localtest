        ...
        <div class="container-fluid">
           <div class="row clearfix">
            ...
            <!-- #END# Exportable Table -->
               <form style="display: hidden" action="<?php echo URL; ?>bc_welfare_mgmt/get_schools_by_symptom_for_requests" method="POST" id="symptom_list_from">
            ...
            <form style="display: hidden" action="<?php echo URL; ?>bc_welfare_mgmt/get_students_by_requests_symptom" method="POST" id="symptom_students_list">
