	...
	function display_data_table(result){
		if(result.length > 0){
			...
			$.each(result, function() {
				...
				data_table = data_table + '<td><a class="btn btn-primary btn-xs" href="'+urlLink+'bc_welfare_mgmt/bc_welfare_reports_display_ehr_uid/?id = '+this.doc_data.widget_data["page1"]['Personal Information']['Hospital Unique ID']+'">Show EHR</a></td>';
