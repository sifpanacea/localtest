...
<div class="row">
				...
				<article class="col-sm-12">
					...
					<div class="alert alert-danger fade in">
						...
						<center>
						 <strong><?php echo $normal_sym; ?></strong>
				...
				<!-- WIDGET END -->
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<header>
							...
							<h2> Normal students on Month Wise <span class="badge bg-color-greenLight"><?php if(!empty($student_list)) {?><?php echo count($student_list);?><?php } else {?><?php echo "0";?><?php }?></span></h2>
