                    ...
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                            ...
                            <tr>     
                                ...
                                <td><?php echo $doc['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['month'] ;?></td>
                                <td><span class="badge badge-warning" style="background-color:red"><?php echo $doc['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['bmi'] ;?></span></td>
                             
                                <td> 
                                    <a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/bc_welfare_reports_display_ehr_uid/"?>? id = <?php echo $doc['doc_data']['widget_data']["page1"]['Student Details']['Hospital Unique ID'];?>'>
