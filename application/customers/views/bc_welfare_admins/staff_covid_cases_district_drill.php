  ...
  <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">                      
                      ...
                      <div class="row">  
                        ...
                        <div class="col-sm-4">
                                 <h3 class="font-bold col-green">Staff Covid Cases Districts Wise Information</h3>
                        </div>
              ...
              <tr>    
                <td><?php echo $doc['doc_data']['staff_name'] ;?></td>
                ...
                <td><?php echo $doc['doc_data']['follow_up_status'] ;?></td> 
                <td><?php echo $doc['doc_data']['call_received_date'] ;?></td>
                <td><?php echo $doc['doc_data']['call_receiver'] ;?></td>
                <td><?php echo $doc['doc_data']['doctors_spoken'] ;?></td>              
              </tr>
              <?php endforeach;?>
            </tbody>
                    </table>
  ...
  $('#set_date').change(function(e){
        ...
        $('#filter_search').click(function(){
            ...
            var district_name  = $('#select_dt_name').val(); 
                ...
                $.ajax({
                    url : 'get_staff_covid_cases_data_based_on_span',
                    type : 'POST',
  ...
  function data_table_for_filters(result){
   ...
   if(result == "No Data Available"){
          $('#sanitation_filters').html('<h4>No Data Available ......</h4>');
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>Staff Name</th><th>Designation</th><th>District</th><th>Contact Number</th><th>School Name</th><th>Follow Up Status</th><th>Call Received Date</th><th>Call Received By</th><th>Dr.Spoken</th></tr></thead><tbody>';
              ...
              data_table = data_table+'<td>'+this.doc_data['staff_name']+'</td>';
              ...
              data_table = data_table+'<td>'+this.doc_data['follow_up_status']+'</td>';
              data_table = data_table+'<td>'+this.doc_data['call_received_date']+'</td>';
              data_table = data_table+'<td>'+this.doc_data['call_receiver']+'</td>';
              data_table = data_table+'<td>'+this.doc_data['doctors_spoken']+'</td>';
