					...
					<div class="row clearfix">
						<div class="col-sm-4">
							<select id="collection_name" class="form-control">
								<option value="bcwelfare_screening_report_col_2021-2022">Academic Year 2021-22</option>
								<option value="bcwelfare_screening_report_col_2020-2021">Academic Year 2020-21</option>
								<option value="healthcare201812217594045">Academic Year 2019-20</option>
							</select>
						</div>
                        <div class="col-sm-4">
...
$(document).ready(function() {
	...
	function display_data_table(result){
		if(result.length > 0){
			data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic">  <thead> <tr> <th>STUDENT NAME</th><th>HOSPITAL UNIQUE ID</th><th>FATHER NAME</th> <th>STUDENT SCHOOL</th><th>DISTRICT</th><th>DATE OF BIRTH</th> <th>CLASS</th><th>SECTION</th><th>MOBILE</th><th>Photo</th><th>Action</th></tr> </thead> <tbody>';
			...
			$.each(result, function() {
				...
				data_table = data_table + '<td><a class="btn bg-blue waves-effect" href="'+urlLink+'bc_welfare_mgmt/bc_welfare_reports_display_ehr_uid/?id = '+this.doc_data.widget_data["page1"]['Personal Information']['Hospital Unique ID']+'">Show EHR</a></td>';
