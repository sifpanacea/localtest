            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="info-box-3 bg-grey hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <a href="" class="badge bg-red status_blink">Today Followup cases :<span class="badge" style="padding: 8px;">0</span></a>
                    </div>
                </div>
            </div>
        </div>
                         ...
                         <div class="body"  style="height: 300px;">
                            <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <!-- <div class="form-group"> -->
                                            <div class="form-line">
                                                ...
                                                <textarea readonly=""><?php echo $pic['discription']; ?></textarea>
                                            </div>
                                       <!--  </div> -->
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <button type="button" style="width: 70%;" class="btn bg-pink waves-effect">Show EHR</button>
                                    </a> 
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="card">
            <div class="header" style="padding: 10px">
                ...
                <input type="radio" name="gender_wise_pie_radio" id="hb_gender_wise_pie" value="hb_gender_wise_pie" class="with-gap radio-col-pink" checked/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="card">
            ...
            <div class="body">
                ...
                <div id="attendance_pie" style="display: none;height: 250px;" class="graph"></div>
            </div>
...
function show_daily_hospitalized_bar(data)
{
    ...
    //var government_hospital = data.government_hospital;
    //var private_hospital = data.private_hospital;
