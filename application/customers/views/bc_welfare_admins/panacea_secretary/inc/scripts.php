		...
		<script src="<?php echo(JS.'adminheader.js');?>" type="text/javascript"></script>
		<script src="<?php echo(JS.'deletepart.js');?>" type="text/javascript"></script>
		<script src="<?php echo(JS.'popImg.js');?>" type="text/javascript"></script>
