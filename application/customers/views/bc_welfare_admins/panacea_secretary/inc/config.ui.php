...
"pa school pie" => array(
		"title" => 'School Status Pies',
		"icon" => "fa-th-large",
		"class" => "menu-links",
		"sub" => array(
				"scabies_pie" => array(
						"title" => "Scabies Pie",
						"url" => URL."panacea_mgmt/get_scabies_schools_health_status",
						"icon" => "fa-heart",
						"class" => "menu-links"
				),
				"abnormal_pie" => array(
						"title" => "Abdominal Pie",
						"url" => URL."panacea_mgmt/get_abnormal_disease_health_status",
						"icon" => "fa-heart",
						"class" => "menu-links"
				),
				...
				"bites_pie" => array(
				        "title" => "Bites PIE",
				        "url" => URL."panacea_mgmt/get_unknown_bites_health_status",
				        "icon" => "fa-heart",
				        "class" => "menu-links"
				),
				...
				"hb_pie" => array(
				        "title" => "HB Status PIE",
				        "url" => URL."panacea_mgmt/get_hb_school_health_status",
				        "icon" => "fa-heart",
				        "class" => "menu-links"
				),
				"bmi_pie" => array(
				        "title" => "BMI Status PIE",
				        "url" => URL."panacea_mgmt/get_bmi_school_health_status",
				        "icon" => "fa-heart",
				        "class" => "menu-links"
				),
