			...
			<li>
						...
						<li>
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									echo "<br>";
									echo "Last updated by: ".$last_stage['submitted_by'];
									?></i></td>
									</tr>
								...
								<li style="display:none">
									...
									<center>
											...
											<a data-magnify="gallery" data-src="" data-caption="Prescriptions" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
												<embed src="<?php echo URLCustomer.$attachment['file_path'];?>" alt="" width="300"/>
											</a>
										</center>
									</div>
								</li>
						...
						<ul>
							<li style="">
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<embed src="<?php echo URLCustomer.$doc['doc_data']['widget_data']['page1']['Personal Information']['Photo']['file_path'];?>" height="125" width="100"/>
									</a>
									<?php else: ?>
					...
					<li>
						...
						<?php foreach ($doc['doc_data']['ocular_diagnosis_attachments'] as $attachment):?>
							<li style="display:none">
								...
								<center>
										<p>Attachment</p>
									<a data-magnify="gallery" data-src="" data-caption="Ocular Diagnosis Attachments" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
				...
				<li>
					...
					<!-- end widget -->
						...
						<!-- ==================================================== -->
					<?php if(isset($BMI_values_report) && !is_null($BMI_report) && !empty($BMI_report)):?>
					<li>
...
$("#submit_print_request").click(function(){
    ...
    var url_parts = window.location.href.split('/');
    console.log(url_parts,'urlllllllllllllllllllllll');
    $.ajax({
