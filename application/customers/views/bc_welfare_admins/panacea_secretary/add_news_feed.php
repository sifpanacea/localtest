            ...
            <div class="card">
				<div class="header">
					...
					<?php 
						...
						echo form_open_multipart((isset($news_feed)? 'panacea_mgmt/update_news_feed' : 'panacea_mgmt/add_news_feed'),$attributes);
					?>
				...
				<div class="body">
                    ...
                    <div class="form-line">
                        ...
                        <input type="text" id="set_date" name="set_date" class="datepicker form-control date set_date" value="<?php echo date('yy-m-d'); ?>" required>
