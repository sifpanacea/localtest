...
$page_title = "Schools Abnormal Status";
...
function draw_request_pie(){
    if(request_data == 1){
        ...
        request_navigation.push("Abnormal Diseases Health Status PIE");
...
$(".student_type").each(function(){
    ...
    $.ajax({
        url : "get_abnormal_disease_students_values",
        method : "POST",
