...
$page_title = "Scabies Schools Status";
...
function draw_request_pie(){
    if(request_data == 1){
        ...
        request_navigation.push("Scabies Health Status PIE");
...
$(".student_type").each(function(){
    ...
    $.ajax({
        url : "get_school_health_students_values",
        method : "POST",
...
function drill_down_chronic_issues_school_level(pie_data){
    ...
    $(document).on('click', 'button[data-id]', function (e)
    {
        ...
        var table="";
        var tr="";
        table += "<table class='table table-bordered'><thead><tr><th> <center><b> Actual Criteria </b></center></th></tr></thead><th> Total Students </th><tbody>";
        
        table += "<tr><td>"+finalStatus+"<br></td></tr>"
        //table += "<tr><td>"school_count"<br></td></tr>"
        table += "</tbody></table>";
