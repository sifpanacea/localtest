                ...
                <div class="body">
                    <div class="row clearfix">
                        <div class="col-sm-4">
                            <div class="form-line">
                              <label>Date</label>
                              <input type="text" id="set_date" name="set_date" class="datepicker form-control" placeholder="Please choose a date..." value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
                        <div class="col-sm-4">
                      ...
                      <button type="submit" class="btn bg-blue waves-effect" id="request_pie_btn" data-toggle="modal" data-target="#load_waiting" data-backdrop="static" data-keyboard="false">SET</button>
