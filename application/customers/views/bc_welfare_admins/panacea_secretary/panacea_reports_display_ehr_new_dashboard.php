...
<!-- widget content -->
	...
	<div class="tree smart-form">
			...
			<li>
				...
				<ul>
					...
					<li>
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<td><?php if(isset($identifiers_normal) && !empty($identifiers_normal)) : 
										   foreach ($identifiers_normal as $identifier => $values) :?>
											...
											<?php if(isset($identifiers_emergency) && !empty($identifiers_emergency)) : 
										...
										<?php  endif; endforeach; endif;?>
										<?php if(isset($identifiers_chronic) && !empty($identifiers_chronic)) : 
									...
									<?php endif; endforeach; endif;?></td>
									<?php else :?>
														<td><i class="icon-leaf"><?php echo (gettype($request['doc_data']['widget_data']['page1']['Problem Info']['Identifier'])=="array")? implode (", ",$request['doc_data']['widget_data']['page1']['Problem Info']['Identifier']) : $request['doc_data']['widget_data']['page1']['Problem Info']['Identifier'];?></i></td>
														<?php endif;?>					
						...
						<?php endif ?>	<!-- <?php //echo '<pre>';echo print_r($request,true); echo '</pre>';?> -->

						<?php if(isset($request['doc_data']['Prescriptions']) && !is_null($request['doc_data']['Prescriptions']) && !empty($request['doc_data']['Prescriptions'])):?>
						<li>
							<span><i class="fa fa-lg fa-plus-circle"></i> Prescriptions <span class="badge bg-color-greenLight">
							...
							<?php foreach ($request['doc_data']['Prescriptions'] as $attachment):?>
								<li style="display:none">
									...
									<center>
											<p>Attachment</p>
											<!-- <a href="<?php //echo URLCustomer.$attachment['file_path'];?>" rel="prettyPhoto[pp_gal]">
																					<img  src="<?php //echo URLCustomer.$attachment['file_path'];?>" width="300"/> -->
						...
						<li>
							<span><i class="fa fa-lg fa-plus-circle"></i> Lab_Reports <span class="badge bg-color-greenLight">
		...
		<?php if(isset($request['doc_data']['special_diet_pics']) && !is_null($request['doc_data']['special_diet_pics']) && !empty($request['doc_data']['special_diet_pics'])):?>

						<li>
							<span><i class="fa fa-lg fa-plus-circle"></i> Special Diet <span class="badge bg-color-greenLight">
								<?php echo (isset($request['doc_data']["special_diet_pics"])? count($request['doc_data']["special_diet_pics"]) : "0"); ?> </span></span>
							<ul>
							<?php foreach ($request['doc_data']['special_diet_pics'] as $attachment):?>
								<li style="display:none">
									<div class="well well-sm">
									<center>
											<p>Attachment</p>
							<a data-magnify="gallery" data-src="" data-caption="Special Diet Pics" data-group="a" href="<?php echo URLCustomer.$attachment['file_path'];?>">
      						<img src="<?php echo URLCustomer.$attachment['file_path'];?>" alt="" width="300" >
        							</a>
										</center>
									</div>
						...
						<?php if(isset($docs_requests) && !is_null($docs_requests) && !empty($docs_requests)):?>
                            <li>
							<span class="label label-warning"><i class="fa fa-lg fa-folder-open"></i> 
                    <?php 
                    echo "Requests Notes"; ?></span>
							<ul>
							<div class="widget-body widget-hide-overflow">
								<!-- content goes here -->
									<?php foreach ($docs_requests as $request): ?>
									<?php if(isset($request['Follow_Up']) && !empty($request['Follow_Up'])):  ?>
									<div class="well well-sm ">
                                	<table id="dt_basic" class="table table-bordered table-hover table-striped">
                                		
		                                    <thead>
			                                    <th><b>Data</b></th>
			                                    <th><b>Medicine Details</b></th>
			                                    <th><b>Description Notes</b></th>                                    
		                                    </thead>
                                			<tbody>
											        <?php foreach($request['Follow_Up'] as $note): ?>
                                   					<tr> 		
					                                    <td><?php echo $note['created_time'];?></td>
					                                    <td><?php echo $note['medicine_details'];?></td>
					                                    <td><?php echo $note['followup_desc'];?></td>                                                                
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                    </table>
				...
				<li>
					...
					<?php endif;?><!--isset($doc["doc_data"]["widget_data"]["page6"]["Without Glasses"]) &&-->
					<?php if(isset($doc["doc_data"]["widget_data"]["page6"]["With Glasses"]) && isset($doc['doc_data']['widget_data']['page7']['Colour Blindness'])):?>
						...
						<li style="display:none">
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
				                     <tbody>
									<tr>
										<th rowspan="2"><!--Without Glasses--> Presenting Vision </th><th>Right</th><td><i class="icon-leaf"><?php echo (isset($doc['doc_data']['widget_data']['page6']['Without Glasses']['Right'])) ? $doc['doc_data']['widget_data']['page6']['Without Glasses']['Right'] : ""?></i></td><th rowspan="2">With Glasses</th><th>Right</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page6']['With Glasses']['Right'];?></i></td>
									</tr>
									<tr>
										<th>Left</th><td><i class="icon-leaf"><?php echo(isset($doc['doc_data']['widget_data']['page6']['Without Glasses']['Left'])) ? $doc['doc_data']['widget_data']['page6']['Without Glasses']['Left'] : "" ; ?></i></td><th>Left</th><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page6']['With Glasses']['Left'];?></i></td>
									</tr>
									<tr>
										<th>Colour Blindness</th><!--<th>Right</th>--><td><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Right'];?></i></td><th>Description</th><td colspan="2"><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Description'];?></i></td>
									</tr>
									<tr>
										<!--<th>Left</th><td><i class="icon-leaf"><?php// echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Left'];?></i></td>-->
										<th rowspan="2">Slit Lamp Examination</th><th>Conjunctiva</th><td><i class="icon-leaf"><?php echo (isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Conjunctiva'])) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Conjunctiva'] : "" ;?></i></td><th>Eye Lids</th><td><i class="icon-leaf"><?php echo (isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Eye Lids'])) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Eye Lids'] : "" ;?></i></td>
									</tr>									
									<tr>
										<th>Cornea</th><td><i class="icon-leaf"><?php echo (isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Cornea'])) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Cornea'] : "" ;?></i></td>
										<th>Pupil</th><td><i class="icon-leaf"><?php echo (isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Pupil'])) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Pupil'] : "" ;?></i></td>
									</tr>
									<tr>										
										<th>Complaints</th><td><i class="icon-leaf"><?php echo (isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Complaints'])) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Complaints'] : "" ;?></i></td>
										<th colspan="2">Wearing Spectacles</th><td><i class="icon-leaf"><?php echo (isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Wearing Spectacles'])) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Wearing Spectacles'] : "" ;?></i></td>
									</tr>
									<tr>	
										<th>Subjective Refraction</th><td><i class="icon-leaf"><?php echo (isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Subjective Refraction'])) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Subjective Refraction'] : "" ;?></i></td>
										<th colspan="2">Ocular Diagnosis</th><td><i class="icon-leaf"><?php echo (isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Ocular Diagnosis'])) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Ocular Diagnosis'] : "" ;?></i></td>
									</tr>
									<tr>	
										
										<th>Referral Made</th><td><i class="icon-leaf"><?php echo (gettype($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Referral Made'])=="array")? implode (", ",$doc['doc_data']['widget_data']['page7']['Colour Blindness']['Referral Made']) : $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Referral Made'];?></i></td>
									</tr>
									<tr>
							...
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<th>Root Canal Treatment</th><td><i class="icon-leaf"><?php echo (isset( $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Root Canal Treatment'])) ? $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Root Canal Treatment'] : "";?></i></td>
									</tr>
									<tr>
										<th>CROWNS</th><td><i class="icon-leaf"><?php echo (isset( $doc['doc_data']['widget_data']['page9']['Dental Check-up']['CROWNS'])) ? $doc['doc_data']['widget_data']['page9']['Dental Check-up']['CROWNS'] : "";?></i></td>
										<th>Fixed Partial Denture</th><td><i class="icon-leaf"><?php echo (isset( $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Fixed Partial Denture'])) ? $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Fixed Partial Denture'] : "";?></i></td>
									</tr>
									<tr>
										<th>Curettage</th><td><i class="icon-leaf"><?php echo (isset( $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Curettage'])) ? $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Curettage'] : "";?></i></td>
										<th>Estimated Amount</th><td><i class="icon-leaf"><?php echo (isset( $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Estimated Amount'])) ? $doc['doc_data']['widget_data']['page9']['Dental Check-up']['Estimated Amount'] : "";?></i></td>
					...
					<?php if(isset($doc['doc_data']['subjective_refraction_attachments']) && !is_null($doc['doc_data']['subjective_refraction_attachments']) && !empty($doc['doc_data']['subjective_refraction_attachments'])):?>
					<li>
						<span><i class="fa fa-lg fa-plus-circle"></i> Subjective Refraction Attachments</span>
						<ul>
						<?php foreach ($doc['doc_data']['subjective_refraction_attachments'] as $attachment):?>
							<li style="display:none">
								<div class="well well-sm ">
								<center>
										<p>Attachment</p>
					...
					<?php endif ?>
					<?php if(isset($doc['doc_data']['ocular_diagnosis_attachments']) && !is_null($doc['doc_data']['ocular_diagnosis_attachments']) && !empty($doc['doc_data']['ocular_diagnosis_attachments'])):?>
					<li>
						<span><i class="fa fa-lg fa-plus-circle"></i> Ocular Diagnosis Attachments</span>
						<ul>
						<?php foreach ($doc['doc_data']['ocular_diagnosis_attachments'] as $attachment):?>
							<li style="display:none">
								<div class="well well-sm ">
								<center>
										<p>Attachment</p>
				...
				<!--============================================================================== --><!--============== Field officer report start  ================= -->

					<?php if(isset($fo_officer_report) && count($fo_officer_report) > 0):?>
                <li>
                    <span class="label label-success"><i class="fa fa-lg fa-plus-circle"></i> Field Officer Report <span class="badge bg-color-red "> <?php echo count($fo_officer_report)?> </span></span> 
                    <ul>
                  <?php foreach ($fo_officer_report as $fo_request):?>
                    
                  
                    <li style="display:none">
                    <span class="label label-warning"><i class="fa fa-lg fa-minus-circle"></i>                  
                    
                     <?php $last_stage = end($fo_request['history']); 
                   
                    $newformat = new DateTime($fo_request['history']['last_stage']['time']);
                    ...
                    $newformat->setTimezone($tz);
                    //echo $dt->format('Y-m-d H:i:s');
                    echo "Field Officer Raised on: ".$newformat->format('Y-m-d H:i:s'). "<strong> <i class='fa fa-lg fa-hand-o-left'></i> Time listed as per IST.</strong>";
                    ?></span>
                    <ul>                        
                        <li>
                            <div class="well well-sm ">
                                <table id="dt_basic" class="table table-striped table-bordered table-hover">
                                    <tbody>
                                    	  <?php if($fo_request['doc_data']['widget_data']['type_of_request'] == 'Out Patients'): ?> 
                                        <tr>   																	
                                            <th>Request Type</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['type_of_request'];?></i></td>
                                        </tr>
                               				   <tr>								
                                                    <th>Hospital Name</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Out Patient']['hospialt_name'];?></i></td>
                                                </tr>
                                                 <tr>
                                                         <th>Doctor's Name</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Out Patient']['doctor_name'];?></i></td>
                                                        </tr>
                                                        <tr>				
                                                            <th>Case Details</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Out Patient']['patient_details'];?></i></td>
                                                        </tr>
                                                        <tr>                  
                                                            <th>Investigation</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Out Patient']['investigations'];?></i></td>
                                                        </tr>
                                                        <tr>								
                                                            <th>Medication</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Out Patient']['medication'];?></i></td>
                                                        </tr>
                                                        <tr>              
                                                            <th>Review Date</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Out Patient']['review_date'];?></i></td>
                                                        </tr>    
                                         <?php endif;?> 
                                    <!-- EMergency -->
                                    	     	  <?php if($fo_request['doc_data']['widget_data']['type_of_request'] == 'Emergency or Admitted'): ?> 
                                    	         <tr>   																	
                                    	             <th>Request Type</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['type_of_request'];?></i></td>
                                    	         </tr>
                                    					   <tr>								
                                    	                     <th>Hospital Name</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Emergency or Admitted']['hospialt_name'];?></i></td>
                                    	                 </tr>
                                    	                  <tr>
                                    	                          <th>Doctor's Name</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Emergency or Admitted']['doctor_name'];?></i></td>
                                    	                         </tr>
                                    	                         <tr>				
                                    	                             <th>Case Details</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Emergency or Admitted']['patient_details'];?></i></td>
                                    	                         </tr>
                                    	                         <tr>                  
                                    	                             <th>Investigation</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Emergency or Admitted']['investigations'];?></i></td>
                                    	                         </tr>
                                    	                         <tr>		
                                    	                             <th>DR.. Advice</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Emergency or Admitted']['Doctor Advice'];?></i></td>
                                    	                         </tr>
                                    	                         <tr>								
                                    	                             <th>Medication</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Emergency or Admitted']['medication'];?></i></td>
                                    	                         </tr>
                                    	                         <tr>              
                                    	                             <th>Review Date</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Emergency or Admitted']['review_date'];?></i></td>
                                    	                         </tr>    
                                    	          <?php endif;?>                                 
                                    <!-- End EMergency -->  
                                     <!-- Review Cases -->
                                    	     	  <?php if($fo_request['doc_data']['widget_data']['type_of_request'] == 'Review Cases'): ?> 
                                    	         <tr>   																	
                                    	             <th>Request Type</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['type_of_request'];?></i></td>
                                    	         </tr>
                                    					   <tr>								
                                    	                     <th>Hospital Name</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Review Cases']['hospialt_name'];?></i></td>
                                    	                 </tr>
                                    	                  <tr>
                                    	                          <th>Doctor's Name</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Review Cases']['doctor_name'];?></i></td>
                                    	                         </tr>
                                    	                         <tr>				
                                    	                             <th>Case Details</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Review Cases']['patient_details'];?></i></td>
                                    	                         </tr>
                                    	                         <tr>                  
                                    	                             <th>Investigation</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Review Cases']['investigations'];?></i></td>
                                    	                         </tr>
                                    	                         <tr>								
                                    	                             <th>Medication</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Review Cases']['medication'];?></i></td>
                                    	                         </tr>
                                    	                         <tr>              
                                    	                             <th>Review Date</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Review Cases']['review_date'];?></i></td>
                                    	                         </tr>   
                                    	                         <tr>              
                                    	                             <th>Case Closed</th><td><i class="icon-leaf"><?php echo $fo_request['doc_data']['widget_data']['Review Cases']['review_caseclose'];?></i></td>
                                    	                         </tr>
                                    	          <?php endif;?>                                 
                                    <!-- End Review cases -->                            
                                    </tbody>
...
$("#submit_print_request").click(function(){
    ...
    $.ajax({
        url    : 'https://mednote.in/PaaS/healthcare/index.php/panacea_mgmt/init_health_summary_report_process',
        type   : 'POST',
