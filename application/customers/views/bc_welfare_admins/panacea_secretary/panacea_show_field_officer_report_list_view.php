...
$page_title = "Field Officer Reports";
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<!-- widget div-->
							<h2><?php echo $field_officer_requests; ?>&nbsp;&nbsp;&nbsp;<span class="badge bg-color-greenLight"><?php if(!empty($get_field_officer_docs)) {?><?php echo count($get_field_officer_docs);?><?php } else {?><?php echo "0";?><?php }?></span></h2>
					...
					<tr>
						...
						<th>School Name</th> -->
						<th>Action</th>
						<?php if($field_officer_requests != "Doctor Visits"): ?>
						<th>Hospital Name</th>
						<?php endif; ?>	
						<th>Submitted By</th>
						<th>FO Submitted Time</th>
						<th>Action</th>
					</tr>
					</thead>
					<tbody>
					<?php foreach ($get_field_officer_docs as $req):?>
					<tr>
						<td><?php echo $req['doc_data']['widget_data']['Student Details']['Hospital Unique ID'];?></td>
						<td><?php echo $req['doc_data']['widget_data']['Student Details']['Name'];?></td>
						<td><?php echo $req['doc_data']['widget_data']['Student Details']['Class'];?></td>
						<td><?php echo $req['doc_data']['widget_data']['Student Details']['Section'];?></td>						
						<!-- <td><?php //echo $req['doc_data']['widget_data']['page1']['Student Info']['District']['field_ref'];?></td>
						<td><?php //echo $req['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref'];?></td> -->
						<?php if($field_officer_requests == "Doctor Visits"): ?>
						<td><a href="<?php echo URL.'panacea_mgmt/show_doctor_treated_student/'.$req['doc_properties']['doc_id']; ?>" class="btn bg-color-greenDark txt-color-white btn-xs">Show Doctor Visiting Report</a></td>
						<?php else: ?>
							<td><a href="<?php echo URL.'panacea_mgmt/show_field_officer_student/'.$req['doc_properties']['doc_id']; ?>" class="btn bg-color-greenDark txt-color-white btn-xs">Show Field Officer Report</a></td>
						<?php endif; ?>	
						
						<?php if($field_officer_requests != "Doctor Visits"): ?>
						<td>
							<?php if($req['doc_data']['widget_data']['type_of_request'] == "Out Patients"): ?>
							<?php echo $req['doc_data']['widget_data']['Out Patient']['hospialt_name'];?>
								<?php elseif($req['doc_data']['widget_data']['type_of_request'] == "Emergency or Admitted"):?>
								<?php echo $req['doc_data']['widget_data']['Emergency or Admitted']['hospialt_name'];?>	
								<?php elseif($req['doc_data']['widget_data']['type_of_request'] == "Review Cases"):?>
								<?php echo $req['doc_data']['widget_data']['Review Cases']['hospialt_name'];?>
							<?php endif; ?>
						</td>
						<?php endif; ?>	

						<td>
						<?php if(!empty($req['history']['last_stage']['submitted_name'])):  ?>
						 <?php echo $req['history']['last_stage']['submitted_name'];?>
						 	<?php endif; ?>
						 </td>	

							<td><?php echo $req['history']['last_stage']['time'];?></td>
													<!-- <td>NA</td> -->
												
						<td> <a class='ldelete' href='<?php echo URL."panacea_mgmt/panacea_reports_display_ehr_uid/"?>? id = <?php echo $req['doc_data']['widget_data']['Student Details']['Hospital Unique ID'];?>'>
