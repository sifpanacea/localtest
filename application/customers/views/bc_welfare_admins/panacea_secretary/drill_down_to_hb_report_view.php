						...
						<div>
							...
							<h5 class="alert alert-info"> <?php echo ucwords($navigation) ;?> </h5>
								...
								<?php	//echo print_r($get_bmi_docs, true); ?>
									<?php if(!empty($get_bmi_docs)): ?>
										<?php foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
							...
							<tr>
								...
								<td><a class='delete1' href='<?php echo URL."panacea_mgmt/show_student_hb_graph/".$get_doc['student_info']['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
