...
<head>
    ...
    <title>BC WELFARE School Health Program</title>
    <!-- Favicon-->
...
<body class="theme-green">
    ...
    echo  form_open('bc_welfare_mgmt/get_entered_related_data',$attributes);
    ?>
            ...
            <div class="navbar-header">
             <a href="javascript:void(0);" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false"></a>
                <div>
                    ...
                    <img class="pull-left"  style="height: 62px; margin-top: -6px;border-radius: 60px;" src="<?php echo IMG; ?>/MJPT Logo copy.jpg" alt="" title="" /> 
                   <img class="pull-left" style="height:58px;margin-left: 4px; margin-top: -5px;width:60px; border-radius: 50px; " src="<?php echo IMG; ?>/Panacea_LOGO_Final.jpg" alt="">
                ...
                <div class="col-sm-offset-6">
                	<a class="navbar-brand" href="#" style="margin-left: 300px"> BC WELFARE SCHOOL HEALTH PROGRAM</a>
                </div>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li style="padding-top: 18px"><button class="btn btn-default" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"  data-placement="bottom" title="Academic Year Filters"><img src="<?php echo IMG ;?>/funnel.png"></button></li>
                     ...
                     <li <?php if($current_page == 'blood_group_wise_search') { echo 'class="active"';} ?>>
                        <a href="<?php echo URL."bc_welfare_mgmt/panacea_blood_group_pie"?>" data-toggle="tooltip" data-placement="bottom" title="Blood Donor Data" data-original-title="Search Blodd Group wise">
                            <i class="material-icons">bloodtype</i>
                        </a>
                    </li>

                    <li <?php if($current_page == 'Gender_wise_search') { echo 'class="active"';} ?>>
                        <a href="<?php echo URL."bc_welfare_mgmt/gender_wise_student_data"?>" data-toggle="tooltip" data-placement="bottom" title="Gender Wise Search" data-original-title="Search Gender wise">
                            <i class="material-icons">grid_on</i>
                        </a>
                    </li>

                    <li <?php if($current_page == 'maximum_raised_requests') { echo 'class="active"';} ?>>
                        <a href="<?php echo URL."bc_welfare_mgmt/maximum_raised_requests"?>" data-toggle="tooltip" data-placement="bottom" title="Maximum Raised Requests" data-original-title="Maximum Raised Requests">
