	<!-- RIBBON -->
	<div id="ribbon" style="margin-top: 95px;">
		...
		<ol class="breadcrumb">
			<?php
				foreach ($breadcrumbs as $display => $url) {
					$breadcrumb = $url != "" ? '<a class="menu-links" href="'.$url.'bc_welfare_mgmt/to_dashboard">'.$display.'</a>' : $display;
		...
		<a class="partner_info" href="http://www.sifhyd.org" target="_blank"><font color="">Knowledge & Implementation Partner</font></a>
		<span id="" class="hide">
