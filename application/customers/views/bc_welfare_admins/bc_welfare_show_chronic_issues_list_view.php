...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<!-- widget div-->
							<h2 class="text-primary">Chornic Case: <?php echo $chronic_case_type; ?> <span class="badge bg-color-red"><?php if(!empty($get_chronic_docs)) {?><?php echo count($get_chronic_docs);?><?php } else {?><?php echo "0";?><?php }?></span></h2>
					...
					<tr>
						...
						<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['District']['field_ref'];?></td>
						<td><?php echo $chronic['doc_data']['widget_data']['page1']['Student Info']['School Name']['field_ref'];?></td>
						<?php if($chronic_case_type == "HIV" ): ?> 
							<td> <a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/bc_welfare_reports_display_ehr_uid/"?>? id = <?php echo $chronic['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>' onclick="return false;">
						                			<button class="btn btn-primary btn-xs" disabled="disabled">Show EHR</button>
						         </a>			
							</td>
						<?php else: ?>
							<td> <a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/bc_welfare_reports_display_ehr_uid/"?>? id = <?php echo $chronic['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'><button class="btn btn-primary btn-xs">Show EHR</button>
						        </a> 			
							</td>
						<?php endif; ?>
					</tr>	
