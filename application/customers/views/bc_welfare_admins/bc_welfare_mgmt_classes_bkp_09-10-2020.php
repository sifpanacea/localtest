...
$page_nav["pa mgmt"]["sub"]["classes"]["active"] = true;
include("inc/nav.php");
...
<div>
	...
	echo  form_open('bc_welfare_mgmt/create_class',$attributes);
	?>
		<!--<form class="smart-form">-->
			...
			<section class="col col-12">
				<label class="label" for="first_name">Class Name</label>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><?php //echo anchor("bc_welfare_mgmt/bc_welfare_mgmt_manage_class/".$class['_id'], lang('app_edit')) ;?>
						
						<a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/bc_welfare_mgmt_delete_class/".$class['_id'];?>'>
