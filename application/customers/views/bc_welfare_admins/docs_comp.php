...
$page_title = "Health Supervisors Import";
...
<div id="main" role="main">
	<?php
		...
		$breadcrumbs["BC Welfare Docs Comp"] = "";
       ...
       <article class="col-sm-12 col-md-12 col-lg-6">
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
						...
						<header>
							...
							<h2>Document Compare and Delete </h2>
		                </header>
						...
						<div>
							...
							<!-- widget content -->
											...
											echo form_open_multipart('bc_welfare_mgmt/docs_comp',$attributes);?>
											<div class="panel-body">
												<fieldset>
                                    				<section >
														<p>To compare document past the array of Unique ID in text box.
														</p>
                                                    </section>
                                              	
                                              	
                                              	<section>
													<label class="label">Hospital Unique ID</label>
													<label class="textarea textarea-resizable"> 										
														<textarea rows="3" class="custom-scroll" id="docs_arr" name="docs_arr"></textarea> 
													</label>
													<div class="note">
														<strong>Example: </strong> MBNR_61412_1564,KMNR_52005_1397,NLG_62302_1422
													</div>
												</section>
