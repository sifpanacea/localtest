   ...
   $('#date_set').click(function(){
    ...
    function data_table_for_filters(result){
      ...
      if(result == "No Data Available"){
          $('#students_more_req').html('<h4>No Data Available For this Field Officer.</h4>');
      }
        else{

            data_table = '<table class="table table-striped table-bordered" id="datatable_fixed_column"><thead><tr><th>Health ID</th><th>Name</th><th>Class</th><th>School Name</th><th>Date of Submit</th><th>Remarks</th><th>Action</th></tr></thead><tbody>';
