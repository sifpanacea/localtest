									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												...
												<!-- <td><?php //echo $student['doc_data']['widget_data']["page2"]['Student Info']['AD No'] ;?></td> -->
												...
												<td><a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/drill_down_screening_to_students_load_ehr_doc/".$student['doc_data']['widget_data']["page1"]['Student Info']['Unique ID'];?>'>
