...
<div class="row">
				...
				<article class="col-sm-12">
					...
					<div class="alert alert-danger fade in">
						...
						<center>
						<strong><?php echo $emergency_sym; ?></strong>
				...
				<!-- WIDGET END -->
					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-0" data-widget-editbutton="false">
						...
						<header>
							...
							<h2> Emergency students on Month Wise <span class="badge bg-color-greenLight"><?php if(!empty($student_list)) {?><?php echo count($student_list);?><?php } else {?><?php echo "0";?><?php }?></span></h2>
					...
					<?php foreach ($student_list as $student):?>
						<tr>
                   		...
                   		<td><a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/bc_welfare_reports_display_ehr_uid/"?>? id = <?php echo $student['doc_data']['widget_data']["page1"]['Student Info']
                   		['Unique ID'];?>'>
