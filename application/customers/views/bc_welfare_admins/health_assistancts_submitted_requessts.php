                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                      <div class="header">
                          <div class="row clearfix">
                              <div class="col-sm-3">
                                 <h3 class="font-bold col-green">Health Assistants Submitted Requests</h3>
                              </div>
                              <div class="collapse" id="multicollapseExample">
                                  ...
                                  <?php $end_date  = date ( "Y-m-d", strtotime ( $today_date . "-90 days" ) ); ?>
                                    ...
                                    <div class="col-sm-2">
                                       <h2 class="card-inside-title">Select Health Assistant</h2>
                                        <div class="form-line">
                                        <select class="form-control" id="user_name" name="user_name">
                                          <?php if(isset($cc_users) && !empty($cc_users)): ?>
                                          <?php foreach($cc_users as $usernames): ?>
                                            <option value="<?php echo $usernames['email']; ?>"><?php echo $usernames['username']; ?></option>
                                          <?php endforeach; ?>
                                          <?php endif; ?>
                                         </select>
                                        </div>
            ...
            <div class="body">
                <div class="table-responsive" id="table_hide">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
							<?php foreach ($health_assis as $index => $doc ):?>
							<tr>
...
/*last_three_months_more_req_students();*/
    ...
    $('#date_set').click(function(){
            ...
            var requestsCount = $('#user_name').val();
           
           // $("#loading_modal").modal('show');
                $.ajax({
                    url : 'get_hs_submitted_records_based_on_span',
                    type : 'POST',
      ...
      if(result == "No Data Available"){
          $('#sanitation_filters').html('<h4>No Data Available For this Doctor....</h4>');
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>Health ID</th><th>Student Name</th><th>Class</th><th>School Name</th><th>Request Raised Time</th><th>Dr. Response time</th><th>Action</th></tr></thead><tbody>';
              ...
              data_table = data_table + '<td><a class="btn btn-primary btn-xs" href="'+urlLink+'bc_welfare_mgmt/bc_welfare_reports_display_ehr_uid/?id = '+this.doc_data.widget_data.page1['Student Info']['Unique ID']+'">Show EHR</a></td>';
