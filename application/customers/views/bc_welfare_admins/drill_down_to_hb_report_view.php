						...
						<div>
							...
							<h5 class="alert alert-info"> <?php echo ucwords($navigation) ;?> </h5>
								...
								<div class = "under weight " id ="under weight">
									...
									<tbody>
								<?php	//echo print_r($get_hb_docs, true);  ?>
								<?php if(!empty($get_hb_docs)): ?>
										<?php foreach ($get_hb_docs as $get_doc): //echo print_r($get_doc,true); exit;?>
												
											<tr>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?></td>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref'];?></td>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page1']['Student Details']['Class']['field_ref'];?></td>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['school_details']['School Name'];?></td>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['school_details']['District'];?></td>
												<td><?php echo $get_doc['student_info']['doc_data']['widget_data']['page1']['Student Details']['HB_latest']['hb'];?></td>
												<?php //foreach() ?>
												<?php //echo json_encode($get_doc['BMI_values']);?>
												<td><a class='delete1' href='<?php echo URL."bc_welfare_mgmt/show_student_hb_graph/".$get_doc['student_info']['doc_data']['widget_data']['page1']['Student Details']['Hospital Unique ID'];?>'>
