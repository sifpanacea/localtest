...
$page_title = "BC Welfare CC Users";
...
<div>
	...
	echo  form_open('bc_welfare_mgmt/create_cc_user',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/bc_welfare_mgmt_delete_cc_user/".$cc_user['_id'];?>'>
