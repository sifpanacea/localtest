...
<div>
	...
	echo  form_open('bc_welfare_mgmt/create_school',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><?php //echo anchor("bc_welfare_mgmt/bc_welfare_mgmt_manage_school/".$school['_id'], lang('app_edit')) ;?>
						
						<a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/bc_welfare_mgmt_delete_school/".$school['_id'];?>'>
