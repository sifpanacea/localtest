    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="body">
                ...
                <h5>Active - Institutions having all ro plants in working status</h5>
                <h5>Inactive - Institution which have incinerators but are not in working stage</h5>
                <h5>Partially Active - Institutions which have both working and not working ro plants</h5>
                <h5>Not available- Institutions which does not have ro plants</h5>
            </div>
        </div>
            </div> 
           <div class="col-lg-6 col-md-3 col-sm-12 col-xs-12">
