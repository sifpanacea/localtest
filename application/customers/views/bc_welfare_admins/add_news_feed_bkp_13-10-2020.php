					...
					<div class="jarviswidget jarviswidget-color-tlsGrey" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
						...
						<div>
							...
							<!-- widget content -->
											...
											echo form_open_multipart((isset($news_feed)? 'bc_welfare_mgmt/update_news_feed' : 'bc_welfare_mgmt/add_news_feed'),$attributes);?>
											<div class="panel-body">
												...
												<section>
													<div class='input-group date' id='datetimepicker345'>
														<input type='text' class="form-control input-group-addon" required name="time"  id="time" value="<?php echo date("Y-m-d");?>" />
