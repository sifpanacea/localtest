...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td><a href="<?php echo URL.'bc_welfare_mgmt/show_doctor_treated_student/'.$req['doc_properties']['doc_id']; ?>" class="btn bg-color-greenDark txt-color-white btn-xs">Show Field Officer Report</a></td>
						<td> <a class='ldelete' href='<?php echo URL."bc_welfare_mgmt/bc_welfare_reports_display_ehr_uid/"?>? id = <?php echo $req['doc_data']['widget_data']['Student Details']['Hospital Unique ID'];?>'>
