	...
	<div id="content">
		...
		<div id="fullpage">
				...
				<article class="col-sm-12">
					...
					<div class="jarviswidget" id="wid-id-100" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
						...
						<header>
							...
							<h2>Symptoms and Request PIE </h2>
						...
						<div class="no-padding">
							...
							<div class="widget-body">
								...
								<div class="col-xs-12 col-sm-3 col-md-4 col-lg-4 hide">
								<div class="well well-sm well-light">
			...
			<!-- end row -->
						...
						<div class="vertical-scrolling hide">
						...
						<div class="no-padding">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-3 col-md-12 col-lg-12">
									...
									<div id="pie_sanitation_dist" class="col-xs-10 col-sm-10 col-md-7 col-lg-7">
									
									</div>
									<div id="pie_sanitation_school_list" class="col-xs-12 col-sm-12 col-md-5 col-lg-5" >
