                ...
                <div class = "under weight " id ="under weight">
                  ...
                  <thead>                     
                    <tr>
                      ...
                      <th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> BMI Value</th>
                   ...
                   <tbody>
                                ...
                                <tr>
                                 ...
                                 <td class="name"><?php echo $case['doc_data']['widget_data']['page1']['Student Details']['Name']['field_ref']; ?></td>
                                  ...
                                  <td class="class"><?php echo $case['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['month'];?></td>
                                  <td>  <span class="badge badge-warning" style="background-color:red"><?php echo $case['doc_data']['widget_data']['page1']['Student Details']['BMI_latest']['bmi'];?></span></td>
                                         <form action='<?php echo URL."panacea_sanitation/panacea_reports_display_ehr_uid" ?>'accept-charset="utf-8" method="POST">
