	...
	<div id="ribbon">
		...
		<ol class="breadcrumb">
			<?php
				foreach ($breadcrumbs as $display => $url) {
					$breadcrumb = $url != "" ? '<a class="menu-links" href="'.$url.'panacea_sanitation/to_dashboard">'.$display.'</a>' : $display;
		...
		<a class="partner_info" href="http://www.sifhyd.org" target="_blank"><font color="white">Knowledge & Implementation Partner</font></a>
		<span id="" class="hide">
