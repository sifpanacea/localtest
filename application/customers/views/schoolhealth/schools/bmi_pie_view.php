				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget" id="wid-id-60" data-widget-editbutton="false">
						...
						<header>
							...
							<h2>BMI PIE</h2>
								<button type="button" class="btn bg-color-pink txt-color-white btn-sm pull-right hide" id="bmi_export_btn" data-toggle="modal" data-target="#load_waiting" data-backdrop="static" data-keyboard="false">Export to Excel</button>
						</header>
