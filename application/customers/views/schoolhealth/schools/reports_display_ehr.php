						...
						<ul>
							<li style="">
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										<th>Admission Number</th><td><i class="icon-leaf"><?php echo isset($doc['doc_data']['widget_data']['page2']['Personal Information']['AD No']) ? $doc['doc_data']['widget_data']['page2']['Personal Information']['AD No'] : "";?></i></td>
									</tr>
									<tr>
									...
									<tr>
										<th>Section</th><td colspan="2"><i class="icon-leaf"><?php echo isset($doc['doc_data']['widget_data']['page2']['Personal Information']['Section']) ? $doc['doc_data']['widget_data']['page2']['Personal Information']['Section'] : "";?></i></td>
									</tr>
									<tr>
						...
						<li style="display:none">
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<tr>
										<th rowspan="2">Colour Blindness</th><th>Right</th><td><i class="icon-leaf"><?php echo isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Right']) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Right'] : "";?></i></td><th>Description</th><td colspan="2"><i class="icon-leaf"><?php echo $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Description'];?></i></td>
									</tr>
									<tr>
										<th>Left</th><td><i class="icon-leaf"><?php echo isset($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Left']) ? $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Left'] : "";?></i></td><th>Referral Made</th><td colspan="2"><i class="icon-leaf"><?php echo (gettype($doc['doc_data']['widget_data']['page7']['Colour Blindness']['Referral Made'])=="array")? implode (", ",$doc['doc_data']['widget_data']['page7']['Colour Blindness']['Referral Made']) : $doc['doc_data']['widget_data']['page7']['Colour Blindness']['Referral Made'];?></i></td>
									</tr>
									<tr>
