...
<div id="main" role="main">
	...
	<div class="row">
		...
		<div class="row">
		<div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 hide">
					...
					<div class="jarviswidget" id="wid-id-1000" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
						...
						<div class="no-padding">
							...
							<div class="widget-body">
								...
								<form class='smart-form' action="<?php echo URL.'schoolhealth_school_portal/get_students_for_generating_health_summary_report';?>" method="POST" id="students_form">
									<fieldset>
											<div class="row">
											<section class="col col-6">
				<label class="label" for="first_name">Class</label>
				<label class="select">
				<select name="selected_class" id="select_class" >
			...
			<section class="col col-6 hide">
				<label class="label" for="first_name">Section</label>
				<label class="select">
				<select name="selected_section" id="select_section" >
					<option value="" selected="0" disabled="">Select a section</option>
					<?php //if(isset($sections)): ?>
						<?php //foreach ($sections as $section):?>
						<option  id="section_name"  value='<?php// echo $section['section_name']?>'><?php //echo ucfirst($section['section_name'])?></option>
						<?php //endforeach;?>
						<?php //else: ?>
						<option value="1"  disabled="">No sections entered yet</option>
					<?php //endif ?>
				</select> <i></i>
			</label>
			</section>
												...
												<div class="row">
													<section class="col col-6">
													<button type="submit" class="btn bg-color-pink txt-color-white btn-sm" id="get_students_btn" data-toggle="modal" data-target="#load_waiting" data-backdrop="static" data-keyboard="false">
						                       Get Students
						                    </button>
						                    </section>
													</div>
							...
							<div class="col-md-12" id="loading_screening_pie" style="display:none;">
											...
											<section class="col col-3">
												...
												<label class="select">
													<select id="screening_pie_span">
														...
														<option selected value="2018_2019">2018-2019</option>
								...
								<div class="col-xs-12 col-sm-3 col-md-12 col-lg-12">
									...
									<div class="alert alert-info fade in">
										...
										<strong>Info! &nbsp; Total Screened Students: <span class="badge bg-color-red"><?php echo $total_screened_Students_count;?></span></strong>
									</div>
										<br>
										<div >
...
$(document).ready(function() {
	...
	var screening_pie_span = "2018_2019";//"Yearly";
	var screening_data = "";
...
function change_to_default(today_date,absent_report,request_report,symptoms_report,screening_report){
	...
	$('#screening_pie_span').val("2018_2019");
