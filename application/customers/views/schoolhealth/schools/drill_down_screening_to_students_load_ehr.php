									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												...
												<td><?php echo isset($student['doc_data']['widget_data']["page2"]['Personal Information']['AD No']) ? $student['doc_data']['widget_data']["page2"]['Personal Information']['AD No'] : "" ;?></td>
												...
												<td><?php echo isset($student['doc_data']['widget_data']["page2"]['Personal Information']['Section']) ? $student['doc_data']['widget_data']["page2"]['Personal Information']['Section'] : "" ;?></td>
												<td><a class='ldelete' href='<?php echo URL."schoolhealth_school_portal/drill_down_screening_to_students_load_ehr_doc/".$student['_id'];?>'>
