...
$page_nav["bmi_pie_view"]["active"] = true;
include("inc/nav.php");
								...
								<div class = "under weight " id ="under weight">
									...
									<thead>			                
										<tr>
											...
											<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Height (C.Ms)</th>
											<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Weight (K.Gs)</th>
											<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> BMI%</th>
											<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Action</th>
										</tr>
									</thead>
									<tbody>
								<?php	//echo print_r($get_bmi_docs, true);
										 foreach ($get_bmi_docs as $get_doc):// echo print_r($get_doc,true); exit;?>
											...
											<tr>
												...
												<td><?php echo $get_doc['doc_data']['widget_data']['page2']['Personal Information']['School Name'];?></td>
												<td><?php echo $get_doc['doc_data']['widget_data']['page3']['Physical Exam']['Height cms'];?></td>
												<td><?php echo $get_doc['doc_data']['widget_data']['page3']['Physical Exam']['Weight kgs'];?></td>
												<td><?php echo $get_doc['doc_data']['widget_data']['page3']['Physical Exam']['BMI%'];?></td>
												<td><a class='delete1' href='<?php echo URL."schoolhealth_school_portal/student_ehr_document/".$get_doc['doc_data']['widget_data']['page1']['Personal Information']['Hospital Unique ID'];?>'>
