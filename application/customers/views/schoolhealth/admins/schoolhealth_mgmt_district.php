...
$page_nav["masters"]["sub"]["district"]["active"] = true;
include("inc/nav.php");
...
<div>
	...
	echo  form_open('schoolhealth_admin_portal/create_district',$attributes);
	?>
...
<div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<td id="deletedistrict">
						<a class='ldelete' href='<?php echo URL."schoolhealth_admin_portal/delete_district/".$dist['_id'];?>'>
...
<script>
// Delete District 
	$('#deletedistrict a').click(function(e) {
		//get the link
		var $this = $(this);
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-minus-square txt-color-orangeDark'></i> Do you want to delete this district ?",
			buttons : '[No][Yes]'

		}, function(ButtonPressed) {
			if (ButtonPressed == "Yes") {
				setTimeout(deletedistrict, 1000)
			}
