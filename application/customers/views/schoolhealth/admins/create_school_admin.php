...
<div>
	...
	echo  form_open_multipart('schoolhealth_admin_portal/create_school',$attributes);
	?>
				...
				<select name="dt_name" id="dt_name" required>
					...
					<label class="input"> <i class="icon-append fa fa-pencil"></i>
					<input type="text" name="school_code" id="school_code" value="<?PHP echo set_value('school_code'); ?>">
				</label>
			</section>
