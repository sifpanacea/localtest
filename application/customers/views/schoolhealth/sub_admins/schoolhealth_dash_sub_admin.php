								...
								<div class="col-xs-12 col-sm-3 col-md-12 col-lg-12">
									<div class="well well-sm well-light">
										...
										<div >
											...
											<form style="display: hidden" action="<?php echo URL.'schoolhealth_sub_admin_portal/drill_down_screening_to_students_load_ehr';?>" method="POST" id="ehr_form">
...
$(document).ready(function() {
	...
	var st_name     = $('#select_state_name').val();
...
$('#screening_pie_span').change(function(e){
	...
	$.ajax({
		url: URL+'schoolhealth_sub_admin_portal/update_screening_pie',
		type: 'POST',
...
$('#set_date_btn').click(function(e)
{
    ...
    $.ajax({
		url : URL+'schoolhealth_sub_admin_portal/to_dashboard_with_date',
		type: 'POST',
		data: {"today_date" : today_date,"screening_pie_span" : screening_pie_span},
		success: function (data) 
		{
...
$('#refresh_screening_data').click(function(e){
	...
	var URL = '<?php echo URL;?>';
	console.log("URL=====1023====",URL);
	$.ajax({
		url    : URL+'schoolhealth_sub_admin_portal/refresh_screening_data',
		type   : 'POST',
		data   : {"today_date" : today_date, "screening_pie_span" : screening_pie_span},
		success: function (data) {
			console.log(data);
	     ...
	     callbacks: {
				onClickSegment: function(a) {
					...
					if(onClickFn == "drill_down_screening_to_abnormalities"){
						...
						//alert("Segment clicked! See the console for all data passed to the click handler.");
						console.log(a);
						previous_screening_a_value[4] = screening_data;
						previous_screening_title_value[4] = heading;
						previous_screening_search[4] = heading;
						console.log(previous_screening_a_value);
						search_arr[0] = previous_screening_search[3];
						search_arr[1] =  a.data.label;
						console.log("SCHOOLS===",search_arr);
						...
						//previous_screening_title_value[index] = previous_screening_title_value[index];
						//previous_screening_search[index] = previous_screening_title_value[index];
						console.log("value from previous function -------------------------------------------",index);
						//console.log(previous_screening_a_value);
...
function drill_down_screening_to_abnormalities(pie_data)
{
  ...
  $.ajax({
	url: URL+'schoolhealth_sub_admin_portal/drilling_screening_to_abnormalities',
	type: 'POST',
	...
	success: function (data) {
		...
		screening_pie(pie_data.data.label, content, "drill_down_screening_to_states");
	...
	function drill_down_screening_to_students(pie_data)
	{
		...
		$.ajax({
			url: URL+'schoolhealth_sub_admin_portal/drill_down_screening_to_students',
			type: 'POST',
			data: {"data" : JSON.stringify(pie_data), "today_date" : today_date, "screening_pie_span" : screening_pie_span},
			success: function (data) {
				console.log("STU*DENT++++++",data);
				$("#ehr_data").val(data);
		...
		function drill_down_screening_to_states(pie_data){

	$.ajax({
		url: URL+'schoolhealth_sub_admin_portal/drilling_screening_to_states',//'drilling_screening_to_states',
		type: 'POST',
		data: {"data" : JSON.stringify(pie_data.data), "today_date" : today_date, "screening_pie_span" : screening_pie_span},
		success: function (data) {
			console.log(data);
	...
	$.ajax({
		url: URL+'schoolhealth_sub_admin_portal/drilling_screening_to_districts',//'drilling_screening_to_states',
		type: 'POST',
		data: {"data" : JSON.stringify(pie_data.data), "today_date" : today_date, "screening_pie_span" : screening_pie_span},
		success: function (data) {
			console.log(data);
	...
	console.log(pie_data);
	$.ajax({
	    url: URL+'schoolhealth_sub_admin_portal/drilling_screening_to_schools',
