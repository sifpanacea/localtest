									...
									<tbody>
										<?php foreach ($students as $student):?>
											<tr>
												...
												<td><a class='ldelete' href='<?php echo URL."schoolhealth_sub_admin_portal/drill_down_screening_to_students_load_ehr_doc/".$student['_id'];?>'>
													...
													<section class="col col-4">
														...
														<select id="select_doc" name="select_doc">
															...
															<?php if(isset($doctor_list)): ?>
																...
																<option value='<?php echo str_replace( "@", "#", $doctor['email'])?>' ><?php echo ucfirst($doctor['name'])?> | <?php echo $doctor['email']?> | <?php echo ucfirst($doctor['specialization'])?></option>
																<?php endforeach;?>
																<?php else: ?>
