...
<header>
	...
	<h2>Select a sick room | Total sick rooms alloted : <span class="badge bg-color-greenLight">
...
<div>
	...
	<form class=smart-form>
		<!--<form class="smart-form">-->
			...
			<section class="col col-4">
				<label class="label" for="first_name">Sick Room Available Schools</label>
				<label class="select">
				<select id="select_dt_name" >
...
<div>
	...
	<div class="widget-body">
		...
		<div id="stud_report">
		Select from drop down to display sick room details.
		</div>
		...
		$.ajax({
			...
			success: function (data) {			
				...
				$.each(result, function() {
				    options.append($("<option />").val(this.district_name).text(this.district_name));
				});
