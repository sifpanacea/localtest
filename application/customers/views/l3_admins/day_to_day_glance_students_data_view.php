    ...
    function data_table_for_filters(result, requestsCount){
      ...
      if(result == "No Data Available"){
          $('#sanitation_filters').html('<h4>No Data Available For this Field Officer.</h4>');
            ...
            data_table = '<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="dt_basic"><thead><tr><th>Health ID</th><th>Student Name</th><th>Request Type</th><th>Visited Date</th><th>Hospital Name</th><th>Problem Info</th></tr></thead><tbody>';
            /*if(requestsCount == 'Animals')<th>Respond '+'<input type="checkbox" id="select_all_chk" class="filled-in chk-col-red">'+
              ...
              /*   data_table = data_table+'<td>'+'<div class="demo-checkbox">'+
                                             '<input type="checkbox" name="checkboxName[]" id="'+this.doc_data.widget_data['Student Details']['Name']+'" class="filled-in chk-col-red" />'+
                                                '<label for="'+this.doc_data.widget_data['Student Details']['Name']+'">Send a message</label>'+
                                            '</div>'+'</td>';*/
