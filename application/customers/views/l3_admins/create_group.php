...
<div>
	...
	echo  form_open('panacea_mgmt/create_group',$attributes);
	?>
        ...
        <div class="row">
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<tr>
						...
						<a class='ldelete' href='<?php echo URL."panacea_mgmt/delete_group/".$group['_id'];?>'>
											...
											<div class="row">
												...
												Select user groups &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Select users<br>
														<select id="select_group_name" name="select_group_name[]" multiple="multiple" required>
															...
															<option value='rhso_group' >RHSO</option>
															<option value='cro_group' >CRO</option>
															<option value='rco_group' >RCO</option>
