...
<form style="display: hidden" action="get_rhso_hospital_followup_data" method="POST" id="rhso_followup_status">
    <input type="hidden" id="hospl_start" name="hos_start_date" value=""/>
    <input type="hidden" id="hospl_end" name="hos_end_date" value=""/>
    <input type="hidden" id="hospl_dist" name="hos_dist" value=""/>
    <input type="hidden" id="from_what" name="from_what" value=""/>
    <input type="hidden" id="hospl_selected" name="hospl_selected" value=""/>
</form>

 <form style="display: hidden" action="get_rhso_hospital_followup_data" method="POST" id="rhso_school_visit">
    <input type="hidden" id="school_start_date" name="school_start_date" value=""/>
    <input type="hidden" id="school_end_date" name="school_end_date" value=""/>
    <input type="hidden" id="school_dist" name="school_dist" value=""/>
    <input type="hidden" id="from_what_scl" name="from_what" value=""/>
    <input type="hidden" id="school_selected" name="school_selected" value=""/>
