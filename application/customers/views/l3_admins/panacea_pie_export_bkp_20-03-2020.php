						...
						<option value='All' >All</option>
				                    ...
				                    <div class='row'> 
					                   ...
					                   * Absent PIE is generated for single day based on date selected
										...
										<fieldset>
											<section>
										<button type="button" class="btn btn-success" id="bmi_pie_btn" data-toggle="modal" data-target="#load_waiting" data-backdrop="static" data-keyboard="false" style="padding: 6px;" >
										BMI PIE</button>
										</section>
										</fieldset>
										</div>
