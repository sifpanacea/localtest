						...
						<li>
							<div class="well well-sm ">
								<table id="dt_basic" class="table table-striped table-bordered table-hover">
									...
									<!--
									<tr>
										<th>Doctor's Email</th><td><i class="icon-leaf"><?php echo (isset($request['history']["1"]['submitted_by'])? $request['history']["1"]['submitted_by'] : "Doctor's information not available");?></i></td>
									</tr>
									-->
