...
class Panacea_viewers extends My_Controller {
	...
	{
		redirect('panacea_viewers/to_dashboard');
	}
	...
	{
		$this->data["message"] = "";
		$this->_render_page('panacea_admin_viewers/panacea_reports_ehr',$this->data);
	}
	...
	public function panacea_reports_display_ehr()
	{
		...
		$this->data = $this->panacea_common_lib->panacea_reports_display_ehr($post);
	 	...
	 	$this->_render_page('panacea_admin_viewers/panacea_reports_display_ehr',$this->data);
	}
	...
	public function panacea_reports_students()
	{
		...
		$this->_render_page('panacea_admin_viewers/panacea_reports_students',$this->data);
	}
	...
	public function panacea_reports_doctors()
	{
		...
		$this->_render_page('panacea_admin_viewers/panacea_reports_doctors',$this->data);
	}
	...
	public function panacea_reports_hospital()
	{
		...
		$this->_render_page('panacea_admin_viewers/panacea_reports_hospitals',$this->data);
	}
	...
	public function panacea_reports_school()
	{
		...
		//$this->data = "";
		$this->_render_page('panacea_admin_viewers/panacea_reports_schools',$this->data);
	}
	...
	public function panacea_reports_symptom()
	{
		...
		$this->_render_page('panacea_admin_viewers/panacea_reports_symptom',$this->data);
		}
	...
	function to_dashboard($date = FALSE, $request_duration = "Daily", $screening_duration = "Yearly")
	{
		...
		$this->_render_page('panacea_admin_viewers/panacea_admin_dash', $this->data);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_admin_viewers/drill_down_screening_to_students_load_ehr',$this->data);
	}
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_admin_viewers/drill_down_absent_to_students_load_ehr',$this->data);
	}
	...
	//log_message("debug","innnnnnnnnnnnnnnnnnnnnn fn gggggggggggggggggggggggggggggggggggggggggggggggggggggg");
		$this->_render_page('panacea_admin_viewers/drill_down_request_to_students_load_ehr',$this->data);
	}
	//========================================================================
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_admin_viewers/drill_down_identifiers_to_students_load_ehr',$this->data);
	}
	...
	public function panacea_reports_students_filter()
	{
		...
		//$this->data = "";
		$this->_render_page('panacea_admin_viewers/panacea_reports_students_filter',$this->data);
	}
	...
	public function pie_export()
	{
		...
		$this->_render_page('panacea_admin_viewers/panacea_pie_export',$this->data);
	}
