...
class Panacea_cc extends My_Controller {
	...
	public function panacea_cc_states()
	{
        ...
        $total_rows = $this->panacea_cc_model->statescount();
		...
		$this->data['states'] = $this->panacea_cc_model->get_states($config['per_page'], $page);
	...
	{
	 	$this->panacea_cc_model->create_state($_POST);	
	 	redirect('panacea_cc/panacea_cc_states');
	}
	 
	public function panacea_cc_delete_states($st_id)
	{
	 	$this->panacea_cc_model->delete_state($st_id);	
	 	redirect('panacea_cc/panacea_cc_states');
	} 
	...
	public function panacea_cc_district()
	{
        ...
        $total_rows = $this->panacea_cc_model->distcount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['dists'] = $this->panacea_cc_model->get_district($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
		...
		$this->data['statelist'] = $this->panacea_cc_model->get_all_states();
	...
	{
	 	$this->panacea_cc_model->create_district($_POST);	
	 	redirect('panacea_cc/panacea_cc_district');
	}
	 
	public function panacea_cc_delete_dists($dt_id)
	{
	 	$this->panacea_cc_model->delete_district($dt_id);	
	 	redirect('panacea_cc/panacea_cc_district');
	}
	...
	public function panacea_cc_health_supervisors()
	{
        ...
        $total_rows = $this->panacea_cc_model->health_supervisorscount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['health_supervisors'] = $this->panacea_cc_model->get_health_supervisors($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
	...
	{
	 	$insert = $this->panacea_cc_model->create_health_supervisors($_POST);
	 	if($insert){
	 		redirect('panacea_cc/panacea_cc_health_supervisors');
	 	}else{
	 		log_message('debug','errrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr.'.print_r($this->panacea_cc_model->errors(),true));
	 		$total_rows = $this->panacea_cc_model->health_supervisorscount();
	 		...
	 		//set the flash data error message if there is one
	 		$this->data['message'] = (validation_errors() ? validation_errors() : ($this->panacea_cc_model->errors() ? $this->panacea_cc_model->errors() : $this->session->flashdata('message')));
	...
	public function panacea_cc_delete_health_supervisors($hs_id)
	{
	 	$this->panacea_cc_model->delete_health_supervisors($hs_id);	
	 	redirect('panacea_cc/panacea_cc_health_supervisors');
	}
	...
	public function panacea_cc_schools()
	{
        ...
        $total_rows = $this->panacea_cc_model->schoolscount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['schools'] = $this->panacea_cc_model->get_schools($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
		...
		$this->data['distslist'] = $this->panacea_cc_model->get_all_district();
	...
	{
	 	$this->panacea_cc_model->create_school($_POST);	
	 	redirect('panacea_cc/panacea_cc_schools');
	}
	 
	public function panacea_cc_delete_school($school_id)
	{
	 	$this->panacea_cc_model->delete_school($school_id);	
	 	redirect('panacea_cc/panacea_cc_schools');
	}
	...
	public function panacea_cc_classes()
	{
        ...
        $total_rows = $this->panacea_cc_model->classescount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['classes'] = $this->panacea_cc_model->get_classes($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
	...
	{
	 	$this->panacea_cc_model->create_class($_POST);	
	 	redirect('panacea_cc/panacea_cc_classes');
	}
	 
	public function panacea_cc_delete_class($class_id)
	{
	 	$this->panacea_cc_model->delete_class($class_id);	
	 	redirect('panacea_cc/panacea_cc_classes');
	}
	...
	public function panacea_cc_sections()
	{
        ...
        $total_rows = $this->panacea_cc_model->sectionscount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['sections'] = $this->panacea_cc_model->get_sections($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
	...
	{
	 	$this->panacea_cc_model->create_section($_POST);	
	 	redirect('panacea_cc/panacea_cc_sections');
	}
	 
	public function panacea_cc_delete_section($section_id)
	{
	 	$this->panacea_cc_model->delete_section($section_id);	
	 	redirect('panacea_cc/panacea_cc_sections');
	}
	...
	public function panacea_cc_symptoms()
	{
        ...
        $total_rows = $this->panacea_cc_model->symptomscount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['symptoms'] = $this->panacea_cc_model->get_symptoms($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
	...
	{
	 	$this->panacea_cc_model->create_symptoms($_POST);	
	 	redirect('panacea_cc/panacea_cc_symptoms');
	}
	 
	public function panacea_cc_delete_symptoms($symptoms_id)
	{
	 	$this->panacea_cc_model->delete_symptoms($symptoms_id);	
	 	redirect('panacea_cc/panacea_cc_symptoms');
	}
	...
	public function panacea_cc_diagnostic()
	{
		...
		$total_rows = $this->panacea_cc_model->diagnosticscount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['diagnostics'] = $this->panacea_cc_model->get_diagnostics($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
	...
	{
		$this->panacea_cc_model->create_diagnostic($_POST);
		redirect('panacea_cc/panacea_cc_diagnostic');
	}
	
	public function panacea_cc_delete_diagnostic($diagnostic_id)
	{
		$this->panacea_cc_model->delete_diagnostic($diagnostic_id);
		redirect('panacea_cc/panacea_cc_diagnostic');
	}
	...
	public function panacea_cc_hospitals()
	{
		...
		$total_rows = $this->panacea_cc_model->hospitalscount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['hospitals'] = $this->panacea_cc_model->get_hospitals($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
	...
	{
		$this->panacea_cc_model->create_hospital($_POST);
		redirect('panacea_cc/panacea_cc_hospitals');
	}
	
	public function panacea_cc_delete_hospital($hospital_id)
	{
		$this->panacea_cc_model->delete_hospital($hospital_id);
		redirect('panacea_cc/panacea_cc_hospitals');
	}
	...
	public function panacea_cc_emp()
	{
		...
		$total_rows = $this->panacea_cc_model->empcount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['emps'] = $this->panacea_cc_model->get_emp($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
	...
	{
		$this->panacea_cc_model->create_emp($_POST);
		redirect('panacea_cc/panacea_cc_emp');
	}
	
	public function panacea_cc_delete_emp($emp_id)
	{
		$this->panacea_cc_model->delete_emp($emp_id);
		redirect('panacea_cc/panacea_cc_emp');
	}
	...
	{
		$docs = $this->panacea_cc_model->get_reports_ehr($_POST['ad_no']);
	...
	{
		$docs = $this->panacea_cc_model->get_reports_ehr_uid($_POST['uid']);
	...
	public function panacea_reports_students()
	{
        ...
        $total_rows = $this->panacea_cc_model->studentscount();
		$this->data['students'] = $this->panacea_cc_model->get_all_students();
	...
	public function panacea_reports_doctors()
	{
		...
		$total_rows = $this->panacea_cc_model->doctorscount();
		...
		//find all the categories with paginate and save it in array to past to the view
		$this->data['doctors'] = $this->panacea_cc_model->get_doctors($config['per_page'], $page);
		//create paginate´s links
		$this->data['links'] = $this->pagination->create_links();
	...
	public function panacea_reports_school()
	{
		...
		$this->data['schools'] = $this->panacea_cc_model->get_all_schools();
	...
	function to_dashboard()
	{
		...
		$count = 0;
		$absent_report = $this->panacea_cc_model->get_all_absent_data();
		...
		$count = 0;
		$symptoms_report = $this->panacea_cc_model->get_all_symptoms();
		...
		$count = 0;
		$request_report = $this->panacea_cc_model->get_all_requests();
		...
		$count = 0;
		$screening_report = $this->panacea_cc_model->get_all_screenings();
	...
	function drilling_screening_to_abnormalities()
	{
		...
		$data = $_POST['data'];
		$screening_report = json_encode($this->panacea_cc_model->get_drilling_screenings_abnormalities($data));
	...
	function drilling_screening_to_districts()
	{
		...
		log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie drillllllllllllllllllllllllll".print_r($_POST,true));
		$data = $_POST['data'];
		$screening_report = json_encode($this->panacea_cc_model->get_drilling_screenings_districts($data));
		//log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie ppppppppppppppppppppppppppppppppppppppppp".print_r($screening_report,true));
		$this->output->set_output($screening_report);
	}
	...
	function drilling_screening_to_schools()
	{
		...
		log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie drillllllllllllllllllllllllll".print_r($_POST,true));
		$data = $_POST['data'];
		$screening_report = json_encode($this->panacea_cc_model->get_drilling_screenings_schools($data));
		//log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie ppppppppppppppppppppppppppppppppppppppppp".print_r($screening_report,true));
		$this->output->set_output($screening_report);
	}
	...
	function drill_down_screening_to_students()
	{
		...
		$docs = $this->panacea_cc_model->get_drilling_screenings_students($data);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$get_docs = $this->panacea_cc_model->get_drilling_screenings_students_docs($docs_id);
	...
	public function drill_down_screening_to_students_load_ehr_doc($_id)
	{
		...
		$docs = $this->panacea_cc_model->drill_down_screening_to_students_load_ehr_doc($_id);
	...
	public function drill_down_screening_initiate_request($_id)
	{
		...
		$this->data['doc'] = $this->panacea_cc_model->drill_down_screening_to_students_doc($_id);
	...
	function drilldown_absent_to_districts()
	{
		...
		log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie drillllllllllllllllllllllllll".print_r($_POST,true));
		$data = $_POST['data'];
		$absent_report = json_encode($this->panacea_cc_model->drilldown_absent_to_districts($data));
		//log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie ppppppppppppppppppppppppppppppppppppppppp".print_r($screening_report,true));
	...
	function drilling_absent_to_schools()
	{
		...
		$data = $_POST['data'];
		$absent_report = json_encode($this->panacea_cc_model->get_drilling_absent_schools($data));
	...
	function drill_down_absent_to_students()
	{
		...
		$docs = $this->panacea_cc_model->get_drilling_absent_students($data);
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		$get_docs = $this->panacea_cc_model->get_drilling_absent_students_docs($UI_id);
	...
	function drilldown_request_to_districts()
	{
		...
		log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie drillllllllllllllllllllllllll".print_r($_POST,true));
		$data = $_POST['data'];
		$request_report = json_encode($this->panacea_cc_model->drilldown_request_to_districts($data));
		//log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie ppppppppppppppppppppppppppppppppppppppppp".print_r($screening_report,true));
	...
	function drilling_request_to_schools()
	{
		...
		log_message("debug","aaaaaaaaaaaaaaaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb".print_r($_POST,true));
		$data = $_POST['data'];
		$request_report = json_encode($this->panacea_cc_model->get_drilling_request_schools($data));
	...
	function drill_down_request_to_students()
	{
		...
		$docs = $this->panacea_cc_model->get_drilling_request_students($data);
		log_message("debug","aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa".print_r($docs,true));
	...
	function drill_down_request_to_students_load_ehr()
	{
		...
		log_message("debug","uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu".print_r($UI_id,true));
		$get_docs = $this->panacea_cc_model->get_drilling_request_students_docs($UI_id);
	...
	function drilldown_identifiers_to_districts()
	{
		...
		log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie drillllllllllllllllllllllllll".print_r($_POST,true));
		$data = $_POST['data'];
		$identifiers_report = json_encode($this->panacea_cc_model->drilldown_identifiers_to_districts($data));
		//log_message("debug","innnnnnnnnnnnnnnnnnnnnnnnpie ppppppppppppppppppppppppppppppppppppppppp".print_r($screening_report,true));
	...
	function drilling_identifiers_to_schools()
	{
		...
		log_message("debug","aaaaaaaaaaaaaaaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb".print_r($_POST,true));
		$data = $_POST['data'];
		$identifiers_report = json_encode($this->panacea_cc_model->get_drilling_identifiers_schools($data));
	...
	function drill_down_identifiers_to_students()
	{
		...
		$docs = $this->panacea_cc_model->get_drilling_identifiers_students($data);
		log_message("debug","aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa".print_r($docs,true));
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		log_message("debug","uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu".print_r($UI_id,true));
		$get_docs = $this->panacea_cc_model->get_drilling_identifiers_students_docs($UI_id);
...
// 			array_push($check_col_array,strtolower($objPHPExcel->getActiveSheet()->getCell("E1")->getValue()));
			...
			if (count($check)==0) {
				...
				for($j=2;$j<count($arr_data)+2;$j++){
					...
					$this->panacea_cc_model->create_diagnostic($data);
...
// 			array_push($check_col_array,strtolower($objPHPExcel->getActiveSheet()->getCell("E1")->getValue()));
			...
			if (count($check)==0) {
				...
				for($j=2;$j<count($arr_data)+2;$j++){
					...
					$this->panacea_cc_model->create_hospital($data);
...
// 			array_push($check_col_array,strtolower($objPHPExcel->getActiveSheet()->getCell("G1")->getValue()));
			...
			$arr_data = [];
				...
				for($j=2;$j<count($arr_data)+2;$j++){
					...
					$this->panacea_cc_model->create_school($data);
...
// 			array_push($check_col_array,strtolower($objPHPExcel->getActiveSheet()->getCell("F1")->getValue()));
			...
			$arr_data = [];
				...
				for($j=2;$j<count($arr_data)+2;$j++){
					...
					$this->panacea_cc_model->create_health_supervisors($data);
			...
			if($import_type == "personal_info")
			{
				...
				if (count($check)==0) {
					...
					for($each_row=2 ; $each_row<=$total_rows ; $each_row++){
						...
						foreach ($cellIterator as $cell) {
							...
							if($check_col_array[$header_row] == "date of birth")
								...
								redirect('panacea_cc/panacea_reports_students_redirect');
					...
					for($j=2;$j<count($arr_data)+2;$j++){
						...
						$this->panacea_cc_model->insert_student_data($doc_data,$history,$doc_properties);
		...
		if ($this->upload->do_upload("file"))
		{
			...
			if ($check) {
				...
				for($j=2;$j<count($arr_data)+2;$j++){
					...
					$doc = $this->panacea_cc_model->get_students_uid($unique_id);
					...
					if($doc){
						...
						$this->panacea_cc_model->update_student_data($doc,$doc_id);
						$update_count++;
					}
