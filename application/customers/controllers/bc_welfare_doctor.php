...
class Bc_welfare_doctor extends My_Controller {
    ...
    function __construct()
	{
		...
		$this->load->model('bc_welfare_doctor_model');
	...
	{
		//redirect('bc_welfare_doctor/to_dashboard');
		redirect('bc_welfare_doctor/fetch_request_docs_from_hs_list');
	}
	
	public function initiate_request()
	{
		$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_application_initiate',$this->data);
	}
	
	public function initiate_attendance()
	{
		$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_attendance_initiate',$this->data);
	}
	
	public function initiate_sanitation_report()
	{
		$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_sanitation_report',$this->data);
	}
	
	public function bc_welfare_doctor_states()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_states');
	    
	    $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_states();
		
		//$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_states',$this->data);
	}
	
	public function bc_welfare_doctor_district()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_district');

        $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_district();
		
		//$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_dist',$this->data);
	}
	
	public function bc_welfare_doctor_health_supervisors()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_health_supervisors');
        $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_health_supervisors();
		
		//$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_health_supervisors',$this->data);
	}
	
	
	//////////////////////////////////////////////////////
	
	public function bc_welfare_doctor_schools()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_schools');

        $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_schools();
		
		//$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_schools',$this->data);
	}
	
	//000000000000000000000000000000000000
	public function bc_welfare_doctor_classes()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_schools');
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_classes',$this->data);
	}
	
	//sssssssssssssssssssssssssssssssssssssssssss
	public function bc_welfare_doctor_sections()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_schools');
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_sections',$this->data);
	}
	
	//syyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy
	public function bc_welfare_doctor_symptoms()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_symptoms');

        $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_symptoms();
		
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_symptoms',$this->data);
	}
	
	public function bc_welfare_doctor_diagnostic()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_diagnostics');
	
		$this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_diagnostic();
	
		//$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_diagnostics',$this->data);
	}	
	
	public function bc_welfare_doctor_hospitals()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_hospitals');
	
		$this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_hospitals();
	
		//$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_hospitals',$this->data);
	}
	
	public function bc_welfare_doctor_emp()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_doctor_emp');
	
		$this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_emp();
	
		//$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_emp',$this->data);
	}
	...
	{
		$this->data["message"] = "";		
		$this->_render_page('bc_welfare_doctor/bc_welfare_reports_ehr',$this->data);
	}
	...
	public function bc_welfare_reports_display_ehr()
	{
		...
		$this->data = $this->bc_welfare_common_lib->bc_welfare_reports_display_ehr($post);
	 	...
	 	$this->_render_page('bc_welfare_doctor/bc_welfare_reports_display_ehr',$this->data);
	}
	
	public function bc_welfare_reports_display_ehr_uid()
	{
		$post = $_POST;
		$this->data = $this->bc_welfare_common_lib->bc_welfare_reports_display_ehr_uid($post);
	...
	public function bc_welfare_reports_students()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_reports_students',$this->data);
	}
	...
	public function bc_welfare_reports_doctors()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_reports_doctors',$this->data);
	}
	...
	public function bc_welfare_reports_hospital()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_reports_hospitals',$this->data);
	}
	...
	public function bc_welfare_reports_school()
	{
		...
		//$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_reports_schools',$this->data);
	}
	...
	public function bc_welfare_reports_symptom()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_reports_symptom',$this->data);
	}
	...
	function to_dashboard($date = FALSE, $request_duration = "Monthly", $screening_duration = "Yearly")
	{
		...
		/* $hs_req_docs  = $this->bc_welfare_doctor_model->get_hs_req_docs($collection);
		...
		$hs_req_emergency  = $this->bc_welfare_doctor_model->get_hs_req_emergency($collection);

		$hs_req_chronic  = $this->bc_welfare_doctor_model->get_hs_req_chronic($collection);
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_dash', $this->data);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$this->_render_page('bc_welfare_doctor/drill_down_screening_to_students_load_ehr',$this->data);
	}
	
	public function drill_down_screening_to_students_load_ehr_doc($_id)
	{
		//$this->data['docs'] = $this->bc_welfare_doctor_model->drill_down_screening_to_students_load_ehr_doc($_id);
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		$this->_render_page('bc_welfare_doctor/drill_down_absent_to_students_load_ehr',$this->data);
	}
	...
	function drill_down_request_to_students_load_ehr()
	{
		...
		$this->_render_page('bc_welfare_doctor/drill_down_request_to_students_load_ehr',$this->data);
	}
	//========================================================================
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		$this->_render_page('bc_welfare_doctor/drill_down_identifiers_to_students_load_ehr',$this->data);
	}
	...
	function bc_welfare_imports_diagnostic()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_imports_diagnostic', $this->data);
	}
	...
	function import_diagnostic()
	{
		...
		{
			redirect('bc_welfare_doctor/bc_welfare_doctor_diagnostic');
	...
	function bc_welfare_imports_hospital()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_imports_hospital', $this->data);
	}
	...
	function import_hospital()
	{
		...
		{
			redirect('bc_welfare_doctor/bc_welfare_doctor_hospitals');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('bc_welfare_doctor/bc_welfare_imports_hospital', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function bc_welfare_imports_school()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_imports_school', $this->data);
	}
	...
	function import_school()
	{
		...
		{
			redirect('bc_welfare_doctor/bc_welfare_doctor_schools');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('bc_welfare_doctor/bc_welfare_imports_school', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function bc_welfare_imports_health_supervisors()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_imports_health_supervisors', $this->data);
	}
	...
	function import_health_supervisors()
	{
		...
		{
			redirect('bc_welfare_doctor/bc_welfare_doctor_health_supervisors');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('bc_welfare_doctor/bc_welfare_imports_health_supervisors', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function bc_welfare_imports_students()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_imports_students', $this->data);
	}
	...
	function import_students()
	{
		...
		{
			redirect('bc_welfare_doctor/bc_welfare_reports_students');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('bc_welfare_doctor/bc_welfare_imports_students', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	public function bc_welfare_reports_students_filter()
	{
		...
		//$this->data = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_reports_students_filter',$this->data);
	}
	...
	public function get_students_list()
	{
		...
		$this->data = $this->bc_welfare_common_model->get_students_by_school_name($school_name,$dist_name);
		//$this->data = "";
		$this->output->set_output(json_encode($this->data));
	}
	...
	public function pie_export()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_pie_export',$this->data);
	}
    ...
    function list_chronic_cases()
	{
	  ...
	  $this->_render_page('bc_welfare_doctor/chronic_case_report',$this->data);
	}
	...
	public function chronic_pie_view(){
		...
		$this->_render_page('bc_welfare_doctor/chronic_pie_view',$this->data);
	}
	...
	public function add_news_feed_view() {
		...
		$this->_render_page ( 'bc_welfare_doctor/add_news_feed', $this->data );
	}
	...
	public function manage_news_feed_view() {
		...
		$this->_render_page ( 'bc_welfare_doctor/manage_news_feed', $this->data );
	}
	public function delete_news_feed($nf_id) {
		$this->bc_welfare_common_lib->delete_news_feed($nf_id);
		
		redirect ( 'bc_welfare_doctor/manage_news_feed_view' );
	}
	...
	public function extend_request_view() 
	{
		...
		$this->_render_page('bc_welfare_doctor/extend_request_view',$this->data);
	}
	...
	public function extend_request()
	{
		...
		$this->_render_page('bc_welfare_doctor/extend_request',$this->data);
	}
	...
	public function app_access($doc_id)
	{
		...
		$this->_render_page('bc_welfare_doctor/extend_request_app',$this->data);
	}
	...
	function hs_req_extend(){
		...
		if($req_return['return_error']){
			...
			redirect('bc_welfare_doctor/extend_request_view');
			//$this->manage_news_feed_view();
		}
	}
	...
	function doctor_req_extend(){
		...
		$form_data = json_decode($_POST['form_data'],true);
		$req_return = $this->bc_welfare_common_lib->doctor_req_extend($form_data);
	...
	{
		$this->data['doc_id'] = $id;
		$this->_render_page('bc_welfare_doctor/ha_req_application_access',$this->data);
	}
	...
	public function feed_bmi_student() 
	 {
		$this->data = "";
		$this->data['message'] = "";
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_feed_bmi',$this->data);
	}
	...
	public function show_bmi_student() 
	 {
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_doctor_show_bmi_graph',$this->data);
	}
	...
	{
		$this->data["message"] = "";		
		$this->_render_page('bc_welfare_doctor/update_personal_info',$this->data);
	}
	...
	public function bc_welfare_update_personal_ehr_uid()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_update_personal_ehr',$this->data);
	...
	public function fetch_request_docs_from_hs_list()
	{
		...
		$collection = "healthcare2018122191146894_static_html";
  		$hs_req_docs  = $this->bc_welfare_doctor_model->get_hs_req_normal_new($collection);

		$hs_req_emergency  = $this->bc_welfare_doctor_model->get_hs_req_emergency_new($collection);

		$hs_req_chronic  = $this->bc_welfare_doctor_model->get_hs_req_chronic_new($collection);
		...
		$this->_render_page('bc_welfare_doctor/fetch_request_docs_from_hs_list',$this->data);
	}
	...
	public function access_request_docs_form_hs($id)
	{
		...
		$query = $this->bc_welfare_doctor_model->access_request_docs_form_hs($doc_id);
		//echo print_r($query,true);exit();
		$this->data['hs_req_docs'] = $query;
		//$this->data['student_photo'] = $query['student_photo'];
		$this->_render_page('bc_welfare_doctor/access_request_docs_form_hs',$this->data);*/
		$session_data = $this->session->userdata("customer");
		$doc_id = $id;
  		$doc_access = "true";
  		$doc_access_by = $session_data['user_type']." ".$session_data['username'];
  		
		$query = $this->bc_welfare_doctor_model->access_request_docs_form_hs($doc_id,$doc_access,$doc_access_by);
		...
		// Attachments
		 /*if(isset($_FILES) && !empty($_FILES))
		 {
		   ...
		   foreach ($_FILES as $index => $value)
	       {
			...
			$doc_history = $this->bc_welfare_doctor_model->get_history($unique_id,$doc_id);
		 ...
		 if(isset($_FILES) && !empty($_FILES))
    {
        ...
        if(strpos($index,'hs_req_attachments')!== false)
      {
       ...
       $doc_history = $this->bc_welfare_schools_common_model->get_history($unique_id,$doc_id);
		...
		$doc_properties['doc_access_time'] = 0;
                 ...
                 $approval_history = $this->bc_welfare_common_model->get_approval_history($doc_id);
       ...
       /*if($add_to_regular_followup == "add_to_regular_followup")
       {
			...
			if($chronic_identifiers)
			{
       		...
       		$this->bc_welfare_doctor_model->create_regular_followup_request($unique_id,$student_name,$class,$request_type,$symptoms,$problem_info_description,$school_name,$district, $scheduled_date, $review_status);
       }*/
       if($review_status == 'Hospitalized' || $review_status == "Surgery-Needed" || $review_status == "Expired" || $review_status == "Discharge")
      {
        ...
        $check_doc_id = $this->bc_welfare_doctor_model->check_doc_id_of_request($doc_id);
        
        if($check_doc_id == 'No Doc Found'){
            $insert_hospitalised = $this->bc_welfare_doctor_model->insert_hospitalised_students_data($doc_data,$approval_history,$unique_id,$doc_id,$doc_properties);
        }
      } 

  	  $existing_update = $this->bc_welfare_doctor_model->request_docs_update_doctor_model($doc_data,$approval_history,$unique_id,$doc_id,$doc_properties); 
	...
	public function reports_display_ehr_uid_new_html_static_hs()
	{
		...
		$this->_render_page('bc_welfare_doctor/bc_welfare_reports_display_ehr_new_dashboard',$this->data);
	}

	public function submitted_request_docs_doctor()
	{
		$collection = "healthcare2018122191146894_static_html";
  		$hs_req_docs  = $this->bc_welfare_doctor_model->get_hs_req_normal_doctor($collection);

		$hs_req_emergency  = $this->bc_welfare_doctor_model->get_hs_req_emergency_doctor($collection);

		$hs_req_chronic  = $this->bc_welfare_doctor_model->get_hs_req_chronic_doctor($collection);
		...
		$this->_render_page('bc_welfare_doctor/submited_request_docs_from_hs_list',$this->data);
	}
