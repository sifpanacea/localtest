...
class L3_mgmt extends My_Controller {
	...
	function to_dashboard($date = FALSE, $request_duration = "Yearly", $screening_duration = "Yearly")
	{
		...
		$this->_render_page('l3_admins/panacea_admin_dash', $this->data);
...
// 	 	$this->index();
	...
	*/
	 ...
	 public function basic_dashboard($date = FALSE, $request_duration = "Daily", $screening_duration = "Yearly")
	{
		...
		$this->_render_page('l3_admins/panacea_basic_dashboard',$this->data);
 ...
 public function get_searched_student_sick_requests()
  ...
  public function panacea_covid_cases()
	...
	*/
	...
	public function get_rhso_hospital_visit_data_based_on_selected()
	{
		$start_date = $this->input->post('start_date',true);
		$end_date = $this->input->post('end_date',true);
		$district = $this->input->post('district',true);
		...
		$this->data = $this->panacea_common_model->get_rhso_hospital_visit_data_based_on_selected($start_date,$end_date,$district, $select_type);
	...
	public function get_rhso_school_visit_data_based_on_selected()
	{
		$start_date = $this->input->post('start_date',true);
		$end_date = $this->input->post('end_date',true);
		$district = $this->input->post('district',true);
		...
		$this->data = $this->panacea_common_model->get_rhso_school_visit_data_based_on_selected($start_date,$end_date,$district, $select_type);
	...
	{
		$this->data ="";
		$this->_render_page('l3_admins/tswreis_swaero_electronic_record', $this->data);
	}
