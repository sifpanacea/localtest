...
class Panacea_doctor extends My_Controller {
    ...
    function __construct()
	{
		...
		$this->load->model('panacea_doctor_model');
	...
	{
		//redirect('panacea_doctor/to_dashboard');
		redirect('panacea_doctor/fetch_request_docs_from_hs_list');
	}
	
	public function initiate_request()
	{
		$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_application_initiate',$this->data);
	}
	
	public function initiate_attendance()
	{
		$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_attendance_initiate',$this->data);
	}
	
	public function initiate_sanitation_report()
	{
		$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_sanitation_report',$this->data);
	}
	
	public function panacea_doctor_states()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_states');
	    
	    $this->data = $this->panacea_common_lib->panacea_mgmt_states();
		
		//$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_states',$this->data);
	}
	
	public function panacea_doctor_district()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_district');

        $this->data = $this->panacea_common_lib->panacea_mgmt_district();
		
		//$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_dist',$this->data);
	}
	
	public function panacea_doctor_health_supervisors()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_health_supervisors');
        $this->data = $this->panacea_common_lib->panacea_mgmt_health_supervisors();
		
		//$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_health_supervisors',$this->data);
	}
	
	
	//////////////////////////////////////////////////////
	
	public function panacea_doctor_schools()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_schools');

        $this->data = $this->panacea_common_lib->panacea_mgmt_schools();
		
		//$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_schools',$this->data);
	}
	
	//000000000000000000000000000000000000
	public function panacea_doctor_classes()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_schools');
		...
		$this->_render_page('panacea_doctor/panacea_doctor_classes',$this->data);
	}
	
	//sssssssssssssssssssssssssssssssssssssssssss
	public function panacea_doctor_sections()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_schools');
		...
		$this->_render_page('panacea_doctor/panacea_doctor_sections',$this->data);
	}
	
	//syyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy
	public function panacea_doctor_symptoms()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_symptoms');

        $this->data = $this->panacea_common_lib->panacea_mgmt_symptoms();
		
		$this->_render_page('panacea_doctor/panacea_doctor_symptoms',$this->data);
	}
	
	public function panacea_doctor_diagnostic()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_diagnostics');
	
		$this->data = $this->panacea_common_lib->panacea_mgmt_diagnostic();
	
		//$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_diagnostics',$this->data);
	}	
	
	public function panacea_doctor_hospitals()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_hospitals');
	
		$this->data = $this->panacea_common_lib->panacea_mgmt_hospitals();
	
		//$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_hospitals',$this->data);
	}
	
	public function panacea_doctor_emp()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_doctor_emp');
	
		$this->data = $this->panacea_common_lib->panacea_mgmt_emp();
	
		//$this->data = "";
		$this->_render_page('panacea_doctor/panacea_doctor_emp',$this->data);
	}
	...
	{
		$this->data["message"] = "";		
		$this->_render_page('panacea_doctor/panacea_reports_ehr',$this->data);
	}
	...
	public function panacea_reports_display_ehr()
	{
		...
		$this->data = $this->panacea_common_lib->panacea_reports_display_ehr($post);
	 	...
	 	$this->_render_page('panacea_doctor/panacea_reports_display_ehr',$this->data);
	}
	...
	public function panacea_reports_students()
	{
		...
		$this->_render_page('panacea_doctor/panacea_reports_students',$this->data);
	}
	...
	public function panacea_reports_doctors()
	{
		...
		$this->_render_page('panacea_doctor/panacea_reports_doctors',$this->data);
	}
	...
	public function panacea_reports_hospital()
	{
		...
		$this->_render_page('panacea_doctor/panacea_reports_hospitals',$this->data);
	}
	...
	public function panacea_reports_school()
	{
		...
		//$this->data = "";
		$this->_render_page('panacea_doctor/panacea_reports_schools',$this->data);
	}
	...
	public function panacea_reports_symptom()
	{
		...
		$this->_render_page('panacea_doctor/panacea_reports_symptom',$this->data);
	}
	...
	function to_dashboard($date = FALSE, $request_duration = "Monthly", $screening_duration = "Yearly")
	{
		...
		/* $hs_req_docs  = $this->panacea_doctor_model->get_hs_req_docs($collection);
		...
		$hs_req_emergency  = $this->panacea_doctor_model->get_hs_req_emergency($collection);

		$hs_req_chronic  = $this->panacea_doctor_model->get_hs_req_chronic($collection);
		...
		$this->_render_page('panacea_doctor/panacea_doctor_dash', $this->data);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_doctor/drill_down_screening_to_students_load_ehr',$this->data);
	}
	
	public function drill_down_screening_to_students_load_ehr_doc($_id)
	{
		//$this->data['docs'] = $this->panacea_doctor_model->drill_down_screening_to_students_load_ehr_doc($_id);
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_doctor/drill_down_absent_to_students_load_ehr',$this->data);
	}
	...
	function drill_down_request_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_doctor/drill_down_request_to_students_load_ehr',$this->data);
	}
	//========================================================================
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_doctor/drill_down_identifiers_to_students_load_ehr',$this->data);
	}
	...
	function panacea_imports_diagnostic()
	{
		...
		$this->_render_page('panacea_doctor/panacea_imports_diagnostic', $this->data);
	}
	...
	function import_diagnostic()
	{
		...
		{
			redirect('panacea_doctor/panacea_doctor_diagnostic');
	...
	function panacea_imports_hospital()
	{
		...
		$this->_render_page('panacea_doctor/panacea_imports_hospital', $this->data);
	}
	...
	function import_hospital()
	{
		...
		{
			redirect('panacea_doctor/panacea_doctor_hospitals');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('panacea_doctor/panacea_imports_hospital', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function panacea_imports_school()
	{
		...
		$this->_render_page('panacea_doctor/panacea_imports_school', $this->data);
	}
	...
	function import_school()
	{
		...
		{
			redirect('panacea_doctor/panacea_doctor_schools');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('panacea_doctor/panacea_imports_school', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function panacea_imports_health_supervisors()
	{
		...
		$this->_render_page('panacea_doctor/panacea_imports_health_supervisors', $this->data);
	}
	...
	function import_health_supervisors()
	{
		...
		{
			redirect('panacea_doctor/panacea_doctor_health_supervisors');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('panacea_doctor/panacea_imports_health_supervisors', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function panacea_imports_students()
	{
		...
		$this->_render_page('panacea_doctor/panacea_imports_students', $this->data);
	}
	...
	function import_students()
	{
		...
		{
			redirect('panacea_doctor/panacea_reports_students');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('panacea_doctor/panacea_imports_students', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	public function panacea_reports_students_filter()
	{
		...
		//$this->data = "";
		$this->_render_page('panacea_doctor/panacea_reports_students_filter',$this->data);
	}
	...
	public function pie_export()
	{
		...
		$this->_render_page('panacea_doctor/panacea_pie_export',$this->data);
	}
    ...
    function list_chronic_cases()
	{
	  ...
	  $this->_render_page('panacea_doctor/chronic_case_report',$this->data);
	}
	...
	public function chronic_pie_view(){
		...
		$this->_render_page('panacea_doctor/chronic_pie_view',$this->data);
	}
	...
	public function add_news_feed_view() {
		...
		$this->_render_page ( 'panacea_doctor/add_news_feed', $this->data );
	}
	...
	public function manage_news_feed_view() {
		...
		$this->_render_page ( 'panacea_doctor/manage_news_feed', $this->data );
	}
	public function delete_news_feed($nf_id) {
		$this->panacea_common_lib->delete_news_feed($nf_id);
		
		redirect ( 'panacea_doctor/manage_news_feed_view' );
	}
	...
	public function extend_request_view() 
	{
		...
		$this->_render_page('panacea_doctor/extend_request_view',$this->data);
	}
	...
	public function extend_request()
	{
		...
		$this->_render_page('panacea_doctor/extend_request',$this->data);
	}
	...
	public function app_access($doc_id)
	{
		...
		$this->_render_page('panacea_doctor/extend_request_app',$this->data);
	}
	...
	function hs_req_extend(){
		...
		if($req_return['return_error']){
			...
			redirect('panacea_doctor/extend_request_view');
			//$this->manage_news_feed_view();
		}
	}
	...
	function doctor_req_extend(){
		...
		$form_data = json_decode($_POST['form_data'],true);
		$req_return = $this->panacea_common_lib->doctor_req_extend($form_data);
	...
	{
		$this->data['doc_id'] = $id;
		$this->_render_page('panacea_doctor/ha_req_application_access',$this->data);
	}
	...
	public function feed_bmi_student() 
	 {
		$this->data = "";
		$this->data['message'] = "";
		$this->_render_page('panacea_doctor/panacea_doctor_feed_bmi',$this->data);
	}
	...
	public function show_bmi_student() 
	 {
		...
		$this->_render_page('panacea_doctor/panacea_doctor_show_bmi_graph',$this->data);
	}
	...
	{
		$this->data["message"] = "";		
		$this->_render_page('panacea_doctor/update_personal_info',$this->data);
	}
	...
	public function panacea_update_personal_ehr_uid()
	{
		...
		$this->_render_page('panacea_doctor/panacea_update_personal_ehr',$this->data);
	...
	public function fetch_request_docs_from_hs_list()
	{
		...
		$collection = "healthcare2016531124515424_static_html";
  		...
  		$hs_req_docs  = $this->panacea_doctor_model->get_hs_req_normal_new($collection);

		$hs_req_emergency  = $this->panacea_doctor_model->get_hs_req_emergency_new($collection);

		$hs_req_chronic  = $this->panacea_doctor_model->get_hs_req_chronic_new($collection);

		$hs_req_hospital  = $this->panacea_doctor_model->get_hs_req_hospitalized_new($collection);

		$hs_req_outpatient  = $this->panacea_doctor_model->get_hs_req_outpatient_new($collection);

		$hs_req_review  = $this->panacea_doctor_model->get_hs_req_review_new($collection);
		...
		if(!empty($hs_req_hospital)){
			$this->data['hs_req_hospital'] = $hs_req_hospital;
		}else{
			$this->data['hs_req_hospital'] = "";
		}

		if(!empty($hs_req_outpatient)){
			$this->data['hs_req_outpatient'] = $hs_req_outpatient;
		}else{
			$this->data['hs_req_outpatient'] = "";
		}

		if(!empty($hs_req_review)){
			$this->data['hs_req_review'] = $hs_req_review;
		}else{
			$this->data['hs_req_review'] = "";
		}
		
		$this->_render_page('panacea_doctor/fetch_request_docs_from_hs_list',$this->data);
	}

	public function submitted_request_docs_doctor()
	{
		$collection = "healthcare2016531124515424_static_html";
  		$hs_req_docs  = $this->panacea_doctor_model->get_hs_req_normal_doctor($collection);

		$hs_req_emergency  = $this->panacea_doctor_model->get_hs_req_emergency_doctor($collection);

		$hs_req_chronic  = $this->panacea_doctor_model->get_hs_req_chronic_doctor($collection);
		...
		$this->_render_page('panacea_doctor/submited_request_docs_from_hs_list',$this->data);
	}
	...
	public function access_request_docs_form_hs($id)
	{
		...
		$doc_id = $id;
  		...
  		$this->data['cc_people'] = $this->panacea_common_model->get_field_officer_name();

		$query = $this->panacea_doctor_model->access_request_docs_form_hs($doc_id,$doc_access,$doc_access_by);
		...
		}else
		{
			...
			{ 
				$this->_render_page('panacea_doctor/access_request_docs_form_hs',$this->data);
			}
	...
	public function doctor_submit_request_docs()
        ...
        if(strpos($index,'hs_req_attachments')!== false)
      {
       ...
       $doc_history = $this->tswreis_schools_common_model->get_history($unique_id,$doc_id);
		...
		$doc_properties['doc_access_time'] = 0;
                 ...
                 $approval_history = $this->panacea_common_model->get_approval_history($doc_id);
       ...
       if($add_to_regular_followup == "add_to_regular_followup")
       {
			...
			if($chronic_identifiers)
			{
       		...
       		$this->panacea_doctor_model->create_regular_followup_request($unique_id,$student_name,$class,$request_type,$symptoms,$problem_info_description,$school_name,$district, $scheduled_date, $review_status);
       }
        ...
        if($review_status == 'Hospitalized' || $review_status == "Surgery-Needed" || $review_status == "Expired" || $review_status == "Discharge")
      {
        ...
        $check_doc_id = $this->panacea_doctor_model->check_doc_id_of_request($doc_id);
        
        if($check_doc_id == 'No Doc Found'){
            $insert_hospitalised = $this->panacea_doctor_model->insert_hospitalised_students_data($doc_data,$approval_history,$unique_id,$doc_id,$doc_properties);
        }
      }

      if($add_to_regular_followup == "add_to_regular_followup"){

      	$check_regular = $this->panacea_doctor_model->check_and_get_if_regular_is_there($doc_id, $unique_id);
  	  ...
  	  $existing_update = $this->panacea_doctor_model->request_docs_update_doctor_model($doc_data,$approval_history,$unique_id,$doc_id,$doc_properties, $followups); 
	...
	public function reports_display_ehr_uid_new_html_static_hs()
	{
		...
		$this->_render_page('panacea_doctor/panacea_reports_display_ehr_new_dashboard',$this->data);
	}
//--------------attachments decleration 
	...
	public function regular_followup_students()
	{
		$regular_followup_cases_from_requests = $this->panacea_doctor_model->get_regular_followup_cases_from_requests();
		...
		$this->_render_page('panacea_doctor/regular_followup_students', $this->data);
	}
	...
	public function update_regular_followup_feed_data()
	{
		...
		if($this->form_validation->run() == FALSE ){
			...
			$this->load->view('panacea_doctor/regular_followup_students');
			...
			$date = new DateTime($next_scheduled_date);
			$next_scheduled_date= $date->format('Y-m-d');

			$update = $this->panacea_doctor_model->update_requests_followup_data($student_id
										,$case_id,$created_time,$medicine_details,$followup_desc, $next_scheduled_date);


			redirect('panacea_doctor/regular_followup_students');
	...
	public function close_followup_request()
	{
		...
		$close_request = $this->panacea_doctor_model->close_followup_request($case_id);
	...
	public function get_parent_submitted_details()
	{
		 $this->data['distslist'] = $this->panacea_common_model->get_all_district();
		$this->_render_page('panacea_doctor/get_parent_submitted_details', $this->data);
	}

	public function parents_personal_details_form()
	{
		$unique_id = $_GET['id_'];
		
		$docs = $this->panacea_common_model->drill_down_screening_to_students_load_ehr_panacea_new_dashboard($unique_id);

		$family_health = $this->panacea_common_model->get_family_health_details($unique_id);
		...
		$this->data['family_data'] = $family_health;

		
		//$this->data = $this->panacea_common_model->get_student_family_data($unique_id);
		$this->_render_page('panacea_doctor/parents_personal_details_form', $this->data);
	}

	public function doctor_analysis()
	{
		$this->data = "";
		$this->_render_page('panacea_doctor/doctor_analysis', $this->data);
	}

	public function get_parents_health_submitted_docs_data()
	{
		...
		$this->data = $this->panacea_common_model->get_parents_health_submitted_docs_data($start, $end, $district, $school);
	...
	public function doctor_analysis_for_student_family()
	{
		$session_data = $this->session->userdata("customer");

		$current = $this->input->post('current_condition', true);
		$parent = $this->input->post('parent_condition', true);
		$doc_advice = $this->input->post('advice_condition', true);
		$unique = $this->input->post('uid', true);
		$stud_status = $this->input->post('zone', true);
		...
		$this->data = $this->panacea_common_model->doctor_analysis_for_student_family($current, $parent, $doc_advice, $unique, $date, $doctor_data, $stud_status);
	...
	public function edit_submitted_request_docs()
	{
		$this->data = "";
		$this->_render_page("panacea_doctor/edit_submitted_request_docs", $this->data);
	}
