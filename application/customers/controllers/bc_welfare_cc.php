...
class bc_welfare_cc extends My_Controller {
	...
	{
		redirect('bc_welfare_cc/to_dashboard');
	}
	
	public function initiate_request()
	{
		$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_application_initiate',$this->data);
	}
	
	public function initiate_attendance()
	{
		$this->data['districts_list'] =  $this->bc_welfare_cc_model->get_all_district();
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_attendance_initiate',$this->data);
	}
	...
	public function create_attendence_report()
    {
        ...
        $district = $this->bc_welfare_cc_model->get_dist_name_with_dist_id( $districtID);
        ...
        $added = $this->bc_welfare_cc_model->create_attendence_report_model($doc_data, $doc_properties, $app_properties, $history);
        if($added)
        {
        ...
        {
            redirect('bc_welfare_cc/initiateAttendanceReport');
        }
    ...
    public function get_schools_list_by_district()
	{
		...
		$this->data = $this->bc_welfare_cc_model->get_schools_by_dist_id_model($dist_id);
		//$this->data = "";
	...
	{
		$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_sanitation_report',$this->data);
	}
	
	public function bc_welfare_cc_states()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_states');
	    
	    $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_states();
		
		//$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_states',$this->data);
	}
	
	public function bc_welfare_cc_district()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_district');

        $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_district();
		
		//$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_dist',$this->data);
	}
	
	public function bc_welfare_cc_health_supervisors()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_health_supervisors');
        $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_health_supervisors();
		
		//$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_health_supervisors',$this->data);
	}
	
	
	//////////////////////////////////////////////////////
	
	public function bc_welfare_cc_schools()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_schools');

        $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_schools();
		
		//$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_schools',$this->data);
	}
	
	//000000000000000000000000000000000000
	public function bc_welfare_cc_classes()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_schools');
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_classes',$this->data);
	}
	
	//sssssssssssssssssssssssssssssssssssssssssss
	public function bc_welfare_cc_sections()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_schools');
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_sections',$this->data);
	}
	
	//syyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy
	public function bc_welfare_cc_symptoms()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_symptoms');

        $this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_symptoms();
		
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_symptoms',$this->data);
	}
	
	public function bc_welfare_cc_diagnostic()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_diagnostics');
	
		$this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_diagnostic();
	
		//$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_diagnostics',$this->data);
	}	
	
	public function bc_welfare_cc_hospitals()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_hospitals');
	
		$this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_hospitals();
	
		//$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_hospitals',$this->data);
	}
	
	public function bc_welfare_cc_emp()
	{
		$this->check_for_admin();
		$this->check_for_plan('bc_welfare_cc_emp');
	
		$this->data = $this->bc_welfare_common_lib->bc_welfare_mgmt_emp();
	
		//$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_emp',$this->data);
	}
	...
	{
		$this->data["message"] = "";		
		$this->_render_page('bc_welfare_cc/bc_welfare_reports_ehr',$this->data);
	}
	...
	public function bc_welfare_reports_display_ehr()
	{
		...
		$this->data = $this->bc_welfare_common_lib->bc_welfare_reports_display_ehr($post);
	 	...
	 	$this->_render_page('bc_welfare_cc/bc_welfare_reports_display_ehr',$this->data);
	}
	...
	public function bc_welfare_reports_students()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_reports_students',$this->data);
	}
	...
	public function bc_welfare_reports_doctors()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_reports_doctors',$this->data);
	}
	...
	public function bc_welfare_reports_hospital()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_reports_hospitals',$this->data);
	}
	...
	public function bc_welfare_reports_school()
	{
		...
		//$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_reports_schools',$this->data);
	}
	...
	public function bc_welfare_reports_symptom()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_reports_symptom',$this->data);
	}
	...
	function to_dashboard($date = FALSE, $request_duration = "Monthly", $screening_duration = "Yearly")
	{
		...
		$hs_req_docs  = $this->bc_welfare_cc_model->get_hs_req_docs($collection);
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_dash', $this->data);
	...
	function to_dashboard_with_date()
	{
		...
		$this->data = $this->bc_welfare_common_lib->to_dashboard_with_date($today_date,$request_pie_span,$screening_pie_span,$dt_name,$school_name);
	...
	function update_request_pie()
	{
		...
		$today_date = $_POST['today_date'];
		$request_pie_span = $_POST['request_pie_span'];
		$this->data = $this->bc_welfare_common_lib->update_request_pie($today_date,$request_pie_span);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$this->_render_page('bc_welfare_cc/drill_down_screening_to_students_load_ehr',$this->data);
	}
	
	public function drill_down_screening_to_students_load_ehr_doc($_id)
	{
		//$this->data['docs'] = $this->bc_welfare_cc_model->drill_down_screening_to_students_load_ehr_doc($_id);
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		$this->_render_page('bc_welfare_cc/drill_down_absent_to_students_load_ehr',$this->data);
	}
	...
	function drilldown_request_to_districts()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$request_report = json_encode($this->bc_welfare_common_model->drilldown_request_to_districts($data,$today_date,$request_pie_span,$dt_name,$school_name));
	...
	function drilling_request_to_schools()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$request_report = json_encode($this->bc_welfare_common_model->get_drilling_request_schools($data,$today_date,$request_pie_span,$dt_name,$school_name));
		$this->output->set_output($request_report);
	}
	...
	function drill_down_request_to_students()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$docs = $this->bc_welfare_common_model->get_drilling_request_students($data,$today_date,$request_pie_span,$dt_name,$school_name);
	...
	function drill_down_request_to_students_load_ehr()
	{
		...
		$this->_render_page('bc_welfare_cc/drill_down_request_to_students_load_ehr',$this->data);
	}
	//========================================================================
	...
	function drilldown_identifiers_to_districts()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$identifiers_report = json_encode($this->bc_welfare_common_model->drilldown_identifiers_to_districts($data,$today_date,$request_pie_span,$dt_name,$school_name));
	...
	function drilling_identifiers_to_schools()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$identifiers_report = json_encode($this->bc_welfare_common_model->get_drilling_identifiers_schools($data,$today_date,$request_pie_span,$dt_name,$school_name));
		$this->output->set_output($identifiers_report);
	}
	...
	function drill_down_identifiers_to_students()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$docs = $this->bc_welfare_common_model->get_drilling_identifiers_students($data,$today_date,$request_pie_span,$dt_name,$school_name);
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		$this->_render_page('bc_welfare_cc/drill_down_identifiers_to_students_load_ehr',$this->data);
	}
	...
	function bc_welfare_imports_diagnostic()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_imports_diagnostic', $this->data);
	}
	...
	function import_diagnostic()
	{
		...
		{
			redirect('bc_welfare_cc/bc_welfare_cc_diagnostic');
	...
	function bc_welfare_imports_hospital()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_imports_hospital', $this->data);
	}
	...
	function import_hospital()
	{
		...
		{
			redirect('bc_welfare_cc/bc_welfare_cc_hospitals');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('bc_welfare_cc/bc_welfare_imports_hospital', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function bc_welfare_imports_school()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_imports_school', $this->data);
	}
	...
	function import_school()
	{
		...
		{
			redirect('bc_welfare_cc/bc_welfare_cc_schools');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('bc_welfare_cc/bc_welfare_imports_school', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function bc_welfare_imports_health_supervisors()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_imports_health_supervisors', $this->data);
	}
	...
	function import_health_supervisors()
	{
		...
		{
			redirect('bc_welfare_cc/bc_welfare_cc_health_supervisors');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('bc_welfare_cc/bc_welfare_imports_health_supervisors', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function bc_welfare_imports_students()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_imports_students', $this->data);
	}
	...
	function import_students()
	{
		...
		{
			redirect('bc_welfare_cc/bc_welfare_reports_students');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('bc_welfare_cc/bc_welfare_imports_students', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function read_excel()
	{
		...
		for($j=$row_value+1;$j<count($arr_data);$j++){
			...
			$doc_properties['doc_owner'] = "bc_welfare";
	...
	public function bc_welfare_reports_students_filter()
	{
		...
		//$this->data = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_reports_students_filter',$this->data);
	}
	...
	public function get_students_list()
	{
		...
		$this->data = $this->bc_welfare_common_model->get_students_by_school_name_cc_user_model($school_name,$dist_name);
		//$this->data = "";
		$this->output->set_output(json_encode($this->data));
	}
	...
	public function pie_export()
	{
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_pie_export',$this->data);
	}
	...
	public function post_note() {
		...
		$token = $this->bc_welfare_common_lib->insert_ehr_note($post,$username);
    ...
    function list_chronic_cases()
	{
	  ...
	  $total_rows = $this->bc_welfare_common_model->bc_welfare_chronic_cases_count();
	  ...
	  $this->data['cases_old'] =$this->bc_welfare_common_model->get_chronic_cases_model($config['per_page'],$page);
	  ...
	  $this->data['cases'] =$this->bc_welfare_common_model->get_chronic_cases_model_for_data_table();
		
	  $this->_render_page('bc_welfare_cc/chronic_case_report',$this->data);
	}
	...
	function create_schedule_followup()
	{
	  ...
	  $is_created = $this->bc_welfare_common_model->create_schedule_followup_model($unique_id,$medication_schedule,$treatment_period,$start_date,$monthNames,$case_id);
	...
	public function chronic_pie_view(){
		...
		$this->_render_page('bc_welfare_cc/chronic_pie_view',$this->data);
	}
	...
	public function add_news_feed_view() {
		...
		$this->_render_page ( 'bc_welfare_cc/add_news_feed', $this->data );
	}
	...
	public function manage_news_feed_view() {
		...
		$this->_render_page ( 'bc_welfare_cc/manage_news_feed', $this->data );
	}
	public function delete_news_feed($nf_id) {
		$this->bc_welfare_common_lib->delete_news_feed($nf_id);
		
		redirect ( 'bc_welfare_cc/manage_news_feed_view' );
	}
	...
	public function extend_request_view() 
	{
		...
		$this->_render_page('bc_welfare_cc/extend_request_view',$this->data);
	}
	
	public function extend_request()
	{
		$post = $_POST;
		$this->data = $this->bc_welfare_common_model->get_reports_for_extend($post['uid']);
		$this->data['message'] = false;
	
		$this->_render_page('bc_welfare_cc/extend_request',$this->data);
	}
	...
	public function app_access($doc_id)
	{
		...
		$this->_render_page('bc_welfare_cc/extend_request_app',$this->data);
	}
	...
	function hs_req_extend(){
		...
		if($req_return['return_error']){
			...
			redirect('bc_welfare_cc/extend_request_view');
			//$this->manage_news_feed_view();
		}
	}
	...
	{
		$this->data['doc_id'] = $id;
		$this->_render_page('bc_welfare_cc/ha_req_application_access',$this->data);
	}
  	...
  	public function fetch_student_info()
	{
		...
		$this->data['get_data'] = $this->bc_welfare_cc_model->fetch_student_info_model( $unique_id);
	...
	public function feed_bmi_student() 
	 {
		$this->data = "";
		$this->data['message'] = "";
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_feed_bmi',$this->data);
	}
	...
	public function show_bmi_student() 
	 {
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_cc_show_bmi_graph',$this->data);
	}
	...
	public function student_bmi_graph(){
		...
		$bmi_value = $this->bc_welfare_common_model->get_student_bmi_values($unique_id);
	...
	{
		$this->data["message"] = "";		
		$this->_render_page('bc_welfare_cc/update_personal_info',$this->data);
	}
	
	public function bc_welfare_update_personal_ehr_uid()
	{
		$post = $_POST;
		$this->data = $this->bc_welfare_common_lib->bc_welfare_update_personal_ehr_uid($post);
		
		$this->data['docscount'] = count($this->data['docs']);
	
		$this->_render_page('bc_welfare_cc/bc_welfare_update_personal_ehr',$this->data);
	...
	public function update_student_ehr()
	{
	  ...
	  $ehr_update = $this->bc_welfare_common_model->update_student_ehr_model($unique_id,$update_profile); 
	...
	public function field_officer()
	{
		...
		$this->_render_page('bc_welfare_cc/field_officer', $this->data);
	}
        ...
        if(strpos($index,'hs_req_attachments')!== false)
		 {
	        ...
	        else
	        {
				...
				$app_properties['app_name'] = "BC-WELFARE Field Officer report App";
				$app_properties['app_id'] = "Field offcer";
				...
				$newly_created = $this->bc_welfare_cc_model->submit_field_officer($doc_data,$doc_attachments, $doc_properties, $app_properties, $history);
				redirect('bc_welfare_cc/field_officer');
	...
	function field_officer_chart() {
		...
		$this->_render_page('bc_welfare_cc/field_officer_pie',$this->data);
	...
	function fetch_field_officer_reports() {
		...
		$reports = $this->bc_welfare_cc_model->fetch_field_officer_reports($today_date);
	...
	public function drill_down_to_field_officer_reports(){
		...
		$this->data['student_list'] = $this->bc_welfare_cc_model->drill_down_to_field_officer_reports_list($selectedCase, $selectedDate);
		$this->data['selected_case'] = $selectedCase;
		$this->data['selected_date'] = $selectedDate;
		$this->_render_page('bc_welfare_cc/field_officer_submit_student_list',$this->data);
	  	
	}
	public function show_doctor_treated_student($doc_id)
	{
		$this->data['unique_id'] = $this->bc_welfare_cc_model->show_field_officer_submit_student($doc_id);
		$this->_render_page('bc_welfare_cc/field_officer_show_submitted_list',$this->data);
	}
	/*
	...
	*/
	public function hs_request()
	{
		...
		$this->_render_page('bc_welfare_cc/hs_initiate_request', $this->data);
	}
		  ...
		  if(isset($_FILES) && !empty($_FILES))
    {
        ...
        foreach ($_FILES as $index => $value)
       {
        ...
        else
        {
		 ...
		 $school_data = $this->bc_welfare_cc_model->get_school_information_for_school_code($schoolCode);
		 ...
		 if(array_key_exists("user_type",$session_data))
		 {
			...
			{
			 	 $health_supervisor = $this->bc_welfare_cc_model->get_health_supervisor_details($schoolCode);
			 	 $hs_name = $health_supervisor['hs_name'];
			 	 $hs_mob  = $health_supervisor['hs_mob'];		
			}
		 }
...
//		echo print_r($doc_data,true);
  	  ...
  	  if ($initate_submit ) // the information has therefore been successfully saved in the db
			{
				...
				redirect('bc_welfare_cc/hs_request');
			}
			else
			{
  		...
  		public function fetch_submited_requests_docs()
  	{
  		...
  		*/
  		...
  		$hs_req_docs  = $this->bc_welfare_cc_model->get_hs_req_normal($collection);

		$hs_req_emergency  = $this->bc_welfare_cc_model->get_hs_req_emergency($collection);

		$hs_req_chronic  = $this->bc_welfare_cc_model->get_hs_req_chronic($collection);

		$hs_req_chronic_anemia  = $this->bc_welfare_cc_model->get_hs_req_chronic_anemia($collection);
		...
		if(!empty($hs_req_chronic_anemia)){
			$this->data['hs_req_chronic_anemia'] = $hs_req_chronic_anemia;
		}else{
			$this->data['hs_req_chronic_anemia'] = "";
		}
		
  		$this->_render_page('bc_welfare_cc/fetch_submited_requests_docs',$this->data);
  	}
  	//upadate request
  	public function access_submited_request_docs($id)
  	{
  		$doc_id = $id;
		$query = $this->bc_welfare_cc_model->access_submited_request_docs($doc_id);
		$this->data['hs_req_docs'] = $query;
		$this->_render_page('bc_welfare_cc/access_submited_request_docs',$this->data);
  	}
  	/*
	...
	*/
		 ...
		 if(isset($_FILES) && !empty($_FILES))
    {
        ...
        if(strpos($index,'hs_req_attachments')!== false)
      {
       ...
       $doc_history = $this->bc_welfare_cc_model->get_history($unique_id,$doc_id);
  	...
  	/* $history = array();
		...
		*/
		...
		$approval_history = $this->bc_welfare_cc_model->get_approval_history($doc_id);

		array_push($approval_history,$approval_data);

  	  $existing_update = $this->bc_welfare_cc_model->update_request_submit_model($doc_data,$approval_history,$unique_id,$doc_id,$doc_properties); 
  	  ...
  	  if ($existing_update ) // the information has therefore been successfully saved in the db
			{
				...
				redirect('bc_welfare_cc/fetch_submited_requests_docs');
			}
			else
			{
				$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
  	...
  	public function reports_display_ehr_uid_new_html_static_hs()
	{
		...
		$school_info = $this->bc_welfare_cc_model->get_school_info($school_code);
		$school_name = $school_info[0]['school_name'];

		$logged_in_user = $this->session->userdata("customer");
		$username       = $logged_in_user['username'];

        $this->data = $this->bc_welfare_common_lib->reports_display_ehr_uid_new_html_static_hs($student_unique_id,$school_name);
		...
		$this->_render_page('bc_welfare_cc/bc_welfare_reports_display_ehr_new_dashboard',$this->data);
	}
	...
	public function initiateHemoglobinReport()
	{
		...
		$this->data["district_code"] = strtoupper($email_array[0]);
	  	...
	  	$this->_render_page('bc_welfare_cc/bc_welfare_cc_hb_view', $this->data);
	}
 	...
 	public function create_hemoglobin_report()
  	{
		...
		$health_supervisor = $this->bc_welfare_cc_model->get_health_supervisor_details($schoolCode);
 	 	$hs_name = $health_supervisor['hs_name'];
 	 	$hs_mob  = $health_supervisor['hs_mob'];		 	 	
		$school_info = $this->bc_welfare_cc_model->get_school_info($schoolCode);
		$school_name = $school_info[0]['school_name'];
		$dist = explode(',', $school_name);
		$districtName = $dist[1];
		$is_exists  = $this->bc_welfare_cc_model->check_if_doc_exists_in_hb($uniqueId);
		...
		if(!empty($is_exists))
		{
		   ...
		   if($hb_count_value < 13 )
		   {
			...
			$existing_update = $this->bc_welfare_cc_model->update_hb_values($ndate,$monthly_hb, $uniqueId);
			...
			if ($existing_update ) // the information has therefore been successfully saved in the db
			{
				...
				redirect('bc_welfare_cc/initiateHemoglobinReport');
			}
			else
			{
				$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
			...
			else 
			{
			   ...
			   if($hb_count_value < 13 )
			   {
				...
				$newly_created = $this->bc_welfare_cc_model->add_student_HB_model($monthly_hb, $doc_properties, $app_properties, $history,$hb_values_data);
	...
	public function get_searched_student_sick_requests()
	{
		...
		$this->data = $this->bc_welfare_cc_model->get_searched_student_sick_requests_model($search_data);
    ...
    /* $this->data["school_code"]   = $email_array[1];
     $this->data["district_code"] = strtoupper($email_array[0]);
     $this->data["message"] = "";*/
     $this->_render_page('bc_welfare_cc/update_screening_info_view',$this->data);
	}
	...
	public function search_screening_info_by_unique_id()
	{
		...
		$this->data = $this->bc_welfare_common_lib->get_study_circle_data_lib($post);

		$this->data['docscount'] = count($this->data['docs']);

		$this->_render_page('bc_welfare_cc/get_screening_report_view',$this->data);
...
*/
		...
		$dental_referral_made = $this->input->post('dental_referral_made');
		  ...
		  $query = $this->bc_welfare_cc_model->get_pf_photo($uniqueid);
		  ...
		  $doc_data['page3']['Physical Exam']['Blood Group']     	= $blood_group;
		   ...
		   // Student Photo
			...
			$doc_history = $this->bc_welfare_cc_model->get_student_history($uniqueid);
	  	...
	  	$added = $this->bc_welfare_cc_model->update_screening_report_model($uniqueid, $doc_data,$history);
	  	if ($added ) // the information has therefore been successfully saved in the db
		{
			...
			redirect('bc_welfare_cc/update_student_info_view');
		}
