...
class Panacea_secretary extends My_Controller {
    ...
    function __construct()
	{
		...
		$this->load->model('panacea_secretary_model');
	...
	public function panacea_reports_display_ehr_uid()
	{
		...
		$this->_render_page('panacea_secretary/panacea_display_new_ehr',$this->data);
	}
	...
	public function panacea_reports_students()
	{
		...
		$this->_render_page('panacea_secretary/panacea_reports_students',$this->data);
	}
	...
	public function panacea_reports_doctors()
	{
		...
		$this->_render_page('panacea_secretary/panacea_reports_doctors',$this->data);
	}
	...
	public function panacea_reports_hospital()
	{
		...
		$this->_render_page('panacea_secretary/panacea_reports_hospitals',$this->data);
	}
	...
	public function panacea_reports_school()
	{
		...
		//$this->data = "";
		$this->_render_page('panacea_secretary/panacea_reports_schools',$this->data);
	}
...
// 	 	$this->index();
	...
	*/
	 ...
	 public function basic_dashboard($date = FALSE, $request_duration = "Daily", $screening_duration = "Yearly")
	{
		...
		//$this->_render_page('panacea_admins/panacea_admin_dash',$this->data);
		$this->_render_page('panacea_secretary/panacea_secretary_dashboard',$this->data);
  ...
  public function disease_wise_students_list()
  {
        $this->data['today_date'] = date('Y-m-d');
        $this->data['district_list'] = $this->panacea_common_model->get_all_district();
        $this->_render_page('panacea_secretary/disease_wise_students_list',$this->data);
  }
  ...
  public function get_month_wise_diseases()
 {
  ...
  public function get_students_list_based_on_request_symptom()
  {
      ...
      $this->_render_page('panacea_secretary/students_list_based_on_request_symptom',$this->data);
  }
 ...
 public function get_searched_student_sick_requests()
  ...
  public function get_screening_pie_values()
	...
	/*public function to_daily_health_request()
	{
		...
		$this->data['students_details'] = $this->panacea_common_model->to_daily_health_request($date, $request_type);
		//echo print_r($this->data,true); exit();
	...
	public function to_daily_health_request()
	{
		...
		$this->_render_page('panacea_secretary/to_daily_health_request', $this->data);
	...
	public function get_attendance_data_for_bar_schools()
	{
		...
		$this->_render_page('panacea_secretary/attendance_data_for_schools', $this->data);
	}
	...
	public function get_attendance_data_for_bar_students()
	{
		...
		$this->_render_page('panacea_secretary/attendance_data_for_students', $this->data);
	}
	...
	public function get_sanitation_report_school_wise()
	{
		...
		$this->_render_page('panacea_secretary/sanitation_display_report_view', $this->data);
	}
	...
	public function get_hospitalized_data_table()
	{
		...
		$this->_render_page('panacea_secretary/hospitalised_students_table_data' , $this->data);
	...
	public function get_hospital_type_of_bar_count()
	{
	    $today_date = $this->input->post('today_date', true);
	    //echo print_r($today_date, true); exit();
	    $this->data = $this->panacea_common_model->get_hospital_type_of_bar_count_model($today_date); 
   ...
   public function get_hospital_type_data_table()
    {
        ...
        $date = $this->input->post('hospital_date', true);
        $hospital_type = $this->input->post('hospital_value', true);
        
        $this->data['students_details'] = $this->panacea_common_model->get_hospital_type_data_table_model($date, $hospital_type);
	...
	public function get_admitted_students_school_with_span()
	{
	  ...
	  $this->_render_page('panacea_secretary/admitted_cases_school_wise_list', $this->data);
	}
	...
	public function get_students_for_admitted()
	{
	  ...
	  $this->_render_page('panacea_secretary/admitted_cases_students_wise_list', $this->data);
	}
    ...
    $this->data = $this->panacea_common_model->get_hb_gender_wise_data_count_model($today_date); 
     ...
     public function get_hb_gender_wise_data_table()
    {
        ...
        $date = $this->input->post('date_hb', true);
        $hb_type = $this->input->post('hb_type', true);
        $hb_gender = $this->input->post('hb_gender', true);

        $this->data['schools_list'] = $this->panacea_common_model->get_hb_gender_wise_data_table_model($date, $hb_type, $hb_gender);
        //echo print_r($this->data,true); exit();
         $this->data['gender'] = $hb_gender;
        $this->data['type']  = $hb_type;
        $this->data['date']  = $date;
        $this->_render_page('panacea_secretary/hb_gender_wise_schools_data_count_view', $this->data);
     ...
     public function hb_gender_wise_students_data()
    {
        ...
        $this->data['students_details'] = $this->panacea_common_model->get_hb_gender_wise_students_data_table_model($date_hb, $hb_type, $hb_gender, $school_name);
        ...
        $this->_render_page('panacea_secretary/hb_gender_wise_students_data_view', $this->data);      
    ...
    $this->data = $this->panacea_common_model->get_bmi_gender_wise_data_count_model($today_date); 
     ...
     public function get_bmi_gender_wise_data_table()
    {
        ...
        $date = $this->input->post('date_bmi', true);
        $bmi_type = $this->input->post('bmi_type', true);
        $bmi_gender = $this->input->post('bmi_gender', true);

        $this->data['schools_list'] = $this->panacea_common_model->get_bmi_gender_wise_data_table_model($date, $bmi_type, $bmi_gender);
        //echo print_r($this->data,true); exit();
        $this->data['date']  = $date;
    ...
    public function bmi_gender_wise_students_data()
    {
        ...
        $date_bmi = $this->input->post('date', true);
        $bmi_type = $this->input->post('type', true);
        $bmi_gender = $this->input->post('gender', true);
        $school_name = $this->input->post('school_name', true);
        
        $this->data['students_details'] = $this->panacea_common_model->get_bmi_gender_wise_students_data_table_model($date_bmi, $bmi_type, $bmi_gender, $school_name);
    ...
    public function get_predictive_counts_zone_wise()
    {
    	$academic_year = $this->input->post('academic', true);
      	$district = $this->input->post('dist_id', true);
      	$school_name = $this->input->post('scl_id', true);

      	$this->data = $this->panacea_common_model->get_predictive_counts_zone_wise($academic_year, $district, $school_name);
    ...
    public function get_schools_for_predictive_zones()
    {
    	$academic_year = $this->input->post('predictive_academic', true);
      	$district = $this->input->post('predictive_dist', true);
      	$school_name = $this->input->post('predictive_scl', true);
      	$zone = $this->input->post('value_zone', true);

      	/*echo print_r($academic_year, true);
      	echo print_r($district, true);
      	echo print_r($school_name, true);
      	echo print_r($zone, true);
      	exit();*/
      	$this->data['academic'] = $academic_year;
      	$this->data['dist'] = $district;
      	$this->data['scl'] = $school_name;
      	$this->data['predi_zone'] = $zone;

      	$this->_render_page('panacea_secretary/predective_reports_schools', $this->data);

    }

    public function school_wise_predictive_zones()
    {
    	...
    	$academic_year = $this->input->post('predictive_academic', true);
      	...
      	$this->data = $this->panacea_common_model->school_wise_predictive_zones($academic_year, $district, $school_name, $zone);
    ...
    public function get_predictive_students_selected_school()
    {
    	$school = $this->input->post('select_scl', true);
      	$academic = $this->input->post('select_date', true);
      	$zone = $this->input->post('select_zone', true);

      	$this->data['students'] = $this->panacea_common_model->get_predictive_students_selected_school($school, $academic, $zone);

      	$this->_render_page('panacea_secretary/predective_reports_students', $this->data);
    }
    ...
    public function panacea_today_followup_cases()
    {
        ...
        $this->_render_page('panacea_secretary/panacea_today_followup_cases');
    }
    ...
    public function show_sanitation_submitted_pics()
    {
        ...
        $this->_render_page('panacea_secretary/show_sanitation_submitted_pics', $this->data);
    ...
    {    	
    	...
    	$file_path = $this->panacea_common_lib->get_symptoms_monthly_tracking_excel($selectedSchool, $selectedDistrict, $selectedMonth);
    	$this->output->set_output($file_path);
    }
