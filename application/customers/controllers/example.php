...
class Example extends MY_Controller
{
    ...
    public function request_dropbox()
	{
		...
		$this->session->set_userdata('redirect', $data['redirect']);
	...
	public function access_dropbox()
	{
		...
		$this->load->library('dropbox', $params);
		$oauth = $this->dropbox->get_access_token($this->session->userdata('token_secret'),'',$this->session->userdata('redirect'));
...
/* Location: ./application/customers/controllers/example.php */