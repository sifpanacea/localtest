...
class Tswreis_schools extends My_Controller {
	...
	{
		redirect('tswreis_schools/to_dashboard');
	}
	
	public function initiate_request()
	{
		$this->data = "";
		$this->_render_page('tswreis_schools/application_initiate',$this->data);
	}
	
	public function access_request($id)
	{
		$this->data['doc_id'] = $id;
		$this->_render_page('tswreis_schools/hs_req_application_access',$this->data);
	}
	
	public function initiate_attendance()
	{
		$this->data = "";
		$this->_render_page('tswreis_schools/attendance_initiate',$this->data);
	}
	
	public function initiate_sanitation_report()
	{
		$this->data = "";
		$this->_render_page('tswreis_schools/sanitation_report',$this->data);
	}
	...
	function list_chronic_cases()
	{
	  ...
	  $total_rows = $this->tswreis_schools_common_model->tswreis_chronic_cases_count($school_name);
	  ...
	  /*$this->data['cases'] =$this->tswreis_schools_common_model->get_chronic_cases_model($config['per_page'],$page,$school_name);*/
	  ...
	  $this->data['cases'] =$this->tswreis_schools_common_model->get_chronic_cases_model_for_data_table($school_name);
		
	  $this->_render_page('tswreis_schools/chronic_case_report',$this->data);
	}
	...
	function to_dashboard($date = FALSE, $request_duration = "Monthly", $screening_duration = "Yearly")
	{
		...
		$this->data = $this->tswreis_schools_common_lib->to_dashboard($date, $request_duration, $screening_duration);
		//echo print_r($this->data,true);exit();
		$this->_render_page('tswreis_schools/school_dash', $this->data);
	...
	function to_dashboard_with_date()
	{
		...
		$this->data = $this->tswreis_schools_common_lib->to_dashboard_with_date($today_date,$request_pie_span,$screening_pie_span);
	...
	function fetch_sanitation_report_against_date()
	{
	  ...
	  $sanitation_report_data = $this->tswreis_schools_common_model->get_sanitation_report_data_with_date($date,$school_name);
		
	  $sanitation_report = $this->tswreis_schools_common_lib->build_sanitation_report($sanitation_report_data);
	...
	function update_request_pie()
	{
		...
		$today_date       = $_POST['today_date'];
		$request_pie_span = $_POST['request_pie_span'];
		$this->data = $this->tswreis_schools_common_lib->update_request_pie($today_date,$request_pie_span);
	...
	function update_screening_pie()
	{
		...
		$today_date         = $_POST['today_date'];
		$screening_pie_span = $_POST['screening_pie_span'];
		$this->data = $this->tswreis_schools_common_lib->update_screening_pie($today_date,$screening_pie_span);
	...
	function refresh_screening_data()
	{
		...
		$this->tswreis_schools_common_model->update_screening_collection($today_date,$screening_pie_span,$school_name);
		$today_date = $this->tswreis_schools_common_model->get_last_screening_update();
	...
	function drilling_screening_to_abnormalities()
	{
		...
		$today_date = $_POST['today_date'];
		$screening_pie_span = $_POST['screening_pie_span'];
		$screening_report = json_encode($this->tswreis_schools_common_model->get_drilling_screenings_abnormalities($data,$today_date,$screening_pie_span));
	...
	function drill_down_screening_to_students()
	{
		...
		$today_date = $_POST['today_date'];
		$screening_pie_span = $_POST['screening_pie_span'];
		$docs = $this->tswreis_schools_common_model->get_drilling_screenings_students($data,$today_date,$screening_pie_span);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$get_docs = $this->tswreis_schools_common_model->get_drilling_screenings_students_docs($docs_id);
		...
		$this->_render_page('tswreis_schools/drill_down_screening_to_students_load_ehr',$this->data);
	}
	...
	public function drill_down_screening_to_students_load_ehr_doc($_id)
	{
		...
		$this->_render_page('tswreis_schools/tswreis_schools_reports_display_ehr',$this->data);
	}
	public function get_students_load_ehr_doc($_id)
	{
		$docs = $this->tswreis_schools_common_model->get_students_load_ehr_doc_model($_id);
	...
	public function get_students_load_ehr_doc_basic_dashboard($_id)
	{
		...
		$this->_render_page('tswreis_schools/tswreis_schools_reports_display_ehr_new',$this->data);
	}
	
	public function drill_down_screening_initiate_request($_id)
	{
		$this->data['doc'] = $this->tswreis_schools_common_model->drill_down_screening_to_students_doc($_id);
	
		$this->_render_page('tswreis_schools/panacea_reports_display_ehr',$this->data);
	}
	...
	function drill_down_absent_to_students()
	{
		...
		// Get my school code
		$school_code = $this->get_my_school_code();
		$school_data = $this->tswreis_schools_common_model->get_school_details_for_school_code($school_code);
		
		$docs = $this->tswreis_schools_common_model->get_drilling_absent_students($label,$today_date,$school_data['school_name']);
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		$get_docs = $this->tswreis_schools_common_model->get_drilling_absent_students_docs($UI_id);
		...
		$this->_render_page('tswreis_schools/drill_down_absent_to_students_load_ehr',$this->data);
	}
	...
	function drill_down_absent_to_students_load_ehr_basic()
	{
		$this->check_for_admin();
		$this->check_for_plan('drill_down_absent_to_students_load_ehr');
		$temp = trim($_POST['ehr_data_for_absent']);
	...
	function drill_down_request_to_students()
	{
		...
		log_message("debug","request_labelllllllllllllllllll".print_r($request_label,true));
		$today_date       = $_POST['today_date'];
		$request_pie_span = $_POST['request_pie_span'];
		...
		$docs = $this->tswreis_schools_common_model->get_drilling_request_students($request_label,$today_date,$request_pie_span,$school_name,$id_pattern);
	...
	function drill_down_request_to_students_load_ehr()
	{
		...
		$get_docs = $this->tswreis_schools_common_model->get_drilling_request_students_docs($UI_id);
		...
		$this->_render_page('tswreis_schools/drill_down_request_to_students_load_ehr',$this->data);
	}
	...
	function drill_down_identifiers_to_students()
	{
		...
		$docs = $this->tswreis_schools_common_model->get_drilling_identifiers_students($identifier,$today_date,$request_pie_span,$school_name,$id_pattern);
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		$get_docs = $this->tswreis_schools_common_model->get_drilling_identifiers_students_docs($UI_id); 
		$this->data['students'] = $get_docs;
		log_message('debug','drill_down_identifiers_to_students_load_ehr===tsreis==410'.print_r($this->data['students'],true));
		//set the flash data error message if there is one
		$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
	
		$this->_render_page('tswreis_schools/drill_down_identifiers_to_students_load_ehr',$this->data);
	}
	 ...
	 public function classes()
	{
		...
		$this->data = $this->tswreis_schools_common_lib->classes($school_code);
		$this->_render_page('tswreis_schools/classes',$this->data);
	}
	...
	public function create_class()
	{
	    ...
	    $school_code = $this->get_my_school_code();
	 	...
	 	$this->tswreis_schools_common_model->create_class($_POST, $school_code);	
	 	redirect('tswreis_schools/classes');
	}
	...
	public function delete_class($class_id)
	{
	    ...
	    $school_code = $this->get_my_school_code();
	 	...
	 	$this->tswreis_schools_common_model->delete_class($class_id, $school_code);	
	 	redirect('tswreis_schools/classes');
	}
	...
	public function sections()
	{
        ...
        $this->data = $this->tswreis_schools_common_lib->sections($school_code);
		$this->_render_page('tswreis_schools/sections',$this->data);
	}
	...
	public function create_section()
	{
	    ...
	    $school_code = $this->get_my_school_code();
	 	...
	 	$this->tswreis_schools_common_model->create_section($_POST, $school_code);
	 	redirect('tswreis_schools/sections');
	}
	...
	public function delete_section($section_id)
	{
	  ...
	  $this->tswreis_schools_common_model->delete_section($section_id, $school_code);	
	  redirect('tswreis_schools/sections');
	}
	...
	public function create_student()
	{
		...
		$school_name = $school_info[0]['school_name'];
		$dist_info = $this->tswreis_schools_common_model->get_district($district_id);
		$district_code = $dist_info[0]['dt_code'];

		$get_district_name = explode(",",$school_name);
		$district = $get_district_name[1];
		
		$classes     = $this->tswreis_schools_common_model->get_all_classes("All",$school_code);
		$sections    = $this->tswreis_schools_common_model->get_all_sections("All",$school_code);
		//$hunique_id  = $this->tswreis_schools_common_model->generate_new_student_hunique_id($school_code,$district_code,$school_name);
		...
		$this->_render_page('tswreis_schools/create_student',$this->data);
	...
	public function create_staff()
	{
		...
		$hunique_id  = $this->tswreis_schools_common_model->generate_new_staff_hunique_id($school_code,$district_code,$school_name);
		
		$this->data['school_name']   = $school_name;
		$this->data['huniqueid']     = $hunique_id;
		$this->data['message']       = '';
		
		$this->_render_page('tswreis_schools/create_staff',$this->data);
	...
	public function add_student_ehr()
	{
	  ...
	  $student_age      = $this->input->post('student_age',TRUE);
	  ...
	  $doc_data['page1']['Personal Information']['Age']            = $student_age;
	 ...
	 /*  
	  ...
	  $added = $this->tswreis_schools_common_model->add_student_ehr_model($doc_data,$history,$doc_properties); 
	  ...
	  {
        $classes  = $this->tswreis_schools_common_model->get_all_classes("All");
		$sections = $this->tswreis_schools_common_model->get_all_sections("All");
		$hunique_id = $this->tswreis_schools_common_model->generate_new_student_hunique_id($school_code,$district_code,$school_name);
		$this->data['classes']   = $classes;
		$this->data['sections']  = $sections;
		$this->data['huniqueid'] = $hunique_id;
	...
	public function add_staff_ehr()
	{
	  ...
	  $added = $this->tswreis_schools_common_model->add_staff_ehr_model($doc_data,$history); 
	...
	public function student_reports()
	{
		...
		$school_name = $school_info[0]['school_name'];
		$this->data['students'] = $this->tswreis_schools_common_model->get_student($per_page,$page,$school_name);
		$this->data['studentscount'] = $this->tswreis_schools_common_model->studentscount($school_name);
		$this->data['classlist'] = $this->tswreis_schools_common_model->get_classes($per_page, $page, $school_code);
		//echo print_r($this->data['classlist'], true); exit();
		
		$this->_render_page('tswreis_schools/student_reports',$this->data);
	}
	...
	public function get_students_list_by_class()
	{
		...
		$school_info = $this->tswreis_schools_common_model->get_school_info($school_code);
		$school_name = $school_info[0]['school_name'];
		$students = $this->tswreis_schools_common_model->get_students_by_class($selected_class, $school_name);
	...
	public function reports_ehr()
	{
		...
		$this->_render_page('tswreis_schools/reports_ehr',$this->data);
	}
	...
	public function reports_display_ehr_uid()
	{
        ...
        $this->data = $this->tswreis_schools_common_lib->reports_display_ehr_uid($student_unique_id,$school_name);
		...
		$this->_render_page('tswreis_schools/reports_display_ehr',$this->data);*/
        ...
        $this->data = $this->tswreis_schools_common_lib->reports_display_ehr_uid_new_html_static_hs($student_unique_id,$school_name);

        //log_message('error','thisdata===============1017'.print_r($this->data,TRUE));
		$this->data["username"] = $username.','.$school_name;
		if(isset($_POST['timee']))
		{
			$time = $_POST['timee'];
		...
		$this->_render_page('tswreis_schools/panacea_reports_display_ehr_new_dashboard',$this->data);
	}
	...
	function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			//render
			$this->_render_page('tswreis_schools/change_password', $this->data);
		}
		else
		{
			...
			$change = $this->tswreis_schools_common_model->change_password($identity, $this->input->post('old'), $this->input->post('new_pwd'));
	...
	public function staff_reports()
	{
		...
		$this->data = "";
        //$this->data = $this->tswreis_schools_common_model->staff_reports();
		$this->_render_page('tswreis_schools/staff_reports',$this->data);
	}
	...
	function create_schedule_followup()
	{
	  ...
	  $is_created = $this->tswreis_schools_common_model->create_schedule_followup_model($unique_id,$medication_schedule,$treatment_period,$start_date,$monthNames,$case_id);
	...
	function update_schedule_followup()
	{
	  ...
	  $compliance = $this->tswreis_schools_common_model->calculate_chronic_graph_compliance_percentage($case_id,$unique_id,$medication_taken);
	  
	  //log_message('debug','update_schedule_followup==3='.print_r($compliance,true));
	  
	  $is_updated = $this->tswreis_schools_common_model->update_schedule_followup_model($unique_id,$case_id,$compliance,$selected_date);
	...
	function prepare_pill_compliance_monthly_graph()
	{
	  ...
	  $pcompl_raw_data   = $this->tswreis_schools_common_model->fetch_student_pill_compliance_data($case_id,$student_unique_id);
	 ...
	 if(isset($pcompl_raw_data) && !empty($pcompl_raw_data))
	 {
       foreach($pcompl_raw_data as $data)
	   {
		  ...
		  foreach($pill_comp_data as $index => $values)
	      {
			   ...
			   log_message("debug","schedule_date==============".print_r($schedule_date,true));
			   $date_array  = explode('-',$schedule_date);
			   log_message("debug","date_array==============".print_r($date_array,true));
	...
	public function extend_request() 
	{
		...
		$this->data['requests'] = $this->panacea_common_model->get_all_rised_req();
		$this->data['message'] = false;
		
		$this->_render_page('tswreis_schools/extend_request',$this->data);
	}
	
	public function app_access($doc_id)
	{

		$this->data = $this->panacea_common_lib->app_access($doc_id);
		$this->_render_page('tswreis_schools/extend_request_app',$this->data);
	}
	...
	function hs_req_extend(){
		...
		$req_return = $this->panacea_common_lib->hs_req_extend($form_data);
		
		if($req_return['return_error']){
			$this->data ['message'] = $req_return['message'];
			$this->_render_page('tswreis_schools/extend_request',$this->data);
		}else{
			redirect('tswreis_schools/extend_request');
	...
	public function feed_bmi_student() 
	 {
		...
		$this->_render_page('tswreis_schools/school_wise_feed_bmi',$this->data);
	}
	...
	public function show_bmi_student() 
	 {
		...
		$this->data["school_code"]   = $email_array[1];
		$this->data["district_code"] = strtoupper($email_array[0]);
		$this->_render_page('tswreis_schools/school_wise_show_bmi_graph',$this->data);
	}
	/*
	*BMI Ajax function
	*author Naresh
	...
	*/ 
	public function student_bmi_graph(){
		...
		$bmi_value = $this->tswreis_schools_common_model->get_student_bmi_values($unique_id);
	...
	//author Naresh
	public function panacea_update_ehr()
	{
		...
		$this->data["district_code"] = strtoupper($email_array[0]);
		$this->data["message"] = "";		
		$this->_render_page('tswreis_schools/tswreis_update_personal_info',$this->data);
	}
	
	public function panacea_update_personal_ehr_uid()
	{
		$post = $_POST['student_unique_id'];
		log_message("debug","student_unique_id====================1475".print_r($post,true));
		$this->data = $this->tswreis_schools_common_lib->panacea_update_personal_ehr_uid($post);
		
		$this->data['docscount'] = count($this->data['docs']);

		$this->_render_page('tswreis_schools/tswreis_update_personal_ehr',$this->data);
	...
	public function update_student_ehr()
	{
	  ...
	  $section      = $this->input->post('section',TRUE);
	  $unique_id    = $this->input->post('unique_id',TRUE);
	  $health_unque_id    = $this->input->post('health_unque_id',TRUE);

      /*echo print_r($student_name, true);
      echo print_r($student_dob ,true);
      echo print_r($unique_id ,true);
      exit();*/
	  //log_message("debug","unique id ddddd1434".print_r($unique_id,true));
	  $id_split = explode('_', $health_unque_id);
	  $single_id = $id_split[2];
	  $id_lenght = strlen((string)$single_id);

	  if($id_lenght < 4 || $id_lenght > 4){
	  ...
	  $ehr_update = $this->tswreis_schools_common_model->update_student_ehr_model($health_unque_id,$update_profile); 
	  //log_message("debug","photo_updateqwerty".print_r($ehr_update,true));
	 // $this->data['message'] = 'Updated Successfully';
	// $this->_render_page('tswreis_schools/tswreis_update_personal_info',$this->data);
		//redirect("tswreis_schools/panacea_update_ehr");
		$logged_in_user = $this->session->userdata("customer");
		$email    		= $logged_in_user['email'];
		$email_array    = explode(".",$email);
	...
	public function usermanual_view()
	{
		 $this->data="";
		$this->_render_page ( 'tswreis_schools/usermanual_view', $this->data );
	}
	...
	public function bmi_pie_view()
	{
	  ...
	  //Fetch school details with school code
		...
		$this->data = $this->tswreis_schools_common_lib->bmi_pie_view_lib($current_month, $school_name);
		$this->_render_page('tswreis_schools/bmi_pie_view',$this->data);
	}
	...
	public function bmi_pie_view_month_wise()
	{
		...
		$school_info = $this->tswreis_schools_common_model->get_school_info($school_code);
	  	$school_name = $school_info[0]['school_name'];
		$this->data = $this->tswreis_schools_common_lib->bmi_pie_view_lib_month_wise($current_month,$school_name);
	...
	function drill_down_bmi_to_students()
	{
		...
		$docs = $this->tswreis_schools_common_model->get_drill_down_to_bmi_report($symptom_type ,$month ,$school_name);
	...
	function drill_down_to_bmi_report_students()
	{
		...
		$students = $this->tswreis_schools_common_model->get_drilling_bmi_students_docs($UI_id);
		//log_message('error','students===================1777'.print_r($students,TRUE));
		...
		$this->_render_page('tswreis_schools/drill_down_to_bmi_report_view',$this->data);
	}
	...
	public function show_student_bmi_graph($hospital_unique_id){
		...
		$bmi_value = $this->tswreis_schools_common_model->get_student_bmi_graph_values($hospital_unique_id);
		...
		$this->_render_page('tswreis_schools/show_student_bmi_graph_view',$final_bmi_data);
		}
	...
	public function generate_bmi_report_to_excel()
	{
		...
		$file_path = $this->tswreis_schools_common_lib->generate_bmi_report_to_excel_lib($date, $school_name);
	...
	*/
	...
	{
		$this->data['message'] = "";
		$this->_render_page("tswreis_schools/show_contact_us",$this->data);
	}
	...
	public function fetch_student_info()
	{
		...
		$this->data['get_data'] = $this->tswreis_schools_common_model->fetch_student_info_model($school_name, $unique_id);
	...
	public function initiateBmiReport()
	{
		...
		$this->data["school_code"]   = $email_array[1];
		$this->data["district_code"] = strtoupper($email_array[0]);
		$this->load->view('tswreis_schools/bmifeed_report_view', $this->data);
	...
	{	
		...
		/* if(array_key_exists("user_type",$session_data))
		 ...
		 $health_supervisor = $this->tswreis_schools_common_model->get_health_supervisor_details($schoolCode);
			...
			$districtName = $dist[1];
		 $bmi_values_data = "";
		 $is_exists = $this->tswreis_schools_common_model->check_if_doc_exists_in_bmi($uniqueId);
		if(!empty($is_exists))
		{
		   ...
		   }else if($bmi_count_value >= 30)
		   {
			...
			$existing_update = $this->tswreis_schools_common_model->update_bmi_values($ndate,$monthly_bmi, $uniqueId,$bmi_values_data);
				...
				if ($existing_update ) // the information has therefore been successfully saved in the db
				{
					...
					redirect('tswreis_schools/initiateBmiReport');
				}
				else
				{
			...
			}elseif($class == "Degree 3rd")
			{
	          ...
	          // History
				...
				$newly_created = $this->tswreis_schools_common_model->add_student_BMI_model($monthly_bmi, $doc_properties, $app_properties, $history,$bmi_values_data);
	...
	public function initiateHemoglobinReport()
	{
		...
		$this->data["district_code"] = strtoupper($email_array[0]);
	  	...
	  	$this->_render_page('tswreis_schools/hb_feed_view', $this->data);
	}
 	...
 	public function create_hemoglobin_report()
  	{
		...
		$is_exists  = $this->tswreis_schools_common_model->check_if_doc_exists_in_hb($uniqueId);
		$hb_values_data = "";
		if(!empty($is_exists))
		{
			$hb_final = array();
		   ...
		   if($hb_count_value < 13 )
		   {
			...
			$existing_update = $this->tswreis_schools_common_model->update_hb_values($ndate,$monthly_hb, $uniqueId,$hb_values_data);
			...
			if ($existing_update ) // the information has therefore been successfully saved in the db
			{
				...
				redirect('tswreis_schools/initiateHemoglobinReport');
			}
			else
			{
				$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
		...
		{				
		   ...
		   if($hb_count_value < 13 )
		   {
			...
			$newly_created = $this->tswreis_schools_common_model->add_student_HB_model($monthly_hb, $doc_properties, $app_properties, $history,$hb_values_data);
	...
	*/ 
	public function show_hb_student() 
	{
		...
		$this->data["school_code"]   = $email_array[1];
		$this->data["district_code"] = strtoupper($email_array[0]);
		$this->_render_page('tswreis_schools/school_wise_show_hb_graph',$this->data);
	}
	...
	*/ 
	...
	public function hb_pie_view()
	{
	  ...
	  //Fetch school details with school code
		...
		$this->data = $this->tswreis_schools_common_lib->hb_pie_view_lib($current_month, $school_name);
		$this->_render_page('tswreis_schools/hb_pie_view',$this->data);
	}
	...
	public function hb_pie_view_month_wise()
	{
		...
		$school_info = $this->tswreis_schools_common_model->get_school_info($school_code);
	  	$school_name = $school_info[0]['school_name'];
		$this->data = $this->tswreis_schools_common_lib->hb_pie_view_lib_month_wise($current_month,$school_name);
	...
	function drill_down_hb_to_students()
	{
		...
		$docs = $this->tswreis_schools_common_model->get_drill_down_to_hb_report($symptom_type ,$month ,$school_name);
	...
	function drill_down_to_hb_report_students()
	{
		...
		$students = $this->tswreis_schools_common_model->get_drilling_hb_students_docs($UI_id);

		//$this->data['get_hb_docs'] = $students['hb_value'];
		...
		$this->_render_page('tswreis_schools/drill_down_to_hb_report_view',$this->data);
	}
	...
	public function student_hb_graph(){
		...
		$hb_value = $this->tswreis_schools_common_model->get_student_hb_values($unique_id);
	...
	/*
	*==============================  HB Related functionalties closed  ==============*
	
	*/ 
	
	 /*
	 | -------------------------------------------------------------------------
	 | Attendance Report Related Functionalties(create).
	 | -------------------------------------------------------------------------
	 */
	...
	public function initiateAttendanceReport()
	{
		...
		$this->_render_page('tswreis_schools/attendance_report_view', $this->data);
	}
	...
	public function create_attendence_report()
	{
		...
		$app_properties['app_id'] = "healthcare201651317373988";
		...
		$added = $this->tswreis_schools_common_model->create_attendence_report_model($doc_data, $doc_properties, $app_properties, $history);
		if($added)
		{
		...
		{
			redirect('tswreis_schools/initiateAttendanceReport');
		}
	...
	*/
	public function hs_request()
	{
		...
		$this->_render_page('tswreis_schools/hs_initiate_request', $this->data);
	}
	...
	*/
	public function fetch_student_information()
	{
		...
		$this->data['get_data'] = $this->tswreis_schools_common_model->fetch_student_information_model($school_name, $unique_id);
	...
	*/
	public function initiate_hs_request()
	{
		...
		//log_message('error','unique_id==hs_initiate_request=======4041'.print_r($unique_id,TRUE));		
		//log_message('error','problem_info_description==hs_initiate_request=======4041'.print_r($problem_info_description,TRUE));
		  ...
		  if(isset($_FILES) && !empty($_FILES))
    {
        ...
        $Special_Diet_upload_info 				    = array();
        ...
        $Special_Diet_external_final				= array();
        ...
        foreach ($_FILES as $index => $value)
       {
            ...
            if(strpos($index,'Lab_Reports')!== false)
			{
                ...
                for($i=0; $i<$cpt; $i++)
                {
                     ...
                     $_FILES['Lab_Reports']['size']  = $files['Lab_Reports']['size'][$i];
              		...
              		$this->upload->initialize($this->Lab_Reports_attachment_upload_options('healthcare2016531124515424_con',$index));
     		...
     		if(strpos($index,'Digital_Images')!== false)
			{
                ...
                for($i=0; $i<$cpt; $i++)
                {
                     ...
                     $_FILES['Digital_Images']['size']  = $files['Digital_Images']['size'][$i];
              		...
              		$this->upload->initialize($this->Digital_Images_attachment_upload_options('healthcare2016531124515424_con',$index));
       	...
       	if(strpos($index,'Payments_Bills')!== false)
		 {
            ...
            for($i=0; $i<$bill; $i++)
            {
                ...
                $this->upload->initialize($this->Payments_Bills_upload_options('healthcare2016531124515424_con',$index));
        	...
        	if(strpos($index,'Discharge_Summary')!== false)
		 {
            ...
            for($i=0; $i<$discharge_summary_count; $i++)
            {
                ...
                $this->upload->initialize($this->Discharge_Summary_upload_options('healthcare2016531124515424_con',$index));
        ...
        if(strpos($index,'hs_req_attachments')!== false)
		 {
            ...
            for($i=0; $i<$hs_req_attachments_count; $i++)
            {
                ...
                $this->upload->initialize($this->external_attachments_upload_options('healthcare2016531124515424_con',$index));
         ...
         if(strpos($index,'special_diet_pics')!== false)
		 {
             if(!empty($value['name']))
            {
            $special_diet_pics_count = count($_FILES['special_diet_pics']['name']);
            for($i=0; $i<$special_diet_pics_count; $i++)
            {
                
                 $_FILES['special_diet_pics']['name']    = $files['special_diet_pics']['name'][$i];
                 $_FILES['special_diet_pics']['type']    = $files['special_diet_pics']['type'][$i];
                 $_FILES['special_diet_pics']['tmp_name']= $files['special_diet_pics']['tmp_name'][$i];
                 $_FILES['special_diet_pics']['error']   = $files['special_diet_pics']['error'][$i];
                 $_FILES['special_diet_pics']['size']    = $files['special_diet_pics']['size'][$i];
                 
                $this->upload->initialize($this->special_diet_attachments_upload_options('healthcare2016531124515424_con',$index));
                ...
                {   
                    ...
                    $Special_Diet_upload_info = $this->upload->data();
                    
                    $Special_Diet_upload_data_array = array(
                                            "DFF_EXTERENAL_FILE_ATTACHMENT_".$i => array(
                                            "file_client_name" =>$Special_Diet_upload_info['client_name'],
                                            "file_encrypted_name" =>$Special_Diet_upload_info['file_name'],
                                            "file_path" =>$Special_Diet_upload_info['file_relative_path'],
                                            "file_size" =>$Special_Diet_upload_info['file_size']
                                                            )
                                             );

                    $Special_Diet_external_final = array_merge($Special_Diet_external_final, $Special_Diet_upload_data_array);
        ...
        if(isset($doc_data['special_diet_pics']))
        {               
                $Special_Diet_merged_data_array = array_merge($doc_data['special_diet_pics'],$Special_Diet_external_final);
                $doc_data['special_diet_pics'] = array_replace_recursive($doc_data['special_diet_pics'],$Special_Diet_merged_data_array);
        }
        else
        {
                $doc_data['special_diet_pics'] = $Special_Diet_external_final;                
        } 
        ...
        else
        {
		 ...
		 $school_data = $this->tswreis_schools_common_model->get_school_information_for_school_code($schoolCode);
			 ...
			 $health_supervisor = $this->tswreis_schools_common_model->get_health_supervisor_details($schoolCode);
			 	 $hs_name = $health_supervisor['hs_name'];
			 	 $hs_mob  = $health_supervisor['hs_mob'];	
		 //log_message('debug','HEALTHCARE2016531124515424_CON=====GET_HEALTH_SUPERVISOR_DETAILS==HSNAME==>'.print_r($hs_name,true));
		// log_message('debug','HEALTHCARE2016531124515424_CON=====GET_HEALTH_SUPERVISOR_DETAILS==HSMOB==>'.print_r($hs_mob,true));
...
//		echo print_r($doc_data,true);
  	...
  	/* $history = array();
  	 ...
  	 //log_message('error','request_type=========2658'.print_r($request_type,TRUE));
	    ...
	    // log_message('error','hs_initiate_request==============history'.print_r($array_history,TRUE));
  	  	...
  	  	$get_doc_id = $this->tswreis_schools_common_model->get_doc_id_for_check($initate_submit);

	    if($review_status == 'Hospitalized' || $review_status == "Surgery-Needed" || $review_status == "Expired" || $review_status == "Discharge")
  	  {
  	  	$insert_hospitalised = $this->tswreis_schools_common_model->insert_hospitalised_students_data($doc_data,$array_history,$unique_id,$get_doc_id,$doc_properties);
  	  }
  	  ...
  	  if($initate_submit ) // the information has therefore been successfully saved in the db
			{
				...
				//$fcm_notification_ios = $this->panacea_common_lib->fcm_message_notification_ios($request_type,$unique_id,$student_name);
	...
	*/
  	...
  	public function fetch_submited_requests_docs()
  	{
  		...
  		$hs_req_docs  = $this->tswreis_schools_common_model->get_hs_req_normal($collection,$unique_id_code);

		$hs_req_emergency  = $this->tswreis_schools_common_model->get_hs_req_emergency($collection,$unique_id_code);

		$hs_req_chronic  = $this->tswreis_schools_common_model->get_hs_req_chronic($collection,$unique_id_code);

		$hs_req_cured  = $this->tswreis_schools_common_model->get_hs_req_cured($collection,$unique_id_code);

		$hs_req_expired  = $this->tswreis_schools_common_model->get_hs_req_expired($collection,$unique_id_code);
		...
		if(!empty($hs_req_expired)){
  		...
  		$this->_render_page('tswreis_schools/fetch_submited_requests_docs',$this->data);
  	}
	...
	*/
  	...
  	{
  		$session_data = $this->session->userdata('customer');
  		//log_message('error','session_data======3357'.print_r($session_data,TRUE));
  		
  		$doc_id = $id;
  		$doc_access = "true";
  		$doc_access_by = $session_data['user_type']." ".$session_data['username'];
		$query = $this->tswreis_schools_common_model->access_submited_request_docs($doc_id,$doc_access,$doc_access_by);

		if(isset($query['access_by']) && !empty($query['access_by']))
		{
			$this->session->set_flashdata('access_by',"Accessed By : ".$query['access_by']['access_by'].", You need to wait for Doctor's Responce or reopen after 5 mins");
				redirect('tswreis_schools/fetch_submited_requests_docs');
			//$this->_render_page('tswreis_schools/access_submited_request_docs',$this->data);
		}else
		{
			$this->data['hs_req_docs'] = [$query];
			//echo print_r($this->data['hs_req_docs'],true);exit();
			$this->_render_page('tswreis_schools/access_submited_request_docs',$this->data);
		}
  	}
	...
	*/
		  ...
		  if(isset($_FILES) && !empty($_FILES))
    {
       ...
       if(strpos($index,'special_diet_pics')!== false)
        {
           ...
           for($i=0; $i<$special_diet_pics_count; $i++)
           {
               ...
               if ( ! $this->upload->do_upload($index))
               {
                    echo "special diet attachments upload failed";
                    //return FALSE;
               }
               else
               {        
        ...
        if(strpos($index,'hs_req_attachments')!== false)
      {
       ...
       $doc_history = $this->tswreis_schools_common_model->get_history($unique_id,$doc_id);
        ...
        if(isset($doc_history[0]['doc_data']['special_diet_pics']))
        {               
                $Special_Diet_merged_data_array = array_merge($doc_history[0]['doc_data']['special_diet_pics'],$Special_Diet_external_final);
                $doc_data['special_diet_pics'] = array_replace_recursive($doc_history[0]['doc_data']['special_diet_pics'],$Special_Diet_merged_data_array);
        }
        else
        {
                $doc_data['special_diet_pics'] = $Special_Diet_external_final;
  	...
  	/* $history = array();
		...
		*/
		...
		$approval_history = $this->tswreis_schools_common_model->get_approval_history($doc_id);

		array_push($approval_history,$approval_data);
		
		/*log_message('error','update_hs_request======approval_history==4042'.print_r($approval_history,TRUE));*/
		
  	  $existing_update = $this->tswreis_schools_common_model->update_request_submit_model($doc_data,$approval_history,$unique_id,$doc_id,$doc_properties);
  	  ...
  	  if ($existing_update ) // the information has therefore been successfully saved in the db
			{
		  	    ...
		  	    if(isset($chronic_identifiers) && !empty($chronic_identifiers))
				{
		  	    ...
		  	    $message = "Hi ".$hs_name.", Updated ".$request_type." Request is created with ".$total_diseaes." Identifier is created for ".$student_name." with UID ".$unique_id." on ".date('Y-m-d').", Doctor will update You soon.";
	...
	*/
	...
	{ 
		...
		$this->data['report_count'] = $this->tswreis_schools_common_model->get_attendance_report_daily_count($school_name, $today_date);
		$docs = $this->tswreis_schools_common_model->get_requests_daily_count($district_school_code, $today_date);
		$requests_info = $this->tswreis_schools_common_model->get_request_info_by_type($district_school_code, $today_date);
		$doctor_docs = $this->tswreis_schools_common_model->get_docs_daily_count($district_school_code, $today_date);
		$doctor_docs_info = $this->tswreis_schools_common_model->get_docs_daily_requests_info($district_school_code, $today_date);
		$this->data['total_student_count'] = $this->tswreis_schools_common_model->studentscount($school_name);
       ...
       if(!empty($doctor_docs_info['doc_chronic_requests_info'])) {
		...
		$bmi_info = $this->tswreis_schools_common_model->get_bmi_report_model_count($current_month, $school_name);
		...
		$bmi_student_info = $this->tswreis_schools_common_model->get_bmi_report_model_info($current_month, $school_name);
		...
		$this->data['screening_info'] =$this->tswreis_schools_common_model->get_all_screenings_count($today_date = false, $screening_duration = "Yearly");
		

		$hb_count = $this->tswreis_schools_common_model->get_hb_report_model_count($current_month, $school_name);
		$hb_count_info = $this->tswreis_schools_common_model->get_hb_report_model_info($current_month, $school_name);
		...
		$sanitation_report = $this->tswreis_schools_common_model->get_sanitation_report_data_with_date_version_2($date,$school_name);

		$this->data['sanitation_report'] = $this->tswreis_schools_common_lib->build_sanitation_report_v2($sanitation_report);
		
		
		//$this->data['sanitation_report'] = $this->tswreis_schools_common_lib->build_sanitation_report_activities($date,$school_name);
		//$this->data['sanitation_report'] = "";
		
		$this->data['basic_dash_screening_report_yearly'] = $this->tswreis_schools_common_model->get_screened_students_count($unique_id_pattern);

		$this->data['basic_dash_yearly_request_count'] = $this->tswreis_schools_common_model->get_all_requests_yearly_count($date,$request_duration="Yearly",$unique_id_pattern);

		$this->data['basic_dash_students_count'] = $this->tswreis_schools_common_model->studentscount($school_name);
		
		$school_color_code = $this->tswreis_schools_common_model->get_school_color_code($school_code);
		$this->data['school_color_code'] = $school_color_code;

		//$hsrequests = $this->tswreis_schools_common_lib->to_dashboard_new($date, $request_duration, $screening_duration);

		//$this->data['report'] = $hsrequests;
		$this->data ['news_feeds'] = $this->tswreis_schools_common_model->get_all_news_feeds();
		$this->data['today_date'] = date('Y-m-d');
		$this->data['all'] = $this->tswreis_schools_common_model->get_doctor_visiting_report_date_wise($school_name);
		// Get School Status
		$this->data['school_status'] = $this->tswreis_schools_common_model->get_schools_health_status_count_model($school_name);
		$this->_render_page('tswreis_schools/all_activities_view',$this->data);
	}
...
public function reports_display_ehr_uid_new_html_static_hs()
	...
	public function school_wise_students_count($school_name)
	{
		$school_code = $this->get_my_school_code();
		$school_info = $this->tswreis_schools_common_model->get_school_info($school_code);
		$school_name = $school_info[0]['school_name'];
		
		$this->data['students_count'] = $this->tswreis_schools_common_model->studentscount($school_name);
	...
	*/
	public function initiateSanitationReport()
	  {
			...
			$this->data = "";
		  	$this->_render_page('tswreis_schools/sanitation_report_view', $this->data);
	  }
	...
	public function create_sanitation_report_new()
	{
		...
		$doc_data['daily']['Kitchen']['Cleanliness Of The Kitchen Place'] = empty($cleanliness_Kitchen) ? "":$cleanliness_Kitchen;
       ...
       foreach ($_FILES as $index => $value)
       {
                ...
                if(!empty($value['name']))
                {
	                ...
	                for($i=0; $i<$cpt; $i++)
	                {
	                     ...
	                     $_FILES['hs_req_attachments_campus']['size']  = $files['hs_req_attachments_campus']['size'][$i];
	              		...
	              		$this->upload->initialize($this->campus_attachment_upload_options($controller,$index));
	            ...
	            else
	            	{
	                	...
	                	$this->resize_attachment_lib($controller,$campus_external_files_upload_info);
	                    $hs_external_data_array = array(
	                                            "DFF_EXTERENAL_FILE_ATTACHMENT_".$i=> array(
     		...
     		if(strpos($index,'hs_req_attachments_toilets')!== false)
			{
                if(!empty($value['name']))
	            {
	                ...
	                for($i=0; $i<$mri; $i++)
	                {
				       ...
				       $this->upload->initialize($this->toilet_attachment_upload_options($controller,$index));
	                if ( ! $this->upload->do_upload($index))
	                {
	                     echo "mri and scan file upload failed";
	                     //return FALSE;
	                ...
	                {   
	                	...
	                	$this->resize_attachment_lib($controller,$toilet_files_upload_info);
	                    $toilet_data_array = array(
	                                            "DFF_EXTERENAL_FILE_ATTACHMENT_".$i => array(
       	...
       	if(strpos($index,'hs_req_attachments_kitchen')!== false)
		 {
            ...
            for($i=0; $i<$bill; $i++)
            {
                ...
                $this->upload->initialize($this->kitchen_attachment_upload_options($controller,$index));
                ...
                {   
                    ...
                    $this->resize_attachment_lib($controller,$kitchen_files_upload_info);
                    $kitchen_data_array = array(
                                            "DFF_EXTERENAL_FILE_ATTACHMENT_".$i => array(
        ...
        if(strpos($index,'hs_req_attachments_dormitory')!== false)
		 {
            ...
            for($i=0; $i<$dormitory; $i++)
            {
                ...
                $this->upload->initialize($this->dormitory_attachment_upload_options($controller,$index));
                ...
                {   
                    ...
                    $this->resize_attachment_lib($controller,$dormitory_files_upload_info);
                    $dormitory_data_array = array(
                                            "DFF_EXTERENAL_FILE_ATTACHMENT_".$i => array(
		...
		$added = $this->tswreis_schools_common_model->create_sanitation_report_model($doc_data, $doc_properties, $app_properties, $history);
		if($added)
		{
			redirect('tswreis_schools/to_dashboard');
		}
		...
		{
			redirect('tswreis_schools/initiateSanitationReport');
		}
	...
	{
	  // POST Data
	  $id_str = $this->input->post('unique_id',true);
	//  echo print_r($id_str, true);
	  //$id_str = json_decode($id_str,true);
	  
	  $health_summary_report = $this->tswreis_schools_common_lib->generate_health_summary_report($id_str);
	...
	public function get_screening_data_with_abnormalities()
	{
		...
		$this->data = $this->tswreis_schools_common_model->get_drilling_screenings_abnormalities_to_count($selectedLabel, $date = false, $screening_duration = "Yearly");
	...
	function drill_down_screening_to_students_count()
	{
		...
		$docs = $this->tswreis_schools_common_model->drill_down_screening_to_students_count($symptome_type,$date = false,$screening_duration = "Yearly");
	...
	function drill_down_screening_to_students_load_ehr_count()
	{
		...
		$get_docs = $this->tswreis_schools_common_model->get_drilling_screenings_students_docs_count($docs_id);
	...
	function total_attended_students()
	{
		...
		$post = $_POST['total_attended'];
		$this->tswreis_schools_common_model->total_attended_students($post);
  	}	
  	public function get_sanitation_report_v2()
	  {
	  		$school_code = $this->get_my_school_code();
			$school_info = $this->tswreis_schools_common_model->get_school_info($school_code);
			$school_name = $school_info[0]['school_name'];
			$data = $this->tswreis_schools_common_model->get_sanitation_report_v2($school_name);
			$this->_render_page('tswreis_schools/sanitation_report_view', $this->data);
	  }
	  function get_sanitaiton_report_by_school(){
	  	$date = $this->input->post('date',TRUE);
		...
		$report = $this->tswreis_schools_common_model->get_sanitation_report_data_with_date($date,$school_name);

		$sanitation_report = $this->tswreis_schools_common_lib->build_sanitation_report_v2($report);
	  ...
	  function get_sanitaiton_report_by_span(){
	  	$date = $this->input->post('set_data',TRUE);
	  	$sanitation_span = $this->input->post('sanitation_span',TRUE);
		...
		$report = $this->tswreis_schools_common_model->get_sanitaiton_report_by_span($date,$sanitation_span, $school_name);

		$sanitation_report = $this->panacea_common_lib->build_sanitation_report_v2($report);
	...
	public function medical_test_details()
	{
		$logged_in_user = $this->session->userdata("customer");
		$email    		= $logged_in_user['email'];
		$email_array    = explode(".",$email);
		...
		$this->data["district_code"] = strtoupper($email_array[0]);
		$this->data["message"] = "";
		$this->_render_page('tswreis_schools/medical_test_details',$this->data);
	}

	public function panacea_get_personal_ehr_details()
	{
		$post = $_POST['student_unique_id'];
		...
		$this->_render_page('tswreis_schools/update_medical_test_reports',$this->data);
		//log_message("debug","panacea_update_personal_ehr_uid======1415".print_r($this->data,true));
	}

	public function resize_attachment_lib($controller,$external_files_upload_info)
	{
		 if($controller == 'healthcare2016531124515424_con')
		 {
		 	$config['image_library'] = 'gd2';  
	        $config['source_image'] = UPLOADFOLDERDIR.'public/uploads/'.$controller.'/files/external_files/'.$external_files_upload_info["file_name"];  
	         $config['create_thumb'] = FALSE;  
	         $config['maintain_ratio'] = FALSE;  
	         $config['quality'] = '75%';  
	         $config['width'] = 500;  
	         $config['height'] = 600;  
	         $config['new_image'] = UPLOADFOLDERDIR.'public/uploads/'.$controller.'/files/external_files/'.$external_files_upload_info["file_name"];  
	         $this->load->library('image_lib', $config);  
	         $this->image_lib->resize();

	         return TRUE;
		 }else if($controller == 'healthcare2016111212310531_con')
		 {
		 	$config['image_library'] = 'gd2';  
	        $config['source_image'] = UPLOADFOLDERDIR.'public/uploads/'.$controller.'/files/external_files/'.$external_files_upload_info["file_name"];  
	         $config['create_thumb'] = FALSE;  
	...
	public function import_medical_certificates()
	{
	 ...
	 /*$update_profile = array(
	   ...
	   'doc_data.widget_data.page2.Personal Information.Father Name'    => $father_name,
		...
		//echo '<pre>';
		//echo print_r($external_attachments_exists,true);
		//echo '</pre>';
		//exit;
			  ...
			  if(!empty($value['name']))
			  {
					...
					if ( ! $this->upload->do_upload($index))
					{
						 $this->session->set_flashdata('message','Submission failed. Each attachment file should be less than 2 MB');
								...
								redirect('tswreis_schools/medical_test_details');  
                    ...
                    $external_files_upload_info = $this->upload->data();
                     ...
                     $this->resize_attachment_lib($controller,$external_files_upload_info);

						$rand_number = mt_rand();
						$external_data_array = array(
												"MEDICAL_TEST_REPORTS_".$rand_number => array(
						...
						// echo print_r($external_final,TRUE);exit();
						
					}  
				}
			}
		 }
		 		$doc_history = $this->tswreis_schools_common_model->get_history_for_attachments($unique_id,$doc_id);
		 		
			   if(isset($doc_history['0']['doc_data']['external_attachments']))
			  {
					   
				$external_merged_data = array_merge($doc_history['0']['doc_data']['external_attachments'],$external_final);
				$update_profile = array_replace_recursive($doc_history['0']['doc_data']['external_attachments'],$external_merged_data);
				//echo print_r($update_profile,TRUE)."nareshhhhh";exit();
			  }
			  else
			 {
			 	//echo print_r($external_final,TRUE);exit();
			    $update_profile = $external_final;
			 } 
		  
		 }
		
	  		$ehr_update = $this->tswreis_schools_common_model->import_medical_certificates($unique_id,$update_profile,$doc_id);  
			$logged_in_user = $this->session->userdata("customer");
			$email    		= $logged_in_user['email'];
			$email_array    = explode(".",$email);
	...
	function panacea_imports_bmi_values()
	{
		...
		$this->data['message'] = "";
		$this->_render_page('tswreis_schools/panacea_imports_bmi_values', $this->data);
	}
	...
	function imported_bmi_xl_sheet()
	{
		...
		//$this->data = $this->tswreis_schools_common_lib->panacea_imports_hb_values();
			$this->data = $this->get_district_school_name();
	...
	function imports_bmi_values()
	{
		...
		if($this->data == "redirect_to_bmi_fn")
		{
			...
			redirect('tswreis_schools/imported_bmi_xl_sheet');
	...
	function panacea_imports_hb_values()
	{
		...
		//$this->data = $this->tswreis_schools_common_lib->panacea_imports_hb_values();
			$this->data = $this->get_district_school_name();
			$this->data['message'] = "";
		$this->_render_page('tswreis_schools/panacea_imports_hb_values', $this->data);
	}
	...
	function imports_hb_values()
	{
		...
		{
			redirect('tswreis_schools/imported_hb_xl_sheet');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->data = $this->get_district_school_name();
			$this->_render_page('tswreis_schools/panacea_imports_hb_values', $this->data);
	...
	{ 
		...
		$result = $this->tswreis_schools_common_model->update_principal_hs_profile($post,$schoolCode);
		...
		if ($result ) // the information has therefore been successfully saved in the db
				{
					...
					redirect('tswreis_schools/my_profile_hs');
				}
				else
				{
					$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
	...
	private function special_diet_attachments_upload_options($controller,$field)
	{
		$config = array();

		if (strpos($field,'special_diet_pics')!== false)
		{
			$controller = 'healthcare2016531124515424_con';
			$config = array();
			$config['upload_path']   = UPLOADFOLDERDIR.'public/uploads/'.$controller.'/files/external_files/';
	...
	public function show_student_hb_graph($hospital_unique_id){
		...
		$hb_value = $this->tswreis_schools_common_model->get_student_hb_graph_values($hospital_unique_id);
	...
	$this->_render_page('tswreis_schools/show_student_hb_graph_view',$final_hb_data);
		
		}
		
		
	}
	public function send_smsto_hs_for_hb()
	{
		$today_date = Date('Y-m-d');
		$query = $this->tswreis_schools_common_model->get_hs_info();
		$get_info = $this->tswreis_schools_common_model->get_officials_info();
		...
		if($end_hb['hb'] <= 8)
		{
			...
			$add_msg['ecc'] = 0;
				if($end_hb['hb'] <= 6)
				{
					$message = "Hi ".$value['school_details'][0]['hs_name'].", ".$value['Name']." with UID :".$value['Student Unique ID']."is having HB value : ".$end_hb['hb']." submitted on ".$end_hb['month']." As this could lead to critical medical issue, request to consult PANACEA immidiately for doctors advice.";
					$mobile = $value['school_details'][0]['hs_mob'];
					$this->bhashsms->send_sms($mobile,$message);
					$mobile_p = $value['school_details'][0]['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,$message);
					$message_official = "A Child with severe anemia found, Details: Name : ".$value['Name']."\nU ID : ".$value['Student Unique ID'].", HB : ".$end_hb['hb'];
					
					$mobile_official = $get_info[3]['mobile_number'];
					$this->bhashsms->send_sms($mobile_official,$message_official);
				//	$mobile_official = $get_info[4]['mobile_number'];
				//	$this->bhashsms->send_sms($mobile_official,$message_official);
					log_message("Error", "Count of HB 6 ".print_r($value['Student Unique ID'], TRUE));
					$hb_6++;
				}/*else if($end_hb['hb'] <= 8)
				{
					$message = "Hi ".$value['school_details'][0]['hs_name'].", ".$value['Name']." with UID :".$value['Student Unique ID']."is having HB value : ".$end_hb['hb']." submitted on ".$end_hb['month']." As this is a severe anemic issue, request to consult PANACEA immidiately for doctors advice."; 
					$mobile = $value['school_details'][0]['hs_mob'];
				//	$this->bhashsms->send_sms($mobile,$message);
					$mobile_p = $value['school_details'][0]['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,$message);
					log_message("Error", "Count of HB 8 ".print_r($value['Student Unique ID'], TRUE));
					$hb_8++;
				}*/
/*else if($end_hb['hb'] <= 10)
				{
					$message = "Hi ".$value['school_details'][0]['hs_name'].", ".$value['Name']." with UID :".$value['Student Unique ID']."is having HB value : ".$end_hb['hb']." submitted on ".$end_hb['month']." As this is a moderate anemic issue, request to consult PANACEA immidiately for doctors advice.";
					$mobile = $value['school_details'][0]['hs_mob'];
				//	$this->bhashsms->send_sms($mobile,$message);
					$mobile_p = $value['school_details'][0]['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,$message);
					log_message("Error", "Count of HB 10 ".print_r($value['Student Unique ID'], TRUE));
					$hb_10++;
				}else if($end_hb['hb'] <= 12)
				{
					$message = "Hi ".$value['school_details'][0]['hs_name'].", ".$value['Name']." with UID :".$value['Student Unique ID']."is having HB value : ".$end_hb['hb']." submitted on ".$end_hb['month']." As this is a mild anemic issue, special attention is needed. Hence act before child becomes unhealthy.";
					$mobile = $value['school_details'][0]['hs_mob'];
			//		$this->bhashsms->send_sms($mobile,$message);
					$mobile_p = $value['school_details'][0]['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,$message);
					log_message("Error", "Count of HB 12 ".print_r($value['Student Unique ID'], TRUE));
					$hb_12++;
				}
*/				
				if($value['msg_count']>6)
				{
					if(($end_hb['hb'] <= 6) || ($end_hb['hb'] <= 8))
					{
					//Send mescalation message to officials
					$message_official = "Respected Sir/Madam, ".$value['Name']." with HB value:".$value['HB_values'][0]['hb']." observed on ".$value['HB_values'][0]['month'].". Its been communicated to ".$value['school_details'][0]['hs_name']." ".$value['msg_count']." times.\n"." We would like to bring to your attention on this issue." ;
					$get_info = $this->tswreis_schools_common_model->get_officials_info();
					$mobile = $get_info[3]['mobile_number'];
					$ret = $this->bhashsms->send_sms($mobile,$message_official);
					//$mobile = $get_info[4]['mobile_number'];
					//$ret = $this->bhashsms->send_sms($mobile,$message_official);
					$mobile_p = $value['school_details'][0]['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,"FWD: ".$message_official);
				//	$this->bhashsms->send_sms($mobile,"FWD: ".$message_official);
					$add_msg['ecc'] = $value['ecc_count'] + 1;
					//Fetch officials numbers
					//send msg to officials officials 
					log_message("Error", "Count of HB OFFICIALS ".print_r($value['Student Unique ID'], TRUE));
					$hb_off++;
					}
				}
				...
				$add_msg_info = array(
					'message' => $message,
					'message_official' => ($message_official) ? $message_official : "",
					'date' => $today_date
				);
				$add_msg['msg'] = $value['msg_count'] + 1;
				array_push($message_history, $add_msg_info);
				// Insert into DB with above values
				$this->tswreis_schools_common_model->update_msg_info($value['Student Unique ID'],$message_history,$add_msg_info,$add_msg);	
				log_message("Error", "Updated DB with counts and message".print_r($value['Student Unique ID'], TRUE));			
			}
		}
		/*log_message("Error", "Count of HB 6 ".print_r($hb_6, true));
		log_message("Error", "Count of HB 8 ".print_r($hb_8, true));
		log_message("Error", "Count of HB 10 ".print_r($hb_10, true));
		log_message("Error", "Count of HB 12 ".print_r($hb_12, true));
		log_message("Error", "Count of HB off ".print_r($hb_off, true));*/
		//$this->bhashsms->send_sms();
	}
	...
	public function doctor_visit(){
		...
		$this->data['doc_names'] = $this->tswreis_schools_common_model->get_doctor_names($email);
		
	  	$this->_render_page('tswreis_schools/doctor_visit', $this->data);
	}
	public function fetch_student_info_for_doctor_visit()
	{
		...
		$this->data['get_data'] = $this->tswreis_schools_common_model->fetch_student_info_for_doctor_visit($school_name, $unique_id);
		//$this->data['get_attachments'] = $this->tswreis_schools_common_model->fetch_student_attachments($school_name, $unique_id);
        ...
        if(strpos($index,'hs_req_attachments')!== false)
		 {
	        ...
	        else
	        {
				...
				$app_properties['app_name'] = "TSWREIS Doctor Visiting App";
	...
	$newly_created = $this->tswreis_schools_common_model->submit_doctor_visiting_report($doc_data,$doc_attachments, $doc_properties, $app_properties, $history);

				if($newly_created){
					$this->session->set_flashdata('success','Doctor Report submitted successfully');
					redirect('tswreis_schools/doctor_visit');
	...
	public function drill_down_to_doctor_treated_list(){
		...
		$this->data['student_list'] = $this->tswreis_schools_common_model->drill_down_to_doctor_treated_list($school_name,$selectedDate);

		$this->data['doctor_visiting_date'] = $selectedDate;
	  	$this->_render_page('tswreis_schools/doctor_visit_student_list', $this->data);
	}
	public function show_doctor_treated_student(/*$uid,$doctor_visit_date*/ $doc_id)

	 {
	 	
		$this->data['unique_id'] = $this->tswreis_schools_common_model->show_doctor_treated_student(/*$uid, $doctor_visit_date*/$doc_id);
		
		
		$this->_render_page('tswreis_schools/show_doctor_visit_student',$this->data);
	}

	public function send_smsto_hs_for_bmi()
	{
		$today_date = Date('Y-m-d');
		$query = $this->tswreis_schools_common_model->get_hs_info_from_bmi();
		$get_info = $this->tswreis_schools_common_model->get_officials_info();
		//echo print_r($get_info[3],TRUE);exit();
		$bmi_14=0;
		$bmi_28=0;
		/*$hb_10=0;
		$hb_12=0;*/
		...
		foreach ($query as $value) 
		{
			$end_bmi  = end($value['BMI_values']); 
		if($end_bmi['bmi'] <= 14 || $end_bmi['bmi'] >= 28)
		{
			$message_official = "";
			$add_msg['ecc'] = 0;
				...
				if($end_bmi['bmi'] <= 14)
				{
					$message = "Hi ".$value['school_details']['hs_name'].", ".$value['Name']." with UID :".$value['Student Unique ID']."is having BMI value : ".$end_bmi['bmi']." submitted on ".$end_bmi['month']." As this could lead to critical medical issue, request to consult PANACEA immidiately for doctors advice.";
					$mobile = $value['school_details']['hs_mob'];
					$this->bhashsms->send_sms($mobile,$message);
					$mobile_p = $value['school_details']['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,$message);
					$message_official = "A Child with Under Weight found, Details: Name : ".$value['Name']."\nU ID : ".$value['Student Unique ID'].", BMI : ".$end_bmi['bmi'];
					...
					//$mobile_official = $get_info[4]['mobile_number'];
				   // $this->bhashsms->send_sms($mobile_official,$message_official);
					//log_message("Error", "Count of BMI 14 ".print_r($value['Student Unique ID'], TRUE));
					$bmi_14++;
				}
				/*else if($end_bmi['bmi'] >= 28.0)
				{
					
					$message = "Hi ".$value['school_details']['hs_name'].", ".$value['Name']." with UID :".$value['Student Unique ID']."is having BMI value : ".$end_bmi['bmi']." submitted on ".$end_bmi['month']." Request to consult PANACEA immidiately for doctors advice."; 
					$mobile = $value['school_details']['hs_mob'];
					$this->bhashsms->send_sms($mobile,$message);
					$mobile_p = $value['school_details']['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,$message);
					log_message("Error", "Count of BMI 28.0 ".print_r($value['Student Unique ID'], TRUE));
					$bmi_28++;
				}
			else if($end_bmi['hb'] <= 10)
				{
					$message = "Hi ".$value['school_details'][0]['hs_name'].", ".$value['Name']." with UID :".$value['Student Unique ID']."is having HB value : ".$end_bmi['hb']." submitted on ".$end_bmi['month']." As this is a moderate anemic issue, request to consult PANACEA immidiately for doctors advice.";
					$mobile = $value['school_details'][0]['hs_mob'];
				//	$this->bhashsms->send_sms($mobile,$message);
					$mobile_p = $value['school_details'][0]['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,$message);
					log_message("Error", "Count of HB 10 ".print_r($value['Student Unique ID'], TRUE));
					$hb_10++;
				}else if($end_bmi['hb'] <= 12)
				{
					$message = "Hi ".$value['school_details'][0]['hs_name'].", ".$value['Name']." with UID :".$value['Student Unique ID']."is having HB value : ".$end_bmi['hb']." submitted on ".$end_bmi['month']." As this is a mild anemic issue, special attention is needed. Hence act before child becomes unhealthy.";
					$mobile = $value['school_details'][0]['hs_mob'];
			//		$this->bhashsms->send_sms($mobile,$message);
					$mobile_p = $value['school_details'][0]['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,$message);
				...
				if($value['msg_count']>6)
				{
					...
					{
					//Send mescalation message to officials
					$message_official = "Respected Sir/Madam, ".$value['Name']." with BMI value:".$end_bmi['bmi']." observed on ".$end_bmi['month'].". Its been communicated to ".$value['school_details']['hs_name']." ".$value['msg_count']." times.\n"." We would like to bring to your attention on this issue." ;
					$get_info = $this->tswreis_schools_common_model->get_officials_info();
					$mobile = $get_info[3]['mobile_number'];
					$ret = $this->bhashsms->send_sms($mobile,$message_official);
					//$mobile = $get_info[9]['mobile_number'];
					//$ret = $this->bhashsms->send_sms($mobile,$message_official);
					$mobile_p = $value['school_details']['principal_mob'];
					$this->bhashsms->send_sms($mobile_p,"FWD: ".$message_official);
				//	$this->bhashsms->send_sms($mobile,"FWD: ".$message_official);
					...
					//Fetch officials numbers
					//send msg to officials officials 
					log_message("Error", "Count of BMI OFFICIALS ".print_r($value['Student Unique ID'], TRUE));
					$bmi_off++;
					}
				}
				...
				array_push($message_history, $add_msg_info);
				// Insert into DB with above values
				$this->tswreis_schools_common_model->update_msg_info_bmi($value['Student Unique ID'],$message_history,$add_msg_info,$add_msg);	
				log_message("Error", "Updated DB with counts and message".print_r($value['Student Unique ID'], TRUE));			
			}
		}
		log_message("Error", "Count of BMI 14 ".print_r($bmi_14, true));
		log_message("Error", "Count of BMI 28 ".print_r($bmi_28, true));
		//log_message("Error", "Count of HB 10 ".print_r($hb_10, true));
		//log_message("Error", "Count of HB 12 ".print_r($hb_12, true));
		log_message("Error", "Count of BMI off ".print_r($bmi_off, true));
		//$this->bhashsms->send_sms();
	}
	...
	public function send_sms_for_not_submited_attendance()
	{
		...
		$result = $this->tswreis_schools_common_model->send_sms_for_not_submited_attendance();

		foreach ($result as $details) {
			$data['message_hs'] = "Hi ".$details['hs_name'].", Today Attendence Report not submitted in Your School, So Please submit Attendace Report daily before 11AM";

			$data['message_principal'] = "Hi ".$details['pc_name'].", Today Attendence Report not submitted in Your School, So Please submit Attendace Report daily before 11AM";
			...
			$this->tswreis_schools_common_model->insert_attendance_info($data);
			...
			//$this->bhashsms->send_sms($details['hs_mob'], $general_msg);
			//$this->bhashsms->send_sms($details['pc_mob'], $general_msg);
//			$this->bhashsms->send_sms($details['rhso_mobile'], $general_msg);
			$this->bhashsms->send_sms($mobile_official_3, $message_official);
			//$this->bhashsms->send_sms($mobile_official_9,$message_official);
		}

			/*$this->bhashsms->send_sms($mobile_official_3, $general_msg);
			$this->bhashsms->send_sms("9705407055", $general_msg);
			$this->bhashsms->send_sms("9121174435",$general_msg);
			$this->bhashsms->send_sms("9866059098",$general_msg);*/
	...
	public function send_sms_for_not_submited_sanitation()
	{
		...
		//$mobile_official_3 = $get_info[3]['mobile_number'];
		//$mobile_official_9 = $get_info[9]['mobile_number'];
		$result = $this->tswreis_schools_common_model->send_sms_for_not_submited_sanitation();
		
		foreach ($result as $details) {
			$data['message_act'] = "Hi ".$details['act_name'].", Today Sanitation Report not submitted in Your School, So Please submit Sanitation Report daily before 11AM";
			...
			$message_official = "Hi Sir/Mam, ".$details['school_name']." This School did not submit Sanitation Report we  have sent SMS for HS : ".$details['act_name']." principal : ".$details['pc_name'];

			$data['message_rhso'] = "Hi ".$details['rhso_name'].",".$details['school_name']." This School did not submit Attendace Report we  have sent SMS for HS : ".$details['act_name']." principal : ".$details['pc_name'];
			$data['school_name'] = $details['school_name'];

			$this->tswreis_schools_common_model->insert_sanitation_info($data);
			//echo print_r($message_official.$message_act.$message_principal.$details['act_mob'].$details['pc_mob'].$mobile_official_9,TRUE);exit();
			$this->bhashsms->send_sms($details['act_mob'],$data['message_act']);
			$this->bhashsms->send_sms($details['pc_mob'],$data['message_principal']);
			$this->bhashsms->send_sms($details['rhso_mobile'],$data['message_rhso']);
			$this->bhashsms->send_sms($mobile_official_3,$message_official);
			//$this->bhashsms->send_sms($mobile_official_9,$message_official);
	...
	/*
	1) General SMS to HS : "Hi HS Name ", if you have any techology related issues in web site an d SIFNote App, Please share the information in chat in technical group.
	2) Any new children admission on Emergency create child profile in web and app otherwise prepare XL sheet and send to panacea, XL sheeet format is already shared, if you didn't recevice send message chat in Technical Group.

	3 All Doctors visits your school Prescriptions must be upload into the System.

	4 HB and BMI submission messages.

	5 Health calender, activities not done messages
	...
	*/
	public function send_sms_for_health_request()
	{
		...
		$mobile_official_3 = $get_info[3]['mobile_number'];
		$mobile_official_9 = $get_info[9]['mobile_number'];
		$documets = $this->tswreis_schools_common_model->send_sms_for_health_request();
		if(isset($documets['Normal']))
		{
			foreach ($documets['Normal'] as $details)
			{		
				$unique_id = $details['doc_data']['widget_data']['page1']['Student Info']['Unique ID'];
				$name = $details['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref'];
				//$hs_name = $details['doc_data']['school_contact_details']['health_supervisor']['name'];
				//$hs_mob = $details['doc_data']['school_contact_details']['health_supervisor']['mobile'];
				//$principal_name = $details['doc_data']['school_contact_details']['principal']['name'];
				//$principal_mob = $details['doc_data']['school_contact_details']['principal']['mobile'];
				$date_created = $details['history']['0']['time'];

				$code = explode("_", $unique_id);
				$hs_details = $this->tswreis_schools_common_model->get_health_supervisors_school_id($code[1]);
				$principal_details = $this->tswreis_schools_common_model->get_school_information_for_school_code($code[1]);

				$message = "Hi ".$hs_details['hs_name'].", A Health Request is created for ".$name." with UID ".$unique_id." on ".$date_created.", Status need to set to CURED or change the same as per current status of the child.";
				
				//echo print_r($hs_details['hs_mob'],TRUE);exit();
				/*$this->bhashsms->send_sms($hs_details['hs_mob'],$message);
				$this->bhashsms->send_sms($principal_details['school_mob'],$message);
				$this->bhashsms->send_sms($mobile_official_3,$message);
				$this->bhashsms->send_sms($mobile_official_9,$message);*/			
			}
		}elseif(isset($documets['Emergency']))
		{
			foreach ($documets['Emergency'] as $details)
			{		
				$unique_id = $details['doc_data']['widget_data']['page1']['Student Info']['Unique ID'];
				$name = $details['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref'];
				//$hs_name = $details['doc_data']['school_contact_details']['health_supervisor']['name'];
				...
				$message = "Hi ".$hs_details['hs_name'].", Emergency Request is created on ".$date_created." with child name ".$name." and U ID ".$unique_id.", update Status in the health request";
		...
		}elseif(isset($documets['Chronic']))
		{
			foreach ($documets['Chronic'] as $details)
			{		
				$unique_id = $details['doc_data']['widget_data']['page1']['Student Info']['Unique ID'];
				$name = $details['doc_data']['widget_data']['page1']['Student Info']['Name']['field_ref'];
				//$hs_name = $details['doc_data']['school_contact_details']['health_supervisor']['name'];
				...
				$message = "Hi ".$hs_details['hs_name'].", Chronic Request Raised on ".$date_created.", with child name ".$name." and U ID ".$unique_id.", Update the status and progress of the child in the Health request.";
	...
	{
		$get_numbres = $this->panacea_common_model->send_sms_for_parents_eclipse();
		foreach ($get_numbres['values'] as $father) {
			$numbers = trim($father);
			if(strlen((string) $numbers) == 10)
			{
				$solar_eclipse_msg = "All the parents are hereby advised not to allow their children out side the  house as there is a solar Eclipse on 26 December from 7am to 2pm which can seriously damage the vision of the child Panacea Doctors Team";
				//$this->bhashsms->send_sms($numbers,$solar_eclipse_msg);
			}
		}
		exit();
	}
	...
	///get the  date wise
	function all_activity_with_date()
	{
		$this->check_for_admin();
		$this->check_for_plan('all_activity_with_date');
		//cc start
		$school_code = $this->get_my_school_code();
		$school_info = $this->tswreis_schools_common_model->get_school_info($school_code);
		$school_name = $school_info[0]['school_name'];
		...
		//c end
		$today_date = $_POST['today_date'];
		$current_month = substr($today_date,0,-3);
		
		$this->data = $this->tswreis_schools_common_lib->all_activite_date($unique_id_pattern,$today_date);
		$this->data = $this->tswreis_schools_common_lib->all_activite_attendance($today_date,$school_name);
		$this->data = $this->tswreis_schools_common_lib->all_activite_hb_bmi($current_month,$school_name);
	...
	function get_treatment_advice_list()
	{
		$session_data = $this->session->userdata('customer');
		$email_id = $session_data['email'];
		$dist_code = strtoupper(str_replace(".","_",substr($email_id, 0,strpos($email_id,'@')-2)));
		$treatment_docs = $this->tswreis_schools_common_model->get_treatment_advice_list($dist_code);
		if(isset($treatment_docs) && !empty($treatment_docs))
		{
			$this->docs['treatment_docs'] = $treatment_docs;
		}else
		{
			$this->docs['message'] = "No Treatment Advice"; 
		}
		$this->_render_page('tswreis_schools/panacea_treatment_advice_list_view',$this->docs);
    ...
    {       
      ...
      $added = $this->tswreis_schools_common_model->add_doctor_profile_model($history,$doc_properties,$doc_data); 
      if($added)
    {
    ...
    function medicine_inventory_import()
    	{
    		$this->check_for_admin();    		
    		$this->data = $this->get_district_school_name();
    		$this->data['message'] = "";
    		$this->_render_page('tswreis_schools/medicine_inventory_import_view', $this->data);
    	}

    function import_medicine_inventory()
    	{
    		$this->check_for_admin();
    		...
    		$email_array    = explode(".",$email);
    		$school_code    = (int) $email_array[1];
    		$school_name = $logged_in_user['school_name'];
    		$explode_school = explode(",", $school_name);
    		$district_name = $explode_school[1];
    		...
    		//$post = $_POST;
    		$this->data = $this->tswreis_schools_common_lib->import_inventory_med($school);
    		
    		if($this->data == "redirect_to_hs_fn")
    		{
    			redirect('tswreis_schools/medicine_inventory_list');
    		}else if($this->data['error'] == 'excel_column_check_fail')
    		{
    			$this->_render_page('tswreis_schools/medicine_inventory_list_view', $this->data);
    		}else if($this->data['error'] == 'file_upload_failed')
    		{
    			$this->_render_page('tswreis_schools/medicine_inventory_list_view', $this->data);
    		}
    ...
    public function medicine_inventory_list()
	{		
		$school_code = $this->get_my_school_code();		
		$this->data['tab_data'] = $this->tswreis_schools_common_model->medicine_inventory_list($school_code);		
		$this->data['count'] = count($this->data['tab_data']);
		/*echo print_r($this->data['count'] , true);
		exit();*/
		$this->_render_page('tswreis_schools/medicine_inventory_list_view', $this->data);
	}	

	public function medicine_inventory()
	{
		$this->check_for_admin();
		$this->check_for_plan('medicine_inventory');		
		$this->data['health_supervisors'] = $this->tswreis_schools_common_model->get_medicine_inventorylist();
		
		//set the flash data error message if there is one
		$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
		$this->data['health_supervisorscount'] = $this->tswreis_schools_common_model->get_import_medicine();
	...
	public function add_news_feed_view()
	{
		...
		$this->_render_page ( 'tswreis_schools/add_news_feed', $this->data );
	}
	public function add_news_feed() {
		$this->check_for_admin ();
		$this->check_for_plan ( 'add_news_feed' );
		
		$news_return = $this->tswreis_schools_common_lib->add_news_feed ();
		...
		if($news_return['return_error']){
			...
			redirect('tswreis_schools/manage_news_feed_view');
		}
	}
	public function manage_news_feed_view() {
		...
		$this->_render_page ( 'tswreis_schools/manage_news_feed', $this->data );
	}
	public function delete_news_feed($nf_id) {
		$this->tswreis_schools_common_lib->delete_news_feed($nf_id);
	...
	public function edit_news_feed_view($nf_id) {
		...
		$this->data ['news_feed'] = $this->tswreis_schools_common_model->get_news_feed($nf_id);
		$this->data ['message'] = "";
	...
	public function update_news_feed() {
		...
		$news_return = $this->tswreis_schools_common_lib->update_news_feed ();
		log_message ( 'debug', 'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn' . print_r ( $news_return, true ) );
		if($news_return['return_error']){
			$this->data ['message'] = $news_return['message'];
			$this->_render_page ( 'tswreis_schools/add_news_feed', $this->data );
	...
	public function get_searched_student_sick_requests()
	{
		...
		$this->data = $this->tswreis_schools_common_model->get_searched_student_sick_requests_model($search_data,$school_name);
