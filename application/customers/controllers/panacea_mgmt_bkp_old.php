  ...
  public function get_daily_request_for_bar()
{
   ...
   public function get_hospital_type_data_table()
    {
        ...
        $date = $this->input->post('date_idd', true);
  ...
  public function get_screening_pie_values()
    ...
    $this->data = $this->panacea_common_model->get_hospitalized_data_count_model($today_date); 
	 ...
	 public function get_hospitalized_data_table()
    {
        ...
        exit();*/        
        $this->data['students_details'] = $this->panacea_common_model->get_hospitalized_data_table_model($date, $request_type, $hospital_district);
        //echo print_r($this->data,true); exit();
     ...
     public function get_day_to_day_glance_students()
	{
		...
		/*echo print_r($this->data['get_students_count'], true);
		echo print_r($this->data['day_to_day_status'], true);	
		exit();*/
		if(!empty($this->data)){
			$this->output->set_output(json_encode($this->data));
		}else{
