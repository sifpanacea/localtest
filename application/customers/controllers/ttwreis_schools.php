...
class Ttwreis_schools extends My_Controller {
	...
	{
		redirect('ttwreis_schools/to_dashboard');
	}
	
	public function initiate_request()
	{
		$this->data = "";
		$this->_render_page('ttwreis_schools/application_initiate',$this->data);
	}
	...
	{
		$this->data['doc_id'] = $id;
		$this->_render_page('ttwreis_schools/hs_req_application_access',$this->data);
	}
	
	public function initiate_attendance()
	{
		$this->data = "";
		$this->_render_page('ttwreis_schools/attendance_initiate',$this->data);
	}
	
	public function initiate_sanitation_report()
	{
		$this->data = "";
		$this->_render_page('ttwreis_schools/sanitation_report',$this->data);
	}
	
	public function initiate_sanitation_infrastructure()
	{
		$this->data = "";
		$this->_render_page('ttwreis_schools/sanitation_infrastructure',$this->data);
	}
	...
	function list_chronic_cases()
	{
	  ...
	  $total_rows = $this->ttwreis_schools_common_model->ttwreis_chronic_cases_count($school_name);
	  ...
	  /*$this->data['cases'] =$this->ttwreis_schools_common_model->get_chronic_cases_model($config['per_page'],$page,$school_name);*/
	  ...
	  $this->data['cases'] =$this->ttwreis_schools_common_model->get_chronic_cases_model_for_data_table($school_name);
		
	  $this->_render_page('ttwreis_schools/chronic_case_report',$this->data);
	}
	...
	function to_dashboard($date = FALSE, $request_duration = "Monthly", $screening_duration = "Yearly")
	{
		...
		$this->data = $this->ttwreis_schools_common_lib->to_dashboard($date, $request_duration, $screening_duration);
		$this->_render_page('ttwreis_schools/school_dash', $this->data);
	...
	function to_dashboard_with_date()
	{
		...
		$this->data = $this->ttwreis_schools_common_lib->to_dashboard_with_date($today_date,$request_pie_span,$screening_pie_span);
	...
	function fetch_sanitation_report_against_date()
	{
	  ...
	  $sanitation_report_data = $this->ttwreis_schools_common_model->get_sanitation_report_data_with_date($date,$school_name);
		
	  $sanitation_report = $this->ttwreis_schools_common_lib->build_sanitation_report($sanitation_report_data);
	...
	function update_request_pie()
	{
		...
		$today_date = $_POST['today_date'];
		$request_pie_span = $_POST['request_pie_span'];
		$this->data = $this->ttwreis_schools_common_lib->update_request_pie($today_date,$request_pie_span);
	...
	function update_screening_pie()
	{
		...
		$today_date = $_POST['today_date'];
		$screening_pie_span = $_POST['screening_pie_span'];
		$this->data = $this->ttwreis_schools_common_lib->update_screening_pie($today_date,$screening_pie_span);
	...
	function refresh_screening_data()
	{
		...
		$this->ttwreis_schools_common_model->update_screening_collection($today_date,$screening_pie_span,$school_name);
		$today_date = $this->ttwreis_schools_common_model->get_last_screening_update();
	...
	function drilling_screening_to_abnormalities()
	{
		...
		$today_date = $_POST['today_date'];
		$screening_pie_span = $_POST['screening_pie_span'];
		$screening_report = json_encode($this->ttwreis_schools_common_model->get_drilling_screenings_abnormalities($data,$today_date,$screening_pie_span));
	...
	function drill_down_screening_to_students()
	{
		...
		$today_date = $_POST['today_date'];
		$screening_pie_span = $_POST['screening_pie_span'];
		$docs = $this->ttwreis_schools_common_model->get_drilling_screenings_students($data,$today_date,$screening_pie_span);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$get_docs = $this->ttwreis_schools_common_model->get_drilling_screenings_students_docs($docs_id);
		...
		$this->_render_page('ttwreis_schools/drill_down_screening_to_students_load_ehr',$this->data);
	}
	
	public function drill_down_screening_to_students_load_ehr_doc($_id)
	{
		//$docs = $this->ttwreis_schools_common_model->drill_down_screening_to_students_load_ehr_doc($_id);
		...
		$this->_render_page('ttwreis_schools/ttwreis_schools_reports_display_ehr',$this->data);
	}
	
	public function drill_down_screening_initiate_request($_id)
	{
		$this->data['doc'] = $this->ttwreis_schools_common_model->drill_down_screening_to_students_doc($_id);
	...
	function drill_down_absent_to_students()
	{
		...
		// Get my school code
		$school_code = $this->get_my_school_code();
		$school_data = $this->ttwreis_schools_common_model->get_school_details_for_school_code($school_code);
		
		$docs = $this->ttwreis_schools_common_model->get_drilling_absent_students($label,$today_date,$school_data['school_name']);
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		$get_docs = $this->ttwreis_schools_common_model->get_drilling_absent_students_docs($UI_id);
	...
	$this->_render_page('ttwreis_schools/drill_down_absent_to_students_load_ehr',$this->data);
	}
	...
	function drill_down_request_to_students()
	{
		...
		$docs = $this->ttwreis_schools_common_model->get_drilling_request_students($request_label,$today_date,$request_pie_span,$school_name,$id_pattern);
	...
	function drill_down_request_to_students_load_ehr()
	{
		...
		$get_docs = $this->ttwreis_schools_common_model->get_drilling_request_students_docs($UI_id);
		...
		$this->_render_page('ttwreis_schools/drill_down_request_to_students_load_ehr',$this->data);
	}
	...
	function drill_down_identifiers_to_students()
	{
		...
		$docs = $this->ttwreis_schools_common_model->get_drilling_identifiers_students($identifier,$today_date,$request_pie_span,$school_name,$id_pattern);
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		$get_docs = $this->ttwreis_schools_common_model->get_drilling_identifiers_students_docs($UI_id);
		...
		$this->_render_page('ttwreis_schools/drill_down_identifiers_to_students_load_ehr',$this->data);
	}
	 ...
	 public function classes()
	{
		...
		$this->data = $this->ttwreis_schools_common_lib->classes($school_code);
		$this->_render_page('ttwreis_schools/classes',$this->data);
	}
	...
	public function create_class()
	{
	    ...
	    $school_code = $this->get_my_school_code();
	 	...
	 	$this->ttwreis_schools_common_model->create_class($_POST, $school_code);	
	 	redirect('ttwreis_schools/classes');
	}
	...
	public function delete_class($class_id)
	{
	    ...
	    $school_code = $this->get_my_school_code();
	 	...
	 	$this->ttwreis_schools_common_model->delete_class($class_id, $school_code);	
	 	redirect('ttwreis_schools/classes');
	}
	...
	public function sections()
	{
        ...
        $this->data = $this->ttwreis_schools_common_lib->sections($school_code);
		$this->_render_page('ttwreis_schools/sections',$this->data);
	}
	...
	public function create_section()
	{
	    ...
	    $school_code = $this->get_my_school_code();
	 	...
	 	$this->ttwreis_schools_common_model->create_section($_POST, $school_code);
	 	redirect('ttwreis_schools/sections');
	}
	...
	public function delete_section($section_id)
	{
	  ...
	  $this->ttwreis_schools_common_model->delete_section($section_id, $school_code);	
	  redirect('ttwreis_schools/sections');
	}
	...
	public function create_student()
	{
		...
		$school_name = $school_info[0]['school_name'];
		$dist_info = $this->ttwreis_schools_common_model->get_district($district_id);
		$district_code = $dist_info[0]['dt_code'];
		
		$classes     = $this->ttwreis_schools_common_model->get_all_classes("All",$school_code);
		$sections    = $this->ttwreis_schools_common_model->get_all_sections("All",$school_code);
		//$hunique_id  = $this->ttwreis_schools_common_model->generate_new_student_hunique_id($school_code,$district_code,$school_name);
		$hunique_id  = $this->ttwreis_schools_common_model->generate_new_uniqueid_for_new_student_by_checking_all_collection($school_code,$district_code,$school_name);
		...
		$this->_render_page('ttwreis_schools/create_student',$this->data);
	...
	public function create_staff()
	{
		...
		$hunique_id  = $this->ttwreis_schools_common_model->generate_new_staff_hunique_id($school_code,$district_code,$school_name);
		
		$this->data['school_name']   = $school_name;
		$this->data['huniqueid']     = $hunique_id;
		$this->data['message']       = '';
		
		$this->_render_page('ttwreis_schools/create_staff',$this->data);
	...
	public function add_student_ehr()
	{
	 ...
	 /*  // History
	  ...
	  $added = $this->ttwreis_schools_common_model->add_student_ehr_model($doc_data,$history,$doc_properties); 
	  ...
	  {
        $classes  = $this->ttwreis_schools_common_model->get_all_classes("All");
		$sections = $this->ttwreis_schools_common_model->get_all_sections("All");
		$hunique_id = $this->ttwreis_schools_common_model->generate_new_student_hunique_id($school_code,$district_code,$school_name);
		$this->data['classes']   = $classes;
		$this->data['sections']  = $sections;
		$this->data['huniqueid'] = $hunique_id;
	...
	public function add_staff_ehr()
	{
	  ...
	  $added = $this->ttwreis_schools_common_model->add_staff_ehr_model($doc_data,$history); 
	...
	public function student_reports()
	{
		...
		$this->data['students'] = $this->ttwreis_schools_common_model->get_student($per_page,$page,$school_name);
		$this->data['studentscount'] = $this->ttwreis_schools_common_model->studentscount($school_name);
		$this->data['classlist'] = $this->ttwreis_schools_common_model->get_classes($per_page, $page, $school_code);
		//echo print_r($this->data['classlist'], true);exit();
		$this->_render_page('ttwreis_schools/student_reports',$this->data);
	}
	...
	public function get_students_list_by_class()
	{
		...
		$school_info = $this->ttwreis_schools_common_model->get_school_info($school_code);
		$school_name = $school_info[0]['school_name'];
		$students = $this->ttwreis_schools_common_model->get_students_by_class($selected_class, $school_name);
		//log_message('debug','students for studentttttt==========12154'.print_r($students,true));
		//echo print_r($students, true); exit();
	...
	public function reports_ehr()
	{
		...
		$this->_render_page('ttwreis_schools/reports_ehr',$this->data);
	}
	...
	public function reports_display_ehr_uid()
	{
		...
		$this->data = $this->ttwreis_schools_common_lib->reports_display_ehr_uid($student_unique_id,$school_name);
		$this->data['username'] = $username.','.$school_name;
		...
		$this->_render_page('ttwreis_schools/reports_display_ehr',$this->data);
	}
	...
	function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			//render
			$this->_render_page('ttwreis_schools/change_password', $this->data);
		}
		else
		{
			...
			$change = $this->ttwreis_schools_common_model->change_password($identity, $this->input->post('old'), $this->input->post('new_pwd'));
	...
	public function staff_reports()
	{
		...
		$this->data = "";
		$this->_render_page('ttwreis_schools/staff_reports',$this->data);
	}
	...
	function create_schedule_followup()
	{
	  ...
	  $is_created = $this->ttwreis_schools_common_model->create_schedule_followup_model($unique_id,$medication_schedule,$treatment_period,$start_date,$monthNames,$case_id);
	...
	function update_schedule_followup()
	{
	  ...
	  $compliance = $this->ttwreis_schools_common_model->calculate_chronic_graph_compliance_percentage($case_id,$unique_id,$medication_taken);
	  
	  //log_message('debug','update_schedule_followup==3='.print_r($compliance,true));
	  
	  $is_updated = $this->ttwreis_schools_common_model->update_schedule_followup_model($unique_id,$case_id,$compliance,$selected_date);
	...
	function prepare_pill_compliance_monthly_graph()
	{
	  ...
	  $pcompl_raw_data   = $this->ttwreis_schools_common_model->fetch_student_pill_compliance_data($case_id,$student_unique_id);
	...
	public function delete_note() 
	{
		...
		$token = $this->ttwreis_schools_common_lib->delete_ehr_note($doc_id);
	...
	public function extend_request() 
	{
		...
		$this->data['requests'] = $this->ttwreis_common_model->get_all_rised_req();
		$this->data['message'] = false;
		
		$this->_render_page('ttwreis_schools/extend_request',$this->data);
	}
	...
	public function app_access($doc_id)
	{
		...
		$this->_render_page('ttwreis_schools/extend_request_app',$this->data);
	}
	...
	function hs_req_extend(){
		...
		if($req_return['return_error']){
			...
			redirect('ttwreis_schools/extend_request');
	...
	public function feed_bmi_student() 
	 {
		...
		$this->_render_page('ttwreis_schools/ttwreis_feed_bmi',$this->data);
	}
	...
	public function show_bmi_student() 
	 {
		...
		$this->data["school_code"]   = $email_array[1];
		$this->data["district_code"] = strtoupper($email_array[0]);
		$this->_render_page('ttwreis_schools/ttwreis_show_bmi_graph',$this->data);
	}
	/*
	*BMI Ajax function
	*author Naresh
	...
	*/ 
	...
	public function ttwreis_update_ehr()
	{
		...
		$this->data["district_code"] = strtoupper($email_array[0]);
		//$this->data["message"] = "";		
		$this->_render_page('ttwreis_schools/update_personal_info',$this->data);
	}
	
	public function ttwreis_update_personal_ehr_uid()
	{
		$post = $_POST['student_unique_id'];
		$this->data = $this->ttwreis_schools_common_lib->ttwreis_update_personal_ehr_uid($post);
		
		$this->data['docscount'] = count($this->data['docs']);
	
		$this->_render_page('ttwreis_schools/ttwreis_update_personal_ehr',$this->data);
	}
	...
	public function update_student_ehr()
	{
	  ...
	  $ehr_update = $this->ttwreis_schools_common_model->update_student_ehr_model($unique_id,$update_profile); 
	 ...
	 redirect("ttwreis_schools/ttwreis_update_ehr");
	}
	...
	public function bmi_pie_view()
	{
	  ...
	  //Fetch school details with school code
		...
		$this->data = $this->ttwreis_schools_common_lib->bmi_pie_view_lib($current_month, $school_name);
		$this->_render_page('ttwreis_schools/ttwreis_schools_bmi_pie_view',$this->data);
	}
	...
	public function bmi_pie_view_month_wise()
	{
		...
		$school_info = $this->ttwreis_schools_common_model->get_school_info($school_code);
	  	$school_name = $school_info[0]['school_name'];
		$this->data = $this->ttwreis_schools_common_lib->bmi_pie_view_lib_month_wise($current_month,$school_name);
	...
	function drill_down_bmi_to_students()
	{
		...
		$docs = $this->ttwreis_schools_common_model->get_drill_down_to_bmi_report($symptom_type ,$month ,$school_name);
	...
	function drill_down_to_bmi_report_students()
	{
		...
		$students = $this->ttwreis_schools_common_model->get_drilling_bmi_students_docs($UI_id);
		...
		$this->_render_page('ttwreis_schools/ttwreis_schools_drill_down_to_bmi_report_view',$this->data);
	}
	...
	public function show_student_bmi_graph($hospital_unique_id){
		...
		$bmi_value = $this->ttwreis_schools_common_model->get_student_bmi_graph_values($hospital_unique_id);
		...
		$this->_render_page('ttwreis_schools/ttwreis_schools_show_student_bmi_graph_view',$final_bmi_data);
		}
	...
	public function generate_bmi_report_to_excel()
	{
		...
		$file_path = $this->ttwreis_schools_common_lib->generate_bmi_report_to_excel_lib($date, $school_name);
	...
	*/
	...
	{
		$this->data['message'] = "";
		$this->_render_page("ttwreis_schools/show_contact_us",$this->data);
	}
	public function fetch_student_info()
	{
		...
		$this->data['get_data'] = $this->ttwreis_schools_common_model->fetch_student_info_model($school_name, $unique_id);
	...
	**author suman reddy */
	public function initiateBmiReport()
	{
		...
		$this->data["school_code"]   = $email_array[1];
		$this->data["district_code"] = strtoupper($email_array[0]);
		$this->load->view('ttwreis_schools/bmifeed_report_view', $this->data);
	...
	{	
		...
		if(!empty($is_exists))
		{
		   ...
		   }else if($bmi_count_value >= 30)
		   {
			...
			$existing_update = $this->ttwreis_schools_common_model->update_bmi_values($ndate,$monthly_bmi, $uniqueId,$bmi_values_data);
				...
				if ($existing_update ) // the information has therefore been successfully saved in the db
				{
					...
					redirect('ttwreis_schools/initiateBmiReport');
				}
				else
				{
			...
			}elseif($class == "Degree 3rd")
			{
	          ...
	          // History
				...
				$newly_created = $this->ttwreis_schools_common_model->add_student_BMI_model($monthly_bmi, $doc_properties, $app_properties, $history,$bmi_values_data);
	...
	function ttwreis_imports_bmi_values()
	{
		...
		$this->data['message'] = "";
		$this->_render_page('ttwreis_schools/ttwreis_imports_bmi_values', $this->data);
	}
	...
	function imported_bmi_xl_sheet()
	{
		...
		//$this->data = $this->ttwreis_schools_common_lib->ttwreis_imports_hb_values();
			$this->data = $this->get_district_school_name();
	...
	function imports_bmi_values()
	{
		...
		$this->data = $this->ttwreis_schools_common_lib->imports_bmi_values($post);

		
		if($this->data == "redirect_to_bmi_fn")
		{

			redirect('ttwreis_schools/imported_bmi_xl_sheet');
	...
	public function initiateHemoglobinReport()
	{
		...
		$this->data["district_code"] = strtoupper($email_array[0]);
	  	...
	  	$this->_render_page('ttwreis_schools/hb_feed_view', $this->data);
	}
 	...
 	public function create_hemoglobin_report()
  	{
		...
		$is_exists  = $this->ttwreis_schools_common_model->check_if_doc_exists_in_hb($uniqueId);
		$hb_values_data = "";
		if(!empty($is_exists))
		{
			$hb_final = array();
		   ...
		   if($hb_count_value < 13 )
		   {
			...
			$existing_update = $this->ttwreis_schools_common_model->update_hb_values($ndate,$monthly_hb, $uniqueId,$hb_values_data);
			...
			if ($existing_update ) // the information has therefore been successfully saved in the db
			{
				...
				redirect('ttwreis_schools/initiateHemoglobinReport');
			}
			else
			{
				$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
		...
		{				
		   ...
		   if($hb_count_value < 13 )
		   {
			...
			$newly_created = $this->ttwreis_schools_common_model->add_student_HB_model($monthly_hb, $doc_properties, $app_properties, $history,$hb_values_data);
	...
	*/ 
	public function show_hb_student() 
	{
		...
		$this->data["school_code"]   = $email_array[1];
		$this->data["district_code"] = strtoupper($email_array[0]);
		$this->_render_page('ttwreis_schools/school_wise_show_hb_graph',$this->data);
	}
	/*
	*BMI Ajax function
	...
	*/ 
	public function student_hb_graph(){
		...
		$hb_value = $this->ttwreis_schools_common_model->get_student_hb_values($unique_id);
	...
	function ttwreis_imports_hb_values()
	{
		...
		//$this->data = $this->ttwreis_schools_common_lib->ttwreis_imports_hb_values();
			$this->data = $this->get_district_school_name();
			$this->data['message'] = "";
		$this->_render_page('ttwreis_schools/ttwreis_imports_hb_values', $this->data);
	}
	...
	function imports_hb_values()
	{
		...
		$post = $_POST;
		//log_message('error','post=============='.print_r($post,true));exit();
		$this->data = $this->ttwreis_schools_common_lib->imports_hb_values($post);

		
		if($this->data == "redirect_to_hb_fn")
		{
			redirect('ttwreis_schools/imported_hb_xl_sheet');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->data = $this->get_district_school_name();
			$this->_render_page('ttwreis_schools/ttwreis_imports_hb_values', $this->data);
	...
	public function initiateAttendanceReport()
	{
		...
		$this->_render_page('ttwreis_schools/attendance_report_view', $this->data);
	}
	...
	public function create_attendence_report()
	{
		...
		$added = $this->ttwreis_schools_common_model->create_attendence_report_model($doc_data, $doc_properties, $app_properties, $history);
		if($added)
		{
		...
		{
			redirect('ttwreis_schools/initiateAttendanceReport');
		}
	...
	public function initiateSanitationReport()
	  {
			...
			$this->data = "";
		  	$this->_render_page('ttwreis_schools/sanitation_report_view', $this->data);
	  }
        ...
        foreach ($_FILES as $index => $value)
       {
            ...
            if(strpos($index,'hs_req_attachments_campus')!== false)
			{
                ...
                for($i=0; $i<$cpt; $i++)
                {
                     ...
                     $_FILES['hs_req_attachments_campus']['size']  = $files['hs_req_attachments_campus']['size'][$i];
              		...
              		$this->upload->initialize($this->campus_attachment_upload_options('healthcare20171211809800_con',$index));
     		...
     		if(strpos($index,'hs_req_attachments_toilets')!== false)
			{
                ...
                for($i=0; $i<$mri; $i++)
                {
			       ...
			       $this->upload->initialize($this->toilet_attachment_upload_options('healthcare20171211809800_con',$index));
                if ( ! $this->upload->do_upload($index))
                {
       	...
       	if(strpos($index,'hs_req_attachments_kitchen')!== false)
		 {
            ...
            for($i=0; $i<$bill; $i++)
            {
                ...
                $this->upload->initialize($this->kitchen_attachment_upload_options('healthcare20171211809800_con',$index));
        	...
        	if(strpos($index,'hs_req_attachments_dormitory')!== false)
		 {
            ...
            for($i=0; $i<$dormitory; $i++)
            {
                ...
                $this->upload->initialize($this->dormitory_attachment_upload_options('healthcare20171211809800_con',$index));
		...
		$added = $this->ttwreis_schools_common_model->create_sanitation_report_model($doc_data, $doc_properties, $app_properties, $history);
		if($added)
		{
			redirect('ttwreis_schools/to_dashboard');
		}
		...
		{
			redirect('ttwreis_schools/initiateSanitationReport');
		}
	...
	*/
	public function hs_request()
	{
		...
		$this->_render_page('ttwreis_schools/hs_initiate_request', $this->data);
	}
	/*
	...
	*/
	public function fetch_student_information()
	{
		...
		$this->data['get_data'] = $this->ttwreis_schools_common_model->fetch_student_information_model($school_name, $unique_id);
	...
	*/
	public function initiate_hs_request()
	{
	  ...
	  // Page 1
		...
		$doc_data['widget_data']['page2']['Diagnosis Info']['Doctor Summary']  = ($doctor_summary) ? $doctor_summary : '';
		$doc_data['widget_data']['page2']['Diagnosis Info']['Doctor Advice']  = ($doctor_advice) ? $doctor_advice : '';
		$doc_data['widget_data']['page2']['Diagnosis Info']['Prescription']  = ($prescription) ? $doctor_prescription : '';
			  ...
			  if(!empty($value['name']))
			  {
					...
					if ( ! $this->upload->do_upload($index))
					{
						 $this->session->set_flashdata('message','Submission failed. Each attachment file should be less than 2 MB');
								...
								redirect('ttwreis_schools/hs_request');  
		...
		/* if(array_key_exists("user_type",$session_data))
		 {
			if($session_data['user_type'] == "HS")
			{
				$health_supervisor = $this->ion_auth->ttwreis_health_supervisors()->row();
				$hs_name = $health_supervisor->hs_name;
				$hs_mob  = $health_supervisor->hs_mob;
			}
			else
...
//		echo print_r($doc_data,true);
	...
	*/
  	...
  	public function fetch_submited_requests_docs()
  	{
  		...
  		$hs_req_docs  = $this->ttwreis_schools_common_model->get_hs_req_normal($collection,$unique_id_code);

		$hs_req_emergency  = $this->ttwreis_schools_common_model->get_hs_req_emergency($collection,$unique_id_code);

		$hs_req_chronic  = $this->ttwreis_schools_common_model->get_hs_req_chronic($collection,$unique_id_code);

		$hs_req_cured  = $this->ttwreis_schools_common_model->get_hs_req_cured($collection,$unique_id_code);

		$hs_req_expired  = $this->ttwreis_schools_common_model->get_hs_req_expired($collection,$unique_id_code);
		...
		if(!empty($hs_req_expired)){
  		...
  		$this->_render_page('ttwreis_schools/fetch_submited_requests_docs',$this->data);
  	}
	...
	*/
	public function access_submited_request_docs($id)
  	{
  		$doc_id = $id;
		$query = $this->ttwreis_schools_common_model->access_submited_request_docs($doc_id);
		$this->data['hs_req_docs'] = $query;
		$this->_render_page('ttwreis_schools/access_submited_request_docs',$this->data);
  	}
  	/*
	...
	*/
		 ...
		 if(isset($_FILES) && !empty($_FILES))
    {
  	...
  	/* $history = array();
		...
		*/
		...
		$approval_history = $this->ttwreis_schools_common_model->get_approval_history($doc_id);

		array_push($approval_history,$approval_data);

  	  $existing_update = $this->ttwreis_schools_common_model->update_request_submit_model($doc_data,$approval_history,$unique_id,$doc_id,$doc_properties); 
  	  ...
  	  if ($existing_update ) // the information has therefore been successfully saved in the db
			{
				...
				redirect('ttwreis_schools/fetch_submited_requests_docs');
			}
			else
			{
				$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
	...
	/* function get_students_list_device()
	{
		...
		$students_lists = $this->ttwreis_schools_common_model->get_students_list_device($school);
	...
	*/
	public function reports_display_ehr_uid_new_html_static_hs()
	{
		...
		$this->_render_page('ttwreis_schools/ttwreis_reports_display_ehr_new_dashboard',$this->data);
	}
	...
	{ 
		...
		$today_date = date('Y-m-d');
		$this->data['report_count'] = $this->ttwreis_schools_common_model->get_attendance_report_daily_count($school_name, $today_date);
		$docs = $this->ttwreis_schools_common_model->get_requests_daily_count($district_school_code, $today_date);
		$requests_info = $this->ttwreis_schools_common_model->get_request_info_by_type($district_school_code, $today_date);
		$doctor_docs = $this->ttwreis_schools_common_model->get_docs_daily_count($district_school_code, $today_date);
		$doctor_docs_info = $this->ttwreis_schools_common_model->get_docs_daily_requests_info($district_school_code, $today_date);
		$this->data['total_student_count'] = $this->ttwreis_schools_common_model->studentscount($school_name);
       ...
       if(!empty($doctor_docs_info['doc_chronic_requests_info'])) {
		...
		$bmi_info = $this->ttwreis_schools_common_model->get_bmi_report_model_count($current_month, $school_name);
		...
		$bmi_student_info = $this->ttwreis_schools_common_model->get_bmi_report_model_info($current_month, $school_name);
		...
		$this->data['screening_info'] =$this->ttwreis_schools_common_model->get_all_screenings_count($today_date = false, $screening_duration = "Yearly");
		

		$hb_count = $this->ttwreis_schools_common_model->get_hb_report_model_count($current_month, $school_name);
		$hb_count_info = $this->ttwreis_schools_common_model->get_hb_report_model_info($current_month, $school_name);
		...
		$sanitation_report = $this->ttwreis_schools_common_model->get_sanitation_report_data_with_date_version_2($date,$school_name);

		$this->data['sanitation_report'] = $this->ttwreis_schools_common_lib->build_sanitation_report_v2($sanitation_report);
		
		
		//$this->data['sanitation_report'] = $this->ttwreis_schools_common_lib->build_sanitation_report_activities($date,$school_name);
		//$this->data['sanitation_report'] = "";
		
		$this->data['basic_dash_screening_report_yearly'] = $this->ttwreis_schools_common_model->get_screened_students_count($unique_id_pattern);

		$this->data['basic_dash_yearly_request_count'] = $this->ttwreis_schools_common_model->get_all_requests_yearly_count($date,$request_duration="Yearly",$unique_id_pattern);

		$this->data['basic_dash_students_count'] = $this->ttwreis_schools_common_model->studentscount($school_name);
		
		$school_color_code = $this->ttwreis_schools_common_model->get_school_color_code($school_code);
		$this->data['school_color_code'] = $school_color_code;

		//$hsrequests = $this->ttwreis_schools_common_lib->to_dashboard_new($date, $request_duration, $screening_duration);

		//$this->data['report'] = $hsrequests;
		$this->data['all'] = $this->ttwreis_schools_common_model->get_doctor_visiting_report_date_wise($school_name);
		$this->data ['news_feeds'] = $this->ttwreis_schools_common_model->get_all_news_feeds();
		$this->data['today_date'] = date('Y-m-d');
		$this->_render_page('ttwreis_schools/all_activities_view',$this->data);
	}
	public function get_students_load_ehr_doc_basic_dashboard($_id)
	{
		$docs = $this->ttwreis_schools_common_model->get_students_load_ehr_doc_model($_id);
		...
		$this->_render_page('ttwreis_schools/ttwreis_schools_reports_display_ehr_new',$this->data);
	}
	public function my_profile_hs()
	{
		 ...
		 $this->_render_page('ttwreis_schools/my_profile_hs',$this->data);
	...
	{ 
		...
		$result = $this->ttwreis_schools_common_model->update_principal_hs_profile($post,$schoolCode);
		...
		if ($result ) // the information has therefore been successfully saved in the db
				{
					...
					redirect('ttwreis_schools/my_profile_hs');
				}
				else
				{
					$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
	...
	public function get_screening_data_with_abnormalities()
	{
		...
		$this->data = $this->ttwreis_schools_common_model->get_drilling_screenings_abnormalities_to_count($selectedLabel, $date = false, $screening_duration = "Yearly");
	...
	function drill_down_screening_to_students_count()
	{
		...
		$docs = $this->ttwreis_schools_common_model->drill_down_screening_to_students_count($symptome_type,$date = false,$screening_duration = "Yearly");
	...
	function drill_down_screening_to_students_load_ehr_count()
	{
		...
		$get_docs = $this->ttwreis_schools_common_model->get_drilling_screenings_students_docs_count($docs_id);
	...
	public function hb_pie_view()
	{
	  ...
	  //Fetch school details with school code
		...
		$this->data = $this->ttwreis_schools_common_lib->hb_pie_view_lib($current_month, $school_name);
		$this->_render_page('ttwreis_schools/hb_pie_view',$this->data);
	}
	...
	function drill_down_hb_to_students()
	{
		...
		$docs = $this->ttwreis_schools_common_model->get_drill_down_to_hb_report($symptom_type ,$month ,$school_name);
	...
	public function show_student_hb_graph($hospital_unique_id){
		...
		$hb_value = $this->ttwreis_schools_common_model->get_student_hb_graph_values($hospital_unique_id);
	...
	$this->_render_page('ttwreis_schools/show_student_hb_graph_view',$final_hb_data);
	...
	public function doctor_visit(){
		...
		$this->data['doc_names'] = $this->ttwreis_schools_common_model->get_doctor_names($email);


	  	$this->_render_page('ttwreis_schools/doctor_visit', $this->data);
	}
	public function fetch_student_info_for_doctor_visit()
	{
		...
		$this->data['get_data'] = $this->ttwreis_schools_common_model->fetch_student_info_for_doctor_visit($school_name, $unique_id);
		$this->data['get_attachments'] = $this->ttwreis_schools_common_model->fetch_student_attachments($school_name, $unique_id);
...
*/
				...
				$app_properties['app_name'] = "TTWREIS Doctor Visiting App";
				...
				$newly_created = $this->ttwreis_schools_common_model->submit_doctor_visiting_report($doc_data,$doc_attachments, $doc_properties, $app_properties, $history);

				if($newly_created){
					$this->session->set_flashdata('success','Doctor Report submitted successfully');
					redirect('ttwreis_schools/doctor_visit');
	...
	public function drill_down_to_doctor_treated_list(){
		...
		$this->data['student_list'] = $this->ttwreis_schools_common_model->drill_down_to_doctor_treated_list($school_name,$selectedDate);

		$this->data['doctor_visiting_date'] = $selectedDate;
	  	$this->_render_page('ttwreis_schools/doctor_visit_student_list', $this->data);
	}
	public function show_doctor_treated_student(/*$uid,$doctor_visit_date*/ $doc_id)

	 {
	 	
		$this->data['unique_id'] = $this->ttwreis_schools_common_model->show_doctor_treated_student(/*$uid, $doctor_visit_date*/$doc_id);
		
		
		$this->_render_page('ttwreis_schools/show_doctor_visit_student',$this->data);
	}

	public function get_officials_info()
	{
		$get_info = $this->ttwreis_schools_common_model->get_officials_info();
		return $get_info;
	}
...
//		$mobile_official_3 = "9121333476";
		...
		$result = $this->ttwreis_schools_common_model->send_sms_for_not_submited_attendance();
		...
		foreach ($result as $details) {
			...
			$this->ttwreis_schools_common_model->insert_attendance_info($data); 
	...
	public function send_sms_for_not_submited_sanitation()
	{
		...
		//$mobile_official_3 = $get_info[3]['mobile_number'];
		//$mobile_official_9 = $get_info[9]['mobile_number'];
		$result = $this->ttwreis_schools_common_model->send_sms_for_not_submited_sanitation();
		...
		foreach ($result as $details) {
			...
			//$this->ttwreis_schools_common_model->insert_sanitation_info($data);
			//echo print_r($message_official.$message_hs.$message_principal.$details['hs_mob'].$details['pc_mob'].$mobile_official_9,TRUE);exit();
			$this->bhashsms->send_sms($details['hs_mob'],$data['message_hs']);
			$this->bhashsms->send_sms($details['pc_mob'],$data['message_principal']);
			$this->bhashsms->send_sms($details['rhso_mobile'],$data['message_rhso']);
    ...
    {       
      ...
      $added = $this->ttwreis_schools_common_model->add_doctor_profile_model($history,$doc_properties,$doc_data); 
      if($added)
    {
    ...
    public function get_searched_student_sick_requests()
	{
		...
		$this->data = $this->ttwreis_schools_common_model->get_searched_student_sick_requests_model($search_data,$school_name);
