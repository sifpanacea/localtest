...
class Tmreis_mgmt extends My_Controller {
    ...
    function __construct()
	{
		...
		$this->load->model('tmreis_mgmt_model');
	...
	{
		//redirect('tmreis_mgmt/to_dashboard');
		redirect('tmreis_mgmt/basic_dashboard');
	}

	/* changed by bhanu===========================================================*/
	
	public function tmreis_sanitation_report($date = FALSE)
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_sanitation_report');
		$this->data['today_date'] = date('Y-m-d');
		$this->data = $this->tmreis_common_lib->to_dashboard($date);
		$this->_render_page('tmreis_admins/tmreis_sanitation_report',$this->data);
	}
	...
	function download_sanitation_report_sent_schools_list()
	{
	   ...
	   // Excel generation
	   $file_path = $this->tmreis_common_lib->generate_excel_for_sanitation_report_sent_schools($date,$schools_list);
	...
	function download_sanitation_report_not_sent_schools_list()
	{
	   ...
	   // Excel generation
	   $file_path = $this->tmreis_common_lib->generate_excel_for_sanitation_report_not_sent_schools($date,$schools_list);
	   $this->output->set_output($file_path);
	}
	
	public function tmreis_sanitation_infrastructure()
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_sanitation_infrastructure');
		
		$this->data['today_date'] = date('Y-m-d');
		$this->data['distslist'] = $this->tmreis_common_model->get_all_district();
		$this->_render_page('tmreis_admins/tmreis_sanitation_infrastructure_report',$this->data);
	}
	
	public function tmreis_chronic_report_graph($date = FALSE)
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_chronic_report_graph');
		
		$chronic_ids = $this->tmreis_common_model->get_all_chronic_unique_ids_model();
		
		$this->data['chronic_ids'] = json_encode($chronic_ids);
		
		$this->_render_page('tmreis_admins/tmreis_chronic_report_graph',$this->data);
	}
	/* changed by bhanu===========================================================*/
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_states');
		$this->data = $this->tmreis_common_lib->tmreis_mgmt_states();
		
		$this->_render_page('tmreis_admins/tmreis_mgmt_states',$this->data);
	}
	
	public function create_state()
	{
	 	$this->tmreis_mgmt_model->create_state($_POST);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_states');
	}
	 
	public function tmreis_mgmt_delete_states($st_id)
	{
	 	$this->tmreis_mgmt_model->delete_state($st_id);
	 	redirect('tmreis_mgmt/tmreis_mgmt_states');
	} 
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_district');
        $this->data = $this->tmreis_common_lib->tmreis_mgmt_district();
		
		$this->_render_page('tmreis_admins/tmreis_mgmt_dist',$this->data);
	}
	
	public function create_district()
	{
	 	$this->tmreis_mgmt_model->create_district($_POST);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_district');
	}
	 
	public function tmreis_mgmt_delete_dists($dt_id)
	{
	 	$this->tmreis_mgmt_model->delete_district($dt_id);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_district');
	}
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_health_supervisors');
        //$this->data = $this->tmreis_common_lib->tmreis_mgmt_health_supervisors();

        $this->data['health_supervisors'] = $this->tmreis_common_model->get_all_health_supervisors();
        //set the flash data error message if there is one
		$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
        $this->data['health_supervisorscount']= $this->tmreis_common_model->health_supervisorscount();
				
		//$this->data = "";
		$this->_render_page('tmreis_admins/tmreis_mgmt_health_supervisors',$this->data);
	}
	
	public function create_health_supervisors()
	{
	 	$insert = $this->tmreis_common_model->create_health_supervisors($_POST);
	 	if($insert){
	...
	public function tmreis_mgmt_delete_health_supervisors($hs_id)
	{
	 	$this->tmreis_mgmt_model->delete_health_supervisors($hs_id);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_health_supervisors');
	}
	/////////////////////////////////////////////////////////
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_doctors');
	
		$this->data = $this->tmreis_common_lib->tmreis_mgmt_doctors();
		
		$this->_render_page('tmreis_admins/tmreis_mgmt_doctors',$this->data);
	}
	
	public function create_doctor()
	{
		$insert = $this->tmreis_mgmt_model->create_doctor($_POST);
		if($insert){
			redirect('tmreis_mgmt/tmreis_mgmt_doctors');
		}else{
			$this->data = $this->tmreis_common_lib->tmreis_mgmt_doctors();			
	...
	public function tmreis_mgmt_delete_doctor($hs_id)
	{
		$this->tmreis_mgmt_model->delete_doctor($hs_id);
		redirect('tmreis_mgmt/tmreis_mgmt_doctors');
	}
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_schools');
        $this->data = $this->tmreis_common_lib->tmreis_mgmt_schools();		
		
		//$this->data = "";
		$this->_render_page('tmreis_admins/tmreis_mgmt_schools',$this->data);
	}
	
	public function create_school()
	{
	 	//$this->tmreis_mgmt_model->create_school($_POST);	
	 	//redirect('tmreis_mgmt/tmreis_mgmt_schools');
	 	
	 	$insert = $this->tmreis_common_model->create_school($_POST);
	 	if($insert){
	 		redirect('tmreis_mgmt/tmreis_mgmt_schools');
	 	}else{
	 		$this->data = $this->tmreis_common_lib->tmreis_mgmt_schools();
	...
	public function tmreis_mgmt_delete_school($school_id)
	{
	 	$this->tmreis_mgmt_model->delete_school($school_id);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_schools');
	}
	...
	public function tmreis_mgmt_classes()
	{
		...
		$this->_render_page('tmreis_admins/tmreis_mgmt_classes',$this->data);
	}
	
	public function create_class()
	{
	 	$this->tmreis_mgmt_model->create_class($_POST);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_classes');
	}
	 
	public function tmreis_mgmt_delete_class($class_id)
	{
	 	$this->tmreis_mgmt_model->delete_class($class_id);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_classes');
	}
	...
	public function tmreis_mgmt_sections()
	{
		...
		$this->_render_page('tmreis_admins/tmreis_mgmt_sections',$this->data);
	}
	
	public function create_section()
	{
	 	$this->tmreis_mgmt_model->create_section($_POST);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_sections');
	}
	 
	public function tmreis_mgmt_delete_section($section_id)
	{
	 	$this->tmreis_mgmt_model->delete_section($section_id);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_sections');
	}
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_symptoms');
        $this->data = $this->tmreis_common_lib->tmreis_mgmt_symptoms();
		
		$this->_render_page('tmreis_admins/tmreis_mgmt_symptoms',$this->data);
	}
	
	public function create_symptoms()
	{
	 	$this->tmreis_mgmt_model->create_symptoms($_POST);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_symptoms');
	}
	 
	public function tmreis_mgmt_delete_symptoms($symptoms_id)
	{
	 	$this->tmreis_mgmt_model->delete_symptoms($symptoms_id);	
	 	redirect('tmreis_mgmt/tmreis_mgmt_symptoms');
	}
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_diagnostics');
		$this->data = $this->tmreis_common_lib->tmreis_mgmt_diagnostic();	
	
		//$this->data = "";
		$this->_render_page('tmreis_admins/tmreis_mgmt_diagnostics',$this->data);
	}
	
	public function create_diagnostic()
	{
		$this->tmreis_common_model->create_diagnostic($_POST);
		redirect('tmreis_mgmt/tmreis_mgmt_diagnostic');
	}
	
	public function tmreis_mgmt_delete_diagnostic($diagnostic_id)
	{
		$this->tmreis_mgmt_model->delete_diagnostic($diagnostic_id);
		redirect('tmreis_mgmt/tmreis_mgmt_diagnostic');
	}
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_hospitals');
		$this->data = $this->tmreis_common_lib->tmreis_mgmt_hospitals();
	
		//$this->data = "";
		$this->_render_page('tmreis_admins/tmreis_mgmt_hospitals',$this->data);
	}
	
	public function create_hospital()
	{
		$this->tmreis_common_model->create_hospital($_POST);
		redirect('tmreis_mgmt/tmreis_mgmt_hospitals');
	}
	
	public function tmreis_mgmt_delete_hospital($hospital_id)
	{
		$this->tmreis_mgmt_model->delete_hospital($hospital_id);
		redirect('tmreis_mgmt/tmreis_mgmt_hospitals');
	}
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_emp');
		$this->data = $this->tmreis_common_lib->tmreis_mgmt_emp();
	
		//$this->data = "";
		$this->_render_page('tmreis_admins/tmreis_mgmt_emp',$this->data);
	}
	
	public function create_emp()
	{
		$this->tmreis_mgmt_model->create_emp($_POST);
		redirect('tmreis_mgmt/tmreis_mgmt_emp');
	}
	
	public function tmreis_mgmt_delete_emp($emp_id)
	{
		$this->tmreis_mgmt_model->delete_emp($emp_id);
		redirect('tmreis_mgmt/tmreis_mgmt_emp');
	}
	...
	{
		$this->data["message"] = "";
		$this->_render_page('tmreis_admins/tmreis_reports_ehr',$this->data);
	}
	...
	public function tmreis_reports_display_ehr()
	{
		...
		$this->data = $this->tmreis_common_lib->tmreis_reports_display_ehr($post);
	 	...
	 	$this->_render_page('tmreis_admins/tmreis_reports_display_ehr',$this->data);
	}
	...
	public function tmreis_reports_students()
	{
		...
		$this->_render_page('tmreis_admins/tmreis_reports_students',$this->data);
	}
	...
	public function tmreis_reports_doctors()
	{
		...
		$this->_render_page('tmreis_admins/tmreis_reports_doctors',$this->data);
	}
	...
	public function tmreis_reports_hospital()
	{
		...
		$this->_render_page('tmreis_admins/tmreis_reports_hospitals',$this->data);
	}
	...
	public function tmreis_reports_school()
	{
		...
		//$this->data = "";
		$this->_render_page('tmreis_admins/tmreis_reports_schools',$this->data);
	}
	...
	public function tmreis_reports_symptom()
	{
		...
		$this->_render_page('tmreis_admins/tmreis_reports_symptom',$this->data);
	}
	...
	function student_db_to_excel(){
		...
		$objPHPExcel->getProperties()->setTitle("tmreis Health Report");
		$objPHPExcel->getProperties()->setSubject("tmreis Health Report");
		$objPHPExcel->getProperties()->setDescription("Document collection of tmreis health check up.");
	
		// Add some data
		echo date('H:i:s') . " Add some data\n";
		$objPHPExcel->setActiveSheetIndex(0);
		$objPHPExcel->getActiveSheet()->SetCellValue('A1', 'tmreis Health Check Up');
		...
		$objWriter->save(EXCEL."/tmreis_Health_Report.xlsx");
	
		$this->secure_file_download(EXCEL."/tmreis_Health_Report.xlsx");
	
		unlink(EXCEL."/tmreis_Health_Report.xlsx");
	}
	 ...
	 public function basic_dashboard($date = FALSE, $request_duration = "Daily", $screening_duration = "Yearly")
	{
		...
		$count = 0;
		$screening_report = $this->tmreis_common_model->get_all_screenings($date,$screening_duration);
		...
		$this->data['distslist'] = $this->tmreis_common_model->get_all_district();
		$this->data = $this->tmreis_common_lib->to_dashboard($date, $request_duration);
		$this->data['screening_report_count'] = $this->tmreis_common_model->get_all_students_count();
		
		$data_req = $this->tmreis_common_model->get_total_requests();
		...
		$this->_render_page('tmreis_admins/tmreis_new_dashboard',$this->data);
	...
	function to_dashboard($date = FALSE, $request_duration = "Daily", $screening_duration = "Yearly")
	{
		...
		$this->_render_page('tmreis_admins/tmreis_admin_dash', $this->data);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$this->_render_page('tmreis_admins/drill_down_screening_to_students_load_ehr',$this->data);
	}
	
	public function drill_down_screening_to_students_load_ehr_doc($_id)
	{
		//$this->data['docs'] = $this->tmreis_mgmt_model->drill_down_screening_to_students_load_ehr_doc($_id);
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		$this->_render_page('tmreis_admins/drill_down_absent_to_students_load_ehr',$this->data);
	}
	...
	function drill_down_request_to_students_load_ehr()
	{
		...
		$this->_render_page('tmreis_admins/drill_down_request_to_students_load_ehr',$this->data);
	}
	//========================================================================
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		log_message("debug","temp temp==============1062".print_r($temp,true));
		$UI_id = json_decode(base64_decode($_POST['ehr_data_for_identifiers']),true);
		log_message("debug","UI_id UI_id==============1064".print_r($UI_id,true));
		$get_docs = $this->tmreis_common_model->get_drilling_identifiers_students_docs($UI_id);
		log_message("debug","get_docs temp==============1066".print_r($get_docs,true));
		...
		$this->_render_page('tmreis_admins/drill_down_identifiers_to_students_load_ehr',$this->data);
	}
	...
	function import_students()
	{
		...
		{
			redirect('tmreis_mgmt/tmreis_reports_students_filter');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('tmreis_admins/tmreis_imports_students', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function update_students()
	{
		...
		$this->data = $this->tmreis_common_lib->update_students();
	...
	//==============================CC mgmt=================================
	public function tmreis_mgmt_cc()
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_mgmt_cc');
	
		$total_rows = $this->tmreis_mgmt_model->cc_users_count();
		...
		$this->data['cc_users'] = $this->tmreis_mgmt_model->get_cc_users($config['per_page'], $page);
		...
		//$this->data = "";
		$this->_render_page('tmreis_admins/tmreis_mgmt_cc_users',$this->data);
	}
	
	public function create_cc_user()
	{
		log_message('debug','pppppppppppppppppppppppppppppppppppppppppppppppppppp.'.print_r($_POST,true));
		$insert = $this->tmreis_mgmt_model->create_cc_user($_POST);
		log_message('debug','iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii.'.print_r($insert,true));
		if($insert){
			redirect('tmreis_mgmt/tmreis_mgmt_cc');
		}else{
			log_message('debug','errrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr.'.print_r($this->tmreis_mgmt_model->errors(),true));
			$total_rows = $this->tmreis_mgmt_model->cc_users_count();
			...
			//set the flash data error message if there is one
			$this->data['message'] = (validation_errors() ? validation_errors() : ($this->tmreis_mgmt_model->errors() ? $this->tmreis_mgmt_model->errors() : $this->session->flashdata('message')));
	...
	public function tmreis_mgmt_delete_cc_user($cc_id)
	{
		$this->tmreis_mgmt_model->delete_cc_user($cc_id);
		redirect('tmreis_mgmt/tmreis_mgmt_cc');
	}
	...
	public function tmreis_reports_students_filter()
	{
		...
		//$this->data = "";
		$this->_render_page('tmreis_admins/tmreis_reports_students_filter',$this->data);
	}
	...
	public function pie_export()
	{
		$this->data['today_date'] = date('Y-m-d');
		$this->data['distslist'] = $this->tmreis_common_model->get_all_district();
		$this->_render_page('tmreis_admins/tmreis_pie_export',$this->data);
	}
	...
	public function generate_excel_for_bmi_pie()
	{
		...
		$dt_name    = $_POST['dt_name'];
		$school_name = $_POST['school_name'];
		$file_path = $this->tmreis_common_lib->generate_excel_for_bmi_pie($today_date,$dt_name,$school_name);
		$this->output->set_output($file_path);
	}
	...
	public function generate_excel_for_screening_pie()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$file_path = $this->tmreis_common_lib->generate_excel_for_screening_pie($today_date,$screening_pie_span,$dt_name,$school_name);
		$this->output->set_output($file_path);
	}
	
	function screening_pie_data_for_stage4_new(){
		$this->tmreis_common_model->screening_pie_data_for_stage4_new();
	}
	
	function forward_request(){
		$this->tmreis_common_lib->submit_request_to_doctor($_POST);
		redirect('tmreis_mgmt/basic_dashboard');
	//	redirect('tmreis_mgmt/to_dashboard');
	}
	
	function tmreis_create_group()
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_create_group');
	
		$this->data = $this->tmreis_common_lib->tmreis_groups();
	
		$this->_render_page('tmreis_admins/create_group', $this->data);
	}
	public function create_group()
	{
		$session_data = $this->session->userdata('customer');
		$user_type = $session_data['user_type'];
		$this->tmreis_mgmt_model->create_group($_POST,$user_type);
		redirect('tmreis_mgmt/tmreis_create_group');
	}
	public function save_users_to_group()
	{
		...
		$this->tmreis_mgmt_model->save_users_to_group($_POST);
		
		redirect('tmreis_mgmt/group_msg');
	}
	public function delete_group($_id)
	{
		$this->tmreis_mgmt_model->delete_chat_group($_id);
		redirect('tmreis_mgmt/tmreis_create_group');
	}
	...
	function group_msg()
	{
		...
		$this->data = $this->tmreis_common_lib->group_msg();
	
		$this->_render_page('tmreis_admins/group_msg', $this->data);
	}
	...
	function get_messages($msg_id,$message = false)
	{
		...
		if($message === false){
			...
			$result = $this->tmreis_common_model->get_messages($msg_id);
			...
			$this->data = $this->tmreis_common_model->add_message($_POST,$msg_id);
...
// 		(
// 		[identity] => tmreis.user@gmail.com
// 		[username] => tmreis Admin
// 		[email] => tmreis.user@gmail.com
...
//		$user["gcm_registration_id"] = $gcm_registration_id;
	...
	function user_msg()
	{
		...
		$this->data = $this->tmreis_common_lib->user_msg();
	
		$this->_render_page('tmreis_admins/user_msg', $this->data);
	}
	...
	function multi_msg()
	{
		...
		$this->_render_page('tmreis_admins/multi_user_msg', $this->data);
	}
	...
	public function get_sanitation_infrastructure()
	{
		...
		$data = $this->tmreis_mgmt_model->get_sanitation_infrastructure_model($district_name,$school_name);
	...
	function draw_sanitation_report_pie()
	{
	  ...
	  $sanitation_report_pie = $this->tmreis_common_model->get_sanitation_report_pie_data($date,$search_criteria,$opt);
	...
	function download_absent_sent_schools_list()
	{
	   ...
	   // Excel generation
	   $file_path = $this->tmreis_common_lib->generate_excel_for_absent_sent_schools($date,$schools_list);
	   $this->output->set_output($file_path);
	}
	...
	function download_absent_not_sent_schools_list()
	{
	   ...
	   // Excel generation
	   $file_path = $this->tmreis_common_lib->generate_excel_for_absent_not_sent_schools($date,$schools_list);
	   $this->output->set_output($file_path);
	}
	...
	function upgrade_class()
	{
	   ...
	   $students_data = $this->tmreis_common_model->get_students_by_school_name($school_name,$dist_name);
	   ...
	   foreach ( $students_data as $student){
		 ...
		 //   }
		   ...
		   $doc_id = $student['_id'];
		   //-------disabled-------------
		   $update_data = $this->tmreis_common_model->update_student_data(array('doc_data.widget_data.page2.Personal Information.Class' => $class),$doc_id);
	   }
	...
	function create_schedule_followup()
	{
	  ...
	  $is_created = $this->tmreis_common_model->create_schedule_followup_model($unique_id,$medication_schedule,$treatment_period,$start_date,$monthNames);
	...
	function prepare_pill_compliance_overall_graph()
	{
	 ...
	 if(isset($pcompl_raw_data) && !empty($pcompl_raw_data))
	 {
	   ...
	   $this->output->set_output(json_encode($final_graph_data));
		...
		$this->_render_page('tmreis_admins/docs_comp',$this->data);
    }
	...
	public function docs_comp() {
		...
		$docs = $this->tmreis_common_model->get_dup_docs($docs_arr);
			
		$this->data['docs'] = json_encode($docs);
		$this->_render_page('tmreis_admins/docs_compare', $this->data);
		//$this->_render_page('tmreis_admins/docs_comp',$this->data);
    }
	...
	function doc_comp($document1, $document2){
	 	...
	 	$doc1 = $this->tmreis_common_model->get_document($document1);
	 	$doc2 = $this->tmreis_common_model->get_document($document2);
...
// 	 	$doc2 = $docs[1];
		...
		$this->_render_page('tmreis_admins/doc_comp_check', $this->data);
	...
	function delete_dup_doc(){
	 	...
	 	$query = $this->mongo_db->where("_id", new MongoId($doc_id))->get("healthcare201672020159570");
	 	$query_ins = $this->mongo_db->insert("healthcare201672020159570_duplicate",$query[0]);
	 	
	 	if ($query_ins) {
	 		$query = $this->mongo_db->where("_id", new MongoId($doc_id))->delete("healthcare201672020159570");
	 	}
	 ...
	 function show_all_docs($id_no = ""){
	 	...
	 	$this->data['docs'] = json_encode($this->tmreis_common_model->get_all_docs_in_uid_no($id_no));
	 	
	 	$this->_render_page('tmreis_admins/show_all_docs', $this->data);
	 }
	 ...
	 function diff_docs(){
	 	...
	 	redirect("tmreis_mgmt/doc_comp/$doc_id[0]/$doc_id[1]");
...
// 	 	$this->index();
	 ...
	 public function add_news_feed_view() {
		...
		$this->_render_page ( 'tmreis_admins/add_news_feed', $this->data );
	}
	public function add_news_feed() {
		...
		if($news_return['return_error']){
			...
			redirect('tmreis_mgmt/manage_news_feed_view');
		}
	}
	public function manage_news_feed_view() {
		...
		$this->_render_page ( 'tmreis_admins/manage_news_feed', $this->data );
	}
	...
	public function tmreis_field_officer_report($date = FALSE)
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_field_officer_report');
		
		$this->data['field_officers'] = json_encode($this->tmreis_common_model->field_officer_report_model_todate($date));
		$this->data['today_date'] = date('Y-m-d');
		$this->_render_page('tmreis_admins/tmreis_field_officer_report_view',$this->data);
		
	}
	
	function tmreis_field_officer_with_date()
	{
		$count  = 0;
		$this->check_for_admin();
		$this->check_for_plan('tmreis_field_officer_with_date');
		$today_date = $_POST['today_date'];
		$report = $this->tmreis_common_model->field_officer_report_model_todate($today_date);
		
		foreach ($report as $value){
			$count = $count + intval($value['value']);
		}
		if($count > 0){
			$this->data = json_encode($report);
		}else{
			$this->data = 1;
		}
		$this->output->set_output($this->data);
	...
	function tmreis_drill_down_to_filed_officer_docs()
	{
		$this->check_for_admin();
		$this->check_for_plan('tmreis_drill_down_to_filed_officer_docs');
		
		$type = $_POST['case_type'];
		$to_date = $_POST['to_date'];                    
		$navigation = $_POST['ehr_navigation_for_field_officer'];
		
		$this->data['get_docs'] = $this->tmreis_common_model->tmreis_get_drilling_field_off_docs($type,$to_date);
		...
		$this->_render_page('tmreis_admins/tmreis_drill_down_field_officer_report_view',$this->data);
	}
	...
	function imports()
	{
	  ...
	  $this->data['message'] = "";
	  $this->_render_page('tmreis_admins/tmreis_zipfile_import_view',$this->data);
	}
	 ...
	 function school_screening_file_import()
	{
		...
		$post = $_POST;
		$this->data = $this->tmreis_common_lib->school_screening_file_import($post);
	...
	public function requests_status()
	{
		...
		$this->data['message'] = "";
		$this->_render_page("tmreis_admins/requests_status_view",$this->data);
	}
	 ...
	 public function initaite_requests_status_count()
	{
		$today_date = $_POST['today_date'];
		$this->data['message'] = "";
		$document = $this->tmreis_common_lib->get_initaite_requests_count($today_date);
	...
	public function bmi_pie_view()
	{
		...
		$this->data['district_list'] = $this->tmreis_common_model->get_all_district();
		$this->_render_page('tmreis_admins/tmreis_bmi_pie_view',$this->data);
	}
	...
	public function bmi_pie_view_month_wise()
	{
		...
		$this->data = $this->tmreis_common_lib->bmi_pie_view_lib_month_wise($current_month,$district_name, $school_name);
	...
	function drill_down_bmi_to_students()
	{
		...
		$docs = $this->tmreis_common_model->get_drill_down_to_bmi_report($symptom_type,$month,$district_name,$school_name);
	...
	function drill_down_to_bmi_report_students()
	{
		...
		$students = $this->tmreis_common_model->get_drilling_bmi_students_docs($UI_id, $selectedMonth);
		...
		$this->_render_page('tmreis_admins/tmreis_drill_down_to_bmi_report_view',$this->data);
	}
	...
	public function show_student_bmi_graph($hospital_unique_id){
		...
		$bmi_value = $this->tmreis_common_model->get_student_bmi_graph_values($hospital_unique_id);
		...
		$this->_render_page('tmreis_admins/tmreis_show_student_bmi_graph_view',$final_bmi_data);
		}
	...
	public function generate_bmi_report_to_excel()
	{
		...
		$file_path = $this->tmreis_common_lib->generate_bmi_report_to_excel_lib($date,$district_name, $school_name);
	...
	public function tmreis_chronic_pie_view(){
		$this->check_for_admin();
		$this->check_for_plan('tmreis_chronic_pie_view');
		
		$this->data = $this->tmreis_common_lib->tmreis_chronic_pie_view();
		
		$this->_render_page('tmreis_admins/tmreis_chronic_pie_view',$this->data);
	}
	...
	public function update_chronic_request_pie(){
		...
		$this->data = $this->tmreis_common_lib->update_chronic_request_pie($status_type);
	...
	function drill_down_request_to_symptoms()
	{
		...
		$symptoms_report = json_encode($this->tmreis_common_model->drill_down_request_to_symptoms($data,$status_type));
	...
	function drilldown_chronic_request_to_districts()
	{
		...
		$data = $_POST['data'];
		$status_type = $_POST['status_type'];
		$identifiers_report = json_encode($this->tmreis_common_model->drilldown_chronic_request_to_districts($data,$status_type));
		$this->output->set_output($identifiers_report);
	}
	...
	function drilldown_chronic_request_to_school()
	{
		...
		$data = $_POST['data'];
		$status_type = $_POST['status_type'];
		$request_report = json_encode($this->tmreis_common_model->drilldown_chronic_request_to_schools($data,$status_type));
		$this->output->set_output($request_report);
	}
	...
	function drilldown_chronic_request_to_students()
	{
		...
		$data = $_POST['data'];
		$status_type = $_POST['status_type'];
		$docs = $this->tmreis_common_model->drilldown_chronic_request_to_students($data,$status_type);
		$identifiers_report = base64_encode(json_encode($docs));
		$this->output->set_output($identifiers_report);
	}
		...
		function drill_down_chronic_request_to_students_load_ehr()
	{
		...
		$doc_list = $this->tmreis_common_model->get_all_doctors();
	 ...
	 * @author bhanu 
	 */
	 public function basic_dashboard1($date = FALSE,  $screening_duration = "Yearly")
	{
		$this->data['today_date'] = date('Y-m-d');
		...
		$absent_report = $this->tmreis_common_model->get_all_absent_data($date);
		...
		$this->data['absent_report_schools_list'] = $this->tmreis_common_model->get_absent_pie_schools_data($date);
...
//		$this->_render_page('tmreis_admins/tmreis_basic_dashboard',$this->data);
		$this->_render_page('tmreis_admins/tmreis_dashboard',$this->data);
	...
	function basic_dashboard_with_date()
	{
		...
		$this->data = $this->tmreis_common_lib->basic_dashboard_with_date($today_date,$screening_pie_span,$dt_name,$school_name);
	...
	public function initiate_request_count_all_today_date()
	{
		...
		//$this->data['message'] = "";
		$document = $this->tmreis_common_lib->get_initaite_requests_count_today_date($today_date);
	...
	public function get_show_ehr_details()
	{
		...
		$this->data['students_details'] = $this->tmreis_common_model->get_show_ehr_details($request_type,$date,$school_name);
		//echo print_r($this->data['students_details'],TRUE); exit();
		$this->_render_page('tmreis_admins/basic_show_ehr_view',$this->data);
	}
	public function drill_down_screening_to_students_load_ehr_new_dashboard($_id)
	{
		//$_id = $_POST['ehr_data'];
		
	$docs = $this->tmreis_common_model->drill_down_screening_to_students_load_ehr_new_dashboard($_id);
		...
		$this->_render_page('tmreis_admins/tmreis_reports_display_ehr_new_dashboard',$this->data);
	}
	function drill_down_screening_to_students_load_ehr_count()
	{
		...
		$get_docs = $this->tmreis_common_model->get_drilling_screenings_students_docs_count($docs_id);
		...
		$this->_render_page('tmreis_admins/screening_to_students_load_ehr',$this->data);
	}
	/************** HB PIE default page************************/
	public function hb_pie_view()
	{
		...
		$this->data['district_list'] = $this->tmreis_common_model->get_all_district();
		$this->_render_page('tmreis_admins/hb_pie_view',$this->data);
	}
	...
	public function hb_pie_view_month_wise()
	{
		...
		$this->data = $this->tmreis_common_lib->hb_pie_view_lib_month_wise($current_month,$district_name, $school_name);
		$this->output->set_output(json_encode($this->data));
	}
	/************** clicking BMI pie to show student reports************************/
	function drill_down_hb_to_students()
	{
		...
		$docs = $this->tmreis_common_model->get_drill_down_to_hb_report($symptom_type,$month,$district_name,$school_name);
	...
	function drill_down_to_hb_report_students()
	{
		...
		$students = $this->tmreis_common_model->get_drilling_hb_students_docs($UI_id, $selectedMonth);
		...
		$this->_render_page('tmreis_admins/drill_down_to_hb_report_view',$this->data);
	}
	...
	public function show_student_hb_graph($hospital_unique_id){
		...
		$hb_values = $this->tmreis_common_model->get_student_hb_graph_values($hospital_unique_id);
		...
		$this->_render_page('tmreis_admins/show_student_hb_graph_view',$final_hb_data);
		}
	...
	public function get_schools()
	{
		...
		$this->check_for_plan('get_schools_list');
		$dist_id = $_POST['dist_id'];
		$this->data = $this->tmreis_common_model->get_schools_by_dist($dist_id);
		$this->output->set_output(json_encode($this->data));
	}
	public function monthly_request_charts()
	{
		...
		$this->data['distslist'] = $this->tmreis_common_model->get_all_district();
		$this->_render_page('tmreis_admins/get_month_wise_report', $this->data);
	...
	public function monthly_request_report_chart()
	{
		...
		$this->data['data']= $this->tmreis_common_model->get_monthly_request_by_month($date_month,$school_name,$dt_name);
		$this->output->set_output(json_encode($this->data));
	...
	public function drill_down_chronic_student_list()
	{
		...
		$this->data['student_list'] = $this->tmreis_common_model->drill_down_chronic_student_list($chronic_symtom);
		
		$this->_render_page('tmreis_admins/monthly_chronic_student_list', $this->data);
	}
	public function drill_down_emergency_student_list(){
		...
		$this->data['student_list'] = $this->tmreis_common_model->drill_down_emergency_student_list($emergency_symtom);
		
		$this->_render_page('tmreis_admins/monthly_emergency_student_list', $this->data);
	}
	public function drill_down_normal_student_list(){
		...
		$this->data['student_list'] = $this->tmreis_common_model->drill_down_normal_student_list($normal_symtom);
		
		$this->_render_page('tmreis_admins/monthly_normal_student_list', $this->data);
	}

	public function get_sevier_count()
	{
		$student_type = $_POST['student_type'];
		$get_count = $this->tmreis_common_model->get_sevier_count($student_type);
	...
	public function get_bmi_count()
	{
		...
		$student_type = $_POST['student_type'];
//		$student_type = "All";
		$get_count = $this->tmreis_common_model->get_bmi_count($student_type);
		$get_count['screened_count'] = $this->tmreis_common_model->get_screened_count();
		$get_count['attendance_count'] = $this->tmreis_common_model->get_attendance_count();
		$get_count['sanitation_count'] = $this->tmreis_common_model->get_sanitation_count();
		$get_count['chronic_count'] = $this->tmreis_common_model->get_chronic_asthma_count($student_type);
		$get_count['emergency_total_count'] = $this->tmreis_common_model->get_total_emergency_req_count();
	...
	{
		$student_type = $_POST['student_type'];
		$get_count = $this->tmreis_common_model->get_student_type_for_tails($student_type);
	...
	public function get_bmi_students_docs()
	{
		...
		$this->data['get_bmi_docs'] = $this->tmreis_common_model->get_bmi_students_docs($bmi_type);
		$this->data['bmi_case_type'] = $bmi_type;
		/*echo print_r($this->data['get_bmi_docs'],true);
		exit;*/
		$this->_render_page('tmreis_admins/tmreis_show_bmi_issues_list_view', $this->data);
	}
	...
	public function get_hb_students_docs()
	{
		...
		$this->data['get_hb_docs'] = $this->tmreis_common_model->get_hb_students_docs($hb_type);
		$this->data['hb_case_type'] = $hb_type;
		
		$this->_render_page('tmreis_admins/tmreis_show_hb_issues_list_view', $this->data);
	}
	public function get_chronic_students_docs()
	{
		...
		$this->data['get_chronic_docs'] = $this->tmreis_common_model->get_chronic_students_docs($chronic_type);
		$this->data['chronic_case_type'] = $chronic_type;
		
		$this->_render_page('tmreis_admins/tmreis_show_chronic_issues_list_view', $this->data);
	}
	public function get_emergency_req_students_docs()
	{
		...
		$this->data['get_emergency_docs'] = $this->tmreis_common_model->get_emergency_req_students_docs($emergencyReq);
		$this->data['emergency_requests'] = $emergencyReq;
		
		$this->_render_page('tmreis_admins/tmreis_show_request_issues_list_view', $this->data);
	}
	...
	public function get_field_officer_docs()
	{
		...
		$this->data['get_field_officer_docs'] = $this->tmreis_common_model->get_field_officer_req_students_docs($fieldOfficerReq);
		$this->data['field_officer_requests'] = $fieldOfficerReq;
		
		$this->_render_page('tmreis_admins/tmreis_show_field_officer_report_list_view', $this->data);
	}
	public function get_doctor_visiting_docs()
	{
		...
		$this->data['get_field_officer_docs'] = $this->tmreis_common_model->get_field_officer_req_students_docs($doctorVisitReq);
	...
	public function show_doctor_treated_student($doc_id)
	 {
		$this->data['unique_id'] = $this->tmreis_common_model->show_doctor_visiting_reports($doc_id);
		$this->_render_page('tmreis_admins/field_dr_show_submitted_list',$this->data);
	}
	public function show_field_officer_student($doc_id)
	 {
		...
		$this->_render_page('tmreis_admins/field_officer_show_submitted_list',$this->data);
	}
	/*******************request chart end***************************************/
