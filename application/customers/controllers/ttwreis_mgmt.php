...
class Ttwreis_mgmt extends My_Controller {
	...
	*/
	...
	public function update_note_request() 
	{
		...
		if(isset($_POST['note_id']) && isset($_POST['note']))
		{
			...
			$token = $this->ttwreis_common_model->update_request_note($doc_id,$note_id,$note);
	...
	public function ttwreis_mgmt_doctors()
	{
		...
		$this->data = $this->ttwreis_common_lib->ttwreis_mgmt_doctors();
	...
	public function ttwreis_reports_display_ehr_uid()
	{
		...
		$this->data['notes_data'] = $docs['notes_data'];*/

		$this->data['docs'] = $docs['screening'];
		$this->data['docs_two'] = $docs['screening_2020'];
		$this->data['docs_2021_22'] = $docs['screening_2021_22'];
		$this->data['docs_requests'] = $docs['request'];
		$this->data['notes'] = $docs['notes'];
		$this->data['hs'] = $docs['hs'];
		$this->data['BMI_report'] = $docs['BMI_report'];
		$this->data['hb_report'] = $docs['hb_report'];
		$this->data['notes_data'] = $docs['notes_data'];
		$this->data['doctors_medical_reports'] = $docs['doctors_visitings'];
		
		//$this->data['history'] = $docs['history'];	
				 
		$this->data['docscount'] = count($this->data['docs']);

		$this->_render_page('ttwreis_admins/panacea_display_new_ehr',$this->data);
	}
	...
	public function get_entered_related_data()
	{
		...
		if(preg_match("/_/", $data)){
			...
			$this->ttwreis_reports_display_ehr_uid($data);
		}else{

			$this->data['students'] = $this->ttwreis_common_model->get_entered_related_data($data);

			if(!empty($data)){
				$this->_render_page('ttwreis_admins/global_search_by_name', $this->data);
			}
		}
	}
	...
	function to_dashboard($date = FALSE, $request_duration = "Yearly", $screening_duration = "Yearly")
	{
		...
		$this->data = $this->ttwreis_common_lib->to_dashboard_old_dash($date, $request_duration, $screening_duration);
		$this->data['emergency_alerts'] = $this->ttwreis_common_model->get_data_for_emergency_carousel($this->data['today_date']);
		$this->data['regular_alerts'] = $this->ttwreis_common_model->get_today_followup_dates_alert($this->data['today_date']);
		$this->_render_page('ttwreis_admins/ttwreis_admin_dash', $this->data);
	...
	function update_request_pie()
	{
		...
		$this->data = $this->ttwreis_common_lib->update_request_pie($today_date,$request_pie_span,$request_pie_status);
	...
	function update_request_pie_old_dash()
	{
		...
		$today_date = $_POST['today_date'];
		$request_pie_span = $_POST['request_pie_span'];
		$this->data = $this->ttwreis_common_lib->update_request_pie_old_dash($today_date,$request_pie_span);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$this->_render_page('ttwreis_admins/drill_down_screening_to_students_load_ehr',$this->data);
	}
	...
	public function drill_down_screening_to_students_load_ehr_doc($_id)
	{
		...
		$this->_render_page('ttwreis_admins/ttwreis_reports_display_ehr_new_dashboard',$this->data);
	}
	...
	function drill_down_absent_to_students()
	{
		...
		log_message('error', 'absent_report================912'.print_r($absent_report, true));
		$this->output->set_output($absent_report);
	}
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		log_message('error', 'temp================912'.print_r($temp, true));
		$UI_id = json_decode(base64_decode($_POST['ehr_data_for_absent']),true);
		log_message('error', 'UI_idddddddddddd================912'.print_r($UI_id, true));
		...
		$this->_render_page('ttwreis_admins/drill_down_absent_to_students_load_ehr',$this->data);
	}
	...
	function drilldown_request_to_districts()
	{
		...
		$request_report = json_encode($this->ttwreis_common_model->drilldown_request_to_districts($data,$today_date,$request_pie_span,$dt_name,$school_name,$request_pie_status,$student_type,$student_age));
...
}else
		{
			...
			$dt_name = $_POST["dt_name"];
			$school_name = $_POST["school_name"];
			$request_report = json_encode($this->ttwreis_common_model->drilldown_request_to_districts_old_dash($data,$today_date,$request_pie_span,$dt_name,$school_name));
	...
	function drilling_request_to_schools()
	{
		...
		$school_name = $_POST["school_name"];
		$request_pie_status = (isset($_POST["request_pie_status"])) ? $_POST["request_pie_status"] : "";
		$request_report = json_encode($this->ttwreis_common_model->get_drilling_request_schools($data,$today_date,$request_pie_span,$dt_name,$school_name,$request_pie_status));
		log_message('error',"request_report====================963".print_r($request_report, true));
		$this->output->set_output($request_report);
		}else
		{
			...
			$dt_name = $_POST["dt_name"];
			$school_name = $_POST["school_name"];
			$request_report = json_encode($this->ttwreis_common_model->get_drilling_request_schools_old_dash($data,$today_date,$request_pie_span,$dt_name,$school_name));
			$this->output->set_output($request_report);
		}
	}
	...
	function drill_down_request_to_students()
	{
		...
		$school_name = $_POST["school_name"];
		$request_pie_status = (isset($_POST["request_pie_status"])) ? $_POST["request_pie_status"] : "";
		$docs = $this->ttwreis_common_model->get_drilling_request_students($data,$today_date,$request_pie_span,$dt_name,$school_name, $request_pie_status);
		log_message('error','docsssssssssssssssssssss'.print_r($docs, true));
	...
	/*echo print_r($_POST['data'], true)."yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy"; exit();*/
			...
			$dt_name = $_POST["dt_name"];
			$school_name = $_POST["school_name"];
			$docs = $this->ttwreis_common_model->get_drilling_request_students_old_dash($data,$today_date,$request_pie_span,$dt_name,$school_name);
	...
	function drill_down_request_to_students_load_ehr()
	{
		...
		log_message('error', "UI_id==============================987".print_r($UI_id, true));
		...
		$this->_render_page('ttwreis_admins/drill_down_request_to_students_load_ehr',$this->data);
		}else
		{
			$UI_id = json_decode(base64_decode($_POST['ehr_data_for_request_old_dash']),true);

			$get_docs = $this->ttwreis_common_model->get_drilling_request_students_docs_old_dash($UI_id);
	...
	//log_message("debug","innnnnnnnnnnnnnnnnnnnnn fn gggggggggggggggggggggggggggggggggggggggggggggggggggggg");
		$this->_render_page('ttwreis_admins/drill_down_request_to_students_load_ehr_old_dash.php',$this->data);
	}
	}
	//========================================================================
	...
	function drilldown_identifiers_to_districts()
	{
		...
		$school_name = $_POST["school_name"];
		$request_pie_status = $_POST["request_pie_status"];
		$identifiers_report = json_encode($this->ttwreis_common_model->drilldown_identifiers_to_districts($data,$today_date,$request_pie_span,$dt_name,$school_name,$request_pie_status));
		...
		}else
		{
			...
			$dt_name = $_POST["dt_name"];
			$school_name = $_POST["school_name"];
			$identifiers_report = json_encode($this->ttwreis_common_model->drilldown_identifiers_to_districts_old_dash($data,$today_date,$request_pie_span,$dt_name,$school_name));
			$this->output->set_output($identifiers_report);
		}
	}
	...
	function drilling_identifiers_to_schools()
	{
		...
		$school_name = $_POST["school_name"];
		$request_pie_status = $_POST["request_pie_status"];
		$identifiers_report = json_encode($this->ttwreis_common_model->get_drilling_identifiers_schools($data,$today_date,$request_pie_span,$dt_name,$school_name,$request_pie_status));
		$this->output->set_output($identifiers_report);
		}else{
			$data = $_POST['data'];
			$today_date = $_POST['today_date'];
			...
			$dt_name = $_POST["dt_name"];
			$school_name = $_POST["school_name"];
			$identifiers_report = json_encode($this->ttwreis_common_model->get_drilling_identifiers_schools_old_dash($data,$today_date,$request_pie_span,$dt_name,$school_name));
			$this->output->set_output($identifiers_report);
		}
	}
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		$this->_render_page('ttwreis_admins/drill_down_identifiers_to_students_load_ehr',$this->data);
	}
	...
	function import_staff_covid_cases()
	{
		...
		$this->data = $this->ttwreis_common_lib->import_staff_covid_cases($post);
		...
		}else if($this->data == "redirect_to_student_fn")
		{
			...
			redirect('ttwreis_mgmt/ttwreis_staff_covid_cases');

		}

	}

	 public function ttwreis_staff_covid_cases()
    {
    ...
    $this->_render_page('ttwreis_admins/ttwreis_staff_covid_cases');
	...
	$data = $this->ttwreis_common_model->ttwreis_staff_covid_cases_model();
      ...
      public function get_staff_covid_cases_district_drill()
	{
		...
		$this->data['staff_covid'] = $this->ttwreis_common_model->get_staff_covid_cases_district_drill_modal($district);

		$this->_render_page('ttwreis_admins/staff_covid_cases_district_drill', $this->data);
	}
	...
	public function get_staff_covid_cases_data_based_on_span()
    {
    	...
    	$data = $this->ttwreis_common_model->get_staff_covid_cases_district_drill_modal($district);
	...
	function ttwreis_upgrade_students_clases()
	{
		$this->check_for_admin();
		$this->check_for_plan('ttwreis_imports_students');
		
		$this->data['distslist'] = $this->ttwreis_common_model->get_all_district();
		$this->data['cls_trsnfer_counts'] = $this->ttwreis_common_model->get_classes_update_students_count_both_yrs();
	
		$this->data['message'] = FALSE;
		$this->data['total_transfer_scl_count'] = count($this->data['cls_trsnfer_counts']);
	
		$this->_render_page('ttwreis_admins/ttwreis_upgrade_students_clases', $this->data);
	}
	...
	function update_students()
	{
		...
		$this->data = $this->ttwreis_common_lib->update_students();
	...
	public function get_excel_for_students_reports()
    {
        ...
        $get_reports = $this->ttwreis_common_lib->get_excel_for_students_reports_lib($district, $scl ,$collection_year);
	...
	public function get_students_list()
	{
		...
		$this->data = $this->ttwreis_common_model->get_students_by_school_name($school_name,$dist_name,$academic_year);
		//$this->data = "";
		$this->output->set_output(json_encode($this->data));
	}
	...
	public function generate_excel_for_bmi_pie()
	{
		...
		$dt_name    = $_POST['dt_name'];
		$school_name = $_POST['school_name'];
		$file_path = $this->ttwreis_common_lib->generate_excel_for_bmi_pie($today_date,$dt_name,$school_name);
		$this->output->set_output($file_path);
	}
	...
	function forward_request(){
		$this->ttwreis_common_lib->submit_request_to_doctor($_POST);
		redirect('ttwreis_mgmt/to_dashboard');
	}
	...
	function ttwreis_create_group()
	{
		...
		$this->data = $this->ttwreis_common_lib->ttwreis_groups();
	...
	public function create_group()
	{
		...
		$this->ttwreis_mgmt_model->create_group($_POST,$user_type);
	...
	function group_msg()
	{
		...
		$this->data = $this->ttwreis_common_lib->group_msg();
...
//		$user["gcm_registration_id"] = $gcm_registration_id;
	...
	function user_msg()
	{
		...
		$this->data = $this->ttwreis_common_lib->user_msg();
	...
	function sanitation_report()
	{
		...
		$this->_render_page('ttwreis_admins/sanitation_dashboard', $this->data);
	...
	function create_schedule_followup()
	{
	  ...
	  $is_created = $this->ttwreis_common_model->create_schedule_followup_model($unique_id,$medication_schedule,$treatment_period,$start_date,$monthNames);
...
// 	 	$this->index();
	...
	function imports()
	{
	  ...
	  $this->data['message'] = "";
	  $this->_render_page('ttwreis_admins/ttwreis_zipfile_import_view',$this->data);
	}
	 ...
	 function school_screening_file_import()
	{
		...
		$post = $_POST;
		$this->data = $this->ttwreis_common_lib->school_screening_file_import($post);
	...
	public function requests_status()
	{
		...
		$this->data['message'] = "";
		$this->_render_page("ttwreis_admins/requests_status_view",$this->data);
	}
	 ...
	 public function initaite_requests_status_count()
	{
		$today_date = $_POST['today_date'];
		$this->data['message'] = "";
		$document = $this->ttwreis_common_lib->get_initaite_requests_count($today_date);
	...
	public function bmi_pie_view()
	{
		...
		$this->data['district_list'] = $this->ttwreis_common_model->get_all_district();
		$this->data['total_students'] = $this->ttwreis_common_model->get_all_students_count();
		$this->_render_page('ttwreis_admins/bmi_pie_view',$this->data);
	}
	...
	public function bmi_pie_view_month_wise()
	{
		...
		$this->data = $this->ttwreis_common_lib->bmi_pie_view_lib_month_wise($current_month,$district_name, $school_name,$student_type,$student_age);
		$this->output->set_output(json_encode($this->data));
	}
	...
	/*function drill_down_bmi_to_students()
	{
		...
		$docs = $this->ttwreis_common_model->get_drill_down_to_bmi_report($symptom_type,$month,$district_name,$school_name);
	...
	/*function drill_down_to_bmi_report_students()
	{
		...
		$students = $this->ttwreis_common_model->get_drilling_bmi_students_docs($UI_id, $selectedMonth);
		...
		$this->_render_page('ttwreis_admins/ttwreis_drill_down_to_bmi_report_view',$this->data);
	}*/
	...
	function drill_down_bmi_to_students()
	{
		...
		$docs = $this->ttwreis_common_model->get_drill_down_to_bmi_report($symptom_type,$month,$district_name,$school_name,$student_type,$student_age);
	...
	function drill_down_to_bmi_report_students()
	{
		...
		$this->_render_page('ttwreis_admins/drill_down_to_bmi_report_view',$this->data);
	}
	...
	public function show_student_bmi_graph($hospital_unique_id){
		...
		$bmi_value = $this->ttwreis_common_model->get_student_bmi_graph_values($hospital_unique_id);
		...
		$this->_render_page('ttwreis_admins/ttwreis_show_student_bmi_graph_view',$final_bmi_data);
		}
	...
	public function generate_bmi_report_to_excel()
	{
		...
		$file_path = $this->ttwreis_common_lib->generate_bmi_report_to_excel_lib($date,$district_name, $school_name);
	...
	public function ttwreis_chronic_pie_view(){
		...
		$this->data = $this->ttwreis_common_lib->ttwreis_chronic_pie_view();
		
		$this->_render_page('ttwreis_admins/ttwreis_chronic_pie_view',$this->data);
	}
	 ...
	 public function basic_dashboard($date = FALSE, $request_duration = "Daily", $screening_duration = "Yearly")
	{
		...
		$count = 0;
		$screening_report = $this->ttwreis_common_model->get_all_screenings($date,$screening_duration);
		...
		$this->data['distslist'] = $this->ttwreis_common_model->get_all_district();
		$this->data = $this->ttwreis_common_lib->to_dashboard($date, $request_duration);
		$this->data['screening_report_count'] = $this->ttwreis_common_model->get_all_students_count();

		$data_req = $this->ttwreis_common_model->get_total_requests();
		...
		$this->_render_page('ttwreis_admins/ttwreis_basic_dashboard',$this->data);
	...
	function basic_dashboard_with_date()
	{
		...
		$this->data = $this->ttwreis_common_lib->basic_dashboard_with_date($today_date,$screening_pie_span,$dt_name,$school_name);
	...
	public function initiate_request_count_all_today_date()
	{
		...
		//$this->data['message'] = "";
		$document = $this->ttwreis_common_lib->get_initaite_requests_count_today_date($today_date);
	...
	public function get_show_ehr_details()
	{
		...
		$this->data['students_details'] = $this->ttwreis_common_model->get_show_ehr_details($request_type,$date,$school_name);
		//echo print_r($this->data['students_details'],TRUE); exit();
		$this->_render_page('ttwreis_admins/basic_show_ehr_view',$this->data);
	}
	public function drill_down_screening_to_students_load_ehr_new_dashboard($_id)
	{
		//$_id = $_POST['ehr_data'];
		
	$docs = $this->ttwreis_common_model->drill_down_screening_to_students_load_ehr_new_dashboard($_id);
		...
		//$this->data['history'] = $docs['history'];
	/*	echo '<pre>';
		echo print_r($this->data['BMI_report'],true);
		echo print_r($this->data['hb_report'],true);
		echo '</pre>';
		exit;*/
	...
	function drill_down_screening_to_students_load_ehr_count()
	{
		...
		$get_docs = $this->ttwreis_common_model->get_drilling_screenings_students_docs_count($docs_id);
		...
		$this->_render_page('ttwreis_admins/screening_to_students_load_ehr',$this->data);
	}
	/************** HB PIE default page************************/
	public function hb_pie_view()
	{
		...
		$this->data['district_list'] = $this->ttwreis_common_model->get_all_district();
		$this->data['total_students'] = $this->ttwreis_common_model->get_all_students_count();
		$this->_render_page('ttwreis_admins/hb_pie_view',$this->data);
	}
	...
	public function hb_pie_view_month_wise()
	{
		...
		$this->data = $this->ttwreis_common_lib->hb_pie_view_lib_month_wise($current_month,$district_name, $school_name,$student_type,$student_age);
		$this->output->set_output(json_encode($this->data));
	}
	...
	function drill_down_hb_to_students()
	{
		...
		$docs = $this->ttwreis_common_model->get_drill_down_to_hb_report($symptom_type,$month,$district_name,$school_name, $student_type, $student_age);
	...
	function drill_down_to_hb_report_students()
	{
		...
		$students = $this->ttwreis_common_model->get_drilling_hb_students_docs($UI_id, $selectedMonth);
		...
		$this->_render_page('ttwreis_admins/drill_down_to_hb_report_view',$this->data);
	}
	public function show_student_hb_graph($hospital_unique_id){
		...
		$hb_values = $this->ttwreis_common_model->get_student_hb_graph_values($hospital_unique_id);
		...
		$this->_render_page('ttwreis_admins/show_student_hb_graph_view',$final_hb_data);
		}
	...
	{
		//$sevier_count = $_POST['sevier_condition'];
		$student_type = $_POST['student_type'];
		$get_count = $this->ttwreis_common_model->get_sevier_count($student_type);
	...
	{
		//$sevier_count = $_POST['sevier_condition'];
		$get_count = $this->ttwreis_common_model->get_bmi_count();
		$get_count['screened_count'] = $this->ttwreis_common_model->get_screened_count();
		$get_count['attendance_count'] = $this->ttwreis_common_model->get_attendance_count();
		$get_count['sanitation_count'] = $this->ttwreis_common_model->get_sanitation_count();
		$get_count['chronic_count'] = $this->ttwreis_common_model->get_chronic_asthma_count();
		$get_count['emergency_total_count'] = $this->ttwreis_common_model->get_total_emergency_req_count();
		$this->output->set_output(json_encode($get_count));
	}
	public function get_bmi_students_docs()
	{
		...
		$this->data['get_bmi_docs'] = $this->ttwreis_common_model->get_bmi_students_docs($bmi_type);
		$this->data['bmi_case_type'] = $bmi_type;
		$this->_render_page('ttwreis_admins/ttwreis_show_bmi_issues_list_view', $this->data);
	}
	public function get_hb_students_docs()
	{
		...
		$this->data['get_hb_docs'] = $this->ttwreis_common_model->get_hb_students_docs($hb_type);
		$this->data['hb_case_type'] = $hb_type;
		
		$this->_render_page('ttwreis_admins/ttwreis_show_hb_issues_list_view', $this->data);
	}
	...
	{ 
		...
		$this->data['get_chronic_docs'] = $this->ttwreis_common_model->get_chronic_students_docs($chronic_type);
		$this->data['chronic_case_type'] = $chronic_type;
		
		$this->_render_page('ttwreis_admins/ttwreis_show_chronic_issues_list_view', $this->data);
	}
	public function get_field_officer_docs()
	{
		...
		$this->data['get_field_officer_docs'] = $this->ttwreis_common_model->get_field_officer_req_students_docs($fieldOfficerReq);
		$this->data['field_officer_requests'] = $fieldOfficerReq;
		
		$this->_render_page('ttwreis_admins/ttwreis_show_field_officer_report_list_view', $this->data);
	}
	public function get_emergency_req_students_docs()
	{
		...
		$this->data['get_emergency_docs'] = $this->ttwreis_common_model->get_emergency_req_students_docs($emergencyReq);
		$this->data['emergency_requests'] = $emergencyReq;
		
		$this->_render_page('ttwreis_admins/ttwreis_show_request_issues_list_view', $this->data);
	}
	...
	public function get_schools()
	{
		...
		$this->check_for_plan('get_schools_list');
		$dist_id = $_POST['dist_id'];
		$this->data = $this->ttwreis_common_model->get_schools_by_dist($dist_id);
		$this->output->set_output(json_encode($this->data));
	}
	public function monthly_request_charts()
	{
		...
		$this->data['distslist'] = $this->ttwreis_common_model->get_all_district();
		$this->_render_page('ttwreis_admins/get_month_wise_report', $this->data);
	...
	public function monthly_request_report_chart()
	{
		...
		$this->data['data']= $this->ttwreis_common_model->get_monthly_request_by_month($date_month,$school_name,$dt_name);
		$this->output->set_output(json_encode($this->data));
	...
	public function drill_down_chronic_student_list()
	{
		...
		$this->data['student_list'] = $this->ttwreis_common_model->drill_down_chronic_student_list($chronic_symtom);
		
		$this->_render_page('ttwreis_admins/monthly_chronic_student_list', $this->data);
	}
	public function drill_down_emergency_student_list(){
		...
		$this->data['student_list'] = $this->ttwreis_common_model->drill_down_emergency_student_list($emergency_symtom);
		
		$this->_render_page('ttwreis_admins/monthly_emergency_student_list', $this->data);
	}
	public function drill_down_normal_student_list(){
		...
		$this->data['student_list'] = $this->ttwreis_common_model->drill_down_normal_student_list($normal_symtom);
		
		$this->_render_page('ttwreis_admins/monthly_normal_student_list', $this->data);
	}

	public function show_doctor_treated_student($doc_id)
	 {
		$this->data['unique_id'] = $this->ttwreis_common_model->show_doctor_visiting_reports($doc_id);
		$this->_render_page('ttwreis_admins/field_dr_show_submitted_list',$this->data);
	}
	public function show_field_officer_student($doc_id)
	 {
		$this->data['unique_id'] = $this->ttwreis_common_model->show_field_officer_submit_student($doc_id);
		$this->_render_page('ttwreis_admins/field_officer_show_submitted_list',$this->data);
	}
	...
	public function init_health_summary_report_process()
	{
	 ...
	 /* echo print_r ($id_str ,true); 
	  ...
	  $health_summary_report = $this->ttwreis_common_lib->generate_health_summary_report($id_str);
	...
	public function hb_overall_dashboard(){
        ...
        $this->_render_page("ttwreis_admins/hb_overall_dashboard", $this->data);
    }
    ...
    public function get_hb_students_girls_from_bar()
        ...
        $this->data['scl_list'] = $this->ttwreis_common_model->get_hb_submitted_schools_data_with_symptom($symptom_type, $gender_type);
      ...
      /*  echo '<pre>';
        ...
        $this->_render_page("ttwreis_admins/hb_students_schools_list", $this->data);
  }
...
public function bmi_overall_dashboard(){
        ...
        $this->_render_page("ttwreis_admins/bmi_overall_dashboard", $this->data);
    }

public function get_screening_hb_data_by_gender()
    {
          $hb_boys = $this->ttwreis_common_model->get_screening_hb_data_for_boys();
          $this->data['hb_boys'] = json_encode($hb_boys);
          //echo print_r($this->data['hb_boys'], true); exit();

          $hb_girls = $this->ttwreis_common_model->get_screening_hb_data_for_girls();
    ...
    public function get_students_hb_list_scl_wise()
  {
  	...
  	$this->data['student_list'] = $this->ttwreis_common_model->get_students_hb_list_scl_wise($school_name, $symptom_type, $gender_type);

  	$this->_render_page("ttwreis_admins/students_hb_list_school_wise.php", $this->data);
  }
  ...
  public function get_bmi_students_girls_from_bar()
        ...
        $this->data['scl_list'] = $this->ttwreis_common_model->get_bmi_submitted_schools_data_with_symptom($symptom_type, $gender_type);
      ...
      /*  echo '<pre>';
        ...
        $this->_render_page("ttwreis_admins/bmi_students_schools_list.php", $this->data);
  }


public function get_screening_bmi_data_by_gender()
    {
          $bmi_boys = $this->ttwreis_common_model->get_screening_bmi_data_for_boys();
          $this->data['bmi_boys'] = json_encode($bmi_boys);
          //echo print_r($this->data['hb_boys'], true); exit();

          $bmi_girls = $this->ttwreis_common_model->get_screening_bmi_data_for_girls();
    ...
    public function get_students_bmi_list_scl_wise()
  {
    ...
    $this->data['student_list'] = $this->ttwreis_common_model->get_students_bmi_list_scl_wise($school_name, $symptom_type, $gender_type);

    $this->_render_page("ttwreis_admins/students_bmi_list_school_wise.php", $this->data);
  }
  ...
  public function get_date_wise_attendance_report()
  {
  	$today_date = $_POST['today_date'];
  	$count = 0;
  	$absent_report = $this->ttwreis_common_model->get_all_absent_data($today_date);
	...
	$this->data['absent_report_schools_list'] = $this->ttwreis_common_model->get_absent_pie_schools_data($today_date);
  ...
  public function show_tails_label_counts()
    {
        //$month = $_POST['month'];
        $student_type = $_POST['student_type'];
        $get_count = $this->ttwreis_common_model->get_bmi_count($student_type);
        //echo print_r($get_count[0]['under_weight'], true); exit();
        $get_count['screened_count'] = $this->ttwreis_common_model->get_screened_count();
        $get_count['attendance_count'] = $this->ttwreis_common_model->get_attendance_count();
        $get_count['sanitation_count'] = $this->ttwreis_common_model->get_sanitation_count();
        $get_count['chronic_count'] = $this->ttwreis_common_model->get_chronic_asthma_count($student_type);
        $get_count['requests_total_count'] = $this->ttwreis_common_model->get_total_emergency_req_count($student_type);
	...
	public function ttwreis_covid_cases()
	{
	$this->data['message'] = "";
	...
	$this->data['covid_details'] = $this->ttwreis_common_model->ttwreis_covid_cases_model($passing_date);

   
    $this->_render_page('ttwreis_admins/ttwreis_covid_cases_view',$this->data['covid_details']);
	}

	/*public function ttwreis_covid_cured_cases()
	{
	$this->data['message'] = "";
	...
	$this->data['covid_details'] = $this->ttwreis_common_model->ttwreis_covid_cured_cases_model($passing_date);

   
    $this->_render_page('ttwreis_admins/ttwreis_covid_cured_cases_view',$this->data['covid_details']);
	}*/
	...
	public function get_covid_cases_reports_span()
   {
    ...
    $this->data = $this->ttwreis_common_model->get_covid_cases_reports_span_model($start,$end);
    ...
    public function get_covid_cured_cases_reports_span()
   {
    ...
    $this->data = $this->ttwreis_common_model->get_covid_cured_cases_reports_span_model($start,$end);
    ...
    public function ttwreis_dr_not_responded()
	{
		$this->data['message'] = "";

		 $today_date=Date("Y-m-d");		 
       
		$this->data['students_details'] = $this->ttwreis_common_model->ttwreis_dr_not_responded_model($today_date);

		$this->_render_page('ttwreis_admins/ttwreis_dr_not_responded');
	}

	public function get_dr_not_responded_span()
   {
   	 $start = $this->input->post('start_date', true);
   	 $end = $this->input->post('end_date', true);
   
   	$this->data = $this->ttwreis_common_model->get_dr_not_responded_span_model($start, $end);
   ...
   if(!empty($this->data)){
    ...
    public function get_excel_doctor_not_responded_req_notes()
	 {
    	...
    	$get_reports = $this->ttwreis_common_lib->get_excel_dr_not_responded_reports_lib($start_date, $end_date);
	 ...
	 public function get_excel_covid_notes()
    {
    	...
    	$get_reports = $this->ttwreis_common_lib->get_excel_for_covidcases_lib($start_date, $end_date);
...
/************************ NEW Interface for admin DashBoard **********************************/
    ...
    public function get_daily_request_for_bar()
	{
		$start_date = $this->input->post('request_start_date', true);
	  	...
	  	$this->data = $this->ttwreis_common_model->get_daily_request_for_bar($start_date, $end_date, $district_name, $school_name); 
	...
	public function to_daily_health_request()
	{
		...
		$this->data['students_details'] = $this->ttwreis_common_model->to_daily_health_request($start_date,$end_date, $request_type,  $school_name, $district);

		$this->data['doctor_name'] = $this->ttwreis_common_model->get_doctor_names();

		$this->_render_page('ttwreis_admins/to_daily_health_request', $this->data);
	...
	public function get_daily_doc_response_with_name()
	{
		...
		$this->data = $this->ttwreis_common_model->get_daily_doc_response_with_name($start_date,$end_date, $request_type,  $school_name, $district);
	...
	public function get_doc_res_students_daily_req()
	{
		...
		$this->data['students_details'] = $this->ttwreis_common_model->get_doc_res_students_daily_req($start_date,$end_date, $doc_name);
	...
	public function get_dr_submitted_records_based_on_span()
	{
		...
		$this->data = $this->ttwreis_common_model->get_dr_submitted_records_based_on_span_model($start, $end, $dr_mail);
	...
	public function get_daily_updated_request_for_bar()
	{
		$start_date = $this->input->post('request_start_date', true);
	  	...
	  	$this->data = $this->ttwreis_common_model->get_daily_updated_request_for_bar($start_date, $end_date, $district_name, $school_name); 
	...
	public function get_daily_updated_health_request()
	{
		...
		$this->data['students_details'] = $this->ttwreis_common_model->get_daily_updated_health_request($start_date,$end_date, $request_type,$school_name, $district);
		
		$this->_render_page('ttwreis_admins/get_daily_updated_health_request', $this->data);
	...
	public function get_data_for_cards()
  	{
	  	...
	  	$this->data = $this->ttwreis_common_model->get_data_for_cards_with_filters($academic_year, $district_name, $school_name, $gender_type);
	 ...
	 public function do_stage1_refresh(){
	 	...
	 	$this->data = $this->ttwreis_common_model->do_stage1_refresh($span);
	 }
	...
	public function get_screening_pie_values()
	{
		...
		$this->data = $this->ttwreis_common_model->get_screening_pie_values($span);
	...
	public function tswreis_diseases_counts_report()
	{
		...
		$this->_render_page('ttwreis_admins/tswreis_diseases_counts_report', $this->data);
	}
	...
	public function get_schools_by_symptom()
	{
		...
		if($dt_name != 'All'){
			$dist = $this->ttwreis_common_model->get_dt_name_based_on_id($dt_name);
			$po_name = $dist[0]['dt_name'];
		}else{
			$po_name = 'All';
		}

		$this->data['students_list'] = $this->ttwreis_common_model->get_schools_by_symptom($symptom, $academic_year, $po_name, $school_name);
		...
		$this->_render_page('ttwreis_admins/symptom_wise_schools_list_view',$this->data);
	...
	public function get_students_by_symptom()
	{
		...
		$this->data['students_list'] = $this->ttwreis_common_model->get_students_by_symptom($symptom, $school, $academic_year);

		//$this->data['hospitals'] = $this->maharashtra_common_model->get_all_hospitals();
		$this->data['symptom_name'] = $symptom; 
		$this->data['academic_year'] = $academic_year; 
		$this->data['students_count'] = count($this->data['students_list']); 
		$this->_render_page('ttwreis_admins/symptom_wise_students_list_view',$this->data);
	...
	public function get_all_screening_diseases_counts()
	{
		...
		$abnormalities = $this->ttwreis_common_model->get_all_screening_diseases_counts($academic_year, $abnormalities, $po_name, $school_name);
	...
	public function get_disease_wise_school_health_status_for_all()
	{
		...
		$result = $this->ttwreis_common_model->get_schools_satus_for_dashboard_for_all($selected_opt);
	...
	public function get_disease_wise_school_health_status()
	{
		...
		$this->data = $this->ttwreis_common_model->get_schools_satus_for_dashboard($selected_opt, $district, $scl_zone, $type);
...
/*Quick Glance*/
	...
	public function show_quick_glance_label_counts()
    {
        ...
        if(isset($_POST['today_date']))
        {
            ...
            $data_req = $this->ttwreis_common_model->get_quick_glance_label_counts_model($today_date);
     ...
     public function get_anemia_records_based_on_span()
	{
	  ...
	  $this->data = $this->ttwreis_common_model->get_anemia_records_based_on_span_model($start, $end);
    ...
    public function get_day_to_day_glance_data_fetching()
	{
		...
		$this->data['field_offers'] = $this->ttwreis_common_model->get_field_officer_name();
		
		$this->_render_page('ttwreis_admins/day_to_day_glance_students_data_view', $this->data);
	}
	...
	public function get_fo_records_based_on_span()
	{
		...
		$this->data = $this->ttwreis_common_model->get_fo_records_based_on_span_model($start, $end, $fo_mail);
	...
	public function anemia_daily_health_request()
	{
	  ...
	  $this->data['anemic_cases'] = $this->ttwreis_common_model->get_hs_anemia_submitted_docs_students_model($date);
	  //echo print_r($date,true);
	  //echo print_r($status,true);
	  //exit();

	  $this->_render_page('ttwreis_admins/anemia_daily_health_request_view', $this->data);
    }
    ...
    public function surgery_daily_health_request()
	{
	  ...
	  $this->data['surgery_cases'] = $this->ttwreis_common_model->get_hs_surgery_submitted_docs_students_model($date,$status);

	  $this->_render_page('ttwreis_admins/surgery_daily_health_request_view', $this->data);
 	...
 	public function daily_doctor_visit_schools_list()
	{
	  ...
	  $this->data['doctor_visit'] = $this->ttwreis_common_model->get_daily_doctor_visit_schools_list_model($date, $status);

	    $this->data['dr_visit']  = $status;
	   	$this->data['date']  = $date;

	  $this->_render_page('ttwreis_admins/daily_doctor_visit_schools_list_view', $this->data);
	 ...
	 public function time_span_visiting_doctor_students_data()
	   {
	    ...
	    $this->data['dr_visit_student_list'] = $this->ttwreis_common_model->get_time_span_visiting_student_list_model($school_name,$start_date,$end_date);

	    $this->_render_page('ttwreis_admins/daily_doctor_visit_students_list_view', $this->data);
	   }
    ...
    $this->data['dr_visit_student_list'] = $this->ttwreis_common_model->get_daily_doctor_visit_student_list_model($date, $status, $school_name);
    ...
    public function get_dr_visit_schools_based_on_span()
	  {
	   ...
	   $this->data = $this->ttwreis_common_model->get_dr_visit_schools_based_on_span_model($start, $end);
...
/* Yearly Request Pie */	
	...
	public function get_total_counts_requests_pie()
    {
	 	...
	 	$this->data = $this->ttwreis_common_model->get_total_counts_requests_pie($academic_year, $district_name, $school_name, $gender_type);
    ...
    /*Chronic PiE*/
    /*Author BY Yoga narasimha*/
    public function get_chronic_counts_requests_pie()
	 {	   
	  
	   $this->data = $this->ttwreis_common_model->get_chronic_counts_requests_pie_model();
	  ...
	  public function get_chronic_students_from_pie()
	 {
	   ...
	   $this->data['students_list'] = $this->ttwreis_common_model->get_chronic_students_from_pie_model($symptom);

	   
	   $this->data['symptom_name'] =   $symptom; 
	   $this->data['students_count'] = count($this->data['students_list']); 

	   $this->_render_page('ttwreis_admins/chronic_symptom_wise_students_list_view',$this->data);
    ...
    public function total_request_page()
	{
		...
		$this->_render_page('ttwreis_admins/total_request_page', $this->data);
	}
	...
	public function total_requests_pie_with_filters()
	{
		...
		$this->data = $this->ttwreis_common_model->total_requests_pie_with_filters_model($req_type, $dist, $scl, $academic);
	...
	public function get_schools_list_with_dist_name()
	{
		...
		$this->data = $this->ttwreis_common_model->get_schools_by_district_name($dist_id);
	...
	public function get_schools_by_symptom_for_requests()
	{
		...
		$this->data['students_list'] = $this->ttwreis_common_model->get_schools_by_symptom_for_requests($symptom, $academic, $dist, $scl, $request_type);
		...
		$this->_render_page('ttwreis_admins/total_requests_school_list', $this->data);
	}
	...
	public function get_students_by_requests_symptom()
	{
		...
		$this->data['students_list'] = $this->ttwreis_common_model->get_students_by_requests_symptom($symptom, $academic, $dist, $scl, $request_type);
		...
		$this->_render_page('ttwreis_admins/get_students_by_requests_symptom', $this->data);
...
/*Hospitalized details*/
	...
	public function get_hospitalized_data_count()
	{
	   ...
	   $this->data = $this->ttwreis_common_model->get_hospitalized_data_count_model($start,$end);
	...
	public function get_hospitalized_data_table()
	{
    	...
    	$this->data["students_details"] = $this->ttwreis_common_model->get_hospitalized_data_table_model($start,$end, $hospital_district, $request_type);    	
    	$this->data['request_type'] = $request_type;
    	$this->data['hospital_district'] = $hospital_district;

		$this->_render_page('ttwreis_admins/hospitalised_students_table_data' , $this->data);
	...
	public function get_hospital_type_of_bar_count()
	{
	    ...
	    $end   = $this->input->post('end_date', true); 
	    //echo print_r($today_date, true); exit();
	    $this->data = $this->ttwreis_common_model->get_hospital_type_of_bar_count_model($start,$end); 
	...
	public function get_hospital_type_data_table()
    {
        ...
        $this->data['students_details'] = $this->ttwreis_common_model->get_hospital_type_data_table_model($start,$end, $hospital_type);

        $this->data['type'] = $hospital_type;
        //echo print_r($this->data,true); exit();
        $this->_render_page('ttwreis_admins/get_hospital_type_data_table_view', $this->data);
	...
	{        
	  ...
	  $data = $this->ttwreis_common_model->last_three_months_req_monitoring($start_date, $end_date);
    ...
    public function get_admitted_students_school_with_span()
	{
	  ...
	  $this->_render_page('ttwreis_admins/admitted_cases_school_wise_list', $this->data);
	}
	...
	public function get_admitted_cases_schools_list()
	{
		$start_date = $this->input->post('start_date', true);
	  	...
	  	$this->data = $this->ttwreis_common_model->get_admitted_cases_schools_list($start_date, $end_date, $request_type);
    ...
    $this->data = $this->ttwreis_common_model->get_hb_overall_data_count_model($start,$end); 
     ...
     public function get_hb_overall_data_table()
    {
        ...
        $this->data['schools_list'] = $this->ttwreis_common_model->get_hb_overall_data_table_model($start, $end, $hb_type);
        ...
        $this->_render_page('ttwreis_admins/hb_overall_schools_data_count_view', $this->data);
     ...
     public function hb_overall_students_data()
    {
        ...
        $this->data['students_details'] = $this->ttwreis_common_model->get_hb_overall_students_data_table_model($start_hb,$end_hb, $hb_type, $school_name);
        ...
        $this->_render_page('ttwreis_admins/hb_overall_students_data_view', $this->data);      
...
/*HB Gender wise*/
	...
	public function get_hb_gender_wise_data_count()
    {
	    ...
	    $this->data = $this->ttwreis_common_model->get_hb_gender_wise_data_count_model($start,$end); 
    ...
    public function get_hb_gender_wise_data_table()
    {
        ...
        $this->data['schools_list'] = $this->ttwreis_common_model->get_hb_gender_wise_data_table_model($start, $end, $hb_type, $hb_gender);
        ...
        $this->data['end_date']  = $end;
        $this->data['schools_count']  = count($this->data['schools_list']);
        $this->_render_page('ttwreis_admins/hb_gender_wise_schools_data_count_view', $this->data);
    ...
    public function hb_gender_wise_students_data()
    {
        ...
        $this->data['students_details'] = $this->ttwreis_common_model->get_hb_gender_wise_students_data_table_model($start_hb,$end_hb, $hb_type, $hb_gender, $school_name);
       ...
       // $this->data['date']  = $date_hb;
        ...
        $this->_render_page('ttwreis_admins/hb_gender_wise_students_data_view', $this->data);      
...
/*BMI Genderwise*/
    ...
    public function get_bmi_gender_wise_data_count()
    {
	    ...
	    $this->data = $this->ttwreis_common_model->get_bmi_gender_wise_data_count_model($start,$end); 
    ...
    public function get_bmi_gender_wise_data_table()
    {
        ...
        $this->data['schools_list'] = $this->ttwreis_common_model->get_bmi_gender_wise_data_table_model($start, $end, $bmi_type, $bmi_gender);
        //echo print_r($this->data,true); exit();
        $this->data['start_date']  = $start;
        $this->data['end_date']  = $end;
        ...
        $this->data['schools_count'] = count($this->data['schools_list']);
        $this->_render_page('ttwreis_admins/bmi_gender_wise_schools_data_count_view', $this->data);
    ...
    public function bmi_gender_wise_students_data()
    {
        ...
        $this->data['students_details'] = $this->ttwreis_common_model->get_bmi_gender_wise_students_data_table_model($start_bmi, $end_bmi, $bmi_type, $bmi_gender, $school_name);
        ...
        $this->_render_page('ttwreis_admins/bmi_gender_wise_students_data_view', $this->data);      
...
/*Sanitaion Counts*/  
	...
	public function get_sanitation_report_school_wise()
	{
		...
		$this->_render_page('ttwreis_admins/sanitation_display_report_view', $this->data);
	}
	...
	public function get_sanitation_data_schools_data()
	{
		...
		$this->data = $this->ttwreis_common_model->get_schools_list_based_on_sanitation_type($today_date, $sanitaion_type);
	...
	public function get_daily_attendance_report()
	 {
	   ...
	   $this->data = $this->ttwreis_common_model->get_daily_attendance_report_model($today_date, $district, $school_name);
	...
	public function get_attendance_data_for_bar_schools()
	{
		...
		$this->data['attendance_details'] = $this->ttwreis_common_model->get_attendance_data_for_bar_schools($date, $attendance_type, $district, $school);
		$sum = 0;
		...
		$this->_render_page('ttwreis_admins/attendance_data_for_schools', $this->data);
	}
	...
	public function get_attendance_data_for_bar_students()
	{
		...
		$this->data['students_list'] = $this->ttwreis_common_model->get_attendance_data_for_bar_students($symptom, $school, $date);
		...
		$this->_render_page('ttwreis_admins/attendance_data_for_students', $this->data);
	}
/*Todays follow up cases*/

	public function panacea_today_followup_cases()
    {
    	$regular_followup_cases_from_requests = $this->ttwreis_common_model->get_regular_followup_cases_from_requests();
		...
		$this->data['regular_followups_closed'] = $this->ttwreis_common_model->get_regular_followup_closed_cases();

		$this->data['total_count'] = count($this->data['regular_followup_cases'])+ count($this->data['regular_followups_closed']);

    	$this->_render_page('ttwreis_admins/panacea_today_followup_cases', $this->data);
    }
...
/*Total schools*/  
	...
	public function getschoolsInformation()
   {
 	 ...
 	 $this->data = $this->ttwreis_common_model-> getschoolsInformation_model();
...
/*School Health Status*/
	public function refresh_for_create_db_school_zone_status()
	{
		...
		$type = $this->input->post('checks',true);
        //echo print_r($selected_opt,true);exit(); 
		$this->data = $this->ttwreis_common_model->refresh_for_create_db_school_zone_status($selected_opt, $district, $scl_zone, $type);
		if(!empty($this->data)){
		$this->output->set_output(json_encode($this->data));
		}else{
		$this->output->set_output(json_encode('No Data Available'));
	...
	public function get_school_health_status_zone_schools()
    {
    	...
    	$this->_render_page('ttwreis_admins/school_health_status_for_schools' , $this->data);
    }
    ...
    public function requests_notes()
    {
      ...
      $this->data['notes_data'] = $this->ttwreis_common_model->requests_notes_model($today_date);

      $this->_render_page('ttwreis_admins/requests_notes_view');
    }
    ...
    public function get_request_notes_based_on_time_span()
    {
      ...
      $this->data = $this->ttwreis_common_model->get_request_notes_based_on_time_span_model($start, $end);
    ...
    {        
        ...
        $get_notes_data = $this->ttwreis_common_lib->get_excel_for_request_notes($start, $end);
	...
	{
		$this->data['distslist'] = $this->ttwreis_common_model->get_all_district();
		$this->_render_page('ttwreis_admins/ttwreis_reports_download', $this->data);
	}
	...
	public function get_excel_for_screening_overall()
	{
		...
		$result = $this->ttwreis_common_lib->get_excel_for_screening_overall($dist, $scl, $academic);
	...
	public function get_excel_for_selected_field()
	{
		...
		if($requested == 'Get Request Report'){
			$result = $this->ttwreis_common_lib->get_excel_for_requests_span($dist, $scl, $start, $end);
		}elseif ($requested == 'Get Attendance Report') {
			$result = $this->ttwreis_common_lib->get_excel_for_attendance_span($dist, $scl, $start, $end);
		}elseif ($requested == 'Get Sanitation Report') {
			$result = $this->ttwreis_common_lib->get_excel_for_sanitation_span($dist, $scl, $start, $end);
		}elseif ($requested == 'Get HB Report') {
			$result = $this->ttwreis_common_lib->get_excel_for_hb_span($dist, $scl, $start, $end);
		}elseif ($requested == 'Get BMI Report') {
			$result = $this->ttwreis_common_lib->get_excel_for_bmi_span($dist, $scl, $start, $end);
		}		
		$this->output->set_output($result);
	}

	 public function tribal_covid_cases()
    {
    $this->data['message'] = "";
	...
	$this->data['covid_details'] = $this->ttwreis_common_model->tribal_covid_cases_model($passing_date);
   
    $this->_render_page('ttwreis_admins/tribal_covid_cases_view');
    }
      ...
      public function get_covid_cases_students()
   {
    ...
    $this->data = $this->ttwreis_common_model->get_covid_cases_students_model($start,$end);
     ...
     public function get_excel_covid_cases()
    {
     ...
     public function tribal_covid_cured_cases()
	    {
	    $this->data['message'] = "";
	    ...
	    $this->_render_page('ttwreis_admins/tribal_covid_cured_cases_view');
	    }
	   ...
	   public function get_covid_cured_cases_students()
	   {
	    ...
	    $this->data = $this->ttwreis_common_model->get_covid_cured_cases_students_model($start,$end);
	 ...
	 public function get_excel_covid_cured_cases()
	 {
    	...
    	$get_reports = $this->ttwreis_common_lib->get_excel_for_covid_cured_cases_lib($start_date, $end_date);
	  ...
	  public function disease_wise_students_list()
  {
        ...
        $this->_render_page('ttwreis_admins/disease_wise_students_list',$this->data);
  }
  ...
  public function get_month_wise_diseases()
 {
    ...
    $data = $this->ttwreis_common_model->get_data($start_date,$end_date, $selectedDistrict, $selectedSchool);
    $this->output->set_output(json_encode($data));
 }
  ...
  public function get_students_list_based_on_request_symptom()
  {
     ...
     // $selectedMonth = substr($_POST['selectedMonth'], 0,-3);
      ...
      $this->data['students'] = $this->ttwreis_common_model->get_students_list_based_on_request_symptom($symptomName, $symptomCategory, $selectedMonth_start, $selectedMonth_end, $selectedDistrict, $selectedSchool);
      ...
      $this->_render_page('ttwreis_admins/students_list_based_on_request_symptom',$this->data);
  }
  ...
  public function get_symptoms_monthly_tracking_excel()
    {    	
    	...
    	$file_path = $this->ttwreis_common_lib->get_symptoms_monthly_tracking_excel($selectedSchool, $selectedDistrict, $selectedMonth);
   ...
   public function get_students_for_admitted()
	{
	  ...
	  $this->data['students_list'] = $this->ttwreis_common_model->get_students_for_admitted($start_date, $end_date, $scl, $request_type);

	  $this->data['school'] = $scl;
	  $this->data['symptom_name'] = $request_type;
	  $this->data['students_count'] = count($this->data['students_list']);

	  $this->_render_page('ttwreis_admins/admitted_cases_students_wise_list', $this->data);
	}
	...
	function upgrade_class_schoolwise()
	{
	   ...
	   $students_data = $this->ttwreis_common_model->migrate_student_personal_info($school_name);
	  if($students_data)
	  {
	  		$this->session->set_flashdata('failed',"It seems to be already migrated. $school_name. Please cross check once");
			redirect('ttwreis_mgmt/ttwreis_upgrade_students_clases');
	  }
	  else
	  {
    ...
    {
    	$this->data['distslist'] = $this->ttwreis_common_model->get_all_district();
    	$this->_render_page('ttwreis_admins/get_trasferred_other_classes_count' , $this->data);
    }
    ...
    public function show_sanitation_submitted_pics()
	{
		...
		$this->data['pics'] = $this->ttwreis_common_model->show_sanitation_submitted_pics($school, $date);

		$this->data['sele_date']= $date;

		$this->_render_page('ttwreis_admins/show_sanitation_submitted_pics', $this->data);
	...
	{
		$this->data['distslist'] = $this->ttwreis_common_model->get_all_district();
		$this->_render_page('ttwreis_admins/send_message_to_schools', $this->data);
	}

	public function get_parent_health_registration()
    {
    	$this->data['distslist'] = $this->ttwreis_common_model->get_all_district();
    	$this->_render_page('ttwreis_admins/parent_registration_view', $this->data);
    ...
    public function maximum_raised_requests()
	{
		...
		$this->_render_page('ttwreis_admins/maximum_raised_requests_view',$this->data);
	}
	...
	{		
		...
		$data = $this->ttwreis_common_model->maximum_raised_requests_script_model($start_date, $end_date, $request_count);
    ...
    {
   		$this->data['distslist'] = $this->ttwreis_common_model->get_all_district();
   		$this->_render_page("ttwreis_admins/gender_wise_student_data_view" , $this->data);
    }
    ...
    public function get_students_data_genderwise()
    {
   	    ...
   	    $this->data = $this->ttwreis_common_model->get_students_data_genderwise($district_name, $school_name);
    ...
    public function get_classes_wise_male_female_data()
    {
   	...
   	$this->data = $this->ttwreis_common_model->get_classes_wise_male_female_data($district_name, $school_name);
    ...
    public function absent_report_for_date_wise()
	{
		...
		$this->data['absent_report_schools_list'] = $this->ttwreis_common_model->get_absent_pie_schools_data($date);
		$this->data['sanitation_report_schools_list'] = $this->ttwreis_common_model->get_sanitation_report_pie_schools_data($date);

		$this->output->set_output(json_encode($this->data));
	}


	public function ttwreis_dr_not_responded_docs()
	{
		$today_date =  date('Y-m-d');
		$passing_date = substr($today_date,0,-3);
		$this->data['students_details'] = $this->ttwreis_common_model->ttwreis_dr_not_responded_docs_model($passing_date);
		$this->_render_page('ttwreis_admins/ttwreis_doctor_not_responded');
	}
	...
	public function get_doctor_not_responded_span()
   {
   	...
   	$this->data = $this->ttwreis_common_model->get_doctor_not_responded_span_model($start, $end);
	...
	*/
	...
	public function panacea_blood_group_pie()
	{
		...
		$this->_render_page('ttwreis_admins/panacea_blood_group_pie', $this->data);
	}
	...
	*/
	...
	public function get_blood_group_wise_data()
	{
        ...
        $this->data = $this->ttwreis_common_model->get_blood_group_wise_data_modal($blood, $district);
...

    {
        ...
        $this->data['blood_group_details'] = $this->ttwreis_common_model->get_blood_group_clicking_data_modal($blood_group, $district);
      ...
      /*  echo print_r($this->data['blood_group_details'],true);
       ...
       $this->_render_page('ttwreis_admins/get_blood_group_clicking_data_view', $this->data);
     ...
     public function get_blood_groupwise_data_based_on_selected()
    {
        ...
        $this->data = $this->ttwreis_common_model->get_blood_groupwise_data_based_on_selected($blood,$district);
    ...
    public function panacea_aarogyasri_hospitals_list()
    {
      ...
      $this->_render_page('ttwreis_admins/panacea_aarogyasri_hospitals_list_view');
    }
	...
	*/
	...
	public function panacea_organ_transplant_hospitals_list()
	{
		...
		$this->_render_page('ttwreis_admins/panacea_organ_transplant_hospitals_view', $this->data);
	...
	public function get_organ_name_clicking_data()
	{
		...
		$this->_render_page('ttwreis_admins/get_organ_name_clicking_data_view', $this->data);
	...
	public function panacea_blood_blanks_report()
	{
		...
		//$this->data = "";
		$this->_render_page('ttwreis_admins/panacea_blood_blanks_report',$this->data);
	}
	...
	public function panacea_mgmt_dmho_numbers()
	{
		...
		//$this->data = "";
		$this->_render_page('ttwreis_admins/panacea_mgmt_dmho_numbers',$this->data);
	}
	...
	public function napkin_distribution_reports()
    {
      ...
      $this->data['napkins_data'] = $this->ttwreis_common_model->napkin_distribution_reports_model();

      $this->_render_page('ttwreis_admins/napkin_distribution_reports_view');
    }
    ...
    function import_detailed_school_information()
	{
		...
		$this->data = $this->ttwreis_common_lib->import_detailed_school_information($post);
		...
		{
			redirect('ttwreis_admins/ttwreis_imports_students');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('ttwreis_admins/ttwreis_imports_students', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
    ...
    {     
      ...
      $this->data['schools_data'] = $this->ttwreis_common_model->schools_overall_information_model();

      $this->_render_page('ttwreis_admins/schools_overall_information_view');
    ...
    public function get_hs_jobtype_based_on_span()
	{
		...
		$this->data = $this->ttwreis_common_model->get_hs_jobtype_based_on_span_model($district_name,$hs_job_type);
	...
	public function tt_welfare_ro_plant_incinarators()
	{

		$this->data['distslist'] = $this->panacea_common_model->get_all_district();

		$this->_render_page('ttwreis_admins/tt_welfare_ro_plant_incinarators_view', $this->data);
	...
	{
		$data = $this->ttwreis_common_model->get_ro_plants_incinarators_data_model();
	...
	public function get_incinarator_data()
	{
		...
		$data = $this->ttwreis_common_model->get_incinarator_data_model();
	...
	public function get_ro_plants_schools_drill()
	{
		...
		$this->data['school_details'] = $this->ttwreis_common_model->get_ro_plants_schools_drill_model($status);
        ...
        $this->_render_page('ttwreis_admins/tt_welfare_ro_plants_schools_drill_view', $this->data);
	...
	public function get_incinarators_schools_drill()
	{
		...
		$this->data['school_details'] = $this->ttwreis_common_model->get_incinarators_schools_drill_model($status);

		$this->data['incinarator_status'] = $status;

		$this->data['distslist'] = $this->panacea_common_model->get_all_district();
     
        $this->_render_page('ttwreis_admins/tt_welfare_incinarators_schools_drill_view', $this->data);
	...
	public function health_assistancts_status()
	{
		...
		$this->data['health_assis'] = $this->ttwreis_common_model->health_assistancts_status_modal($today_date);
		
		$this->data['cc_users'] = $this->ttwreis_common_model->get_field_officer_name();

		$this->_render_page('ttwreis_admins/health_assistancts_submitted_requessts', $this->data);
	...
	public function get_hs_submitted_records_based_on_span()
	{
		...
		$this->data = $this->ttwreis_common_model->get_hs_submitted_records_based_on_span_model($start, $end, $cc_mail);
	 ...
	 public function tribal_deadth_cases()
    {
	...
	$this->data['covid_details'] = $this->ttwreis_common_model->tribal_deadth_cases_model($passing_date);
   
    $this->_render_page('ttwreis_admins/tribal_deadth_cases_view');
     ...
     public function get_deadth_cases_students()
   {
    ...
    $this->data = $this->ttwreis_common_model->get_deadth_cases_students_model($start,$end);
   ...
   {
   	    $this->data['cc_names'] = $this->ttwreis_common_model->get_cc_user_names();
   	    $this->_render_page('ttwreis_admins/employees_tracking_dashboard', $this->data);
   }
   ...
   /* CC work load*/
	...
	{		
		...
		$this->data = $this->ttwreis_common_model->get_cc_work_based_on_span($start, $end, $rhso_name=null);
		//echo print_r($this->data, true); exit();
