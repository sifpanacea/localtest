...
class Panacea_cc extends My_Controller {
	...
	{
		redirect('panacea_cc/to_dashboard');
	}
	
	public function initiate_request()
	{
		$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_application_initiate',$this->data);
	}
	
	public function initiate_attendance()
	{
		$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_attendance_initiate',$this->data);
	}
	
	public function initiate_sanitation_report()
	{
		$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_sanitation_report',$this->data);
	}
	
	public function panacea_cc_states()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_states');
	    
	    $this->data = $this->panacea_common_lib->panacea_mgmt_states();
		
		//$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_states',$this->data);
	}
	
	public function panacea_cc_district()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_district');

        $this->data = $this->panacea_common_lib->panacea_mgmt_district();
		
		//$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_dist',$this->data);
	}
	
	public function panacea_cc_health_supervisors()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_health_supervisors');
        $this->data = $this->panacea_common_lib->panacea_mgmt_health_supervisors();
		
		//$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_health_supervisors',$this->data);
	}
	
	
	//////////////////////////////////////////////////////
	
	public function panacea_cc_schools()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_schools');

        $this->data = $this->panacea_common_lib->panacea_mgmt_schools();
		
		//$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_schools',$this->data);
	}
	
	//000000000000000000000000000000000000
	public function panacea_cc_classes()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_schools');
		...
		$this->_render_page('panacea_cc/panacea_cc_classes',$this->data);
	}
	
	//sssssssssssssssssssssssssssssssssssssssssss
	public function panacea_cc_sections()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_schools');
		...
		$this->_render_page('panacea_cc/panacea_cc_sections',$this->data);
	}
	
	//syyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy
	public function panacea_cc_symptoms()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_symptoms');

        $this->data = $this->panacea_common_lib->panacea_mgmt_symptoms();
		
		$this->_render_page('panacea_cc/panacea_cc_symptoms',$this->data);
	}
	
	public function panacea_cc_diagnostic()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_diagnostics');
	
		$this->data = $this->panacea_common_lib->panacea_mgmt_diagnostic();
	
		//$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_diagnostics',$this->data);
	}	
	
	public function panacea_cc_hospitals()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_hospitals');
	
		$this->data = $this->panacea_common_lib->panacea_mgmt_hospitals();
	
		//$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_hospitals',$this->data);
	}
	
	public function panacea_cc_emp()
	{
		$this->check_for_admin();
		$this->check_for_plan('panacea_cc_emp');
	
		$this->data = $this->panacea_common_lib->panacea_mgmt_emp();
	
		//$this->data = "";
		$this->_render_page('panacea_cc/panacea_cc_emp',$this->data);
	}
	...
	{
		$this->data["message"] = "";		
		$this->_render_page('panacea_cc/panacea_reports_ehr',$this->data);
	}
	...
	public function panacea_reports_display_ehr()
	{
		...
		$this->data = $this->panacea_common_lib->panacea_reports_display_ehr($post);
	 	...
	 	$this->_render_page('panacea_cc/panacea_reports_display_ehr',$this->data);
	}
	...
	public function panacea_reports_students()
	{
		...
		$this->_render_page('panacea_cc/panacea_reports_students',$this->data);
	}
	...
	public function panacea_reports_doctors()
	{
		...
		$this->_render_page('panacea_cc/panacea_reports_doctors',$this->data);
	}
	...
	public function panacea_reports_hospital()
	{
		...
		$this->_render_page('panacea_cc/panacea_reports_hospitals',$this->data);
	}
	...
	public function panacea_reports_school()
	{
		...
		//$this->data = "";
		$this->_render_page('panacea_cc/panacea_reports_schools',$this->data);
	}
	...
	public function panacea_reports_symptom()
	{
		...
		$this->_render_page('panacea_cc/panacea_reports_symptom',$this->data);
	}
	...
	function to_dashboard($date = FALSE, $request_duration = "Monthly", $screening_duration = "Yearly")
	{
		...
		$hs_req_docs  = $this->panacea_cc_model->get_hs_req_docs($collection);
		...
		$this->_render_page('panacea_cc/panacea_cc_dash', $this->data);
	...
	function to_dashboard_with_date()
	{
		...
		$this->data = $this->panacea_common_lib->to_dashboard_with_date($today_date,$request_pie_span,$screening_pie_span,$dt_name,$school_name);
	...
	function drill_down_screening_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_cc/drill_down_screening_to_students_load_ehr',$this->data);
	}
	
	public function drill_down_screening_to_students_load_ehr_doc($_id)
	{
		//$this->data['docs'] = $this->panacea_cc_model->drill_down_screening_to_students_load_ehr_doc($_id);
	...
	function drill_down_absent_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_cc/drill_down_absent_to_students_load_ehr',$this->data);
	}
	...
	function drilldown_request_to_districts()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$request_report = json_encode($this->panacea_common_model->drilldown_request_to_districts($data,$today_date,$request_pie_span,$dt_name,$school_name));
	...
	function drilling_request_to_schools()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$request_report = json_encode($this->panacea_common_model->get_drilling_request_schools($data,$today_date,$request_pie_span,$dt_name,$school_name));
		$this->output->set_output($request_report);
	}
	...
	function drill_down_request_to_students()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$docs = $this->panacea_common_model->get_drilling_request_students($data,$today_date,$request_pie_span,$dt_name,$school_name);
	...
	function drill_down_request_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_cc/drill_down_request_to_students_load_ehr',$this->data);
	}
	//========================================================================
	...
	function drilldown_identifiers_to_districts()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$identifiers_report = json_encode($this->panacea_common_model->drilldown_identifiers_to_districts($data,$today_date,$request_pie_span,$dt_name,$school_name));
	...
	function drilling_identifiers_to_schools()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$identifiers_report = json_encode($this->panacea_common_model->get_drilling_identifiers_schools($data,$today_date,$request_pie_span,$dt_name,$school_name));
		$this->output->set_output($identifiers_report);
	}
	...
	function drill_down_identifiers_to_students()
	{
		...
		$dt_name = $_POST["dt_name"];
		$school_name = $_POST["school_name"];
		$docs = $this->panacea_common_model->get_drilling_identifiers_students($data,$today_date,$request_pie_span,$dt_name,$school_name);
	...
	function drill_down_identifiers_to_students_load_ehr()
	{
		...
		$this->_render_page('panacea_cc/drill_down_identifiers_to_students_load_ehr',$this->data);
	}
	...
	function panacea_imports_diagnostic()
	{
		...
		$this->_render_page('panacea_cc/panacea_imports_diagnostic', $this->data);
	}
	...
	function import_diagnostic()
	{
		...
		{
			redirect('panacea_cc/panacea_cc_diagnostic');
	...
	function panacea_imports_hospital()
	{
		...
		$this->_render_page('panacea_cc/panacea_imports_hospital', $this->data);
	}
	...
	function import_hospital()
	{
		...
		{
			redirect('panacea_cc/panacea_cc_hospitals');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('panacea_cc/panacea_imports_hospital', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function panacea_imports_school()
	{
		...
		$this->_render_page('panacea_cc/panacea_imports_school', $this->data);
	}
	...
	function import_school()
	{
		...
		{
			redirect('panacea_cc/panacea_cc_schools');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('panacea_cc/panacea_imports_school', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function panacea_imports_health_supervisors()
	{
		...
		$this->_render_page('panacea_cc/panacea_imports_health_supervisors', $this->data);
	}
	...
	function import_health_supervisors()
	{
		...
		{
			redirect('panacea_cc/panacea_cc_health_supervisors');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('panacea_cc/panacea_imports_health_supervisors', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	function panacea_imports_students()
	{
		...
		$this->_render_page('panacea_cc/panacea_imports_students', $this->data);
	}
	...
	function import_students()
	{
		...
		{
			redirect('panacea_cc/panacea_reports_students');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			$this->_render_page('panacea_cc/panacea_imports_students', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
	...
	public function panacea_reports_students_filter()
	{
		...
		//$this->data = "";
		$this->_render_page('panacea_cc/panacea_reports_students_filter',$this->data);
	}
	...
	public function get_students_list()
	{
		...
		$this->data = $this->panacea_common_model->get_students_by_school_name_cc_user($school_name,$dist_name);
	
		//$this->data = "";
		$this->output->set_output(json_encode($this->data));
	}

	public function get_students_list_only()
	{
		$this->check_for_admin();
		$this->check_for_plan('get_students_list');
	...
	{
		$this->check_for_admin();
		$this->check_for_plan('get_schools_list_only');
		
		$this->data = $this->panacea_cc_model->get_schools_list_only();
		//$this->data = "";
		$this->output->set_output(json_encode($this->data));
	}
	...
	public function pie_export()
	{
		...
		$this->_render_page('panacea_cc/panacea_pie_export',$this->data);
	}
	...
	public function post_note() {
		...
		$token = $this->panacea_common_lib->insert_ehr_note($post,$username);
    ...
    function list_chronic_cases()
	{
	  ...
	  $total_rows = $this->panacea_common_model->tswreis_chronic_cases_count();
	  ...
	  $this->data['cases_old'] =$this->panacea_common_model->get_chronic_cases_model($config['per_page'],$page);
	  ...
	  $this->data['cases'] =$this->panacea_common_model->get_chronic_cases_model_for_data_table();
		
	  $this->_render_page('panacea_cc/chronic_case_report',$this->data);
	}
	...
	function create_schedule_followup()
	{
	  ...
	  $is_created = $this->panacea_common_model->create_schedule_followup_model($unique_id,$medication_schedule,$treatment_period,$start_date,$monthNames,$case_id);
	...
	public function chronic_pie_view(){
		...
		$this->_render_page('panacea_cc/chronic_pie_view',$this->data);
	}
	...
	public function add_news_feed_view() {
		...
		$this->_render_page ( 'panacea_cc/add_news_feed', $this->data );
	}
	...
	public function manage_news_feed_view() {
		...
		$this->data ['news_feeds'] = $this->panacea_common_model->get_all_news_feeds();
		$this->data ['message'] = "";
	
		$this->_render_page ( 'panacea_cc/manage_news_feed', $this->data );
	}
	public function delete_news_feed($nf_id) {
		$this->panacea_common_lib->delete_news_feed($nf_id);
		
		redirect ( 'panacea_cc/manage_news_feed_view' );
	}
	...
	public function extend_request_view() 
	{
		...
		$this->_render_page('panacea_cc/extend_request_view',$this->data);
	}
	
	public function extend_request()
	{
		$post = $_POST;
		$this->data = $this->panacea_common_model->get_reports_for_extend($post['uid']);
		$this->data['message'] = false;	
		$this->_render_page('panacea_cc/extend_request',$this->data);
	}
	
	public function app_access($doc_id)
	{
		$this->data = $this->panacea_common_lib->app_access($doc_id);
		$this->_render_page('panacea_cc/extend_request_app',$this->data);
	}
	...
	function hs_req_extend()
	{
		...
		if($req_return['return_error']){
			...
			redirect('panacea_cc/extend_request_view');
			//$this->manage_news_feed_view();
		}
	}
	...
	{
		$this->data['doc_id'] = $id;
		$this->_render_page('panacea_cc/ha_req_application_access',$this->data);
	}
	...
	public function feed_bmi_student() 
	 {
		$this->data = "";
		$this->data['message'] = "";
		$this->_render_page('panacea_cc/panacea_cc_feed_bmi',$this->data);
	}
	...
	public function show_bmi_student() 
	 {
		...
		$this->_render_page('panacea_cc/panacea_cc_show_bmi_graph',$this->data);
	}
	...
	public function student_bmi_graph(){
		...
		$bmi_value = $this->panacea_common_model->get_student_bmi_values($unique_id);
	...
	{
		$this->data["message"] = "";		
		$this->_render_page('panacea_cc/update_personal_info',$this->data);
	}
	
	public function panacea_update_personal_ehr_uid()
	{
		$post = $_POST;
		$this->data = $this->panacea_common_lib->panacea_update_personal_ehr_uid($post);
		
		$this->data['docscount'] = count($this->data['docs']);
	
		$this->_render_page('panacea_cc/panacea_update_personal_ehr',$this->data);
	...
	public function update_student_ehr()
	{
	  ...
	  $ehr_update = $this->panacea_common_model->update_student_ehr_model($unique_id,$update_profile); 
	  log_message("debug","photo_updateqwerty".print_r($ehr_update,true));
	   $this->data['message'] = 'Updated Successfully';
	 $this->_render_page('panacea_cc/update_personal_info',$this->data);
	}
	//  new hs request formhs_request
public function hs_request()
	{
		...
		$this->_render_page('panacea_cc/hs_initiate_request', $this->data);
	}
//submit hs request
...
//		echo print_r($doc_data,true);
  	  ...
  	  if ($initate_submit ) // the information has therefore been successfully saved in the db
			{
				...
				redirect('panacea_cc/hs_request');
			}
			else
			{
  		...
  		public function fetch_submited_requests_docs()
  	{
		...
		if(!empty($hs_req_chronic)){
  		...
  		$this->_render_page('panacea_cc/fetch_submited_requests_docs',$this->data);
  	}
  	//upadate request
...
/*
  	  ...
  	  if ($existing_update ) // the information has therefore been successfully saved in the db
			{
				...
				redirect('panacea_cc/fetch_submited_requests_docs');
			}
			else
			{
				$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
  		...
  		public function access_submited_request_docs($id)
  	{
		...
		$this->_render_page('panacea_cc/access_submited_request_docs',$this->data);
  	}
	...
	public function initiateBmiReport()
	{
			...
			$this->data  = "";
			$this->load->view('panacea_cc/panacea_cc_feed_bmi', $this->data);
	...
	{
		$monthly_bmi = array();
		$uniqueId   = $this->input->post('page1_StudentDetails_HospitalUniqueID');
		...
		$school_info = $this->tswreis_schools_common_model->get_school_info($schoolCode);
		...
		$is_exists = $this->panacea_cc_model ->check_if_doc_exists($uniqueId);
		if(!empty($is_exists))
		{
		   ...
		   }else if($bmi_count_value >= 30)
		   {
			...
			$existing_update = $this->tswreis_schools_common_model->update_bmi_values($ndate,$monthly_bmi, $uniqueId,$bmi_values_data);
				...
				if ($existing_update ) // the information has therefore been successfully saved in the db
				{
					...
					redirect('panacea_cc/initiateBmiReport');
				}
				else
				{
					$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
 ...
 public function update_bmi_values($month, $monthly_bmi, $unique_id)
    ...
    public function initiateHemoglobinReport()
	{
		...
		$this->data["district_code"] = strtoupper($email_array[0]);
	  	...
	  	$this->_render_page('panacea_cc/panacea_cc_hb_view', $this->data);
	}
 	...
 	public function create_hemoglobin_report()
  	{
		...
		$dist = explode(',', $school_name);
		$districtName = $dist[1];
		$is_exists  = $this->panacea_cc_model->check_if_doc_exists_in_hb($uniqueId);
		...
		if(!empty($is_exists))
		{
		   ...
		   if($hb_count_value < 13 )
		   {
			...
			$existing_update = $this->tswreis_schools_common_model->update_hb_values($ndate,$monthly_hb, $uniqueId);
			...
			if ($existing_update ) // the information has therefore been successfully saved in the db
			{
				...
				redirect('panacea_cc/initiateHemoglobinReport');
			}
			else
			{
				$this->session->set_flashdata('fail','Some thing went wrong! Try Again');
	...
	*/ 
	public function show_hb_student() 
	{
		...
		$this->data["school_code"]   = $email_array[1];
		$this->data["district_code"] = strtoupper($email_array[0]);
		$this->_render_page('panacea_cc/school_wise_show_hb_graph',$this->data);
	}
	/*
	*BMI Ajax function
	...
	*/ 
	public function student_hb_graph(){
		...
		$hb_value = $this->panacea_cc_model->get_student_hb_values($unique_id);
...
public function initiateAttendanceReport()
	{
		$this->data['districts_list'] =  $this->panacea_cc_model->get_all_district();

		$this->_render_page('panacea_cc/attendance_report_view', $this->data);
	}
public function get_schools_list_by_district()
	{
		...
		$this->data = $this->panacea_cc_model->get_schools_by_dist_id_model($dist_id);
		//$this->data = "";
		$this->output->set_output(json_encode($this->data));
	}	
public function reports_display_ehr_uid_new_html_static_hs()
	{
		...
		$school_code = $this->get_my_school_code();
		$school_info = $this->panacea_cc_model->get_school_info($school_code);
		$school_name = $school_info[0]['school_name'];

		$logged_in_user = $this->session->userdata("customer");
		$username       = $logged_in_user['username'];

        $this->data = $this->panacea_common_lib->reports_display_ehr_uid_new_html_static_hs($student_unique_id,$school_name);
		...
		$this->_render_page('panacea_cc/panacea_reports_display_ehr_new_dashboard',$this->data);
	}
	...
	function panacea_imports_bmi_values()
	{
		...
		$this->data['districts_list'] =  $this->panacea_cc_model->get_all_district();
		$this->data['message'] = "";
		$this->_render_page('panacea_cc/panacea_imports_bmi_values', $this->data );
	}
	function imports_bmi_values()
	{
		...
		if($this->data == "redirect_to_bmi_fn")
		{
			...
			redirect('panacea_cc/panacea_imports_bmi_values');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			/*$this->data = $this->get_district_school_name();*/
			$this->data = $this->panacea_cc_model->get_all_district();
			//$this->data['districts_list'] =  $this->panacea_cc_model->get_all_district();
			$this->_render_page('panacea_cc/panacea_imports_bmi_values', $this->data);
		}else if($this->data['error'] == 'file_upload_failed')
		{
	...
	function panacea_imports_hb_values()
	{
		...
		$this->data['districts_list'] =  $this->panacea_cc_model->get_all_district();
			...
			$this->data['message'] = "";
		$this->_render_page('panacea_cc/panacea_imports_hb_values', $this->data);
	}
	...
	function imports_hb_values()
	{
		...
		{
			redirect('panacea_cc/imported_hb_xl_sheet');
		}else if($this->data['error'] == 'excel_column_check_fail')
		{
			/*$this->data = $this->get_district_school_name();*/
			$this->_render_page('panacea_cc/panacea_imports_hb_values', $this->data);
	...
	public function create_attendence_report()
    {
        ...
        $district = $this->panacea_cc_model->get_dist_name_with_dist_id( $districtID);
        ...
        $added = $this->panacea_cc_model->create_attendence_report_model($doc_data, $doc_properties, $app_properties, $history);
        if($added)
        {
        ...
        {
            redirect('panacea_cc/initiateAttendanceReport');
        }

    }

    public function create_screening_info_view()
	{
		
		$this->data["message"]  = "";
		$this->_render_page('panacea_cc/create_screening_report_view',$this->data);
	}

	public function submit_screening_report()
	{
		...
		$general_problems = $this->input->post('general_problems');
		$ortho_problems = $this->input->post('ortho_problems');
		...
		$occular_diagnosis = $this->input->post('occular_diagnosis');
		...
		$compliaints = $this->input->post('compliaints');
		...
		$dental_referral_made = $this->input->post('dental_referral_made');
		  ...
		  $doc_data['page1']['Personal Information']['Mobile']           = array("country_code"=>"91","mob_num"=>$mobile);
          ...
          if(isset($_FILES) && !empty($_FILES))
	  {
		  ...
		  // $doc_data['doc_data']['widget_data']['page1']['Personal Information']['Photo'] = $photo_ele;
			...
			$doc_data['page4']['Doctor Check Up']['Ortho'] = is_array($postural_problems) ? $ortho_problems : [];
			...
			$doc_data['page6']['Without Glasses']['Right'] = $without_glasses_right;
			$doc_data['page6']['Without Glasses']['Left'] = $without_glasses_left;

			$doc_data['page6']['With Glasses']['Right'] = $with_glasses_right;
			$doc_data['page6']['With Glasses']['Left'] = $with_glasses_left;

			/*$doc_data['page6']['Slit Lamp Observartion']['Eye lids'] = $eye_lids;
			$doc_data['page6']['Slit Lamp Observartion']['Conjuctiva'] = $conjuctiva;
			$doc_data['page6']['Slit Lamp Observartion']['Cornea'] = $cornea;
			$doc_data['page6']['Slit Lamp Observartion']['Pupil'] = $pupil;
			$doc_data['page6']['Slit Lamp Observartion']['Compliaints'] = $compliaints;
			$doc_data['page6']['Slit Lamp Observartion']['Wearing Spectacles'] = $wearing_spectacles;

			$doc_data['page6']['Subjective Refraction'] = $subjective_refraction;*/

			$doc_data['page7']['Colour Blindness']['Right'] = $colour_blindness_right;
			$doc_data['page7']['Colour Blindness']['Left'] = $colour_blindness_left;

			$doc_data['page7']['Occular Diagnosis'] = $occular_diagnosis;
			...
			$doc_data['page8'][' Auditory Screening']['Right'] = $auditory_screening_right;
			$doc_data['page8'][' Auditory Screening']['Left'] = $auditory_screening_left;
			...
			$doc_data['page9']['Dental Check-up']['Oral Hygiene'] = $oral_hygiene;
			$doc_data['page9']['Dental Check-up']['Carious Teeth'] = $carious_teeth;
			$doc_data['page9']['Dental Check-up']['Flourosis'] = $flourosis;
			$doc_data['page9']['Dental Check-up']['Orthodontic Treatment'] = $orthodontics_treatment;
			$doc_data['page9']['Dental Check-up']['Indication for extraction'] = $indication_for_extraction;
			$doc_data['page9']['Dental Check-up']['root_canal_treatment'] = $root_canal_treatment;
			$doc_data['page9']['Dental Check-up']['Crowns'] = $crowns;
			$doc_data['page9']['Dental Check-up']['Fixed partial denture'] = $fixed_partial_denture;
			$doc_data['page9']['Dental Check-up']['Curettage'] = $curettage;
			$doc_data['page9']['Dental Check-up']['Referral Made'] = is_array($dental_referral_made) ? $dental_referral_made : [];
			$doc_data['page9']['Dental Check-up']['Result'] = $dental_result;
			//$doc_data['page9']['Dental Check-up']['Estimated Amount'] = $estimated_amount;
	  	...
	  	$added = $this->panacea_cc_model->create_screening_report_model($doc_data,$doc_properties,$app_properties,$history);
	  	if ($added ) // the information has therefore been successfully saved in the db
		{
			$this->session->set_flashdata('success','Screening Data Submitted successfully !!');
			redirect('panacea_cc/create_screening_info_view');
		}
		
		
	}

	/// Screening Report Update Functions======================
    ...
    /* $this->data["school_code"]   = $email_array[1];
     $this->data["district_code"] = strtoupper($email_array[0]);
     $this->data["message"] = "";*/
     $this->_render_page('panacea_cc/update_screening_info_view',$this->data);
	}
	...
	public function search_screening_info_by_unique_id()
	{
		...
		$this->data = $this->panacea_common_lib->get_study_circle_data_lib($post);

		$this->data['docscount'] = count($this->data['docs']);


		$this->_render_page('panacea_cc/get_screening_report_view',$this->data);
...
*/
		...
		$dental_referral_made = $this->input->post('dental_referral_made');
		  ...
		  $doc_data['page1']['Personal Information']['Date of Birth']    = $date_of_birth;
		  $doc_data['page1']['Personal Information']['Hospital Unique ID'] = $uniqueid;
		  $query = $this->panacea_cc_model->get_pf_photo($uniqueid);
		  ...
		  $doc_data['page3']['Physical Exam']['Blood Group']     	= $blood_group;
		   ...
		   // Student Photo
			...
			$doc_history = $this->panacea_cc_model->get_student_history($uniqueid);
			 	...
			 	if(isset($_FILES) && !empty($_FILES))
				{
				   ...
				   if(isset($_FILES['external_attachments']['name']) && !empty($_FILES['external_attachments']['name']))
				   {
				       ...
				       {			       
						  	...
						  	{
						        $config = array();
								$config['upload_path']   = UPLOADFOLDERDIR.'public/uploads/healthcare2016226112942701_con/files/external_files/';
								$config['allowed_types'] = '*';
								$config['max_size']      = '*';
								$config['encrypt_name']  = TRUE;
								...
								if (!is_dir($config['upload_path']))
								{
									mkdir(UPLOADFOLDERDIR."public/uploads/healthcare2016226112942701_con/files/external_files/",0777,TRUE);
								}
				...
				/* MEF Forms */
					   if(isset($_FILES['mef_files']['name']) && !empty($_FILES['mef_files']['name']))
					   {
					       ...
					       {			       
							  	...
							  	{
							        $config = array();
									$config['upload_path']   = UPLOADFOLDERDIR.'public/uploads/files/mef_external_files/';
									$config['allowed_types'] = '*';
									$config['max_size']      = '*';
									$config['encrypt_name']  = TRUE;
									...
									if (!is_dir($config['upload_path']))
									{
										mkdir(UPLOADFOLDERDIR."public/uploads/files/mef_external_files/",0777,TRUE);
									}
	  	...
	  	$added = $this->panacea_cc_model->update_screening_report_model($uniqueid, $doc_data,$history);
	  	if ($added ) // the information has therefore been successfully saved in the db
		{
			$this->session->set_flashdata('success','Screening Data updated successfully !!');
			redirect('panacea_cc/update_student_info_view');
		}
	...
	public function field_officer()
	{
		...
		$this->data ="";
		$this->data['distslist'] = $this->panacea_common_model->get_all_district();
		$this->_render_page('panacea_cc/field_officer', $this->data);
	}
	...
	public function submit_field_officer()
	{
		...
		$admitted_meditation      	= $this->input->post('admitted_medication',TRUE);
		$admitted_doctor_advice		= $this->input->post('doctor_advice',TRUE);
		//$admitted_tretment      	= $this->input->post('dr_advice_tretment',TRUE);
		...
		$review_meditation     		= $this->input->post('review_medication',TRUE);
		...
		///op patient		
		$doc_data['widget_data']['Out Patient']['doctor_name'] =  ($op_doctor_name) ? $op_doctor_name : "";
		$doc_data['widget_data']['Out Patient']['hospialt_name'] =  ($op_hospital_name) ? $op_hospital_name : "";
		$doc_data['widget_data']['Out Patient']['patient_details'] =  ($op_patient_details) ? $op_patient_details : "";
		$doc_data['widget_data']['Out Patient']['investigations'] =  ($op_investigation) ? $op_investigation : "";
		$doc_data['widget_data']['Out Patient']['review_date'] =  ($op_review_date) ? $op_review_date : "";
		$doc_data['widget_data']['Out Patient']['medication'] =  ($op_meditation) ? $op_meditation : "";		

		$doc_data['widget_data']['Emergency or Admitted']['doctor_name'] =  ($admitted_doctor_name) ? $admitted_doctor_name : "";
		$doc_data['widget_data']['Emergency or Admitted']['hospialt_name'] =  ($admitted_hospital_name) ? $admitted_hospital_name : "";
		$doc_data['widget_data']['Emergency or Admitted']['patient_details'] =  ($admitted_patient_details) ? $admitted_patient_details : "";
		$doc_data['widget_data']['Emergency or Admitted']['investigations'] =  ($admitted_investigation) ? $admitted_investigation : "";
		$doc_data['widget_data']['Emergency or Admitted']['Doctor Advice'] =  (!empty($admitted_doctor_advice)) ? implode(",", $admitted_doctor_advice) : "";
		//$doc_data['widget_data']['Emergency or Admitted']['Treatment'] =  ($admitted_tretment)? $admitted_tretment : "";
		$doc_data['widget_data']['Emergency or Admitted']['medication'] =  ($admitted_meditation) ? $admitted_meditation : "";
		$doc_data['widget_data']['Emergency or Admitted']['review_date'] =  ($admitted_review_date) ? $admitted_review_date : "";

		$doc_data['widget_data']['Review Cases']['doctor_name'] =  ($review_doctor_name) ? $review_doctor_name : "";
		$doc_data['widget_data']['Review Cases']['hospialt_name'] =  ($review_hospital_name) ? $review_hospital_name : "";
		$doc_data['widget_data']['Review Cases']['patient_details'] =  ($review_patient_details) ? $review_patient_details : "";
		$doc_data['widget_data']['Review Cases']['investigations'] =  ($review_investigation) ? $review_investigation : "";
		$doc_data['widget_data']['Review Cases']['medication'] =  ($review_meditation) ? $review_meditation : "";
		$doc_data['widget_data']['Review Cases']['review_date'] =  ($review_review_date) ? $review_review_date : "";
		$doc_data['widget_data']['Review Cases']['review_caseclose'] =  ($review_caseclose) ? $review_caseclose : "";
        ...
        if(strpos($index,'hs_req_attachments')!== false)
		 {
	        ...
	        else
	        {
				...
				$newly_created = $this->panacea_cc_model->submit_field_officer($doc_data,$doc_attachments, $doc_properties, $app_properties, $history);
				redirect('panacea_cc/field_officer');
	...
	function field_officer_chart() {
		...
		$this->_render_page('panacea_cc/field_officer_pie',$this->data);

	}
	function fetch_field_officer_reports() {

		$today_date= $_POST['today_date'];
		$reports = $this->panacea_cc_model->fetch_field_officer_reports($today_date);
	...
	public function drill_down_to_field_officer_reports(){
		...
		$this->data['student_list'] = $this->panacea_cc_model->drill_down_to_field_officer_reports_list($selectedCase, $selectedDate);
		$this->data['selected_case'] = $selectedCase;
		$this->data['selected_date'] = $selectedDate;
		$this->_render_page('panacea_cc/field_officer_submit_student_list',$this->data);
	  	
	}
	public function show_doctor_treated_student($doc_id)
	{
		$this->data['unique_id'] = $this->panacea_cc_model->show_field_officer_submit_student($doc_id);
		$this->_render_page('panacea_cc/field_officer_show_submitted_list',$this->data);
	}

	public function regular_followups_list()
	{
		$session_data = $this->session->userdata("customer");
		$email_id = $session_data['email'];
		//$username = $session_data['username'];
		$regular_followup_cases_from_requests = $this->panacea_cc_model->get_regular_followup_cases_from_requests($email_id);
		...
		$this->data['regular_followups_closed'] = $this->panacea_cc_model->get_regular_followup_closed_cases();

		$this->data['total_count'] = count($this->data['regular_followup_cases'])+ count($this->data['regular_followups_closed']);

		$this->_render_page('panacea_cc/regular_followups_list', $this->data);
	}

	public function notes_for_cc()
	{
		$session_data = $this->session->userdata("customer");
		$email_id = $session_data['email'];
		...
		$this->_render_page('panacea_cc/notes_for_cc', $this->data);
	}

	public function update_regular_followup_feed_data()
	{

		$this->form_validation->set_rules('student_id','Student Health ID','required');
		$this->form_validation->set_rules('case_id','Case ID','required');
		$this->form_validation->set_rules('feeding_date','Feed date','required');
		
		if($this->form_validation->run() == FALSE ){

			$this->load->view('panacea_cc/regular_followups_list');
			...
			$next_scheduled_date = $this->input->post('next_scheduled_date');

			$update = $this->panacea_cc_model->update_requests_followup_data($student_id
										,$case_id,$created_time,$medicine_details,$followup_desc, $next_scheduled_date);


			redirect('panacea_cc/regular_followups_list');

		}
		
	}

	public function close_followup_request()
	{
		$case_id = $_POST['followupcid'];

		$close_request = $this->panacea_cc_model->close_followup_request($case_id);

		if($close_request){
		$this->session->set_flashdata('success','Successfully Closed From Regular Followup List !!');
			redirect('panacea_cc/regular_followups_list');
		}
	}
	...
	public function get_student_photo_details()
	{
		
		$this->data['distslist'] = $this->panacea_common_model->get_all_district();

		$total_rows = $this->panacea_common_model->studentscount();
		$this->data['studentscount'] = $total_rows;

		//$this->data = "";
		$this->_render_page('panacea_cc/display_student_photos', $this->data);
	}

	public function get_other_classes_details()
	{		
		$this->data['distslist'] = $this->panacea_common_model->get_all_district();
		...
		$this->_render_page('panacea_cc/display_other_classes_students', $this->data);
	}


	public function transfer_dental_to_external_attachment()
	{
		$doc_id = $_POST['photo_doc_id'];
		$academic = $_POST['academic_year'];

		if(isset($doc_id) && !empty($doc_id)){
			$this->data['update_data'] = $this->panacea_cc_model->transfer_dental_to_external_attachment($doc_id, $academic);
		}

		redirect('panacea_cc/get_student_photo_details');
		
		///$this->_render_page('panacea_cc/display_student_photos', $this->data);
	}

	/*public function save_cc_request_notes()
	{
		$this->data = "";
	...
	public function saved_notes_for_cc()
	{
		$this->data = "";
		$this->_render_page('panacea_cc/saved_notes_for_cc', $this->data);
	}

	public function save_cc_notes_ref()
	{
		$post = $_POST;

		$getDistrict = explode(",", $post['school_name']);
		$district = $getDistrict[1];

		$school = $post['school_name'];

		if(isset($post['student_name']) && !empty($post['student_name'])){

			$getuid = explode(' , ', $post['student_name']);
		...
		$data = array(
				...
				"problem_info" => $post['problem_info'],
				"status" => $post['status_info'],
				"requestRaisedOrNot" => 0,
				"req_already_raised_by_hs" => isset($post['req_already_raised']) ? $post['req_already_raised'] : "No" 
			);
		...
		$save = $this->panacea_cc_model->save_cc_request_notes($data, $history);

		redirect("panacea_cc/notes_for_cc");
	}

	public function save_cc_calls_count()
	{
		$post = $_POST;

		$purpose = $post["purpose_type"];
		$call = $post["call_options"];
		...
		$save = $this->panacea_cc_model->save_cc_calls_count($purpose, $call, $history);

		redirect("panacea_cc/notes_for_cc");
	}

	public function date_wise_saved_notes()
	{
		...
		$this->data = $this->panacea_cc_model->get_saved_notes($start_date, $username);

		$this->output->set_output(json_encode($this->data));
	}

	public function get_student_recent_requests_data()
	{
		$studID = $this->input->post("stud", true);

		$data = explode(' , ', $studID);

		$id = $data[1];

		$this->data = $this->panacea_cc_model->get_student_recent_requests_data($id);

		$this->output->set_output(json_encode($this->data));
	}

	public function calls_data_date_wise()
	{
		...
		$this->data = $this->panacea_cc_model->calls_data_date_wise($date, $email);
