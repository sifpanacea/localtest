...
class Tswreis_schools extends My_Controller {
	...
	public function create_student()
	{
		...
		$this->_render_page('tswreis_schools/create_student_view',$this->data);
	...
	*/ 
	...
	public function update_student_ehr()
	{
	  ...
	  $ehr_update = $this->tswreis_schools_common_model->update_student_ehr_model($unique_id,$update_profile); 
